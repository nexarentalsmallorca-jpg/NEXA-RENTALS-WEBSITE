// app/[locale]/noleggio-scooter-palma-di-maiorca/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Pratico per borsa, casco o acquisti.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Portacellulare impermeabile",
    text: "Ideale per la navigazione a Palma di Maiorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Lucchetto",
    text: "Per soste sicure in città, al porto o in hotel.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "it") {
    return "/it/noleggio-scooter-palma-di-maiorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Palma di Maiorca | Scooter 125cc nel capoluogo | NEXA Rentals",
    description:
      "Noleggio scooter a Palma di Maiorca. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf ed esplora il centro storico, La Seu, Santa Catalina, Paseo Marítimo, il porto crociere e Maiorca.",
    keywords: [
      "noleggio scooter Palma di Maiorca",
      "affitto scooter Palma di Maiorca",
      "scooter 125cc Palma di Maiorca",
      "noleggio motorino Palma di Maiorca",
      "scooter a noleggio Palma di Maiorca",
      "scooter rental Palma de Mallorca",
      "noleggio scooter centro storico Palma",
      "affitto scooter centro storico Palma",
      "noleggio scooter Cattedrale Palma",
      "noleggio scooter La Seu Palma",
      "noleggio scooter Santa Catalina",
      "affitto scooter Santa Catalina",
      "noleggio scooter Paseo Marítimo",
      "noleggio scooter porto crociere Palma",
      "affitto scooter porto Palma",
      "noleggio scooter Cala Major",
      "noleggio scooter centro Palma",
      "noleggio scooter capoluogo Maiorca",
      "prenotare scooter online Palma di Maiorca",
      "NEXA Rentals Palma di Maiorca",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-palma-di-maiorca",
    },
    openGraph: {
      title: "Noleggio scooter Palma di Maiorca | NEXA Rentals",
      description:
        "Prenota online uno scooter 125cc per Palma di Maiorca, il centro storico, La Seu, Santa Catalina, Paseo Marítimo e il porto crociere. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-palma-di-maiorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Palma di Maiorca con NEXA Rentals",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterPalmaDiMaiorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter per Palma di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo direttamente a Magaluf. È una soluzione pratica per chi soggiorna a Palma di Maiorca, nel centro storico, a Santa Catalina, Cala Major, Portixol e nelle zone vicine.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da Palma di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da Palma di Maiorca puoi raggiungere la nostra sede in circa 20-25 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per visitare Palma di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è pratico per raggiungere il centro storico di Palma, la Cattedrale La Seu, Santa Catalina, Paseo Marítimo, il porto crociere, Cala Major, Portixol e altre località di Maiorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna a Palma di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Palma di Maiorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <Script
        id="nexa-schema-faq-palma-de-mallorca"
      ...
      <Script
        id="nexa-schema-business-palma-de-mallorca"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A circa 20–25 minuti da Palma di Maiorca
              </span>
            ...
            <h1>
              Noleggia uno scooter per Palma di Maiorca ed esplora liberamente
              il capoluogo.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un{" "}
              <strong>noleggio scooter a Palma di Maiorca</strong>, uno{" "}
              <strong>scooter a noleggio a Palma de Mallorca</strong> o uno{" "}
              <strong>scooter 125cc a Palma di Maiorca</strong>? Con NEXA
            ...
            <p className="nexa-hero-text small">
              Ideale per il centro storico di Palma, la Cattedrale La Seu, Santa
              Catalina, Paseo Marítimo, il porto crociere, Cala Major, Portixol
              e le escursioni giornaliere a Maiorca. Il ritiro e la riconsegna
              avvengono presso NEXA Rentals a Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Palma de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Per Palma di Maiorca, il centro storico, La Seu, Santa Catalina e il
          porto crociere
        </p>

        <div className="nexa-trust-logos">
          <span>Palma di Maiorca</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Raggiungi facilmente Palma di Maiorca, il centro storico e la
              costa.
            </h2>

            <p>
              Palma di Maiorca è perfetta per il centro storico, lo shopping, i
              ristoranti, la Cattedrale La Seu, Santa Catalina, Paseo Marítimo e
              il porto. Con uno scooter 125cc puoi esplorare il capoluogo e la
              costa con maggiore libertà, senza dover organizzare ogni
              spostamento in autobus, taxi o cercando parcheggio per l’auto.
            </p>

            <p>
              NEXA Rentals è una soluzione pratica per chi cerca un noleggio
              scooter a Palma di Maiorca, uno scooter a noleggio a Palma de
              Mallorca o un motorino nel centro di Palma. Prenoti online, paghi
              online e ritiri il tuo scooter direttamente a Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Palma di Maiorca e Maiorca</li>
              <li>Prenotazione e pagamento online</li>
              <li>Due caschi inclusi</li>
              <li>Bauletto da 50 litri per borsa, casco o acquisti</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota il tuo scooter per Palma di Maiorca in tre semplici
            passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Palma di Maiorca, Magaluf, Palmanova o il tuo itinerario
                sull’isola.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora lo scooter per Palma di Maiorca
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Noleggio scooter Palma de Mallorca
          </span>

          <h2>
            Per chi vuole scoprire Palma di Maiorca e l’isola in completa
            libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter Palma di Maiorca”, “affitto scooter
            Palma de Mallorca”, “noleggio scooter centro storico Palma”,
            “noleggio scooter Cattedrale Palma” o “noleggio scooter porto
            crociere Palma”, hai bisogno di una soluzione semplice:
            prenotazione online, pagamento sicuro e uno scooter 125cc per
            spostarti liberamente.
          </p>

          <p>
            Uno scooter è particolarmente pratico per gli spostamenti tra il
            centro storico di Palma, Santa Catalina, Paseo Marítimo, Cala Major,
            Portixol, Magaluf, Palmanova e altre località di Maiorca. NEXA
            Rentals offre una prenotazione online semplice e il ritiro a
            Magaluf. Al momento non offriamo un servizio di consegna, così la
            consegna del veicolo, il controllo dei documenti e la riconsegna
            vengono gestiti in modo chiaro e sicuro.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Noleggio scooter Palma di Maiorca</span>
            <span>Affitto scooter Palma de Mallorca</span>
            <span>Noleggio scooter centro storico Palma</span>
            <span>Noleggio scooter Cattedrale Palma</span>
            <span>Noleggio scooter porto crociere Palma</span>
            <span>Scooter 125cc Palma di Maiorca</span>
            <span>Noleggio motorino centro Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a Palma di Maiorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Posso prenotare uno scooter per Palma di Maiorca?
              </summary>
              <p>
                ...
                Palma di Maiorca, il centro storico, Santa Catalina, Cala Major
                e Portixol.
              </p>
            </details>
            ...
            <details>
              <summary>
                Quanto dista NEXA Rentals da Palma di Maiorca?
              </summary>
              <p>
                La nostra sede si trova a Magaluf. Da Palma di Maiorca puoi
                raggiungerci in circa 20-25 minuti in auto, a seconda del
                traffico. Il ritiro e la riconsegna avvengono direttamente
                presso NEXA Rentals a Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>
                È disponibile la consegna a Palma di Maiorca?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Palma di Maiorca?</h3>
            <p>
