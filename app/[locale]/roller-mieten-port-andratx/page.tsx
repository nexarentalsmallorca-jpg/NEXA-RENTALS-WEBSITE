// app/[locale]/roller-mieten-port-andratx/page.tsx
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Port d’Andratx | 125cc Scooter Südwest Mallorca | NEXA Rentals",
    description:
      "Roller mieten in Port d’Andratx / Puerto de Andratx. 125cc Scooter online bei NEXA Rentals buchen, in Magaluf abholen und Port d’Andratx, Andratx, Camp de Mar, Paguera und Südwest Mallorca flexibel entdecken.",
    keywords: [
      "Roller mieten Port Andratx",
      "Roller mieten Port d’Andratx",
      "Scooter mieten Port Andratx",
      "Scooter mieten Port d’Andratx",
      "125cc Roller Port Andratx",
      "Motorroller mieten Port Andratx",
      "Roller Verleih Port Andratx",
      "Scooter Rental Port Andratx",
      "Roller mieten Puerto de Andratx",
      "Scooter mieten Puerto de Andratx",
      "Roller mieten Andratx",
      "Scooter mieten Andratx",
      ...
      "Roller online buchen Port Andratx",
      "NEXA Rentals Port Andratx",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-port-andratx`,
    },
    openGraph: {
      title: "Roller mieten Port d’Andratx | NEXA Rentals Mallorca",
      description:
        "125cc Roller für Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar und Südwest Mallorca online buchen. Abholung bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-port-andratx`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Port d’Andratx bei NEXA Rentals Mallorca",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenPortAndratxPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich in Port d’Andratx einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist praktisch für Gäste aus Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar und Paguera.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Port d’Andratx entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Von Port d’Andratx erreichst du unseren Standort je nach Verkehr ungefähr in 25 bis 35 Minuten mit dem Auto. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Ist ein Roller praktisch für Port d’Andratx und Südwest Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Port d’Andratx, Andratx, Camp de Mar, Paguera, Santa Ponsa, Cala Fornells und den Südwesten Mallorcas flexibel entdecken möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung nach Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Port d’Andratx",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-port-andratx`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 25–35 Min. von Port d’Andratx entfernt
              </span>
            ...
            <h1>Roller mieten in Port d’Andratx und den Südwesten Mallorcas erleben.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Port d’Andratx</strong>,{" "}
              <strong>Scooter mieten Puerto de Andratx</strong> oder{" "}
            ...
            <p className="nexa-hero-text small">
              Ideal für Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar,
              Paguera, Cala Fornells, Santa Ponsa und schöne Küstenfahrten im
              Südwesten Mallorcas. Aktuell Abholung und Rückgabe nur bei NEXA
              Rentals in Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Port d’Andratx Südwest Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Für Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar und Paguera</p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Roller Verleih Port d’Andratx
            </span>

            <h2>Hafen, Berge und Küste im Südwesten Mallorcas flexibler entdecken.</h2>

            <p>
              Port d’Andratx ist einer der schönsten Orte im Südwesten Mallorcas:
              Hafen, Restaurants, Aussichtspunkte und Küstenstraßen. Mit einem
              125cc Roller kannst du Port d’Andratx, Andratx, Camp de Mar,
              Paguera, Cala Fornells und Santa Ponsa flexibler verbinden.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Port d’Andratx, Scooter mieten Puerto de Andratx oder
              Motorroller mieten Südwest Mallorca suchen. Du buchst online,
              bezahlst online und holst deinen Roller direkt in Magaluf ab.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Port d’Andratx und Südwest Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Port d’Andratx zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Port d’Andratx, Andratx, Camp de Mar oder deine Mallorca-Tour.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller für Port d’Andratx buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Für Gäste, die Port d’Andratx und den Südwesten Mallorcas unabhängig
            erleben möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Port d’Andratx”, “Scooter mieten Port
            Andratx”, “Roller mieten Puerto de Andratx”, “125cc Roller Andratx”
          ...
          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Port d’Andratx,
            Andratx, Camp de Mar, Paguera, Cala Fornells, Santa Ponsa, Magaluf
            und Palmanova. NEXA Rentals bietet dir eine einfache Online-Buchung
            und Abholung in Magaluf. Aktuell bieten wir keinen Lieferservice an,
            damit Übergabe, Dokumentencheck und Rückgabe klar und sicher bleiben.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Roller mieten Port d’Andratx</span>
            <span>Scooter mieten Port Andratx</span>
            <span>Roller mieten Puerto de Andratx</span>
            <span>Roller mieten Andratx</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten in Port d’Andratx</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Port d’Andratx buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für Port
                d’Andratx, Puerto de Andratx, Andratx, Camp de Mar und Paguera.
              </p>
            </details>

            <details>
              <summary>
                Wie weit ist NEXA Rentals von Port d’Andratx entfernt?
              </summary>
              <p>
                Unser Standort befindet sich in Magaluf. Von Port d’Andratx sind
                es je nach Verkehr ungefähr 25 bis 35 Minuten mit dem Auto.
            ...
            <details>
              <summary>Gibt es Lieferung nach Port d’Andratx?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Bereit für Port d’Andratx?</h3>
            <p>
