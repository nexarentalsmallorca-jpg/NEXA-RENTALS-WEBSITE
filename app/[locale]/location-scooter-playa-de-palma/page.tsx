// app/[locale]/location-scooter-playa-de-palma/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Idéal pour utiliser le GPS à Playa de Palma.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-playa-de-palma";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-playa-de-palma";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Playa de Palma | Scooter 125cc El Arenal | NEXA Rentals",
    description:
      "Location de scooter à Playa de Palma. Réservez un scooter 125cc en ligne dès 39 €, récupérez-le chez NEXA Rentals à Magaluf et découvrez Playa de Palma, El Arenal, S’Arenal, Can Pastilla, Palma et Majorque en toute liberté.",
    keywords: [
      "location scooter Playa de Palma",
      "louer un scooter Playa de Palma",
      "scooter 125cc Playa de Palma",
      "location de scooter Playa de Palma",
      "location deux roues Playa de Palma",
      "location scooter Ballermann",
      "louer un scooter Ballermann",
      "scooter 125cc Ballermann",
      "location scooter El Arenal",
      "louer un scooter El Arenal",
      "location scooter S’Arenal",
      "louer un scooter S’Arenal",
      "location scooter Can Pastilla",
      "louer un scooter Can Pastilla",
      "location scooter aéroport Palma",
      "location scooter Palma de Majorque",
      "réserver scooter Playa de Palma",
      "NEXA Rentals Playa de Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-playa-de-palma",
    },
    openGraph: {
      title: "Location scooter Playa de Palma | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour Playa de Palma, El Arenal, S’Arenal et Can Pastilla. Retrait chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-playa-de-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Playa de Palma avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterPlayaDePalmaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter à Playa de Palma ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Cette solution est pratique si vous séjournez à Playa de Palma, El Arenal, S’Arenal ou Can Pastilla.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de Playa de Palma ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis Playa de Palma, le trajet prend généralement environ 30 à 35 minutes en voiture selon la circulation. Le retrait et le retour standard s’effectuent directement chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Un scooter est-il pratique pour Playa de Palma et El Arenal ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour relier Playa de Palma, El Arenal, S’Arenal, Can Pastilla, Palma, Portixol, Cala Major et d’autres destinations de Majorque en toute liberté.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison à Playa de Palma est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison à Playa de Palma, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Playa de Palma",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Playa de Palma, Majorque",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <Script
        id="nexa-schema-faq-playa-de-palma"
      ...
      <Script
        id="nexa-schema-business-playa-de-palma"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                À environ 30 à 35 min de Playa de Palma
              </span>
            ...
            <h1>
              Location de scooter à Playa de Palma pour découvrir Majorque en
              toute liberté.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Playa de Palma</strong>, une{" "}
              <strong>location de scooter à El Arenal</strong> ou un{" "}
              <strong>scooter 125cc à Can Pastilla</strong> ? Chez NEXA Rentals,
            ...
            <p className="nexa-hero-text small">
              Une solution idéale pour Playa de Palma, El Arenal, S’Arenal, Can
              Pastilla, Palma, Portixol et vos excursions à Majorque. Parfait
              pour relier librement les plages, la ville, les restaurants et la
              côte.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Playa de Palma et El Arenal"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Pour Playa de Palma, El Arenal, S’Arenal et Can Pastilla</p>

        <div className="nexa-trust-logos">
          <span>Playa de Palma</span>
          <span>Ballermann</span>
          <span>El Arenal</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Reliez plus librement Playa de Palma, El Arenal et Palma.</h2>

            <p>
              Playa de Palma est idéale pour profiter de la plage, de la
              promenade, des restaurants, des hôtels et des excursions vers
              Palma ou Can Pastilla. Avec un scooter 125cc, vous vous déplacez
              plus librement sans dépendre des bus, des taxis ou d’une longue
              recherche de stationnement.
            </p>

            <p>
              NEXA Rentals est une solution pratique pour les voyageurs qui
              recherchent une location de scooter à Playa de Palma, un scooter
              125cc à El Arenal ou une location de deux-roues à Can Pastilla.
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Playa de Palma et Majorque</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter pour Playa de Palma en trois étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                location. La réservation est rapide, claire et idéale pour votre
                séjour à Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                scooter pour Playa de Palma, El Arenal, Palma ou votre excursion
                sur l’île.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour Playa de Palma
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs francophones qui souhaitent découvrir Playa de
            Palma et Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Playa de Palma
            », « louer un scooter à Playa de Palma », « location scooter El
            Arenal », « scooter 125cc Can Pastilla » ou « location scooter Palma
            de Majorque », vous cherchez une solution simple : réserver en
            ligne, payer en toute sécurité et vous déplacer librement avec un
            scooter 125cc.
          </p>

          <p>
            Un scooter est particulièrement pratique pour les trajets entre
            Playa de Palma, El Arenal, S’Arenal, Can Pastilla, Palma, Portixol,
            Cala Major, Magaluf et Palmanova. NEXA Rentals vous propose une
            réservation simple en ligne et un retrait à Magaluf. Pour une
            demande de livraison à Playa de Palma, contactez-nous avant de
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Louer un scooter Playa de Palma</span>
            <span>Location scooter Ballermann</span>
            <span>Location scooter El Arenal</span>
            <span>Location scooter S’Arenal</span>
            <span>Location scooter Can Pastilla</span>
            <span>Scooter 125cc Playa de Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Playa de Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Puis-je réserver un scooter pour Playa de Palma ?
              </summary>
              <p>
                ...
                est pratique pour Playa de Palma, El Arenal, S’Arenal et Can
                Pastilla.
              </p>
            </details>
            ...
            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de Playa de Palma
                ?
              </summary>
              <p>
                Notre agence se trouve à Magaluf. Depuis Playa de Palma, le
                trajet prend généralement environ 30 à 35 minutes en voiture
            ...
            <details>
              <summary>
                La livraison à Playa de Palma est-elle disponible ?
              </summary>
              <p>
                Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour
                une demande de livraison à Playa de Palma, contactez-nous avant
          ...
          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Playa de Palma ?</h3>
            <p>
