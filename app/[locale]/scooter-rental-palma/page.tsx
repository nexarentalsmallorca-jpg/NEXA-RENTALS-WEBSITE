...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Palma | 125cc Scooter Hire Palma | NEXA Rentals Mallorca",
    description:
      "Scooter rental in Palma and Mallorca. Book a 125cc scooter online with NEXA Rentals, collect it in Magaluf and explore Palma, Santa Catalina, Paseo Marítimo, Portixol and Can Pastilla freely.",
    keywords: [
      "scooter rental Palma",
      "scooter hire Palma",
      "125cc scooter Palma",
      "motor scooter rental Palma",
      "rent a scooter Palma",
      "cheap scooter rental Palma",
      "scooter rental near me Palma",
      "scooter rental Palma centre",
      "scooter hire Palma city",
      "125cc scooter Palma Mallorca",
      "scooter rental Santa Catalina",
      "scooter hire Paseo Marítimo Palma",
      "scooter rental Portixol",
      "scooter hire Can Pastilla",
      "scooter rental Palma coast",
      "scooter hire Mallorca capital",
      "book scooter online Palma",
      "Palma scooter rental prices",
      "NEXA Rentals Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-palma",
    },
    openGraph: {
      title: "Scooter Rental Palma | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Palma, Santa Catalina, Paseo Marítimo, Portixol and the surrounding coast. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Palma with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalPalmaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book a 125cc scooter online with NEXA Rentals and collect it directly in Magaluf. It is a practical option for exploring Palma, Santa Catalina, Paseo Marítimo, Portixol and Can Pastilla.",
        },
      },
      {
        "@type": "Question",
        name: "Where do I collect a scooter booked for Palma?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Is a scooter practical for Palma and the surrounding coast?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is practical for exploring Palma, Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla and other parts of Mallorca freely.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental for Palma",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            ...
            <h1>
              Rent a scooter for Palma and explore Mallorca’s capital freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Palma</strong>,{" "}
              <strong>scooter hire in Palma city</strong> or a{" "}
            ...
            <p className="nexa-hero-text small">
              Ideal for exploring Palma, Santa Catalina, Paseo Marítimo,
              Portixol, Can Pastilla and the surrounding coast. Perfect for
              reaching beaches, neighbourhoods, marinas and restaurants with
              greater freedom.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc scooter hire in Palma and Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For Palma, Santa Catalina, Paseo Marítimo, Portixol and Can Pastilla
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore Palma, Portixol and the surrounding coast more easily.
            </h2>

            <p>
              Palma combines historic streets, busy neighbourhoods, beaches,
              restaurants and a long waterfront. With a 125cc scooter, you can
              travel more easily between Palma’s centre, Santa Catalina, Paseo
              Marítimo, Portixol, Can Pastilla, Illetes and other nearby areas.
            </p>

            <p>
              NEXA Rentals is a practical choice for travellers looking for
              scooter rental in Palma, scooter hire in Palma city or a motor
              scooter for exploring Mallorca’s capital and coast. You book
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Palma and the surrounding coast</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book a scooter for Palma in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Palma, Portixol, Can Pastilla or your planned route around
                Mallorca.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Palma and Mallorca’s coast with
            complete freedom.
          </h2>

          <p>
            When you search for “scooter rental Palma”, “scooter hire Palma”,
            “rent a scooter Palma”, “125cc scooter Palma” or “cheap scooter
            rental Palma”, you need a simple solution: online booking, secure
            payment and a 125cc scooter that gives you the freedom to explore.
          </p>

          <p>
            A scooter is particularly practical for travelling between Palma,
            Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla, Illetes and
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Scooter hire Palma</span>
            <span>Rent a scooter Palma</span>
            <span>Scooter rental Santa Catalina</span>
            <span>Scooter hire Paseo Marítimo</span>
            <span>Scooter rental Portixol</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for Palma?</summary>
              <p>
                Yes. You can book a 125cc scooter online with NEXA Rentals and
                collect it directly in Magaluf. It is a practical option for
                Palma, Santa Catalina, Paseo Marítimo, Portixol and Can Pastilla.
              </p>
            </details>

            <details>
              <summary>Where do I collect a scooter booked for Palma?</summary>
              <p>
            ...
            <details>
              <summary>Is delivery available in Palma?</summary>
              <p>
