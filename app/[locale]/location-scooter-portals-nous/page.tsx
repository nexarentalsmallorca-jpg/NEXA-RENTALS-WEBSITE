...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Idéal pour utiliser le GPS autour de Portals Nous.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-portals-nous";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Portals Nous | Scooter 125cc Puerto Portals | NEXA Rentals",
    description:
      "Location de scooter à Portals Nous et Puerto Portals. Réservez un scooter 125cc en ligne dès 39 €, récupérez-le chez NEXA Rentals à Magaluf et découvrez Bendinat, Illetas, Costa d’en Blanes, Palmanova et le sud-ouest de Majorque.",
    keywords: [
      "location scooter Portals Nous",
      "louer un scooter Portals Nous",
      "scooter 125cc Portals Nous",
      "location de scooter Portals Nous",
      "location deux roues Portals Nous",
      "location scooter Puerto Portals",
      "louer un scooter Puerto Portals",
      "scooter 125cc Puerto Portals",
      "location scooter Bendinat",
      "louer un scooter Bendinat",
      "location scooter Illetas",
      "louer un scooter Illetas",
      "location scooter Illetes",
      "location scooter Costa d’en Blanes",
      "louer un scooter Costa d’en Blanes",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-portals-nous",
    },
    openGraph: {
      title: "Location scooter Portals Nous | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour Portals Nous, Puerto Portals, Bendinat, Illetas et Costa d’en Blanes. Retrait chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-portals-nous",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Portals Nous avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterPortalsNousPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter à Portals Nous ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Cette solution est pratique si vous séjournez à Portals Nous, Puerto Portals, Bendinat, Illetas ou Costa d’en Blanes.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de Portals Nous ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis Portals Nous, le trajet prend généralement environ 12 à 18 minutes en voiture selon la circulation. Le retrait et le retour standard s’effectuent directement chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Un scooter est-il pratique pour Portals Nous et Puerto Portals ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour découvrir librement Portals Nous, Puerto Portals, Bendinat, Illetas, Costa d’en Blanes, Palmanova, Magaluf et le sud-ouest de Majorque.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison à Portals Nous est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison à Portals Nous, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Portals Nous",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Portals Nous, Majorque",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                À environ 12 à 18 min de Portals Nous
              </span>
            ...
            <h1>
              Location de scooter à Portals Nous pour découvrir Puerto Portals
              en toute liberté.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Portals Nous</strong>, une{" "}
              <strong>location de scooter à Puerto Portals</strong> ou un{" "}
              <strong>scooter 125cc à Bendinat</strong> ? Chez NEXA Rentals,
            ...
            <p className="nexa-hero-text small">
              Une solution idéale pour Portals Nous, Puerto Portals, Bendinat,
              Illetas, Costa d’en Blanes, Palmanova, Magaluf et le sud-ouest de
              Majorque.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Puerto Portals et Portals Nous"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Pour Portals Nous, Puerto Portals, Bendinat, Illetas et Costa d’en
          Blanes
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Reliez plus facilement Puerto Portals, Bendinat et le sud-ouest
              de Majorque.
            </h2>

            <p>
              Portals Nous et Puerto Portals sont parfaits pour profiter du
              port, des restaurants, des hôtels, des plages et des trajets
              rapides vers Bendinat, Illetas, Palmanova ou Magaluf. Avec un
              scooter 125cc, vous vous déplacez plus librement sans dépendre des
              taxis ou des horaires de bus.
            </p>

            <p>
              NEXA Rentals est une solution pratique pour les voyageurs qui
              recherchent une location de scooter à Portals Nous, un scooter à
              Puerto Portals ou une location de deux-roues à Bendinat. Vous
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Portals Nous et Majorque</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter pour Portals Nous en trois étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                scooter pour Portals Nous, Puerto Portals, Bendinat ou votre
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour Portals Nous
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs francophones qui souhaitent découvrir Portals
            Nous et le sud-ouest de Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Portals Nous
            », « louer un scooter Portals Nous », « location scooter Puerto
            Portals », « scooter 125cc Bendinat » ou « location scooter Illetas
            », vous cherchez une solution simple : réserver en ligne, payer en
          ...
          <p>
            ...
            Portals Nous, Puerto Portals, Bendinat, Illetas, Costa d’en Blanes,
            Cala Major, Palmanova et Magaluf. NEXA Rentals vous propose une
            réservation simple en ligne et un retrait à Magaluf. Pour une
            demande de livraison à Portals Nous, contactez-nous avant de
            réserver afin de vérifier la disponibilité selon vos dates et votre
            adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter Portals Nous</span>
            <span>Louer un scooter Portals Nous</span>
            <span>Location scooter Puerto Portals</span>
            <span>Location scooter Bendinat</span>
            <span>Location scooter Illetas</span>
            <span>Location scooter Costa d’en Blanes</span>
            <span>Scooter 125cc Portals Nous</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Portals Nous</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Puis-je réserver un scooter pour Portals Nous ?
              </summary>
              <p>
                ...
                est pratique pour Portals Nous, Puerto Portals, Bendinat,
                Illetas et Costa d’en Blanes.
              </p>
            </details>

            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de Portals Nous ?
              </summary>
              <p>
                Notre agence se trouve à Magaluf. Depuis Portals Nous, le trajet
                prend généralement environ 12 à 18 minutes en voiture selon la
            ...
            <details>
              <summary>
                La livraison à Portals Nous est-elle disponible ?
              </summary>
              <p>
                Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour
                une demande de livraison à Portals Nous, contactez-nous avant de
          ...
          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Portals Nous ?</h3>
            <p>
