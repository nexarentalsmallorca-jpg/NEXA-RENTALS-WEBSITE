// app/[locale]/alquiler-scooter-puerto-andratx/page.tsx
...
const SEO_PATH = "/alquiler-scooter-puerto-andratx";
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por el suroeste de Mallorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title: "Alquiler scooter Puerto Andratx desde 39 € | NEXA",
    description:
      "Alquila un scooter 125 cc para Puerto de Andratx desde 39 €. Reserva online con NEXA Rentals, recoge en Magaluf y recorre el suroeste de Mallorca.",
    keywords: [
      "alquiler scooter Port Andratx",
      "alquiler scooter Port d’Andratx",
      "alquilar scooter Port Andratx",
      "alquilar scooter Port d’Andratx",
      "scooter 125cc Port Andratx",
      "alquiler moto scooter Port Andratx",
      "alquiler motos Puerto de Andratx",
      "scooter de alquiler Puerto de Andratx",
      "alquiler scooter Andratx",
      "alquilar scooter Andratx",
      "alquiler scooter Camp de Mar",
      "alquilar scooter Camp de Mar",
      "alquiler scooter Paguera",
      "alquilar scooter Paguera",
      "alquiler scooter Cala Fornells",
      "alquiler scooter suroeste Mallorca",
      "alquilar scooter suroeste Mallorca",
      "reservar scooter online Port Andratx",
      "NEXA Rentals Port Andratx",
    ...
    openGraph: {
      title: "Alquiler de scooter en Puerto de Andratx | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar y el suroeste de Mallorca. Recogida en NEXA Rentals, Magaluf.",
      url: canonicalUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Port d’Andratx con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function AlquilerScooterPuertoAndratxPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo directamente en nuestra oficina de Magaluf. Es una opción práctica si te alojas en Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar o Paguera.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se encuentra en Magaluf. Desde Port d’Andratx, nuestra oficina está a unos 25–35 minutos en coche, dependiendo del tráfico. La recogida y la devolución habituales se realizan directamente en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para recorrer Port d’Andratx y el suroeste de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es práctico para descubrir con libertad Port d’Andratx, Andratx, Camp de Mar, Paguera, Santa Ponsa, Cala Fornells y el suroeste de Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc para Port d’Andratx",
      price: "39",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Port d’Andratx",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <Script
        id="nexa-schema-faq-port-andratx"
      ...
      <Script
        id="nexa-schema-business-port-andratx"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A unos 25–35 minutos de Port d’Andratx
              </span>
            ...
            <h1>
              Alquila un scooter para Port d’Andratx y descubre el suroeste de
              Mallorca.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Port d’Andratx</strong>,{" "}
              <strong>alquilar un scooter en Puerto de Andratx</strong> o un{" "}
              <strong>scooter de 125 cc en el suroeste de Mallorca</strong>? Con
              NEXA Rentals puedes reservar online, pagar de forma segura y
              recoger tu scooter directamente en nuestra oficina de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal para recorrer Port d’Andratx, Puerto de Andratx, Andratx,
              Camp de Mar, Paguera, Cala Fornells, Santa Ponsa y las rutas
              costeras del suroeste de Mallorca. La recogida y la devolución se
              realizan exclusivamente en NEXA Rentals, Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter de 125 cc para Port d’Andratx y el suroeste de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar y Paguera
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Port d’Andratx
            </span>

            <h2>
              Descubre el puerto, las montañas y la costa del suroeste de
              Mallorca con libertad.
            </h2>

            <p>
              Port d’Andratx es uno de los destinos más atractivos del suroeste
              de Mallorca, con su puerto deportivo, restaurantes, miradores y
              carreteras costeras. Con un scooter de 125 cc puedes desplazarte
              más fácilmente entre Port d’Andratx, Andratx, Camp de Mar,
              Paguera, Cala Fornells y Santa Ponsa.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en Port d’Andratx, alquilar un scooter en Puerto de
              Andratx o una moto scooter en el suroeste de Mallorca. Reservas y
              pagas online, y después recoges el scooter directamente en
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Port d’Andratx y el suroeste de Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva tu scooter para Port d’Andratx en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                alquiler. El proceso de reserva es rápido, claro e ideal para
                tu estancia en el suroeste de Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Paga online de forma segura y reserva tu scooter para Port
                d’Andratx, Andratx, Camp de Mar o la ruta que tengas prevista
                por Mallorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva tu scooter para Port d’Andratx
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooter en Puerto de Andratx
          </span>

          <h2>
            Para viajeros que quieren descubrir Port d’Andratx y el suroeste
            de Mallorca con total libertad.
          </h2>

          <p>
            Cuando buscas “alquiler scooter Port d’Andratx”, “alquilar scooter
            Port Andratx”, “alquiler scooter Puerto de Andratx”, “scooter 125
            cc Andratx” o “alquiler scooter suroeste Mallorca”, necesitas una
            opción sencilla: reserva online, pago seguro y un scooter de 125 cc
            que te dé libertad para recorrer Mallorca.
          </p>

          <p>
            Un scooter resulta especialmente práctico para desplazarte entre
            Port d’Andratx, Andratx, Camp de Mar, Paguera, Cala Fornells, Santa
            Ponsa, Magaluf y Palmanova. NEXA Rentals ofrece una reserva online
            sencilla con recogida en Magaluf. Actualmente no ofrecemos servicio
            de entrega de scooters, por lo que la entrega del vehículo, la
            comprobación de documentos y la devolución habitual se gestionan
            directamente en nuestra oficina de Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Port d’Andratx</span>
            <span>Alquilar scooter Port Andratx</span>
            <span>Alquiler scooter Puerto de Andratx</span>
            <span>Alquiler scooter Andratx</span>
            <span>Alquiler scooter Camp de Mar</span>
            <span>Alquiler scooter Paguera</span>
            <span>Alquiler scooter suroeste Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Port d’Andratx</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Port d’Andratx?</summary>
              <p>
                Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals
                y recogerlo directamente en nuestra oficina de Magaluf. Es una
                opción práctica para Port d’Andratx, Puerto de Andratx, Andratx,
                Camp de Mar y Paguera.
              </p>
            </details>

            <details>
              <summary>¿A qué distancia está NEXA Rentals de Port d’Andratx?</summary>
              <p>
                Nuestra oficina está en Magaluf. Desde Port d’Andratx está a
                unos 25–35 minutos en coche, dependiendo del tráfico. La
                recogida y la devolución habituales se realizan directamente
                en NEXA Rentals, Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>¿Hay servicio de entrega en Port d’Andratx?</summary>
              <p>
                No. Actualmente no ofrecemos servicio de entrega de scooters.
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Port d’Andratx?</h3>
            <p>
