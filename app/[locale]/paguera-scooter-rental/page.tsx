// app/[locale]/paguera-scooter-rental/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal for navigation from Paguera across Mallorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Paguera Scooter Rental | 125cc Scooter Hire Peguera | NEXA Rentals",
    description:
      "Scooter rental in Paguera and Peguera, Mallorca. Book a 125cc scooter online from €39 with NEXA Rentals, pay securely and collect it in Magaluf, around 10 minutes from Paguera. Ideal for Paguera, Camp de Mar, Cala Fornells, Santa Ponsa and south-west Mallorca.",
    keywords: [
      "Paguera scooter rental",
      "scooter rental Paguera",
      "scooter rental Peguera",
      "scooter hire Paguera",
      "scooter hire Peguera",
      "motor scooter rental Paguera",
      "125cc scooter Paguera",
      "125cc scooter Peguera",
      "Paguera scooter rental Mallorca",
      "book scooter online Paguera",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/paguera-scooter-rental",
    },
    openGraph: {
      title:
        "Paguera Scooter Rental | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Paguera and south-west Mallorca. NEXA Rentals is around 10 minutes from Paguera, with collection and return at our Magaluf office.",
      url: "https://www.nexarentals.es/en/paguera-scooter-rental",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Paguera, Mallorca, with NEXA Rentals",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function PagueraScooterRentalPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Where can I rent a scooter in Paguera or Peguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "You can book your 125cc scooter online with NEXA Rentals and collect it from our office in Magaluf. NEXA Rentals is around 10 minutes from Paguera and is a practical choice if you are staying in Paguera, Peguera, Camp de Mar, Cala Fornells or Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        name: "How far is NEXA Rentals from Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is in Magaluf, around 10 minutes from Paguera by car or taxi. Collection and return take place directly at the NEXA Rentals office in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is scooter delivery available in Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. We do not currently provide a scooter delivery service in Paguera. Collection and return take place directly at NEXA Rentals in Magaluf, keeping the vehicle handover quick, secure and straightforward.",
        },
      },
      {
        "@type": "Question",
        name: "Can I pay online for my Paguera scooter rental?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What is included with scooter rental in Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental in Paguera, Mallorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Paguera scooter rental: hire a 125cc scooter and explore
              Mallorca freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Paguera</strong>,{" "}
              <strong>scooter hire in Peguera</strong> or a{" "}
              <strong>125cc scooter in Paguera, Mallorca</strong>? With NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal if you are staying in Paguera, Peguera, Cala Fornells, Camp
              de Mar, Santa Ponsa or elsewhere in south-west Mallorca and want
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Around 10 minutes from Paguera.</strong>
                <span>
                  NEXA Rentals is in Magaluf: book online, collect your scooter in
                  Magaluf and ride directly towards Paguera, Camp de Mar or
                  Santa Ponsa.
                </span>
              </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter rental in Paguera and south-west Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For travellers staying in Paguera and south-west
          Mallorca
        </p>

        <div className="nexa-trust-logos">
          <span>Paguera scooter rental</span>
          <span>Scooter rental Peguera</span>
          <span>10 min from Paguera</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Rent a scooter near Paguera with simple online booking.
            </h2>

            <p>
              Many travellers staying in Paguera or Peguera look for a reliable
            ...
            <p>
              NEXA Rentals is around 10 minutes from Paguera, making it a
              practical option if you are staying in Paguera, Cala Fornells,
              Camp de Mar, Santa Ponsa, Palmanova, Magaluf or Calvià. Explore
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Paguera and Mallorca</li>
              <li>Around 10 minutes from Paguera</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book your scooter for Paguera in just a few simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                quick, clear and ideal if you are staying in Paguera, Peguera
                or nearby areas.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                from Paguera. We will explain everything before you set off
                towards Paguera, the beach or your planned route.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Book your scooter for Paguera
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Paguera and Mallorca with
            complete freedom.
          </h2>

          <p>
            When you search for “Paguera scooter rental”, “scooter rental
            Paguera”, “scooter rental Peguera”, “motor scooter rental Paguera”
            or “125cc scooter Paguera Mallorca”, you probably want a simple
          ...
          <p>
            This page is particularly useful if you are staying in Paguera,
            Peguera, Cala Fornells, Camp de Mar, Santa Ponsa or elsewhere in
            south-west Mallorca. NEXA Rentals is in Magaluf, around 10 minutes
            from Paguera. We do not currently provide scooter delivery in
            Paguera: collection and return take place directly at NEXA Rentals
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Scooter rental Peguera</span>
            <span>125cc scooter Paguera</span>
            <span>Motor scooter rental Paguera</span>
            <span>Scooter hire Paguera</span>
            <span>Scooter rental Camp de Mar</span>
            <span>10 minutes from Paguera</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Paguera</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>How far is NEXA Rentals from Paguera?</summary>
              <p>
                NEXA Rentals is in Magaluf, around 10 minutes from Paguera. You
                can book online, collect your scooter in Magaluf and ride
                directly towards Paguera, Camp de Mar, Cala Fornells or Santa
                Ponsa.
              </p>
            </details>
            ...
            <details>
              <summary>
                Can I have the scooter delivered directly to Paguera?
              </summary>
              <p>
                No. We do not currently provide a scooter delivery service in
                Paguera. Collection and return take place directly at NEXA
            ...
            <details>
              <summary>
                Is NEXA Rentals a good option for Paguera, Peguera and Camp
                de Mar?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Paguera and Mallorca?</h3>
            <p>
              Book your 125cc scooter online and start directly from NEXA
              Rentals in Magaluf, around 10 minutes from Paguera.
            </p>
