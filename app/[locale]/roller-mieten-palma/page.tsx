// app/[locale]/roller-mieten-palma/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal für Navigation durch Palma und Mallorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Schloss",
    text: "Für sichere Stopps in der Stadt, am Strand oder Hotel.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Palma | 125cc Scooter Palma de Mallorca | NEXA Rentals",
    description:
      "Roller mieten in Palma und Palma de Mallorca. 125cc Scooter online bei NEXA Rentals buchen, in Magaluf abholen und Palma, Altstadt, Kathedrale, Santa Catalina, Paseo Marítimo und Mallorca flexibel entdecken.",
    keywords: [
      "Roller mieten Palma",
      "Scooter mieten Palma",
      "125cc Roller Palma",
      "Motorroller mieten Palma",
      "Roller Verleih Palma",
      ...
      "Scooter mieten Cala Major",
      "Roller mieten Mallorca Palma",
      "Roller online buchen Palma",
      "NEXA Rentals Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-palma`,
    },
    openGraph: {
      title: "Roller mieten Palma | NEXA Rentals Mallorca",
      description:
        "125cc Roller für Palma, Palma de Mallorca, Altstadt, Kathedrale, Santa Catalina und Cala Major online buchen. Abholung bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-palma`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Palma bei NEXA Rentals Mallorca",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenPalmaPage({ params }: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich in Palma einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist praktisch für Gäste aus Palma, Palma de Mallorca, Cala Major, Santa Catalina, Portixol und Umgebung.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Palma entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Von Palma erreichst du unseren Standort je nach Verkehr ungefähr in 20 bis 25 Minuten mit dem Auto. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Palma, die Altstadt, Santa Catalina, Paseo Marítimo, Cala Major, Portixol, Palmanova, Magaluf oder weitere Orte auf Mallorca flexibel verbinden möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung nach Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Palma",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-palma`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 20–25 Min. von Palma entfernt
              </span>
            ...
            <h1>Roller mieten in Palma und Mallorca ohne Wartezeit erleben.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Palma</strong>,{" "}
              <strong>Scooter mieten Palma de Mallorca</strong> oder{" "}
              <strong>125cc Roller Palma</strong>? Bei NEXA Rentals buchst du
              deinen Roller online, bezahlst sicher online und holst ihn direkt
              in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Palma Altstadt, Kathedrale La Seu, Santa Catalina, Paseo
              Marítimo, Cala Major, Portixol, Palmanova und Tagesausflüge auf
              Mallorca. Perfekt, wenn du Stadt, Strand, Hafen und Küste flexibel
              verbinden möchtest.
            </p>
      ...
      <section className="nexa-trust-section">
        <p>Für Palma, Palma de Mallorca, Altstadt, Santa Catalina und Cala Major</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Roller Verleih Palma</span>

            <h2>Palma, Altstadt und Küste flexibler verbinden.</h2>

            <p>
              Palma ist perfekt für Altstadt, Shopping, Restaurants, Santa
              Catalina, die Kathedrale La Seu und den Paseo Marítimo. Mit einem
              125cc Roller kannst du Palma und die Küste flexibler erleben, ohne
              jeden Weg mit Bus, Taxi oder Parkplatzsuche zu planen.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Palma, Scooter mieten Palma de Mallorca oder Motorroller
              mieten Palma suchen. Du buchst online, bezahlst online und holst
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Palma und Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Palma zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Palma, Magaluf, Palmanova oder deine Insel-Tour.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Scooter mieten Palma de Mallorca</span>

          <h2>
            Für Gäste, die Palma und Mallorca unabhängig entdecken möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Palma”, “Scooter mieten Palma”,
            “Roller mieten Palma de Mallorca”, “125cc Roller Palma” oder
            “Motorroller mieten Palma Altstadt” suchst, brauchst du eine
            einfache Lösung: online buchen, sicher bezahlen und mit einem 125cc
            Roller flexibel unterwegs sein.
          </p>

          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Palma, Santa
            Catalina, Paseo Marítimo, Cala Major, Portixol, Magaluf, Palmanova
            und weiteren Orten auf Mallorca. NEXA Rentals bietet dir eine
            einfache Online-Buchung und Abholung in Magaluf. Aktuell bieten wir
            keinen Lieferservice an, damit Übergabe, Dokumentencheck und
            Rückgabe klar und sicher bleiben.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Roller mieten Palma</span>
            <span>Scooter mieten Palma</span>
            <span>Roller mieten Palma de Mallorca</span>
            <span>125cc Roller Palma</span>
            <span>Roller mieten Santa Catalina</span>
            <span>Roller mieten Cala Major</span>
            <span>Motorroller mieten Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten in Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Palma buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für Palma,
                Palma de Mallorca, Santa Catalina, Cala Major und Portixol.
              </p>
            </details>

            <details>
              <summary>Wie weit ist NEXA Rentals von Palma entfernt?</summary>
              <p>
                Unser Standort befindet sich in Magaluf. Von Palma sind es je
                nach Verkehr ungefähr 20 bis 25 Minuten mit dem Auto. Abholung
                und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>Gibt es Lieferung nach Palma?</summary>
              <p>
