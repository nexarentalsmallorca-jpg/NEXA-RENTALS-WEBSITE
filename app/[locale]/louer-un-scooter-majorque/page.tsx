...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Antivol",
    text: "Pour stationner en sécurité à la plage, à l’hôtel ou près d’un point de vue.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/louer-un-scooter-majorque";
  }

  if (languageCode === "de") {
    return "/de/scooter-mieten-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title: "Louer un scooter à Majorque | Scooter 125cc | NEXA Rentals",
    description:
      "Louez un scooter 125cc à Majorque chez NEXA Rentals à Magaluf. Réservez et payez en ligne dès 39 €, puis récupérez votre scooter à l’agence. Deux casques, top case, antivol, support téléphone, kilométrage illimité et assurance de base inclus.",
    keywords: [
      "louer un scooter Majorque",
      "location scooter Majorque",
      "scooter location Majorque",
      "location scooter 125cc Majorque",
      "scooter 125cc Majorque",
      "louer scooter Magaluf",
      "location scooter Magaluf",
      "louer scooter Palmanova",
      "location scooter Palmanova",
      "louer scooter Santa Ponsa",
    ...
    alternates: {
      canonical: "https://www.nexarentals.es/fr/louer-un-scooter-majorque",
    },
    openGraph: {
      title: "Louer un scooter à Majorque | NEXA Rentals Magaluf",
      description:
        "Réservez un scooter 125cc à Majorque en ligne et récupérez-le chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/louer-un-scooter-majorque",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Louer un scooter à Majorque chez NEXA Rentals à Magaluf",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LouerUnScooterMajorquePage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const externalBookingHref = "/fr/home";
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Où puis-je louer un scooter à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement à notre agence de Magaluf. La récupération et le retour standards s’effectuent chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Puis-je payer la location du scooter en ligne ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Chez NEXA Rentals, vous pouvez réserver votre scooter et payer la location en ligne. Votre scooter 125cc est ainsi réservé pour les dates choisies.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison à l’hôtel est-elle disponible à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "La récupération et le retour standards s’effectuent chez NEXA Rentals à Magaluf. Une livraison à l’hôtel peut être disponible sur demande selon la zone, la date et l’adresse. Contactez-nous avant de réserver pour vérifier la disponibilité.",
        },
      },
    ],
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Louer un scooter à Majorque : réservez votre 125cc en ligne.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez où{" "}
              <strong>louer un scooter à Majorque</strong>, une{" "}
              <strong>location de scooter 125cc à Majorque</strong> ou un{" "}
              <strong>service de location de scooter à Majorque</strong> ? Chez
              NEXA Rentals, vous réservez votre scooter en ligne, payez la
              location en toute sécurité et récupérez facilement votre scooter
              125cc à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Idéal pour Magaluf, Palmanova, Palma Nova, Santa Ponsa, Paguera,
              Calvià, les journées à la plage, les points de vue, les
              restaurants et les excursions sans dépendre des taxis.
            </p>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Directement à Magaluf, à Majorque.</strong>

                <span>
                  NEXA Rentals se trouve à Magaluf : réservez en ligne,
                  récupérez votre scooter sur place et partez directement vers
                  la plage, Palmanova, Santa Ponsa ou Paguera.
                </span>
              </div>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Réservez en ligne, récupérez sur place</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-top">
                <Image
                  ...
                  alt="Louer un scooter à Majorque avec NEXA Rentals à Magaluf"
                  width={900}
                  height={620}
                  priority
      ...
      <section className="nexa-trust-section">
        <p>Apprécié des voyageurs francophones qui découvrent Majorque</p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Pourquoi NEXA Rentals ?
            </span>

            <h2>La manière simple de louer un scooter à Majorque.</h2>

            <p>
              De nombreux voyageurs recherchent un scooter à Majorque pour ne
              pas dépendre chaque jour des taxis, des bus ou des longues
              attentes. Chez NEXA Rentals, tout est plus simple : vous réservez
              votre scooter 125cc en ligne, payez en ligne et le récupérez
              directement à notre agence de Magaluf.
            </p>

            <p>
              Nos scooters sont parfaits pour les petits trajets, les journées
              à la plage et les excursions autour de Magaluf, Palmanova, Palma
              Nova, Portals Nous, Santa Ponsa, Paguera et Calvià. Vous montez,
              vous partez et découvrez Majorque à votre rythme.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              ...
              <li>Récupération directe à Magaluf</li>
              <li>Réservation et paiement en ligne</li>
              <li>Deux casques inclus</li>
              <li>
                Top case de 50 L pour un sac, un casque ou vos achats
              </li>
              <li>Support téléphone étanche pour la navigation</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter à Majorque en quelques étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                location. La réservation est rapide, claire et adaptée à votre
                séjour à Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Payez la location en ligne et réservez votre scooter pour les
                dates choisies. Votre véhicule est ainsi confirmé avant le
                début de votre journée de vacances.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Venez chez NEXA Rentals à Magaluf avec votre permis de conduire
                original et votre carte d’identité ou passeport. Nous vous
                expliquons tout, puis vous pouvez partir vers la plage,
                Palmanova, Santa Ponsa ou Paguera.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter à Majorque
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Louer un scooter à Majorque
          </span>

          <h2>
            Pour les voyageurs francophones qui souhaitent découvrir Majorque
            librement et à leur rythme.
          </h2>

          <p>
            Si vous recherchez « louer un scooter à Majorque », « location de
            scooter à Majorque », « scooter 125cc Majorque » ou « location
            scooter Magaluf », vous ne voulez pas d’une procédure compliquée,
            mais une solution rapide. NEXA Rentals vous propose des
            informations claires, une véritable réservation en ligne, un
            paiement sécurisé et un scooter pour découvrir Majorque librement.
          </p>

          <p>
            Cette page est particulièrement utile si vous séjournez à Magaluf,
            Palmanova, Palma Nova, Santa Ponsa, Paguera, Portals Nous ou dans le
            sud-ouest de Majorque. La récupération et le retour standards
            s’effectuent chez NEXA Rentals à Magaluf. Une livraison à l’hôtel
            peut être disponible sur demande selon la zone, la date et
            l’adresse. Contactez-nous avant de réserver pour vérifier la
            disponibilité.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Location deux-roues Majorque</span>
          ...
          <div className="nexa-faq-list">
            <details>
              ...
              <p>
                ...
                également accepté lorsqu’il est valide depuis au moins 3 ans.
                Les permis provisoires et les permis d’apprentissage ne sont
                pas acceptés.
              </p>
            </details>

            <details>
              <summary>Où dois-je récupérer le scooter ?</summary>

              <p>
                La récupération et le retour standards s’effectuent directement
                chez NEXA Rentals à Magaluf. Une livraison à l’hôtel peut être
                disponible sur demande selon la zone, la date et l’adresse.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Oui. Vous réservez et payez la location en ligne afin que votre
                scooter soit confirmé pour les dates choisies.
              </p>
            </details>
            ...
            <details>
              <summary>
                NEXA Rentals est-il bien situé pour Magaluf et Palmanova ?
              </summary>

              <p>
                Oui. Notre agence de Magaluf est idéalement située si vous
                séjournez à Magaluf, Palmanova, Palma Nova, Santa Ponsa,
                Paguera ou Calvià et souhaitez louer un scooter à Majorque.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Majorque ?</h3>
