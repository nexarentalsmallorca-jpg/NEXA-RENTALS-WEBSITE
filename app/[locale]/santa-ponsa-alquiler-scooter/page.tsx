...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Espacio práctico para una bolsa de playa, un casco o compras.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Soporte impermeable para móvil",
    text: "Ideal para orientarte desde Santa Ponsa por Mallorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Candado de seguridad",
    text: "Para estacionar con más tranquilidad en la playa, el hotel o los miradores.",
  },
  {
    image: "/images/ex5.png",
    title: "Seguro",
    text: "El seguro básico está incluido.",
  },
];
...
function getLanguageHref(languageCode: Locale) {
  ...
  if (languageCode === "es") {
    return "/es/santa-ponsa-alquiler-scooter";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Santa Ponsa alquiler scooter | Scooter de 125 cc en Nova Santa Ponsa | NEXA Rentals",
    description:
      "Alquiler de scooter en Santa Ponsa y Nova Santa Ponsa, Mallorca. Reserva online un scooter de 125 cc desde 39 € con NEXA Rentals, paga de forma segura y recógelo en Magaluf, a unos 10 minutos de Santa Ponsa.",
    keywords: [
      "Santa Ponsa alquiler scooter",
      "alquiler scooter Santa Ponsa",
      "alquiler scooter Nova Santa Ponsa",
      "alquilar scooter Santa Ponsa",
      "alquilar scooter Nova Santa Ponsa",
      "alquiler moto scooter Santa Ponsa",
      "scooter 125cc Santa Ponsa",
      "scooter 125cc Nova Santa Ponsa",
      "Santa Ponsa alquiler scooter Mallorca",
      "reservar scooter online Santa Ponsa",
      "alquiler scooter El Toro",
      "alquiler scooter Costa de la Calma",
      "alquiler scooter Port Adriano",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/santa-ponsa-alquiler-scooter",
    },
    openGraph: {
      title:
        "Santa Ponsa alquiler scooter | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Santa Ponsa y el suroeste de Mallorca. NEXA Rentals está a unos 10 minutos de Santa Ponsa, con recogida y devolución en Magaluf.",
      url: "https://www.nexarentals.es/es/santa-ponsa-alquiler-scooter",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Santa Ponsa, Mallorca, con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function SantaPonsaScooterRentalPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Dónde puedo alquilar un scooter en Santa Ponsa o Nova Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Puedes reservar online tu scooter de 125 cc con NEXA Rentals y recogerlo en nuestra oficina de Magaluf. NEXA Rentals está a unos 10 minutos de Santa Ponsa y es una opción práctica si te alojas en Santa Ponsa, Nova Santa Ponsa, El Toro, Costa de la Calma o Port Adriano.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals está en Magaluf, a unos 10 minutos de Santa Ponsa en coche o taxi. La recogida y la devolución se realizan directamente en la oficina de NEXA Rentals en Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. Actualmente no ofrecemos servicio de entrega de scooters en Santa Ponsa. La recogida y la devolución se realizan directamente en NEXA Rentals, Magaluf, para que la entrega del vehículo sea rápida, segura y sencilla.",
        },
      },
      {
        "@type": "Question",
        name: "¿Puedo pagar online el alquiler del scooter para Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar tu scooter online y pagar el alquiler por internet para que el scooter de 125 cc quede reservado durante las fechas seleccionadas.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aceptamos los permisos de moto A, A1 y A2. También puedes conducir un scooter de 125 cc con un permiso de coche de categoría B si tiene una antigüedad mínima de 3 años. No se aceptan permisos provisionales ni de aprendizaje.",
        },
      },
      {
        "@type": "Question",
        name: "¿Qué incluye el alquiler de scooter para Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals incluye dos cascos, un baúl de 50 litros, candado de seguridad, soporte impermeable para móvil, kilómetros ilimitados y seguro básico.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Santa Ponsa, Mallorca",
      price: "39",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Santa Ponsa, Nova Santa Ponsa, Mallorca",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Santa Ponsa alquiler scooter: alquila un scooter de 125 cc y descubre
              Mallorca con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Santa Ponsa</strong>,{" "}
              <strong>alquilar un scooter en Nova Santa Ponsa</strong> o un{" "}
              <strong>scooter de 125 cc en Santa Ponsa, Mallorca</strong>? Con NEXA
              Rentals puedes reservar online, pagar de forma segura y recoger tu
              scooter de 125 cc directamente en nuestra oficina de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal si te alojas en Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro,
              Port Adriano o cualquier otra zona del suroeste de Mallorca y
              quieres visitar playas, restaurantes, miradores y localidades
              cercanas sin depender de taxis.
            </p>

            <div className="nexa-hero-actions">
              <Link href={bookHref} className="nexa-primary-cta">
                Reserva tu scooter ahora
              </Link>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>A unos 10 minutos de Santa Ponsa.</strong>
                <span>
                  NEXA Rentals está en Magaluf: reserva online, recoge tu scooter
                  en Magaluf y conduce directamente hacia Santa Ponsa, El Toro o
                  Port Adriano.
                </span>
              </div>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Reserva online y recógelo en Magaluf</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en Santa Ponsa y el suroeste de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para viajeros que se alojan en Santa Ponsa y el suroeste de Mallorca
        </p>

        <div className="nexa-trust-logos">
          <span>Santa Ponsa alquiler scooter</span>
          <span>Alquiler scooter Nova Santa Ponsa</span>
          <span>A 10 min de Santa Ponsa</span>
          <span>El Toro</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              ¿Por qué elegir NEXA Rentals?
            </span>

            <h2>
              Alquila un scooter cerca de Santa Ponsa con una sencilla reserva online.
            </h2>

            <p>
              Muchos viajeros que se alojan en Santa Ponsa o Nova Santa Ponsa buscan un
              servicio fiable de alquiler de scooters en Mallorca para no
              depender cada día de taxis, autobuses o largas esperas. Con NEXA
              Rentals el proceso es sencillo: reserva online tu scooter de 125
              cc, paga por internet y recógelo en nuestra oficina de Magaluf.
            </p>

            <p>
              NEXA Rentals está a unos 10 minutos de Santa Ponsa, por lo que es una
              opción práctica si te alojas en Santa Ponsa, Costa de la Calma,
              El Toro, Port Adriano, Palmanova, Magaluf o Calvià. Descubre playas,
              calas, restaurantes y miradores a tu ritmo y disfruta de más
              libertad durante tus vacaciones en Mallorca.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Santa Ponsa y Mallorca</li>
              <li>A unos 10 minutos de Santa Ponsa</li>
              <li>Reserva online y pago seguro</li>
              <li>Dos cascos incluidos</li>
              <li>Baúl de 50 litros para una bolsa de playa, casco o compras</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva tu scooter para Santa Ponsa en unos sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                Elige tu scooter de 125 cc, la fecha y la duración del alquiler.
                La reserva es rápida, clara e ideal si te alojas en Santa Ponsa,
                Nova Santa Ponsa o las zonas cercanas.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                fechas de tus vacaciones. Así confirmas el vehículo antes de que
                comience el alquiler.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Acude a NEXA Rentals en Magaluf con tu permiso de conducir
                original y el pasaporte o documento de identidad. Nuestra
                oficina está a unos 10 minutos de Santa Ponsa. Te explicaremos todo
                antes de que comiences tu ruta.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva tu scooter para Santa Ponsa
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Para viajeros que quieren descubrir Santa Ponsa y Mallorca con total libertad.
          </h2>

          <p>
            Cuando buscas “Santa Ponsa alquiler scooter”, “alquiler scooter
            Santa Ponsa”, “alquiler scooter Nova Santa Ponsa”, “alquiler moto scooter
            Santa Ponsa” o “scooter 125 cc Santa Ponsa Mallorca”, probablemente quieres
            una solución sencilla. NEXA Rentals ofrece información clara,
            reserva online, pago seguro y un scooter para descubrir Mallorca.
          </p>

          <p>
            Esta página es especialmente útil si te alojas en Santa Ponsa, Nova Santa Ponsa,
            Costa de la Calma, El Toro, Port Adriano u otra zona del suroeste de
            Mallorca. NEXA Rentals está en Magaluf, a unos 10 minutos de Santa Ponsa.
            Actualmente no ofrecemos entrega de scooters en Santa Ponsa: la recogida
            y la devolución se realizan directamente en NEXA Rentals, Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Santa Ponsa alquiler scooter</span>
            <span>Alquiler scooter Santa Ponsa</span>
            <span>Alquiler scooter Nova Santa Ponsa</span>
            <span>Scooter 125 cc Santa Ponsa</span>
            <span>Alquiler moto scooter Santa Ponsa</span>
            <span>Alquilar scooter Santa Ponsa</span>
            <span>Alquiler scooter El Toro</span>
            <span>A 10 minutos de Santa Ponsa</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Santa Ponsa</h2>
          ...
          <div className="nexa-faq-list">
            <details>
              ...
              <p>
                ...
                categoría B si tiene al menos 3 años de antigüedad. No se
                aceptan permisos provisionales ni de aprendizaje.
              </p>
            </details>

            <details>
              <summary>¿A qué distancia está NEXA Rentals de Santa Ponsa?</summary>
              <p>
                NEXA Rentals está en Magaluf, a unos 10 minutos de Santa Ponsa.
                Puedes reservar online, recoger tu scooter en Magaluf y conducir
                hacia Santa Ponsa, El Toro, Costa de la Calma o Port Adriano.
              </p>
            </details>

            <details>
              <summary>
                ¿Puedo recibir el scooter directamente en Santa Ponsa?
              </summary>
              <p>
                No. Actualmente no ofrecemos servicio de entrega de scooters en
                Santa Ponsa. La recogida y la devolución se realizan directamente en
                NEXA Rentals, Magaluf.
              </p>
            </details>

            <details>
              <summary>¿Puedo pagar el scooter online?</summary>
              <p>
                Sí. Puedes reservar y pagar online para que el scooter quede
                reservado durante las fechas seleccionadas.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                ...
                soporte impermeable para móvil, kilómetros ilimitados y seguro básico.
              </p>
            </details>

            <details>
              <summary>
                ¿Es NEXA Rentals una buena opción para Santa Ponsa, Nova Santa Ponsa y El Toro?
              </summary>
              <p>
                Sí. NEXA Rentals es una opción práctica si te alojas en Santa Ponsa,
                Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano, Magaluf o
                Palmanova y quieres alquilar un scooter de 125 cc en Mallorca.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Santa Ponsa y Mallorca?</h3>
            <p>
              Reserva online tu scooter de 125 cc y comienza directamente desde
              NEXA Rentals, Magaluf, a unos 10 minutos de Santa Ponsa.
            </p>
      ...
      <footer className="nexa-seo-footer">
        <div className="nexa-seo-footer-inner">
          <div className="nexa-seo-footer-brand">
            ...
            />
            <p>
              NEXA Rentals · Alquiler de scooters y bicicletas eléctricas en Magaluf, Mallorca
            </p>
          </div>
