...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/mallorca-scooter-rental";
  }
  ...
  if (languageCode === "es") {
    return "/es/mallorca-alquiler-scooter";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Mallorca alquiler scooter | Scooters 125 cc desde 39 € | NEXA Rentals",
    description:
      "Alquiler de scooter en Mallorca con NEXA Rentals. Reserva online un scooter de 125 cc desde 39 € y recógelo en Magaluf. Ideal para Palmanova, Santa Ponsa, Palma, Paguera y el suroeste de Mallorca.",
    keywords: [
      "Mallorca alquiler scooter",
      "alquiler scooter Mallorca",
      "alquiler de scooter Mallorca",
      "alquilar scooter Mallorca",
      ...
      "alquiler scooter Palma",
      "alquiler scooter Paguera",
    ...
    alternates: {
      canonical: "https://www.nexarentals.es/es/mallorca-alquiler-scooter",
    },
    openGraph: {
      title: "Mallorca alquiler scooter | NEXA Rentals",
      description:
      ...
      url: "https://www.nexarentals.es/es/mallorca-alquiler-scooter",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Mallorca con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function MallorcaScooterRentalPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Alquiler de scooter en Mallorca · recogida en Magaluf
              </span>
            ...
            <h1>
              Alquila un scooter en Mallorca: reserva tu 125 cc online y
              descubre la isla con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Mallorca</strong>,{" "}
              <strong>alquilar un scooter en Mallorca</strong> o un{" "}
              <strong>scooter de 125 cc en Mallorca</strong>? Con NEXA Rentals
              puedes reservar online, pagar de forma segura y recogerlo
              directamente en nuestra oficina de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal para Magaluf, Palmanova, Santa Ponsa, Palma, Paguera,
              Camp de Mar, Portals Nous, Cala Vinyes y el suroeste de Mallorca.
              Precios desde 39 € por media jornada y 49 € por 24 horas, con los
              principales accesorios incluidos.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter de 125 cc de alquiler en Mallorca"
                  width={900}
                  height={720}
      ...
      <section className="nexa-trust-section">
        <p>Alquiler de scooter para Mallorca, Magaluf, Palmanova, Santa Ponsa y Palma</p>
      ...
      <section className="nexa-price-section">
        <div className="nexa-price-inner">
          ...
          <h2>Precios claros para alquilar un scooter en Mallorca.</h2>
          ...
          <div className="nexa-price-grid">
            ...
            <div className="nexa-price-card">
              <span className="nexa-price-badge">Fianza</span>
              <h3>Depósito de seguridad</h3>
              <p className="nexa-price-time">
                Se devuelve tras entregar correctamente el scooter
              </p>
              <div className="nexa-price-number">
                <span>por scooter</span>
                <strong>€150</strong>
              </div>
              <ul>
                <li>Importe de 150 € por scooter</li>
                <li>Reembolsable tras la devolución correcta</li>
                <li>Permiso de conducir original obligatorio</li>
                <li>Pasaporte o documento de identidad</li>
                <li>Comprobación en nuestra oficina</li>
                <li>Recogida y devolución en Magaluf</li>
              </ul>
