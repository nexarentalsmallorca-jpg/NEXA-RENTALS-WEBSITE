// app/[locale]/scooter-rental-palma-de-mallorca/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal for navigation around Palma and Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-palma-de-mallorca";
  }

  if (languageCode === "es") {
    return "/es/alquiler-scooter-palma-de-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Palma de Mallorca | 125cc Hire | NEXA Rentals",
    description:
      "Scooter rental in Palma de Mallorca. Book a 125cc scooter online with NEXA Rentals, collect it in Magaluf and explore Palma Old Town, Santa Catalina, Paseo Marítimo, Portixol and the coast freely.",
    keywords: [
      "scooter rental Palma de Mallorca",
      "scooter hire Palma de Mallorca",
      "rent a scooter Palma de Mallorca",
      "125cc scooter Palma de Mallorca",
      "motor scooter rental Palma de Mallorca",
      "cheap scooter rental Palma de Mallorca",
      "scooter rental near me Palma de Mallorca",
      "scooter rental Palma de Mallorca centre",
      "scooter hire Palma de Mallorca Old Town",
      "scooter rental near Palma Cathedral",
      "scooter rental Santa Catalina Palma",
      "scooter hire Paseo Marítimo Palma de Mallorca",
      "scooter rental Portixol Palma",
      "scooter hire Can Pastilla Mallorca",
      "scooter rental Palma de Mallorca coast",
      "scooter hire Mallorca capital",
      "book scooter online Palma de Mallorca",
      "Palma de Mallorca scooter rental prices",
      "NEXA Rentals Palma de Mallorca",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-palma-de-mallorca",
    },
    openGraph: {
      title: "Scooter Rental Palma de Mallorca | NEXA Rentals",
      description:
        "Book a 125cc scooter online for Palma de Mallorca, the Old Town, Santa Catalina, Paseo Marítimo, Portixol and the coast. Collection in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-palma-de-mallorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Palma de Mallorca with NEXA Rentals",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalPalmaDeMallorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book a 125cc scooter online with NEXA Rentals and collect it directly in Magaluf. It is a practical option for exploring Palma de Mallorca, the Old Town, Santa Catalina, Paseo Marítimo, Portixol and Can Pastilla.",
        },
      },
      {
        "@type": "Question",
        name: "Where do I collect a scooter booked for Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf. Standard collection and return take place directly at our office at C. Galeón, 13, Loc 57, 07181 Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for Palma de Mallorca and the coast?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is practical for exploring Palma de Mallorca, Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla and other parts of the island freely.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental for Palma de Mallorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Palma de Mallorca · Collection from NEXA Rentals in Magaluf
              </span>
            ...
            <h1>
              Rent a scooter for Palma de Mallorca and explore the city, coast
              and island freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Palma de Mallorca</strong>,{" "}
              <strong>scooter hire near Palma Old Town</strong> or a{" "}
              <strong>125cc scooter in Mallorca’s capital</strong>? With NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal for exploring Palma de Mallorca, the historic centre,
              Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla and the
              coast. Perfect for combining city sightseeing, beaches, marinas
              and restaurants with greater freedom.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc scooter hire in Palma de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For Palma de Mallorca, the Old Town, Santa Catalina, Portixol and the coast
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore Palma de Mallorca from the historic centre to the coast.
            </h2>

            <p>
              Palma de Mallorca combines a historic centre, the cathedral,
              lively neighbourhoods, beaches, restaurants and a long
              waterfront. With a 125cc scooter, you can travel more easily
              between Palma Old Town, Santa Catalina, Paseo Marítimo, Portixol,
              Can Pastilla, Illetes and other nearby areas.
            </p>

            <p>
              NEXA Rentals is a practical choice for travellers looking for
              scooter rental in Palma de Mallorca, scooter hire near the city
              centre or a motor scooter for exploring Mallorca’s capital and
              coast. You book online, pay online and collect your scooter
              directly in Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Palma de Mallorca and the coast</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book a scooter for Palma de Mallorca in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                booking process is quick, clear and ideal for your stay in
                Palma de Mallorca and the island.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Pay the rental price online and reserve your scooter for
                Palma de Mallorca, Portixol, Can Pastilla or your planned route
                around the island.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Book a scooter for Palma de Mallorca
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Palma de Mallorca from the Old
            Town to the coast with complete freedom.
          </h2>

          <p>
            When you search for “scooter rental Palma de Mallorca”, “scooter
            hire Palma de Mallorca”, “rent a scooter Palma de Mallorca”, “125cc
            scooter Palma de Mallorca” or “cheap scooter rental Palma de
            Mallorca”, you need a simple solution: online booking, secure
            payment and a 125cc scooter that gives you freedom to explore.
          </p>

          <p>
            A scooter is particularly practical for travelling between Palma
            Old Town, Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla,
            Illetes and other nearby areas. NEXA Rentals offers straightforward
            online booking and collection in Magaluf. We do not currently
            provide a scooter delivery service.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Scooter rental Palma de Mallorca</span>
            <span>Scooter hire Palma de Mallorca</span>
            <span>Rent a scooter Palma de Mallorca</span>
            <span>Scooter rental Palma Old Town</span>
            <span>Scooter hire near Palma Cathedral</span>
            <span>Scooter rental Portixol Palma</span>
            <span>Scooter rental Can Pastilla Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Palma de Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for Palma de Mallorca?</summary>
              <p>
                Yes. You can book a 125cc scooter online with NEXA Rentals and
                collect it directly in Magaluf. It is a practical option for
                Palma de Mallorca, the Old Town, Santa Catalina, Paseo Marítimo,
                Portixol and Can Pastilla.
              </p>
            </details>

            <details>
              <summary>Where do I collect a scooter booked for Palma de Mallorca?</summary>
              <p>
            ...
            <details>
              <summary>Is delivery available in Palma de Mallorca?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Palma de Mallorca?</h3>
            <p>
