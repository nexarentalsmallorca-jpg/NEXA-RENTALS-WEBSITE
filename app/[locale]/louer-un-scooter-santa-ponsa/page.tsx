// app/[locale]/louer-un-scooter-santa-ponsa/page.tsx
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/louer-un-scooter-santa-ponsa";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Louer un scooter à Santa Ponsa | Location scooter Majorque | NEXA Rentals",
    description:
      "Louez un scooter 125cc à Santa Ponsa dès 39 €. Réservez et payez en ligne, puis récupérez votre scooter chez NEXA Rentals à Magaluf, à environ 10 minutes de Santa Ponsa. Idéal pour Costa de la Calma, El Toro, Port Adriano et le sud-ouest de Majorque.",
    keywords: [
      "louer un scooter Santa Ponsa",
      "location scooter Santa Ponsa",
      "location de scooter Santa Ponsa",
      "location scooter Santa Ponsa Majorque",
      "scooter 125cc Santa Ponsa",
      "louer scooter 125cc Santa Ponsa",
      "location deux roues Santa Ponsa",
      "réserver scooter Santa Ponsa en ligne",
      "location scooter Costa de la Calma",
      "louer un scooter Costa de la Calma",
      "location scooter El Toro",
      "louer un scooter El Toro",
      "location scooter Port Adriano",
      "louer un scooter Port Adriano",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/louer-un-scooter-santa-ponsa",
    },
    openGraph: {
      title: "Louer un scooter à Santa Ponsa | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour Santa Ponsa et le sud-ouest de Majorque. NEXA Rentals se trouve à Magaluf, à environ 10 minutes de Santa Ponsa.",
      url: "https://www.nexarentals.es/fr/louer-un-scooter-santa-ponsa",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Louer un scooter à Santa Ponsa avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LouerUnScooterSantaPonsaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Où peut-on louer un scooter à Santa Ponsa ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer dans notre agence à Magaluf. NEXA Rentals se trouve à environ 10 minutes de Santa Ponsa et constitue une solution pratique pour les voyageurs séjournant à Santa Ponsa, Costa de la Calma, El Toro, Port Adriano ou Paguera.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf, à environ 10 minutes de Santa Ponsa en voiture ou en taxi selon la circulation. Le retrait et le retour standard s’effectuent directement dans notre agence à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "La livraison à Santa Ponsa est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison à Santa Ponsa, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location du scooter à Santa Ponsa ?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Santa Ponsa",
      priceCurrency: "EUR",
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Louer un scooter à Santa Ponsa pour découvrir Majorque en 125cc.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Santa Ponsa</strong>, souhaitez{" "}
              <strong>louer un scooter à Santa Ponsa</strong> ou réserver un{" "}
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>
                  À environ 10 minutes de Santa Ponsa.
                </strong>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Location de scooter à Santa Ponsa et dans le sud-ouest de Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        ...
        <div className="nexa-trust-logos">
          ...
          <span>Louer un scooter Santa Ponsa</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Louer un scooter près de Santa Ponsa avec une réservation simple
              en ligne.
            </h2>
            ...
            <p>
              ...
              est pratique pour les voyageurs séjournant à Santa Ponsa, Costa
              de la Calma, El Toro, Port Adriano, Paguera, Palmanova, Magaluf ou
              Calvià. Vous pouvez découvrir les plages, les criques, les
              restaurants et les points de vue à votre propre rythme.
            </p>
          </article>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Votre scooter pour Santa Ponsa en quelques étapes simples.
          </h2>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Location de scooter à Santa Ponsa
          </span>
          ...
          <p>
            Lorsque vous recherchez sur Google « louer un scooter à Santa
            Ponsa », « location scooter Santa Ponsa », « location de scooter à
            Santa Ponsa », « scooter 125cc Santa Ponsa » ou « location de
            deux-roues à Santa Ponsa », vous cherchez généralement une solution
            rapide et simple. NEXA Rentals vous propose une réservation claire,
            un paiement sécurisé en ligne et un scooter 125cc pour découvrir
            Majorque librement.
          </p>
          ...
          <p>
            ...
            10 minutes de Santa Ponsa. Le retrait standard s’effectue
            directement dans notre agence. Pour une demande de livraison à
            Santa Ponsa, contactez-nous avant de réserver afin de vérifier la
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>
            Questions sur la location de scooter à Santa Ponsa
          </h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              ...
              <p>
                ...
                Ponsa selon la circulation. Vous pouvez réserver en ligne,
                récupérer votre scooter à Magaluf et partir directement vers
                Santa Ponsa, Costa de la Calma, El Toro ou Port Adriano.
              </p>
            </details>

            <details>
              <summary>
                Peut-on faire livrer le scooter directement à Santa Ponsa ?
              </summary>

              <p>
                Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour
                une demande de livraison à Santa Ponsa, contactez-nous avant de
            ...
            <details>
              <summary>
                NEXA Rentals est-il pratique pour Santa Ponsa, El Toro et Port
                Adriano ?
              </summary>
