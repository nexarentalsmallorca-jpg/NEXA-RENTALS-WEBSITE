// app/[locale]/roller-mieten-santa-ponsa/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal für Navigation in Santa Ponsa und Umgebung.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Santa Ponsa | 125cc Scooter Südwest Mallorca | NEXA Rentals",
    description:
      "Roller mieten in Santa Ponsa. 125cc Scooter online bei NEXA Rentals buchen, in Magaluf abholen und Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano und Calvià flexibel entdecken.",
    keywords: [
      "Roller mieten Santa Ponsa",
      "Scooter mieten Santa Ponsa",
      "125cc Roller Santa Ponsa",
      "Motorroller mieten Santa Ponsa",
      "Roller Verleih Santa Ponsa",
      "Scooter Rental Santa Ponsa",
      "Roller mieten Nova Santa Ponsa",
      "Scooter mieten Nova Santa Ponsa",
      "Roller mieten Costa de la Calma",
      "Scooter mieten Costa de la Calma",
      ...
      "Roller online buchen Santa Ponsa",
      "NEXA Rentals Santa Ponsa",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-santa-ponsa`,
    },
    openGraph: {
      title: "Roller mieten Santa Ponsa | NEXA Rentals Mallorca",
      description:
        "125cc Roller für Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro und Port Adriano online buchen. Abholung bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-santa-ponsa`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Santa Ponsa bei NEXA Rentals Mallorca",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenSantaPonsaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich in Santa Ponsa einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist praktisch für Gäste aus Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro und Port Adriano.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Von Santa Ponsa erreichst du unseren Standort je nach Verkehr ungefähr in 10 bis 15 Minuten mit dem Auto. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Ist ein Roller praktisch für Santa Ponsa und Südwest Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano, Palmanova, Magaluf und den Südwesten Mallorcas flexibel entdecken möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung nach Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Santa Ponsa",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-santa-ponsa`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 10–15 Min. von Santa Ponsa entfernt
              </span>
            ...
            <h1>Roller mieten in Santa Ponsa und Calvià flexibel entdecken.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Santa Ponsa</strong>,{" "}
              <strong>Scooter mieten Santa Ponsa</strong> oder{" "}
            ...
            <p className="nexa-hero-text small">
              Ideal für Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El
              Toro, Port Adriano, Palmanova, Magaluf und schöne Küstenfahrten im
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Santa Ponsa Südwest Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Für Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro und Port Adriano</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Santa Ponsa, Port Adriano und Südwest Mallorca einfacher verbinden.</h2>

            <p>
              Santa Ponsa ist perfekt für Strand, Promenade, Restaurants, Hotels
              und kurze Wege Richtung Nova Santa Ponsa, Costa de la Calma, El
              Toro, Port Adriano, Palmanova und Magaluf. Mit einem 125cc Roller
              bist du flexibler unterwegs und kannst Mallorca ohne Taxi-Wartezeit
              oder Bus-Stress erleben.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Santa Ponsa, Scooter mieten Santa Ponsa oder Motorroller
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Santa Ponsa zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                schnell, klar und ideal für deinen Urlaub in Santa Ponsa.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Santa Ponsa, Port Adriano, Palmanova oder deine Mallorca-Tour.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Für Gäste, die Santa Ponsa und den Südwesten Mallorcas unabhängig
            entdecken möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Santa Ponsa”, “Scooter mieten Santa
            Ponsa”, “125cc Roller Santa Ponsa”, “Roller mieten Port Adriano”
            oder “Roller mieten Costa de la Calma” suchst, brauchst du eine
            einfache Lösung: online buchen, sicher bezahlen und mit einem 125cc
            Roller flexibel unterwegs sein.
          </p>

          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Santa Ponsa,
            Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano,
            Palmanova, Magaluf und Paguera. NEXA Rentals bietet dir eine
            einfache Online-Buchung und Abholung in Magaluf. Aktuell bieten wir
            keinen Lieferservice an, damit Übergabe, Dokumentencheck und Rückgabe
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Roller mieten Nova Santa Ponsa</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten in Santa Ponsa</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Santa Ponsa buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für Santa
                Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro und Port
                Adriano.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Unser Standort befindet sich in Magaluf. Von Santa Ponsa sind es
                je nach Verkehr ungefähr 10 bis 15 Minuten mit dem Auto.
            ...
            <details>
              <summary>Gibt es Lieferung nach Santa Ponsa?</summary>
              <p>
