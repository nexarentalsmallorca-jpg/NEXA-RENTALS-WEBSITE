...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal for navigation around south-west Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-port-andratx";
  }

  if (languageCode === "it") {
    return "/it/noleggio-scooter-port-andratx";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Port d’Andratx | 125cc Scooter Hire | NEXA Rentals",
    description:
      "Scooter rental for Port d’Andratx and Puerto de Andratx. Book a 125cc scooter online with NEXA Rentals, collect it from our Magaluf office and explore Andratx, Camp de Mar, Paguera and south-west Mallorca.",
    keywords: [
      "scooter rental Port Andratx",
      "scooter rental Port d’Andratx",
      "scooter hire Port Andratx",
      "scooter hire Port d’Andratx",
      "125cc scooter Port Andratx",
      "motor scooter rental Port Andratx",
      "rent a scooter Port Andratx",
      "scooter rental Port Andratx",
      "scooter rental Puerto de Andratx",
      "scooter hire Puerto de Andratx",
      "scooter rental Andratx",
      "scooter hire Andratx",
      "scooter rental Camp de Mar",
      "scooter hire Camp de Mar",
      "scooter rental Paguera",
      "scooter hire Paguera",
      "scooter rental south-west Mallorca",
      "scooter hire south-west Mallorca",
      "book scooter online Port Andratx",
      "NEXA Rentals Port Andratx",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-port-andratx",
    },
    openGraph: {
      title: "Scooter Rental Port d’Andratx | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar and south-west Mallorca. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-port-andratx",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Port d’Andratx with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalPortAndratxPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book your 125cc scooter online with NEXA Rentals and collect it directly from our Magaluf office. It is a practical option if you are staying in Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar or Paguera.",
        },
      },
      {
        "@type": "Question",
        name: "How far is NEXA Rentals from Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf. From Port d’Andratx, our office is around 25–35 minutes away by car, depending on traffic. Standard collection and return take place directly at NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for Port d’Andratx and south-west Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is a practical way to explore Port d’Andratx, Andratx, Camp de Mar, Paguera, Santa Ponsa, Cala Fornells and south-west Mallorca freely.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental for Port d’Andratx",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Around 25–35 minutes from Port d’Andratx
              </span>
            ...
            <h1>
              Rent a scooter for Port d’Andratx and explore south-west Mallorca.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Port d’Andratx</strong>,{" "}
              <strong>scooter hire in Puerto de Andratx</strong> or a{" "}
              <strong>125cc scooter in south-west Mallorca</strong>? With NEXA
              Rentals, you can book online, pay securely and collect your
              scooter directly from our Magaluf office.
            </p>

            <p className="nexa-hero-text small">
              Ideal for Port d’Andratx, Puerto de Andratx, Andratx, Camp de
              Mar, Paguera, Cala Fornells, Santa Ponsa and coastal routes across
              south-west Mallorca. Collection and return take place exclusively
              at NEXA Rentals in Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc scooter rental for Port d’Andratx in south-west Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar and Paguera
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore the marina, mountains and coast of south-west Mallorca freely.
            </h2>

            <p>
              Port d’Andratx is one of the most attractive destinations in
              south-west Mallorca, with its marina, restaurants, viewpoints and
              coastal roads. With a 125cc scooter, you can travel more easily
              between Port d’Andratx, Andratx, Camp de Mar, Paguera, Cala
              Fornells and Santa Ponsa.
            </p>

            <p>
              NEXA Rentals is a practical option for travellers looking for
              scooter rental in Port d’Andratx, scooter hire in Puerto de
              Andratx or a motor scooter in south-west Mallorca. Book and pay
              online, then collect your scooter directly from our Magaluf office.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Port d’Andratx and south-west Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book your scooter for Port d’Andratx in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                quick, clear and ideal for your holiday in south-west Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Pay securely online and reserve your scooter for Port d’Andratx,
                Andratx, Camp de Mar or your route around Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Come to NEXA Rentals in Magaluf with your original driving
                licence and an ID card or passport. We will explain everything
                before you set off.
              </p>
            </div>
          </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Book your scooter for Port d’Andratx
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Port d’Andratx and south-west Mallorca with complete freedom.
          </h2>

          <p>
            When you search for “scooter rental Port d’Andratx”, “scooter hire
            Port Andratx”, “scooter rental Puerto de Andratx”, “125cc scooter
            Andratx” or “scooter rental south-west Mallorca”, you want a simple
            option: online booking, secure payment and a 125cc scooter that gives
            you the freedom to travel around Mallorca.
          </p>

          <p>
            A scooter is particularly practical for travelling between Port
            d’Andratx, Andratx, Camp de Mar, Paguera, Cala Fornells, Santa
            Ponsa, Magaluf and Palmanova. NEXA Rentals offers simple online
          ...
          <div className="nexa-keyword-cloud">
            <span>Scooter rental Port d’Andratx</span>
            <span>Scooter hire Port Andratx</span>
            <span>Scooter rental Puerto de Andratx</span>
            <span>Scooter rental Andratx</span>
            <span>Scooter rental Camp de Mar</span>
            <span>Scooter rental Paguera</span>
            <span>Scooter rental south-west Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Port d’Andratx</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Can I book a scooter for Port d’Andratx?
              </summary>
              <p>
                Yes. You can book your 125cc scooter online with NEXA Rentals
                and collect it directly from our Magaluf office. It is a
                practical option for Port d’Andratx, Puerto de Andratx, Andratx,
                Camp de Mar and Paguera.
              </p>
            </details>

            <details>
              <summary>
                How far is NEXA Rentals from Port d’Andratx?
              </summary>
              <p>
                Our office is in Magaluf. From Port d’Andratx, it is around
                25–35 minutes away by car, depending on traffic. Standard
                collection and return take place directly at NEXA Rentals in
                Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>
                Is scooter delivery available in Port d’Andratx?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Port d’Andratx?</h3>
            <p>
