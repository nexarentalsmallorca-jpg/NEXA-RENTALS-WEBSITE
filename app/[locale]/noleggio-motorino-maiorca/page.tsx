...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio motorino Maiorca | Scooter 125cc a Magaluf | NEXA Rentals",
    description:
      "Noleggio motorino a Maiorca con NEXA Rentals. Prenota online uno scooter 125cc, ritiralo a Magaluf e scopri l’isola in libertà. Da 39€ con 2 caschi, bauletto, lucchetto, portacellulare, chilometri illimitati e assicurazione di base inclusi.",
    keywords: [
      "noleggio motorino Maiorca",
      "affitto motorino Maiorca",
      "motorino a noleggio Maiorca",
      "noleggio scooter 125cc Maiorca",
      "scooter 125cc Maiorca",
      "noleggio motorino Magaluf",
      "affitto motorino Magaluf",
      "scooter rental Mallorca",
      "noleggio scooter Maiorca",
      "affitto scooter Maiorca",
      "noleggio motorino economico Maiorca",
      "prenotare motorino online Maiorca",
      "prezzi noleggio motorino Maiorca",
      "noleggio motorino con patente B Maiorca",
      "noleggio motorino Palmanova",
      "noleggio motorino Santa Ponsa",
      "noleggio motorino Palma",
      "noleggio motorino Paguera",
      "Piaggio Liberty 125 Maiorca",
      "SYM Symphony 125 Maiorca",
      "NEXA Rentals scooter",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-motorino-maiorca",
    },
    openGraph: {
      title: "Noleggio motorino Maiorca | NEXA Rentals",
      description:
        "Prenota online uno scooter 125cc a Maiorca. Ritiro presso NEXA Rentals a Magaluf. Prezzi da 39€ con accessori inclusi.",
      url: "https://www.nexarentals.es/it/noleggio-motorino-maiorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio motorino a Maiorca con NEXA Rentals",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioMotorinoMaiorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare un motorino a Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Con NEXA Rentals puoi prenotare online uno scooter 125cc e ritirarlo direttamente presso il nostro ufficio di Magaluf. I nostri scooter sono ideali per Magaluf, Palmanova, Santa Ponsa, Palma, Paguera e per esplorare Maiorca.",
        },
      },
      {
        "@type": "Question",
        name: "Quali motorini noleggia NEXA Rentals?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals noleggia scooter 125cc Piaggio e SYM, tra cui Piaggio Liberty 125 e SYM Symphony 125. Attualmente non noleggiamo scooter 50cc.",
        },
      },
      {
        "@type": "Question",
        name: "Quale patente serve per noleggiare un motorino a Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Per guidare uno scooter 125cc sono accettate le patenti A, A1 e A2. Puoi guidarlo anche con la patente B, purché sia valida da almeno 3 anni. Non sono accettate patenti provvisorie o da allievo conducente.",
        },
      },
      {
        "@type": "Question",
        name: "Cosa è incluso nel noleggio del motorino?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Dove posso ritirare il motorino?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Il ritiro e la riconsegna standard avvengono presso NEXA Rentals a Magaluf. La consegna in hotel può essere disponibile su richiesta per alcune zone vicine, in base alla località, alla data e all’indirizzo. Contatta NEXA Rentals prima di prenotare per verificarne la disponibilità.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto costa noleggiare un motorino a Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Con NEXA Rentals il noleggio di uno scooter 125cc parte da 39€ per mezza giornata. Il noleggio di 24 ore costa 49€. Per più giorni possono essere disponibili tariffe diverse in base alla stagione e alla durata.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio motorino 125cc a Maiorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Scooter 125cc · Ritiro a Magaluf
              </span>
            ...
            <h1>
              Noleggia un motorino a Maiorca e scopri l’isola in libertà.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un servizio di{" "}
              <strong>noleggio motorino a Maiorca</strong>,{" "}
              <strong>affitto motorino a Maiorca</strong> o{" "}
              <strong>scooter 125cc a Maiorca</strong>? Con NEXA Rentals
              prenoti il tuo scooter online, paghi in modo sicuro e lo ritiri
              direttamente presso il nostro ufficio di Magaluf.
            </p>

            <p className="nexa-hero-text small">
              I nostri scooter 125cc sono ideali per Magaluf, Palmanova, Santa
              Ponsa, Palma, Paguera, Cala Vinyes, Camp de Mar e per esplorare
              il sud-ovest di Maiorca. Attualmente non noleggiamo scooter 50cc.
              La consegna in hotel può essere disponibile solo su richiesta e
              previa conferma.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter 125cc a Maiorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Scooter per Magaluf, Palmanova, Santa Ponsa, Palma e tutta Maiorca
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Noleggio motorino a Maiorca
            </span>

            <h2>
              Con uno scooter 125cc puoi scoprire molto di più di Maiorca.
            </h2>

            <p>
              Un motorino è uno dei modi più semplici per raggiungere spiagge,
              porti, ristoranti e punti panoramici di Maiorca. Invece di
              dipendere dagli orari degli autobus o dai prezzi dei taxi, puoi
              decidere liberamente dove andare e quando partire.
            </p>

            <p>
              NEXA Rentals noleggia scooter 125cc a Magaluf. I nostri modelli
              sono più potenti e confortevoli dei piccoli scooter 50cc e sono
              particolarmente adatti per spostarsi verso Palmanova, Santa
              Ponsa, Palma, Paguera, Portals Nous, Cala Vinyes o Camp de Mar.
            </p>
          </article>
      ...
      <section className="nexa-license-section">
        <div className="nexa-license-inner">
          <span className="nexa-section-label">
            Patente per scooter 125cc
          </span>

          <h2>Quale patente serve per guidare uno scooter 125cc?</h2>
          ...
          <div className="nexa-license-grid">
            ...
            <div>
              ...
              <p>
                Puoi guidare uno scooter 125cc anche con la patente B, purché la
                patente automobilistica sia valida da almeno 3 anni.
              </p>
            </div>

            <div>
              <strong>Non accettate</strong>
              <p>
                Non sono accettate patenti provvisorie, patenti da allievo
                conducente, fotografie o copie. Porta con te la patente
                originale.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota il tuo motorino a Maiorca in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                La prenotazione è rapida, chiara e perfetta per la tua vacanza.
              </p>
            </div>
            ...
            <div>
              ...
              <h3>Paga online</h3>
              <p>
                Paga online il prezzo del noleggio e assicurati il tuo motorino
                per le date del tuo soggiorno a Maiorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                d’identità o passaporto. Dopo la consegna puoi partire subito.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora il motorino
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Motorino a Maiorca</span>

          <h2>
            Per chi vuole esplorare Maiorca in autonomia e senza complicazioni.
          </h2>

          <p>
            Quando cerchi “noleggio motorino Maiorca”, “affitto motorino
            Maiorca”, “scooter 125cc Maiorca”, “noleggio motorino Magaluf” o
            “prenotare motorino online Maiorca”, hai bisogno di una soluzione
            chiara: prenotazione online, pagamento sicuro, ritiro a Magaluf e
            partenza immediata.
          </p>

          <p>
            NEXA Rentals rende semplice il noleggio di uno scooter a Maiorca:
            modelli 125cc, prezzi trasparenti, 2 caschi, bauletto da 50 litri,
            lucchetto, portacellulare impermeabile, chilometri illimitati e
            assicurazione di base inclusi. Il ritiro e la riconsegna standard
            avvengono nel nostro ufficio di Magaluf. La consegna in hotel può
            essere disponibile su richiesta per alcune zone vicine, in base
            alla località, alla data e all’indirizzo. Contattaci prima di
            prenotare per verificarne la disponibilità.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Noleggio motorino Maiorca</span>
            <span>Affitto motorino Maiorca</span>
            ...
            <span>Piaggio Liberty 125 Maiorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio motorino a Maiorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Posso noleggiare un motorino con NEXA Rentals?
              </summary>
              <p>
                Sì. Puoi prenotare online uno scooter 125cc e ritirarlo
                direttamente presso NEXA Rentals a Magaluf.
              </p>
            </details>

            <details>
              <summary>Noleggiate scooter 50cc o 125cc?</summary>
              <p>
                Attualmente noleggiamo scooter 125cc Piaggio e SYM. Non
                offriamo scooter 50cc.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Accettiamo le patenti A, A1 e A2. Accettiamo anche la patente B
                se è valida da almeno 3 anni. Non sono accettate patenti
                provvisorie o da allievo conducente.
              </p>
            </details>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto per il tuo motorino?</h3>
            <p>
              Prenota online il tuo scooter 125cc e parti direttamente da NEXA
              Rentals a Magaluf.
            </p>
            <Link href={bookHref}>Prenota ora il motorino</Link>
          </div>
        </div>
      </section>
