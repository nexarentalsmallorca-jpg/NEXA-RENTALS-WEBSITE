// app/[locale]/alquiler-scooter-playa-de-palma/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por Playa de Palma y Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-playa-de-palma";
  }

  if (languageCode === "es") {
    return "/es/alquiler-scooter-playa-de-palma";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Playa de Palma | 125 cc | NEXA Rentals",
    description:
      "Alquiler de scooter para Playa de Palma, El Arenal, S'Arenal y Can Pastilla. Reserva online un scooter de 125 cc y recógelo en NEXA Rentals, Magaluf.",
    keywords: [
      "alquiler scooter Playa de Palma",
      "alquilar scooter Playa de Palma",
      "scooter 125cc Playa de Palma",
      "alquiler moto scooter Playa de Palma",
      "alquiler motos Playa de Palma",
      "scooter de alquiler Playa de Palma",
      "alquiler scooter barato Playa de Palma",
      "alquiler scooter cerca de Playa de Palma",
      "alquiler scooter El Arenal",
      "alquiler scooter S'Arenal",
      "alquiler scooter Can Pastilla",
      "scooter 125cc El Arenal Mallorca",
      "alquiler scooter Ballermann",
      "alquiler scooter Las Maravillas",
      "alquiler scooter costa sur Mallorca",
      "reservar scooter online Playa de Palma",
      "precios alquiler scooter Playa de Palma",
      "NEXA Rentals Playa de Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-playa-de-palma",
    },
    openGraph: {
      title: "Alquiler de scooter en Playa de Palma | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Playa de Palma, El Arenal, S'Arenal y Can Pastilla. Recogida en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-playa-de-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter para Playa de Palma con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalPlayaDePalmaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo directamente en Magaluf. Es una opción práctica para descubrir Playa de Palma, El Arenal, S'Arenal, Can Pastilla y Mallorca.",
        },
      },
      {
        "@type": "Question",
        name: "¿Dónde recojo un scooter reservado para Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se encuentra en Magaluf. La recogida y la devolución habituales se realizan directamente en nuestra oficina de C. Galeón, 13, Loc 57, 07181 Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para recorrer Playa de Palma y la costa cercana?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es práctico para descubrir con libertad Playa de Palma, El Arenal, S'Arenal, Can Pastilla, Las Maravillas y otras zonas de Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc para Playa de Palma",
      price: "39",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Playa de Palma",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Recogida en NEXA Rentals, Magaluf
              </span>
            ...
            <h1>
              Alquila un scooter para Playa de Palma y descubre Mallorca con
              libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Playa de Palma</strong>,{" "}
              <strong>alquilar un scooter en El Arenal</strong> o un{" "}
              <strong>scooter de 125 cc cerca de Can Pastilla</strong>? Con NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal para recorrer Playa de Palma, El Arenal, S&apos;Arenal, Can
              Pastilla, Las Maravillas y la costa cercana. Perfecto para llegar
              a playas, paseos marítimos, restaurantes y complejos turísticos
              cercanos con mayor libertad.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter de 125 cc para Playa de Palma y El Arenal"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para Playa de Palma, El Arenal, S&apos;Arenal, Can Pastilla y Las
          Maravillas
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Playa de Palma
            </span>

            <h2>
              Descubre Playa de Palma, El Arenal y la costa con más facilidad.
            </h2>

            <p>
              Playa de Palma combina una larga playa de arena, un animado paseo
              marítimo, restaurantes y complejos turísticos cercanos. Con un
              scooter de 125 cc puedes desplazarte más fácilmente entre Playa
              de Palma, El Arenal, S&apos;Arenal, Can Pastilla, Las Maravillas y
              otras zonas próximas.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en Playa de Palma, alquilar un scooter en El Arenal o
              recorrer la costa sur de Mallorca en moto scooter. Reservas y
              pagas online, y recoges el scooter directamente en Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Playa de Palma y la costa cercana</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva un scooter para Playa de Palma en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                tu estancia en Playa de Palma y Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Playa de Palma, El Arenal, Can Pastilla o la ruta que tengas
                prevista por Mallorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva un scooter para Playa de Palma
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Para viajeros que quieren descubrir Playa de Palma y la costa de
            Mallorca con total libertad.
          </h2>

          <p>
            Cuando buscas “alquiler scooter Playa de Palma”, “alquilar scooter
            Playa de Palma”, “alquiler scooter El Arenal”, “scooter 125 cc Can
            Pastilla” o “alquiler scooter barato Playa de Palma”, necesitas una
          ...
          <p>
            ...
            Playa de Palma, El Arenal, S&apos;Arenal, Can Pastilla, Las Maravillas
            y otras zonas cercanas. NEXA Rentals ofrece una reserva online
            sencilla y recogida en Magaluf. Actualmente no ofrecemos servicio
            de entrega de scooters.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Playa de Palma</span>
            <span>Alquilar scooter Playa de Palma</span>
            <span>Alquiler scooter El Arenal</span>
            <span>Alquiler scooter S&apos;Arenal</span>
            <span>Alquiler scooter Can Pastilla</span>
            <span>Alquiler scooter Las Maravillas</span>
            <span>Scooter 125 cc Playa de Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Playa de Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Playa de Palma?</summary>
              <p>
                Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals
                y recogerlo directamente en Magaluf. Es una opción práctica para
                Playa de Palma, El Arenal, S&apos;Arenal y Can Pastilla.
              </p>
            </details>

            <details>
              <summary>¿Dónde recojo un scooter reservado para Playa de Palma?</summary>
              <p>
            ...
            <details>
              <summary>¿Hay servicio de entrega en Playa de Palma?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Playa de Palma?</h3>
            <p>
