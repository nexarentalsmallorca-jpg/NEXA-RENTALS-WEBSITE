...
export async function generateMetadata({
  ...
  return {
    title:
      "Motorroller mieten Mallorca | 125cc Roller Verleih | NEXA Rentals",
    description:
      "Motorroller mieten auf Mallorca. 125cc Roller online bei NEXA Rentals buchen, in Magaluf abholen und Mallorca flexibel entdecken. Von 39€ alles inklusive: 2 Helme, Topcase, Schloss, Handyhalterung und unbegrenzte Kilometer.",
    keywords: [
      "Motorroller mieten Mallorca",
      "Motorroller Verleih Mallorca",
      "Motorroller Mallorca mieten",
      "Motorroller Mallorca",
      "Motorroller mieten Magaluf",
      "Motorroller Verleih Magaluf",
      "125cc Motorroller Mallorca",
      "125cc Motorroller mieten Mallorca",
      "Roller mieten Mallorca",
      "Scooter mieten Mallorca",
      "Scooter Rental Mallorca",
      "Roller Verleih Mallorca",
      "Motorroller online buchen Mallorca",
      "Motorroller mieten Mallorca günstig",
      "Motorroller mieten Mallorca Preise",
      "Motorroller mieten Mallorca ohne Stress",
      "Motorroller mieten Mallorca B Führerschein",
      "Motorroller mieten Palmanova",
      "Motorroller mieten Santa Ponsa",
      "Motorroller mieten Palma",
      "Motorroller mieten Paguera",
      "Piaggio Liberty 125 Mallorca",
      "SYM Symphony 125 Mallorca",
      "NEXA Rentals Motorroller",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/motorroller-mieten-mallorca`,
    },
    openGraph: {
      title: "Motorroller mieten Mallorca | NEXA Rentals",
      description:
        "125cc Motorroller auf Mallorca online buchen. Abholung bei NEXA Rentals in Magaluf. Von 39€ alles inklusive.",
      url: `https://www.nexarentals.es/${locale}/motorroller-mieten-mallorca`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Motorroller mieten Mallorca bei NEXA Rentals",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function MotorrollerMietenMallorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich auf Mallorca einen Motorroller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Bei NEXA Rentals kannst du einen 125cc Motorroller online buchen und direkt in Magaluf abholen. Unsere Motorroller sind ideal für Magaluf, Palmanova, Santa Ponsa, Palma, Paguera und Ausflüge auf Mallorca.",
        },
      },
      {
        "@type": "Question",
        name: "Welche Motorroller vermietet NEXA Rentals?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals vermietet 125cc Motorroller wie Piaggio Liberty 125 und SYM Symphony 125. Aktuell vermieten wir keine 50cc Roller.",
        },
      },
      {
        "@type": "Question",
        name: "Welchen Führerschein brauche ich für einen Motorroller auf Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Für einen 125cc Motorroller brauchst du A, A1 oder A2. Mit einem B-Führerschein kannst du fahren, wenn dein B-Führerschein seit mindestens 3 Jahren gültig ist.",
        },
      },
      {
        "@type": "Question",
        name: "Was ist beim Motorroller mieten inklusive?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Wo hole ich den Motorroller ab?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Wie viel kostet ein Motorroller auf Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Bei NEXA Rentals starten 125cc Motorroller ab 39€ für die Halbtagsmiete. 24 Stunden kosten 49€. Mehrtägige Preise können je nach Saison und Mietdauer verfügbar sein.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Motorroller mieten Mallorca",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/motorroller-mieten-mallorca`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                125cc Motorroller · Abholung in Magaluf
              </span>
            ...
            <h1>Motorroller mieten auf Mallorca und die Insel flexibel erleben.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Motorroller mieten Mallorca</strong>,{" "}
              <strong>Motorroller Verleih Mallorca</strong> oder{" "}
              <strong>125cc Motorroller Mallorca</strong>? Bei NEXA Rentals
              buchst du deinen Motorroller online, bezahlst sicher online und
              holst ihn direkt in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Unsere 125cc Motorroller sind ideal für Magaluf, Palmanova, Santa
              Ponsa, Palma, Paguera, Cala Vinyes, Camp de Mar und Ausflüge im
              Südwesten Mallorcas. Aktuell bieten wir keine 50cc Roller und
              keinen Lieferservice an.
            </p>
            ...
            <div className="nexa-hero-points">
              <div>
                ...
                <span>Halbtags Motorroller</span>
              </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc Motorroller mieten Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Motorroller für Magaluf, Palmanova, Santa Ponsa, Palma und Mallorca</p>

        <div className="nexa-trust-logos">
          <span>Motorroller mieten Mallorca</span>
          <span>125cc Motorroller</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Motorroller Verleih Mallorca</span>

            <h2>Mit einem 125cc Motorroller erreichst du mehr von Mallorca.</h2>

            <p>
              Ein Motorroller ist auf Mallorca eine der einfachsten Möglichkeiten,
              Strände, Häfen, Restaurants und Aussichtspunkte flexibel zu
              verbinden. Statt auf Buszeiten oder Taxipreise zu achten, kannst du
              spontan entscheiden, wohin du fahren möchtest.
            </p>

            <p>
              NEXA Rentals vermietet 125cc Motorroller in Magaluf. Unsere Roller
              sind stärker und komfortabler als kleine 50cc Modelle und eignen
              sich besonders gut für Fahrten nach Palmanova, Santa Ponsa, Palma,
              Paguera, Portals Nous, Cala Vinyes oder Camp de Mar.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Motorroller für Mallorca</li>
      ...
      <section className="nexa-license-section">
        <div className="nexa-license-inner">
          <span className="nexa-section-label">Führerschein für Motorroller</span>

          <h2>Welche Fahrerlaubnis brauchst du für einen 125cc Motorroller?</h2>

          <div className="nexa-license-grid">
            <div>
              <strong>A / A1 / A2</strong>
              <p>
                Mit A, A1 oder A2 kannst du bei NEXA Rentals einen 125cc
                Motorroller mieten, wenn dein Führerschein gültig und original
                vorhanden ist.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Mit B-Führerschein ist ein 125cc Motorroller möglich, wenn dein
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Motorroller auf Mallorca in drei einfachen Schritten buchen.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                Wähle deinen 125cc Motorroller, Datum und Mietdauer. Die Buchung
                ist schnell, klar und ideal für deinen Urlaub.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Bezahle den Mietpreis online und sichere dir deinen Motorroller
                für Mallorca.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Motorroller Mallorca</span>

          <h2>
            Für Urlauber, die Mallorca unabhängig und ohne komplizierte Wege
            erleben möchten.
          </h2>

          <p>
            Wenn du nach “Motorroller mieten Mallorca”, “Motorroller Verleih
            Mallorca”, “125cc Motorroller Mallorca”, “Motorroller mieten
            Magaluf” oder “Motorroller online buchen Mallorca” suchst, brauchst
            du eine klare Lösung: online buchen, sicher bezahlen, in Magaluf
            abholen und direkt starten.
          </p>

          <p>
            NEXA Rentals macht den Motorroller-Verleih auf Mallorca einfach:
            125cc Roller, transparente Preise, 2 Helme, Topcase, Schloss,
            Handyhalterung, unbegrenzte Kilometer und Basisversicherung
            inklusive. Aktuell bieten wir keinen Lieferservice an, damit
            Übergabe, Dokumentencheck, Erklärung und Rückgabe sauber im Büro
            stattfinden.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>125cc Motorroller Mallorca</span>
            <span>Motorroller mieten Magaluf</span>
            <span>Roller mieten Mallorca</span>
            <span>Scooter mieten Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Motorroller mieten auf Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich bei NEXA Rentals einen Motorroller mieten?</summary>
              <p>
                Ja. Du kannst online einen 125cc Motorroller buchen und ihn direkt
                bei NEXA Rentals in Magaluf abholen.
              </p>
            </details>

            <details>
              <summary>Vermietet ihr 50cc oder 125cc Motorroller?</summary>
              <p>
                Aktuell vermieten wir 125cc Motorroller. 50cc Roller bieten wir
                derzeit nicht an.
              </p>
            </details>
            ...
            <details>
              <summary>Gibt es Lieferung zum Hotel?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Bereit für deinen Motorroller?</h3>
            <p>
              Buche deinen 125cc Motorroller online und starte direkt bei NEXA
              Rentals in Magaluf.
            </p>
            <Link href={bookHref}>Jetzt Motorroller buchen</Link>
          </div>
        </div>
      </section>
