// app/[locale]/alquiler-scooter-portals-nous/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por Portals Nous y Mallorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Candado de seguridad",
    text: "Para estacionar con más tranquilidad en el puerto deportivo, la playa o un restaurante.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  const campaignRoutes: Partial<Record<Locale, string>> = {
    en: "/en/scooter-rental-portals-nous",
    de: "/de/roller-mieten-portals-nous",
    fr: "/fr/location-scooter-portals-nous",
    it: "/it/noleggio-scooter-portals-nous",
    es: "/es/alquiler-scooter-portals-nous",
  };

  return campaignRoutes[languageCode] ?? `/${languageCode}`;
}
...
export async function generateMetadata({
  ...
  return {
    title: "Alquiler scooter Portals Nous | NEXA Rentals",
    description:
      "Alquila un scooter de 125 cc para Portals Nous y Puerto Portals. Reserva online con NEXA Rentals y recógelo en nuestra oficina de Magaluf.",
    keywords: [
      "alquiler scooter Portals Nous",
      "alquilar scooter Portals Nous",
      "scooter 125cc Portals Nous",
      "alquiler moto scooter Portals Nous",
      "alquiler motos Portals Nous",
      "scooter de alquiler Portals Nous",
      "alquiler scooter Puerto Portals",
      "alquilar scooter Puerto Portals",
      "scooter 125cc Puerto Portals",
      "alquiler scooter Bendinat",
      "alquilar scooter Bendinat",
      "alquiler scooter Illetes",
      "alquilar scooter Illetes",
      "alquiler scooter Costa d’en Blanes",
      "alquilar scooter Costa d’en Blanes",
      "alquiler scooter Palmanova",
      "alquilar scooter Palmanova",
      "alquiler scooter Cala Major",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-portals-nous",
      languages: {
        en: "https://www.nexarentals.es/en/scooter-rental-portals-nous",
        de: "https://www.nexarentals.es/de/roller-mieten-portals-nous",
        fr: "https://www.nexarentals.es/fr/location-scooter-portals-nous",
        it: "https://www.nexarentals.es/it/noleggio-scooter-portals-nous",
        es: "https://www.nexarentals.es/es/alquiler-scooter-portals-nous",
        "x-default":
          "https://www.nexarentals.es/en/scooter-rental-portals-nous",
      },
    },
    openGraph: {
      title: "Alquiler de scooter en Portals Nous | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Portals Nous, Puerto Portals, Bendinat, Illetes y Costa d’en Blanes. Recogida en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-portals-nous",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Portals Nous con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalPortalsNousPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter en Portals Nous?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online tu scooter de 125 cc con NEXA Rentals y recogerlo directamente en nuestra oficina de Magaluf. Es una opción práctica si te alojas en Portals Nous, Puerto Portals, Bendinat, Illetes o Costa d’en Blanes.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de Portals Nous?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se encuentra en Magaluf. Desde Portals Nous, nuestra oficina está a unos 12–18 minutos en coche, dependiendo del tráfico. La recogida y la devolución habituales se realizan directamente en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para Portals Nous y Puerto Portals?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es práctico para descubrir con libertad Portals Nous, Puerto Portals, Bendinat, Illetes, Costa d’en Blanes, Palmanova, Magaluf y el suroeste de Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Portals Nous?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. Actualmente no ofrecemos servicio de entrega de scooters. La recogida y la devolución habituales se realizan directamente en NEXA Rentals, Magaluf.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Portals Nous",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A unos 12–18 minutos de Portals Nous
              </span>
            ...
            <h1>
              Alquila un scooter en Portals Nous y descubre Puerto Portals con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Portals Nous</strong>,{" "}
              <strong>alquilar un scooter en Puerto Portals</strong> o un{" "}
              <strong>scooter de 125 cc para Bendinat</strong>? Con NEXA Rentals
              puedes reservar online, pagar de forma segura y recoger tu scooter
              directamente en nuestra oficina de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal para Portals Nous, Puerto Portals, Bendinat, Illetes, Costa
              d’en Blanes, Palmanova, Magaluf y el suroeste de Mallorca. La
              recogida y la devolución habituales se realizan exclusivamente en
              NEXA Rentals, Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en Puerto Portals y Portals Nous"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para Portals Nous, Puerto Portals, Bendinat, Illetes y Costa d’en Blanes
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Portals Nous
            </span>

            <h2>
              Descubre Puerto Portals, Bendinat y el suroeste de Mallorca con más facilidad.
            </h2>

            <p>
              Portals Nous y Puerto Portals son ideales para disfrutar del puerto
              deportivo, restaurantes, hoteles, días de playa y excursiones hacia
              Bendinat, Illetes, Palmanova o Magaluf. Con un scooter de 125 cc
              puedes desplazarte con más libertad y disfrutar de Mallorca sin
              esperar taxis ni depender de las conexiones de autobús.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en Portals Nous, alquilar un scooter en Puerto Portals o
              una moto scooter para Bendinat. Reserva y paga online, y después
              recoge tu scooter directamente en nuestra oficina de Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Portals Nous y Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva tu scooter para Portals Nous en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                La reserva es rápida, clara y fácil de organizar para tu estancia
                en Portals Nous.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Paga online de forma segura y reserva tu scooter para Portals
                Nous, Puerto Portals, Bendinat o tu ruta por Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                pasaporte o documento de identidad. Te explicaremos todo antes de
                que comiences tu ruta.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva tu scooter para Portals Nous
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooter en Puerto Portals
          </span>

          <h2>
            Para viajeros que quieren descubrir Portals Nous y el suroeste de Mallorca con total libertad.
          </h2>

          <p>
            Cuando buscas “alquiler scooter Portals Nous”, “alquilar scooter
            Portals Nous”, “alquiler scooter Puerto Portals”, “scooter 125 cc
            Bendinat” o “alquiler scooter Illetes”, quieres una opción sencilla:
            reserva online, pago seguro y un scooter de 125 cc que te dé libertad
            para recorrer Mallorca.
          </p>

          <p>
            Un scooter resulta especialmente práctico para desplazarte entre
            Portals Nous, Puerto Portals, Bendinat, Illetes, Costa d’en Blanes,
            Cala Major, Palmanova y Magaluf. NEXA Rentals ofrece una reserva
            online sencilla con recogida en Magaluf. Actualmente no ofrecemos
            servicio de entrega de scooters, por lo que la entrega del vehículo,
            la comprobación de documentos y la devolución habitual se gestionan
            directamente en nuestra oficina de Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Portals Nous</span>
            <span>Alquilar scooter Portals Nous</span>
            <span>Alquiler scooter Puerto Portals</span>
            <span>Alquiler scooter Bendinat</span>
            <span>Alquiler scooter Illetes</span>
            <span>Alquiler scooter Costa d’en Blanes</span>
            <span>Scooter 125 cc Portals Nous</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Portals Nous</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Portals Nous?</summary>
              <p>
                Sí. Puedes reservar online tu scooter de 125 cc con NEXA Rentals
                y recogerlo directamente en nuestra oficina de Magaluf. Es una
                opción práctica para Portals Nous, Puerto Portals, Bendinat,
                Illetes y Costa d’en Blanes.
              </p>
            </details>

            <details>
              <summary>
                ¿A qué distancia está NEXA Rentals de Portals Nous?
              </summary>
              <p>
                Nuestra oficina está en Magaluf. Desde Portals Nous está a unos
                12–18 minutos en coche, dependiendo del tráfico. La recogida y
                la devolución habituales se realizan directamente en NEXA
                Rentals, Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>
                ¿Hay servicio de entrega de scooters en Portals Nous?
              </summary>
              <p>
                No. Actualmente no ofrecemos servicio de entrega de scooters. La
                recogida y la devolución habituales se realizan directamente en
                NEXA Rentals, Magaluf.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Portals Nous?</h3>
            <p>
              Reserva online tu scooter de 125 cc y comienza tu ruta directamente
