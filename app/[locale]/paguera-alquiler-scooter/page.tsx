// app/[locale]/paguera-alquiler-scooter/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte desde Paguera por Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/paguera-scooter-rental";
  }

  if (languageCode === "es") {
    return "/es/paguera-alquiler-scooter";
  }

  if (languageCode === "it") {
    return "/it/scooter-a-noleggio-paguera";
  }

  if (languageCode === "de") {
    return "/de/rollerverleih-paguera";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Paguera alquiler scooter | Scooter de 125 cc en Peguera | NEXA Rentals",
    description:
      "Alquiler de scooter en Paguera y Peguera, Mallorca. Reserva online un scooter de 125 cc desde 39 € con NEXA Rentals, paga de forma segura y recógelo en Magaluf, a unos 10 minutos de Paguera.",
    keywords: [
      "Paguera alquiler scooter",
      "alquiler scooter Paguera",
      "alquiler scooter Peguera",
      "alquilar scooter Paguera",
      "alquilar scooter Peguera",
      "alquiler moto scooter Paguera",
      "scooter 125cc Paguera",
      "scooter 125cc Peguera",
      "Paguera alquiler scooter Mallorca",
      "reservar scooter online Paguera",
      "alquiler scooter Camp de Mar",
      "alquiler scooter Cala Fornells",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/paguera-alquiler-scooter",
    },
    openGraph: {
      title:
        "Paguera alquiler scooter | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Paguera y el suroeste de Mallorca. NEXA Rentals está a unos 10 minutos de Paguera, con recogida y devolución en Magaluf.",
      url: "https://www.nexarentals.es/es/paguera-alquiler-scooter",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Paguera, Mallorca, con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function PagueraScooterRentalPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Dónde puedo alquilar un scooter en Paguera o Peguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Puedes reservar online tu scooter de 125 cc con NEXA Rentals y recogerlo en nuestra oficina de Magaluf. NEXA Rentals está a unos 10 minutos de Paguera y es una opción práctica si te alojas en Paguera, Peguera, Camp de Mar, Cala Fornells o Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals está en Magaluf, a unos 10 minutos de Paguera en coche o taxi. La recogida y la devolución se realizan directamente en la oficina de NEXA Rentals en Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. Actualmente no ofrecemos servicio de entrega de scooters en Paguera. La recogida y la devolución se realizan directamente en NEXA Rentals, Magaluf, para que la entrega del vehículo sea rápida, segura y sencilla.",
        },
      },
      {
        "@type": "Question",
        name: "¿Puedo pagar online el alquiler del scooter para Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Qué incluye el alquiler de scooter para Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Paguera, Mallorca",
      price: "39",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Paguera, Peguera, Mallorca",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Paguera alquiler scooter: alquila un scooter de 125 cc y descubre
              Mallorca con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Paguera</strong>,{" "}
              <strong>alquilar un scooter en Peguera</strong> o un{" "}
              <strong>scooter de 125 cc en Paguera, Mallorca</strong>? Con NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal si te alojas en Paguera, Peguera, Cala Fornells, Camp de Mar,
              Santa Ponsa o cualquier otra zona del suroeste de Mallorca y
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>A unos 10 minutos de Paguera.</strong>
                <span>
                  NEXA Rentals está en Magaluf: reserva online, recoge tu scooter
                  en Magaluf y conduce directamente hacia Paguera, Camp de Mar o
                  Santa Ponsa.
                </span>
              </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en Paguera y el suroeste de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para viajeros que se alojan en Paguera y el suroeste de Mallorca
        </p>

        <div className="nexa-trust-logos">
          <span>Paguera alquiler scooter</span>
          <span>Alquiler scooter Peguera</span>
          <span>A 10 min de Paguera</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Alquila un scooter cerca de Paguera con una sencilla reserva online.
            </h2>

            <p>
              Muchos viajeros que se alojan en Paguera o Peguera buscan un
            ...
            <p>
              NEXA Rentals está a unos 10 minutos de Paguera, por lo que es una
              opción práctica si te alojas en Paguera, Cala Fornells, Camp de
              Mar, Santa Ponsa, Palmanova, Magaluf o Calvià. Descubre playas,
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Paguera y Mallorca</li>
              <li>A unos 10 minutos de Paguera</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva tu scooter para Paguera en unos sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                La reserva es rápida, clara e ideal si te alojas en Paguera,
                Peguera o las zonas cercanas.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                oficina está a unos 10 minutos de Paguera. Te explicaremos todo
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva tu scooter para Paguera
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Para viajeros que quieren descubrir Paguera y Mallorca con total libertad.
          </h2>

          <p>
            Cuando buscas “Paguera alquiler scooter”, “alquiler scooter
            Paguera”, “alquiler scooter Peguera”, “alquiler moto scooter
            Paguera” o “scooter 125 cc Paguera Mallorca”, probablemente quieres
          ...
          <p>
            Esta página es especialmente útil si te alojas en Paguera, Peguera,
            Cala Fornells, Camp de Mar, Santa Ponsa u otra zona del suroeste de
            Mallorca. NEXA Rentals está en Magaluf, a unos 10 minutos de Paguera.
            Actualmente no ofrecemos entrega de scooters en Paguera: la recogida
            y la devolución se realizan directamente en NEXA Rentals, Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Paguera alquiler scooter</span>
            <span>Alquiler scooter Paguera</span>
            <span>Alquiler scooter Peguera</span>
            <span>Scooter 125 cc Paguera</span>
            <span>Alquiler moto scooter Paguera</span>
            <span>Alquilar scooter Paguera</span>
            <span>Alquiler scooter Camp de Mar</span>
            <span>A 10 minutos de Paguera</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Paguera</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>¿A qué distancia está NEXA Rentals de Paguera?</summary>
              <p>
                NEXA Rentals está en Magaluf, a unos 10 minutos de Paguera.
                Puedes reservar online, recoger tu scooter en Magaluf y conducir
                hacia Paguera, Camp de Mar, Cala Fornells o Santa Ponsa.
              </p>
            </details>

            <details>
              <summary>
                ¿Puedo recibir el scooter directamente en Paguera?
              </summary>
              <p>
                No. Actualmente no ofrecemos servicio de entrega de scooters en
                Paguera. La recogida y la devolución se realizan directamente en
                NEXA Rentals, Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>
                ¿Es NEXA Rentals una buena opción para Paguera, Peguera y Camp de Mar?
              </summary>
              <p>
                Sí. NEXA Rentals es una opción práctica si te alojas en Paguera,
                Peguera, Cala Fornells, Camp de Mar, Santa Ponsa, Magaluf o
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Paguera y Mallorca?</h3>
            <p>
              Reserva online tu scooter de 125 cc y comienza directamente desde
              NEXA Rentals, Magaluf, a unos 10 minutos de Paguera.
            </p>
