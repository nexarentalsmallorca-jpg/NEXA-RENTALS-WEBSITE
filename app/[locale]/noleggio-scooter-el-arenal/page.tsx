...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per orientarsi nella baia di Palma.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter El Arenal | Scooter 125cc Playa de Palma | NEXA Rentals",
    description:
      "Noleggio scooter a El Arenal e Playa de Palma. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf e scopri El Arenal, Playa de Palma, Can Pastilla, Palma e Llucmajor in libertà.",
    keywords: [
      "noleggio scooter El Arenal",
      "affitto scooter El Arenal",
      "scooter 125cc El Arenal",
      "noleggio motorino El Arenal",
      "scooter a noleggio El Arenal",
      "scooter rental El Arenal",
      "noleggio scooter S'Arenal",
      "affitto scooter S'Arenal",
      "noleggio scooter Playa de Palma",
      "affitto scooter Playa de Palma",
      "noleggio scooter Can Pastilla",
      "affitto scooter Can Pastilla",
      "noleggio scooter Palma",
      "noleggio scooter Llucmajor",
      "noleggio scooter sud Maiorca",
      "scooter 125cc Playa de Palma",
      "prenotare scooter online El Arenal",
      "NEXA Rentals El Arenal",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-el-arenal",
    },
    openGraph: {
      title: "Noleggio scooter El Arenal | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per El Arenal, Playa de Palma, Can Pastilla e il sud di Maiorca. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-el-arenal",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a El Arenal con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterElArenalPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter per El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online uno scooter 125cc con NEXA Rentals e ritirarlo direttamente presso il nostro ufficio di Magaluf. È una soluzione pratica per chi vuole esplorare El Arenal, S’Arenal, Playa de Palma, Can Pastilla, Palma e Llucmajor.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da El Arenal puoi raggiungere la nostra sede generalmente in circa 25-30 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna standard avvengono presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per El Arenal e Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è pratico per scoprire El Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor e altre località del sud di Maiorca in completa libertà.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna dello scooter a El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a El Arenal",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Circa 25-30 minuti da El Arenal
              </span>
            ...
            <h1>
              Noleggia uno scooter a El Arenal e scopri la baia di Palma in
              libertà.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un servizio di{" "}
              <strong>noleggio scooter a El Arenal</strong>,{" "}
              <strong>affitto scooter a El Arenal</strong> o uno{" "}
              <strong>scooter 125cc a Playa de Palma</strong>? Con NEXA Rentals
            ...
            <p className="nexa-hero-text small">
              Ideale per El Arenal, Playa de Palma, Can Pastilla, Palma,
              Llucmajor e per piacevoli itinerari lungo la baia di Palma.
              Perfetto per raggiungere spiagge, ristoranti e diverse località
              turistiche in completa libertà.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a El Arenal e Playa de Palma"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Per El Arenal, Playa de Palma, Can Pastilla, Palma e il sud di
          Maiorca
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Scopri El Arenal, Playa de Palma e Can Pastilla con maggiore
              libertà.
            </h2>

            <p>
              El Arenal è ideale per giornate in spiaggia, ristoranti, vita
              notturna ed escursioni nella baia di Palma. Con uno scooter 125cc
              puoi raggiungere più facilmente El Arenal, Playa de Palma, Can
              Pastilla, Palma, Llucmajor e altre località del sud di Maiorca.
            </p>

            <p>
              NEXA Rentals è una soluzione pratica per chi cerca noleggio
              scooter a El Arenal, affitto scooter a El Arenal o noleggio
              motorino a Playa de Palma. Prenoti online, paghi online e ritiri
              lo scooter direttamente presso il nostro ufficio di Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per El Arenal e Playa de Palma</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota uno scooter per El Arenal in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                La prenotazione è rapida, chiara e ideale per la tua vacanza a
                El Arenal e Playa de Palma.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                El Arenal, Playa de Palma, Can Pastilla o per il tuo itinerario
                a Maiorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota uno scooter per El Arenal
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole esplorare El Arenal, Playa de Palma e il sud di
            Maiorca in autonomia.
          </h2>

          <p>
            Quando cerchi “noleggio scooter El Arenal”, “affitto scooter El
            Arenal”, “scooter 125cc El Arenal”, “noleggio motorino El Arenal” o
            “noleggio scooter Playa de Palma”, hai bisogno di una soluzione
            semplice: prenotazione online, pagamento sicuro e uno scooter 125cc
            con cui spostarti in completa libertà.
          </p>

          <p>
            Uno scooter è particolarmente pratico per gli spostamenti tra El
            Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor, Magaluf e
            Palmanova. Il ritiro e la riconsegna standard avvengono presso NEXA
            Rentals a Magaluf. La consegna in hotel può essere disponibile solo
            su richiesta per alcune zone vicine, in base alla località, alla
            data e all’indirizzo. Contattaci prima di prenotare per verificarne
            la disponibilità.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Noleggio scooter El Arenal</span>
            <span>Affitto scooter El Arenal</span>
            <span>Scooter 125cc El Arenal</span>
            <span>Noleggio scooter Playa de Palma</span>
            <span>Noleggio scooter Can Pastilla</span>
            <span>Noleggio scooter Palma</span>
            <span>Noleggio scooter Llucmajor</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a El Arenal</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Posso prenotare uno scooter per El Arenal?</summary>
              <p>
                ...
                El Arenal, Playa de Palma, Can Pastilla, Llucmajor e Palma.
              </p>
            </details>

            <details>
              <summary>Quanto dista NEXA Rentals da El Arenal?</summary>
              <p>
                La nostra sede si trova a Magaluf. Da El Arenal il tragitto
                richiede generalmente circa 25-30 minuti in auto, a seconda del
            ...
            <details>
              <summary>È disponibile la consegna a El Arenal?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto a scoprire El Arenal?</h3>
            <p>
