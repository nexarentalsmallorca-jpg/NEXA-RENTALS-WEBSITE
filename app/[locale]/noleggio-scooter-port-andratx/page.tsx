// app/[locale]/noleggio-scooter-port-andratx/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Lucchetto",
    text: "Per soste sicure al porto, in spiaggia o al ristorante.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Port d’Andratx | Scooter 125cc sud-ovest Maiorca | NEXA Rentals",
    description:
      "Noleggio scooter a Port d’Andratx e Puerto de Andratx. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf ed esplora Andratx, Camp de Mar, Paguera e il sud-ovest di Maiorca.",
    keywords: [
      "noleggio scooter Port Andratx",
      "noleggio scooter Port d’Andratx",
      "affitto scooter Port Andratx",
      "affitto scooter Port d’Andratx",
      "scooter 125cc Port Andratx",
      "noleggio motorino Port Andratx",
      "scooter a noleggio Port Andratx",
      "scooter rental Port Andratx",
      "noleggio scooter Puerto de Andratx",
      "affitto scooter Puerto de Andratx",
      "noleggio scooter Andratx",
      "affitto scooter Andratx",
      ...
      "prenotare scooter online Port Andratx",
      "NEXA Rentals Port Andratx",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-port-andratx",
    },
    openGraph: {
      title: "Noleggio scooter Port d’Andratx | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar e il sud-ovest di Maiorca. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-port-andratx",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Port d’Andratx con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterPortAndratxPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter a Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo direttamente a Magaluf. È una soluzione pratica per chi soggiorna a Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar e Paguera.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da Port d’Andratx puoi raggiungere la nostra sede in circa 25-35 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per Port d’Andratx e il sud-ovest di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è pratico per esplorare liberamente Port d’Andratx, Andratx, Camp de Mar, Paguera, Santa Ponsa, Cala Fornells e il sud-ovest di Maiorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna a Port d’Andratx?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Port d’Andratx",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A circa 25–35 minuti da Port d’Andratx
              </span>
            ...
            <h1>
              Noleggia uno scooter a Port d’Andratx ed esplora il sud-ovest di
              Maiorca.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un <strong>noleggio scooter a Port d’Andratx</strong>, uno{" "}
              <strong>scooter a noleggio a Puerto de Andratx</strong> o uno{" "}
            ...
            <p className="nexa-hero-text small">
              Ideale per Port d’Andratx, Puerto de Andratx, Andratx, Camp de
              Mar, Paguera, Cala Fornells, Santa Ponsa e gli itinerari costieri
              nel sud-ovest di Maiorca. Il ritiro e la riconsegna avvengono
              esclusivamente presso NEXA Rentals a Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Port d’Andratx nel sud-ovest di Maiorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Per Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar e Paguera
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Esplora liberamente il porto, le montagne e la costa del
              sud-ovest di Maiorca.
            </h2>

            <p>
              Port d’Andratx è una delle località più affascinanti del
              sud-ovest di Maiorca, con il porto, i ristoranti, i punti
              panoramici e le strade costiere. Con uno scooter 125cc puoi
              collegare più facilmente Port d’Andratx, Andratx, Camp de Mar,
              Paguera, Cala Fornells e Santa Ponsa.
            </p>

            <p>
              NEXA Rentals è una soluzione pratica per chi cerca un noleggio
              scooter a Port d’Andratx, uno scooter a noleggio a Puerto de
              Andratx o un motorino nel sud-ovest di Maiorca. Prenoti online,
              paghi online e ritiri il tuo scooter direttamente a Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Port d’Andratx e il sud-ovest di Maiorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota il tuo scooter da Port d’Andratx in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                vacanza nel sud-ovest di Maiorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Port d’Andratx, Andratx, Camp de Mar o il tuo itinerario a
                Maiorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora lo scooter per Port d’Andratx
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole esplorare Port d’Andratx e il sud-ovest di Maiorca in
            completa libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter Port d’Andratx”, “affitto scooter
            Port Andratx”, “noleggio scooter Puerto de Andratx”, “scooter 125cc
            Andratx” o “noleggio scooter sud-ovest Maiorca”, hai bisogno di una
            soluzione semplice: prenotazione online, pagamento sicuro e uno
            scooter 125cc per muoverti liberamente.
          </p>

          <p>
            Uno scooter è particolarmente pratico per gli spostamenti tra Port
            ...
            servizio di consegna, così la consegna del veicolo, il controllo
            dei documenti e la riconsegna vengono gestiti in modo chiaro e
            sicuro.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Noleggio scooter Port d’Andratx</span>
            <span>Affitto scooter Port Andratx</span>
            <span>Noleggio scooter Puerto de Andratx</span>
            <span>Noleggio scooter Andratx</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a Port d’Andratx</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Posso prenotare uno scooter per Port d’Andratx?
              </summary>
              <p>
                ...
                Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar e
                Paguera.
              </p>
            </details>
            ...
            <details>
              <summary>
                Quanto dista NEXA Rentals da Port d’Andratx?
              </summary>
              <p>
                La nostra sede si trova a Magaluf. Da Port d’Andratx puoi
                raggiungerci in circa 25-35 minuti in auto, a seconda del
            ...
            <details>
              <summary>
                È disponibile la consegna a Port d’Andratx?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Port d’Andratx?</h3>
            <p>
