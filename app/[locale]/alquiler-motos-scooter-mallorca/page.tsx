...
function getLanguageHref(languageCode: Locale) {
  ...
  if (languageCode === "es") {
    return "/es/alquiler-motos-scooter-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de motos scooter en Mallorca | 125 cc | NEXA Rentals",
    description:
      "Alquiler de motos scooter en Mallorca con NEXA Rentals. Reserva online un scooter de 125 cc, recógelo en Magaluf y descubre la isla con libertad. Desde 39 € con dos cascos, baúl, candado, soporte para móvil, kilómetros ilimitados y seguro básico incluidos.",
    keywords: [
      "alquiler motos scooter Mallorca",
      "alquiler de scooters Mallorca",
      "alquilar scooter Mallorca",
      "alquiler scooter 125cc Mallorca",
      "alquiler moto 125 Mallorca",
      "alquiler scooter Magaluf",
      "alquiler motos scooter Magaluf",
      "alquiler scooter cerca de mí Mallorca",
      "alquiler de motos Mallorca",
      "scooter de alquiler Mallorca",
      "alquiler scooter barato Mallorca",
      "reservar scooter online Mallorca",
      "precios alquiler scooter Mallorca",
      "alquiler scooter Mallorca carnet coche",
      ...
      "alquiler scooter NEXA Rentals",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-motos-scooter-mallorca",
    },
    openGraph: {
      title: "Alquiler de motos scooter en Mallorca | NEXA Rentals",
      description:
        "Reserva online un scooter de 125 cc en Mallorca y recógelo en NEXA Rentals, Magaluf. Precios desde 39 € con accesorios útiles incluidos.",
      url: "https://www.nexarentals.es/es/alquiler-motos-scooter-mallorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de motos scooter en Mallorca con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function MotorScooterRentalMallorcaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter en Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Con NEXA Rentals puedes reservar online un scooter de 125 cc y recogerlo directamente en nuestra oficina de Magaluf. Nuestros scooters son ideales para moverte por Magaluf, Palmanova, Santa Ponsa, Palma, Paguera y descubrir Mallorca.",
        },
      },
      {
        "@type": "Question",
        name: "¿Qué scooters ofrece NEXA Rentals?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals ofrece scooters Piaggio y SYM de 125 cc, como el Piaggio Liberty 125 y el SYM Symphony 125. Actualmente no alquilamos scooters de 50 cc.",
        },
      },
      {
        "@type": "Question",
        name: "¿Qué permiso de conducir necesito para alquilar un scooter en Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aceptamos permisos de moto A, A1 y A2 para nuestros scooters de 125 cc. También puedes conducirlos con un permiso de coche de categoría B que tenga al menos 3 años de antigüedad. No se aceptan permisos provisionales ni de aprendizaje.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Dónde puedo recoger el scooter?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "La recogida y la devolución habituales se realizan directamente en la oficina de NEXA Rentals en Magaluf. Actualmente no ofrecemos servicio de entrega de scooters.",
        },
      },
      {
        "@type": "Question",
        name: "¿Cuánto cuesta alquilar un scooter en Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "El alquiler de un scooter de 125 cc con NEXA Rentals cuesta desde 39 € por media jornada. El alquiler completo de 24 horas cuesta 49 €. Las tarifas para varios días pueden variar según la duración del alquiler y la temporada.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de motos scooter de 125 cc en Mallorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Scooters de 125 cc · Recogida en Magaluf
              </span>
            ...
            <h1>
              Alquila un scooter en Mallorca y descubre la isla con total
              libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas{" "}
              <strong>alquiler de motos scooter en Mallorca</strong>,{" "}
              <strong>alquiler de scooters en Mallorca</strong> o un{" "}
              <strong>scooter de 125 cc en Mallorca</strong>? Con NEXA Rentals
              puedes reservar tu scooter online, pagar de forma segura y
              recogerlo directamente en nuestra oficina de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Nuestros scooters de 125 cc son ideales para recorrer Magaluf,
              Palmanova, Santa Ponsa, Palma, Paguera, Cala Vinyes, Camp de Mar
              y el suroeste de Mallorca. Actualmente no alquilamos scooters de
              50 cc ni ofrecemos servicio de entrega de scooters.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooters de 125 cc en Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Scooters para Magaluf, Palmanova, Santa Ponsa, Palma y Mallorca
        </p>

        <div className="nexa-trust-logos">
          <span>Alquiler de motos scooter Mallorca</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de motos scooter en Mallorca
            </span>

            <h2>
              Un scooter de 125 cc te permite descubrir mucho más de Mallorca.
            </h2>

            <p>
              Un scooter es una de las formas más cómodas de llegar a las
              playas, puertos, restaurantes y miradores de Mallorca. En lugar
              de depender de los horarios de autobús o pagar taxis, tú decides
              adónde ir y cuándo salir.
            </p>

            <p>
              NEXA Rentals ofrece scooters de 125 cc desde nuestra oficina de
              Magaluf. Nuestros modelos son más potentes y cómodos que los
              pequeños scooters de 50 cc y resultan especialmente adecuados
              para desplazarte a Palmanova, Santa Ponsa, Palma, Paguera,
              Portals Nous, Cala Vinyes y Camp de Mar.
            </p>
          </article>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva tu scooter en Mallorca en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <h3>Paga online</h3>
              <p>
                Paga online el precio del alquiler y asegura tu scooter para
                las fechas elegidas de tu estancia en Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                pasaporte o documento de identidad. Tras completar la entrega,
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Para viajeros que quieren descubrir Mallorca por su cuenta y sin
            complicaciones.
          </h2>

          <p>
            Si buscas “alquiler de motos scooter Mallorca”, “alquiler de
            scooters Mallorca”, “scooter 125 cc Mallorca”, “alquiler scooter
            Magaluf” o “reservar scooter online Mallorca”, necesitas una
            solución sencilla: reserva online, pago seguro, recogida en
            Magaluf y libertad para empezar a descubrir la isla de inmediato.
          </p>

          <p>
            NEXA Rentals facilita el alquiler de scooters en Mallorca con
            modelos fiables de 125 cc, precios transparentes, dos cascos, baúl
            de 50 litros, candado de seguridad, soporte impermeable para móvil,
            kilómetros ilimitados y seguro básico incluidos. La recogida y la
            devolución habituales se realizan en nuestra oficina de Magaluf.
            Actualmente no ofrecemos servicio de entrega de scooters.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Scooter de alquiler Mallorca</span>
            <span>Alquilar scooter Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de motos scooter en Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                ¿Puedo alquilar un scooter con NEXA Rentals?
              </summary>
              <p>
                Sí. Puedes reservar online un scooter de 125 cc y recogerlo
                directamente en NEXA Rentals, Magaluf.
              </p>
            </details>

            <details>
              <summary>¿Alquiláis scooters de 50 cc o de 125 cc?</summary>
              <p>
                Actualmente alquilamos scooters Piaggio y SYM de 125 cc. No
                ofrecemos scooters de 50 cc.
              </p>
            </details>

            <details>
              <summary>¿Qué permisos de conducir acepta NEXA Rentals?</summary>
              <p>
                Aceptamos permisos de moto A, A1 y A2. También aceptamos un
                permiso de coche de categoría B si tiene al menos 3 años de
                antigüedad. No se aceptan permisos provisionales ni de
                aprendizaje.
              </p>
            </details>
            ...
            <details>
              <summary>¿Ofrecéis entrega en hoteles?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Listo para alquilar tu scooter?</h3>
            <p>
              Reserva online tu scooter de 125 cc y empieza tu ruta directamente
              desde NEXA Rentals en Magaluf.
            </p>
