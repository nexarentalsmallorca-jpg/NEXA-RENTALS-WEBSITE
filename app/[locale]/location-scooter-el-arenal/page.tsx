// app/[locale]/location-scooter-el-arenal/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Idéal pour utiliser le GPS autour de la baie de Palma.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter El Arenal | Scooter 125cc Playa de Palma | NEXA Rentals",
    description:
      "Location de scooter à El Arenal et Playa de Palma. Réservez en ligne un scooter 125cc chez NEXA Rentals, récupérez-le à Magaluf et découvrez El Arenal, Playa de Palma, Can Pastilla, Palma et Llucmajor en toute liberté.",
    keywords: [
      "location scooter El Arenal",
      "louer scooter El Arenal",
      "scooter 125cc El Arenal",
      "location deux roues El Arenal",
      "location scooter S'Arenal",
      "louer scooter S'Arenal",
      "location scooter Playa de Palma",
      "louer scooter Playa de Palma",
      "location scooter Can Pastilla",
      "louer scooter Can Pastilla",
      "location scooter Palma",
      "location scooter Llucmajor",
      "location scooter sud Majorque",
      "scooter 125cc Playa de Palma",
      "réserver scooter El Arenal en ligne",
      "NEXA Rentals El Arenal",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/fr/location-scooter-el-arenal",
    },
    openGraph: {
      title: "Location scooter El Arenal | NEXA Rentals Majorque",
      description:
        "Réservez en ligne un scooter 125cc pour El Arenal, Playa de Palma, Can Pastilla et le sud de Majorque. Retrait chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-el-arenal",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à El Arenal avec NEXA Rentals à Majorque",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterElArenalPage({ params }: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter pour El Arenal ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement à Magaluf. Cette solution est pratique pour les voyageurs séjournant à El Arenal, S’Arenal, Playa de Palma, Can Pastilla, Palma ou Llucmajor.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il d’El Arenal ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis El Arenal, le trajet jusqu’à notre agence prend généralement entre 25 et 30 minutes en voiture, selon la circulation. Le retrait et le retour standard s’effectuent chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Un scooter est-il pratique pour El Arenal et Playa de Palma ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour découvrir librement El Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor et d’autres lieux du sud de Majorque.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison à El Arenal est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait et le retour standard s’effectuent chez NEXA Rentals à Magaluf. Pour une demande de livraison à votre hôtel à El Arenal ou dans une zone proche, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à El Arenal",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-el-arenal-fr"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                À environ 25–30 min d’El Arenal
              </span>
            ...
            <h1>Location de scooter à El Arenal pour découvrir librement la baie de Palma.</h1>

            <p className="nexa-hero-text">
              Vous recherchez une <strong>location de scooter à El Arenal</strong>,{" "}
              souhaitez <strong>louer un scooter à El Arenal</strong> ou réserver{" "}
              un <strong>scooter 125cc à Playa de Palma</strong> ? Chez NEXA
              Rentals, vous réservez et payez en ligne, puis récupérez votre
              scooter directement à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Une solution idéale pour El Arenal, Playa de Palma, Can Pastilla,
              Palma, Llucmajor et les routes autour de la baie de Palma. Parfait
              pour relier librement les plages, les restaurants et plusieurs
              zones touristiques.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à El Arenal et Playa de Palma"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Pour El Arenal, Playa de Palma, Can Pastilla, Palma et le sud de Majorque</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Location scooter El Arenal</span>

            <h2>Découvrez plus librement El Arenal, Playa de Palma et Can Pastilla.</h2>

            <p>
              El Arenal est idéal pour profiter de la plage, des restaurants, de
              la vie nocturne et des excursions autour de la baie de Palma. Avec
              un scooter 125cc, vous pouvez relier plus facilement El Arenal,
              Playa de Palma, Can Pastilla, Palma, Llucmajor et d’autres lieux
              du sud de Majorque.
            </p>

            <p>
              NEXA Rentals est une solution pratique pour les voyageurs qui
              recherchent une location de scooter à El Arenal, souhaitent louer
              un scooter à El Arenal ou découvrir Playa de Palma en deux-roues.
              Vous réservez en ligne, payez en ligne et récupérez votre scooter
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour El Arenal et Playa de Palma</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Réservez votre scooter pour El Arenal en trois étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                location. La réservation est rapide, claire et idéale pour vos
                vacances à El Arenal et Playa de Palma.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                scooter pour El Arenal, Playa de Palma, Can Pastilla ou votre
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour El Arenal
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Louer un scooter à El Arenal</span>

          <h2>
            Pour les voyageurs qui souhaitent découvrir El Arenal, Playa de Palma et le
            sud de Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez « location scooter El Arenal », « louer un
            scooter El Arenal », « scooter 125cc El Arenal », « location
            deux-roues El Arenal » ou « location scooter Playa de Palma », vous
            avez besoin d’une solution simple : réserver en ligne, payer en
            toute sécurité et vous déplacer librement avec un scooter 125cc.
          </p>

          <p>
            Un scooter est particulièrement pratique pour les trajets entre El
            Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor, Magaluf et
            Palmanova. Le retrait et le retour standard s’effectuent chez NEXA
            Rentals à Magaluf. Pour une demande de livraison à votre hôtel,
            contactez-nous avant de réserver afin que nous puissions vérifier
            vos dates et votre adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter El Arenal</span>
            <span>Louer un scooter à El Arenal</span>
            <span>Scooter 125cc El Arenal</span>
            <span>Location scooter Playa de Palma</span>
            <span>Location scooter Can Pastilla</span>
            <span>Location scooter Palma</span>
            <span>Location scooter Llucmajor</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à El Arenal</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Peut-on réserver un scooter pour El Arenal ?</summary>
              <p>
                Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA
                Rentals et le récupérer directement à Magaluf. Cette solution
                est pratique pour El Arenal, Playa de Palma, Can Pastilla,
                Llucmajor et Palma.
              </p>
            </details>

            <details>
              <summary>À quelle distance NEXA Rentals se trouve-t-il d’El Arenal ?</summary>
              <p>
                Notre agence se trouve à Magaluf. Depuis El Arenal, le trajet prend
                généralement entre 25 et 30 minutes en voiture, selon la
                circulation. Le retrait et le retour standard s’effectuent chez
            ...
            <details>
              <summary>La livraison à El Arenal est-elle disponible ?</summary>
              <p>
                Le retrait et le retour standard s’effectuent chez NEXA Rentals à
                Magaluf. Pour une demande de livraison à votre hôtel,
                contactez-nous avant de réserver afin de vérifier la
                disponibilité selon vos dates et votre adresse.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Prêt à découvrir El Arenal ?</h3>
            <p>
              Réservez votre scooter 125cc en ligne et commencez votre trajet
              depuis NEXA Rentals à Magaluf.
            </p>
