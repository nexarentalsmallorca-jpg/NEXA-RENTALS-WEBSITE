// app/[locale]/noleggio-scooter-portals-nous/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per la navigazione nei dintorni di Portals Nous.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Portals Nous | Scooter 125cc Puerto Portals | NEXA Rentals",
    description:
      "Noleggio scooter a Portals Nous e Puerto Portals. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf ed esplora Bendinat, Illetes, Costa d’en Blanes, Palmanova e il sud-ovest di Maiorca.",
    keywords: [
      "noleggio scooter Portals Nous",
      "affitto scooter Portals Nous",
      "scooter 125cc Portals Nous",
      "noleggio motorino Portals Nous",
      "scooter a noleggio Portals Nous",
      "scooter rental Portals Nous",
      "noleggio scooter Puerto Portals",
      "affitto scooter Puerto Portals",
      "scooter 125cc Puerto Portals",
      "noleggio scooter Bendinat",
      "affitto scooter Bendinat",
      "noleggio scooter Illetes",
      "affitto scooter Illetes",
      "noleggio scooter Costa d’en Blanes",
      "affitto scooter Costa d’en Blanes",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-portals-nous",
    },
    openGraph: {
      title: "Noleggio scooter Portals Nous | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per Portals Nous, Puerto Portals, Bendinat, Illetes e Costa d’en Blanes. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-portals-nous",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Portals Nous con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterPortalsNousPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter a Portals Nous?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo direttamente a Magaluf. È una soluzione pratica per chi soggiorna a Portals Nous, Puerto Portals, Bendinat, Illetes e Costa d’en Blanes.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da Portals Nous?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da Portals Nous puoi raggiungere la nostra sede in circa 12-18 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per Portals Nous e Puerto Portals?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è pratico per esplorare liberamente Portals Nous, Puerto Portals, Bendinat, Illetes, Costa d’en Blanes, Palmanova, Magaluf e il sud-ovest di Maiorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna a Portals Nous?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Portals Nous",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A circa 12–18 minuti da Portals Nous
              </span>
            ...
            <h1>
              Noleggia uno scooter a Portals Nous ed esplora Puerto Portals in
              libertà.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un <strong>noleggio scooter a Portals Nous</strong>, uno{" "}
              <strong>scooter a noleggio a Puerto Portals</strong> o uno{" "}
              <strong>scooter 125cc a Bendinat</strong>? Con NEXA Rentals
              prenoti online, paghi in modo sicuro e ritiri il tuo scooter
              direttamente a Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideale per Portals Nous, Puerto Portals, Bendinat, Illetes, Costa
              d’en Blanes, Palmanova, Magaluf e il sud-ovest di Maiorca. Il
              ritiro e la riconsegna avvengono esclusivamente presso NEXA
              Rentals a Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Puerto Portals e Portals Nous"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Per Portals Nous, Puerto Portals, Bendinat, Illetes e Costa d’en
          Blanes
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Collega facilmente Puerto Portals, Bendinat e il sud-ovest di
              Maiorca.
            </h2>

            <p>
              Portals Nous e Puerto Portals sono ideali per il porto, i
              ristoranti, gli hotel, le giornate in spiaggia e gli spostamenti
              verso Bendinat, Illetes, Palmanova o Magaluf. Con uno scooter
            ...
            <p>
              ...
              scooter a Portals Nous, uno scooter a noleggio a Puerto Portals o
              un motorino a Bendinat. Prenoti online, paghi online e ritiri il
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Portals Nous e Maiorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota il tuo scooter da Portals Nous in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Portals Nous, Puerto Portals, Bendinat o il tuo itinerario a
                Maiorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora lo scooter per Portals Nous
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole esplorare Portals Nous e il sud-ovest di Maiorca in
            completa libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter Portals Nous”, “affitto scooter
            Portals Nous”, “noleggio scooter Puerto Portals”, “scooter 125cc
            Bendinat” o “noleggio motorino Illetes”, hai bisogno di una
          ...
          <p>
            ...
            Cala Major, Palmanova e Magaluf. NEXA Rentals offre una
          ...
          <div className="nexa-keyword-cloud">
            <span>Noleggio scooter Portals Nous</span>
            <span>Affitto scooter Portals Nous</span>
            <span>Noleggio scooter Puerto Portals</span>
            <span>Noleggio scooter Bendinat</span>
            <span>Noleggio scooter Illetes</span>
            <span>Noleggio scooter Costa d’en Blanes</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a Portals Nous</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Posso prenotare uno scooter per Portals Nous?</summary>
              <p>
                ...
                Portals Nous, Puerto Portals, Bendinat, Illetes e Costa d’en
                Blanes.
              </p>
            </details>
            ...
            <details>
              <summary>
                Quanto dista NEXA Rentals da Portals Nous?
              </summary>
              <p>
                La nostra sede si trova a Magaluf. Da Portals Nous puoi
                raggiungerci in circa 12-18 minuti in auto, a seconda del
            ...
            <details>
              <summary>
                È disponibile la consegna a Portals Nous?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Portals Nous?</h3>
            <p>
