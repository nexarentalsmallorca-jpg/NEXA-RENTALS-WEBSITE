// app/[locale]/location-scooter-port-andratx/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Antivol",
    text: "Pour stationner en sécurité au port, à la plage ou au restaurant.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-port-andratx";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-port-andratx";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Port d’Andratx | Scooter 125cc sud-ouest Majorque | NEXA Rentals",
    description:
      "Location de scooter à Port d’Andratx et Puerto de Andratx. Réservez un scooter 125cc en ligne dès 39 €, récupérez-le chez NEXA Rentals à Magaluf et découvrez Andratx, Camp de Mar, Paguera et le sud-ouest de Majorque.",
    keywords: [
      "location scooter Port Andratx",
      "location scooter Port d’Andratx",
      "louer un scooter Port Andratx",
      "louer un scooter Port d’Andratx",
      "scooter 125cc Port Andratx",
      "location de scooter Port Andratx",
      "location deux roues Port Andratx",
      "location scooter Puerto de Andratx",
      "louer un scooter Puerto de Andratx",
      "location scooter Andratx",
      "louer un scooter Andratx",
      ...
      "scooter sud-ouest Majorque",
      "réserver scooter Port Andratx",
      "NEXA Rentals Port Andratx",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-port-andratx",
    },
    openGraph: {
      title: "Location scooter Port d’Andratx | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar et le sud-ouest de Majorque. Retrait chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-port-andratx",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Port d’Andratx avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterPortAndratxPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter à Port d’Andratx ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Cette solution est pratique si vous séjournez à Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar ou Paguera.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de Port d’Andratx ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis Port d’Andratx, le trajet prend généralement environ 25 à 35 minutes en voiture selon la circulation. Le retrait et le retour standard s’effectuent directement chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Un scooter est-il pratique pour Port d’Andratx et le sud-ouest de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour découvrir librement Port d’Andratx, Andratx, Camp de Mar, Paguera, Santa Ponsa, Cala Fornells et le sud-ouest de Majorque.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison à Port d’Andratx est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison à Port d’Andratx, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Port d’Andratx",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Port d’Andratx, Majorque",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                À environ 25 à 35 min de Port d’Andratx
              </span>
            ...
            <h1>
              Location de scooter à Port d’Andratx pour découvrir le sud-ouest
              de Majorque.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Port d’Andratx</strong>, une{" "}
              <strong>location de scooter à Puerto de Andratx</strong> ou un{" "}
              <strong>scooter 125cc dans le sud-ouest de Majorque</strong> ?
              Chez NEXA Rentals, vous réservez votre scooter en ligne, payez en
              toute sécurité et le récupérez directement dans notre agence à
              Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Une solution idéale pour Port d’Andratx, Puerto de Andratx,
              Andratx, Camp de Mar, Paguera, Cala Fornells, Santa Ponsa et les
              plus belles routes côtières du sud-ouest de Majorque.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Port d’Andratx dans le sud-ouest de Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Pour Port d’Andratx, Puerto de Andratx, Andratx, Camp de Mar et
          Paguera
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Découvrez plus librement le port, les montagnes et la côte du
              sud-ouest de Majorque.
            </h2>

            <p>
              Port d’Andratx est l’une des plus belles destinations du
              sud-ouest de Majorque, avec son port, ses restaurants, ses points
              de vue et ses routes côtières. Avec un scooter 125cc, vous pouvez
              relier plus facilement Port d’Andratx, Andratx, Camp de Mar,
              Paguera, Cala Fornells et Santa Ponsa.
            </p>

            <p>
              NEXA Rentals est une solution pratique pour les voyageurs qui
              recherchent une location de scooter à Port d’Andratx, un scooter
              à Puerto de Andratx ou une location de deux-roues dans le
              sud-ouest de Majorque. Vous réservez en ligne, payez en ligne et
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Port d’Andratx et le sud-ouest de Majorque</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Votre scooter pour Port d’Andratx en trois étapes simples.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                votre séjour dans le sud-ouest de Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                scooter pour Port d’Andratx, Andratx, Camp de Mar ou votre
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour Port d’Andratx
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs francophones qui souhaitent découvrir Port
            d’Andratx et le sud-ouest de Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Port
            d’Andratx », « louer un scooter Port Andratx », « location scooter
            Puerto de Andratx », « scooter 125cc Andratx » ou « location
            scooter sud-ouest Majorque », vous cherchez une solution simple :
            réserver en ligne, payer en toute sécurité et vous déplacer
            librement avec un scooter 125cc.
          </p>
          ...
          <p>
            ...
            Ponsa, Magaluf et Palmanova. NEXA Rentals vous propose une
            réservation simple en ligne et un retrait à Magaluf. Pour une
            demande de livraison à Port d’Andratx, contactez-nous avant de
            réserver afin de vérifier la disponibilité selon vos dates et votre
            adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter Port d’Andratx</span>
            <span>Louer un scooter Port Andratx</span>
            <span>Location scooter Puerto de Andratx</span>
            <span>Location scooter Andratx</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Port d’Andratx</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Puis-je réserver un scooter pour Port d’Andratx ?
              </summary>
              <p>
                ...
                est pratique pour Port d’Andratx, Puerto de Andratx, Andratx,
                Camp de Mar et Paguera.
              </p>
            </details>

            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de Port d’Andratx
                ?
              </summary>
              <p>
                Notre agence se trouve à Magaluf. Depuis Port d’Andratx, le
                trajet prend généralement environ 25 à 35 minutes en voiture
            ...
            <details>
              <summary>
                La livraison à Port d’Andratx est-elle disponible ?
              </summary>
              <p>
                Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour
                une demande de livraison à Port d’Andratx, contactez-nous avant
                de réserver afin de vérifier la disponibilité selon vos dates et
                votre adresse.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Port d’Andratx ?</h3>
            <p>
              Réservez votre scooter 125cc en ligne et partez directement depuis
