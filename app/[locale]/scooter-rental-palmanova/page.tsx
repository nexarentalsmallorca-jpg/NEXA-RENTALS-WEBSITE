// app/[locale]/scooter-rental-palmanova/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Practical storage for a bag, helmet or beach accessories.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Waterproof phone holder",
    text: "Ideal for navigation around Palmanova and Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-palmanova";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Palmanova | 125cc Scooter Hire Palma Nova | NEXA Rentals",
    description:
      "Scooter rental in Palmanova and Palma Nova. Book a 125cc scooter online with NEXA Rentals, collect it in Magaluf and explore Palmanova, Son Matias, Portals Nous, Santa Ponsa and Calvia freely.",
    keywords: [
      "scooter rental Palmanova",
      "scooter hire Palmanova",
      "125cc scooter Palmanova",
      "motor scooter rental Palmanova",
      "rent a scooter Palmanova",
      "scooter rental Palma Nova",
      "scooter hire Palma Nova",
      "125cc scooter Palma Nova",
      "scooter rental Son Matias",
      "scooter hire Son Matias",
      "scooter rental Magaluf",
      "scooter hire Magaluf",
      "scooter rental Calvia",
      "scooter rental Portals Nous",
      "scooter rental Santa Ponsa",
      "scooter rental south west Mallorca",
      "scooter hire south west Mallorca",
      "book scooter online Palmanova",
      "NEXA Rentals Palmanova",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/en/scooter-rental-palmanova",
    },
    openGraph: {
      title: "Scooter Rental Palmanova | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Palmanova, Palma Nova, Son Matias, Magaluf and Calvia. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-palmanova",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Palmanova with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalPalmanovaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book your 125cc scooter online with NEXA Rentals and collect it directly in Magaluf. It is a particularly convenient option for guests staying in Palmanova, Palma Nova, Son Matias and Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "How far is NEXA Rentals from Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf. From Palmanova, you can usually reach our office in around 5 to 10 minutes, depending on traffic. Collection and return take place directly at NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for Palmanova and Palma Nova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is a practical way to explore Palmanova, Palma Nova, Son Matias, Magaluf, Portals Nous, Santa Ponsa, Cala Vinyes and south-west Mallorca freely.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental in Palmanova",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-palmanova-en"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Around 5–10 minutes from Palmanova
              </span>
            ...
            <h1>
              Rent a scooter for Palmanova and explore Mallorca freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Palmanova</strong>, {" "}
              <strong>scooter hire in Palma Nova</strong> or a {" "}
              <strong>125cc scooter in Palmanova</strong>? With NEXA Rentals,
            ...
            <p className="nexa-hero-text small">
              Ideal for Palmanova, Palma Nova, Son Matias, Magaluf, Portals
              Nous, Santa Ponsa, Cala Vinyes and south-west Mallorca. Perfect
              for travelling freely between beaches, hotels, restaurants and
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter rental in Palmanova and Palma Nova"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>For Palmanova, Palma Nova, Son Matias, Magaluf and Calvia</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Travel easily between Palmanova, Magaluf and south-west Mallorca.
            </h2>

            <p>
              Palmanova is ideal for beaches, hotels, restaurants and short
              journeys to Magaluf, Son Matias, Portals Nous or Santa Ponsa.
              With a 125cc scooter, you can travel with greater freedom and
              explore Mallorca without relying on buses or waiting for a taxi.
            </p>

            <p>
              NEXA Rentals is a practical option for travellers looking for scooter
              rental in Palmanova, scooter hire in Palma Nova or a motor scooter
              in Palmanova. Book online, pay online and collect your scooter
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Palmanova and Mallorca</li>
              <li>Online booking and secure online payment</li>
              <li>Two helmets included</li>
              <li>50-litre top box for a bag, helmet or beach accessories</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book your scooter for Palmanova in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <h3>Choose online</h3>
              <p>
                Choose your 125cc scooter, rental date and rental duration. The
                booking process is quick, clear and ideal for your holiday in
                Palmanova.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Pay the rental price online and reserve your scooter for Palmanova,
                Magaluf, Santa Ponsa or your planned route around Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Visit NEXA Rentals with your original driving licence and passport
                or identity card. We will explain everything before you begin
                your journey.
              </p>
            </div>
          </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Book your scooter per Palmanova
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Palmanova and south-west Mallorca
            with complete freedom.
          </h2>

          <p>
            When you search for “scooter rental Palmanova”, “scooter hire
            Palmanova”, “scooter rental Palma Nova”, “125cc scooter
            Palmanova” or “motor scooter rental Palmanova”, you need a simple
            solution: online booking, secure payment and a 125cc scooter for
            travelling freely.
          </p>

          <p>
            A scooter is particularly practical for travelling between Palmanova,
            Son Matias, Magaluf, Portals Nous, Cala Vinyes, Santa Ponsa, Palma
            and other destinations around Mallorca. NEXA Rentals provides easy
            online booking and collection in Magaluf. Standard collection and
            return take place at our Magaluf office. We do not currently
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Palmanova</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for Palmanova?</summary>
              <p>
                Yes. You can book your 125cc scooter online with NEXA Rentals and
                collect it directly in Magaluf. It is a practical option for
                Palmanova, Palma Nova, Son Matias and Magaluf.
              </p>
            </details>

            <details>
              <summary>How far is NEXA Rentals from Palmanova?</summary>
              <p>
                Our office is located in Magaluf. From Palmanova, you can usually
                reach us in around 5–10 minutes, depending on traffic.
            ...
            <details>
              <summary>Is scooter delivery available in Palmanova?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Palmanova?</h3>
            <p>
              Book your 125cc scooter online and begin your journey directly from
