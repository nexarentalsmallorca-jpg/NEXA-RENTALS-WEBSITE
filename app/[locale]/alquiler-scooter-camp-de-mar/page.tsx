...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-camp-de-mar";
  }

  if (languageCode === "it") {
    return "/it/noleggio-scooter-camp-de-mar";
  }
  ...
  if (languageCode === "es") {
    return "/es/alquiler-scooter-camp-de-mar";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Camp de Mar | 125 cc | NEXA Rentals",
    description:
      "Alquiler de scooter en Camp de Mar y el suroeste de Mallorca. Reserva online un scooter de 125 cc con NEXA Rentals, recógelo en Magaluf y descubre Camp de Mar, Cala Fornells, Paguera, Port d’Andratx y Andratx con libertad.",
    keywords: [
      "alquiler scooter Camp de Mar",
      "alquiler de scooters Camp de Mar",
      "alquilar scooter Camp de Mar",
      "scooter 125cc Camp de Mar",
      "alquiler moto scooter Camp de Mar",
      "scooter de alquiler Camp de Mar",
      "alquiler scooter Cala Fornells",
      "alquilar scooter Cala Fornells",
      "alquiler scooter Paguera",
      "alquilar scooter Paguera",
      "alquiler scooter Port d’Andratx",
      "alquiler scooter Puerto de Andratx",
      "alquiler scooter Andratx",
      "alquiler scooter suroeste Mallorca",
      "alquiler de scooters suroeste Mallorca",
      "scooter 125cc suroeste Mallorca",
      "reservar scooter online Camp de Mar",
      "NEXA Rentals Camp de Mar",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-camp-de-mar",
    },
    openGraph: {
      title: "Alquiler de scooter en Camp de Mar | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Camp de Mar, Cala Fornells, Paguera y el suroeste de Mallorca. Recogida en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-camp-de-mar",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Camp de Mar con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalCampDeMarPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo directamente en nuestra oficina de Magaluf. Es una opción práctica para quienes se alojan en Camp de Mar, Cala Fornells, Paguera, Andratx o Port d’Andratx.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals está en Magaluf. El trayecto desde Camp de Mar suele durar entre 20 y 25 minutos en coche, según el tráfico. La recogida y la devolución habituales del scooter se realizan en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para Camp de Mar y el suroeste de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es una forma práctica de descubrir Camp de Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa Ponsa y otros destinos del suroeste de Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. La recogida y la devolución habituales se realizan directamente en la oficina de NEXA Rentals en Magaluf. Actualmente no ofrecemos servicio de entrega de scooters.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Camp de Mar",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A unos 20–25 minutos de Camp de Mar
              </span>
            ...
            <h1>
              Alquila un scooter para Camp de Mar y descubre el suroeste de
              Mallorca.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Camp de Mar</strong>,{" "}
              <strong>alquilar un scooter en Camp de Mar</strong> o un{" "}
              <strong>scooter de 125 cc en el suroeste de Mallorca</strong>?
            ...
            <p className="nexa-hero-text small">
              Ideal para Camp de Mar, Cala Fornells, Paguera, Port d’Andratx,
              Andratx, Santa Ponsa y las preciosas rutas costeras del suroeste
              de Mallorca. Un scooter te da libertad para llegar a playas,
              puertos y restaurantes sin depender de taxis.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en Camp de Mar y el suroeste de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para Camp de Mar, Cala Fornells, Paguera, Andratx y el suroeste de
          Mallorca
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Camp de Mar
            </span>

            <h2>
              Descubre Camp de Mar, Paguera y Port d’Andratx con mayor libertad.
            </h2>

            <p>
              Camp de Mar es ideal para disfrutar de días tranquilos, playas
              preciosas, restaurantes junto al mar y excursiones por el
              suroeste de Mallorca. Con un scooter de 125 cc puedes desplazarte
              con más facilidad entre Cala Fornells, Paguera, Port d’Andratx,
              Andratx, Santa Ponsa y Magaluf.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en Camp de Mar, alquilar una moto scooter en Camp de
              Mar o moverse en scooter por el suroeste de Mallorca. Reservas y
              pagas online, y recoges tu scooter directamente en nuestra
              oficina de Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Camp de Mar y el suroeste de Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva un scooter para Camp de Mar en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                tus vacaciones en el suroeste de Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Paga online el precio del alquiler y reserva tu scooter para
                Camp de Mar, Paguera, Port d’Andratx o la ruta que hayas
                planeado por Mallorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva un scooter para Camp de Mar
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooters en Camp de Mar
          </span>

          <h2>
            Para viajeros que quieren descubrir Camp de Mar y el suroeste de
            Mallorca por su cuenta.
          </h2>

          <p>
            Si buscas “alquiler scooter Camp de Mar”, “alquiler de scooters
            Camp de Mar”, “scooter 125 cc Camp de Mar”, “alquiler moto scooter
            Camp de Mar” o “alquiler scooter suroeste Mallorca”, necesitas una
            solución sencilla: reserva online, pago seguro y un scooter de 125
            cc que te dé libertad para descubrir la zona.
          </p>

          <p>
            Un scooter resulta especialmente práctico para desplazarte entre
            Camp de Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa
            Ponsa, Magaluf y Palmanova. NEXA Rentals ofrece una reserva online
            sencilla y recogida en nuestra oficina de Magaluf. Actualmente no
            ofrecemos servicio de entrega de scooters.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Camp de Mar</span>
            <span>Alquiler de scooters Camp de Mar</span>
            <span>Scooter 125 cc Camp de Mar</span>
            <span>Alquiler scooter Cala Fornells</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Camp de Mar</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Camp de Mar?</summary>
              <p>
                Sí. Puedes reservar online un scooter de 125 cc con NEXA
                Rentals y recogerlo directamente en Magaluf. Es una opción
                práctica para Camp de Mar, Cala Fornells, Paguera, Andratx y
                Port d’Andratx.
              </p>
            </details>

            <details>
              <summary>¿A qué distancia está NEXA Rentals de Camp de Mar?</summary>
              <p>
                Nuestra oficina está en Magaluf. El trayecto desde Camp de Mar
                suele durar entre 20 y 25 minutos en coche, según el tráfico.
                La recogida y la devolución habituales se realizan en NEXA
                Rentals, Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>¿Hay servicio de entrega en Camp de Mar?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Listo para descubrir Camp de Mar?</h3>
            <p>
              Reserva online tu scooter de 125 cc y comienza tu ruta
              directamente desde NEXA Rentals en Magaluf.
            </p>
