...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Top case",
    text: "Un rangement pratique pour vos affaires.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Support téléphone",
    text: "Idéal pour utiliser le GPS à Magaluf et partout à Majorque.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-magaluf";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Magaluf | Louer un scooter à Magaluf | NEXA Rentals",
    description:
      "Location de scooter à Magaluf, Majorque. Réservez un scooter 125cc dès 39 €, payez en ligne et récupérez-le directement chez NEXA Rentals à Magaluf.",
    keywords: [
      "location scooter Magaluf",
      "location de scooter Magaluf",
      "louer un scooter Magaluf",
      "location scooter Magaluf Majorque",
      "scooter 125cc Magaluf",
      "location scooter 125 Magaluf",
      "location scooter pas cher Magaluf",
      "location deux roues Magaluf",
      "réserver scooter Magaluf",
    ...
    alternates: {
      canonical: "https://www.nexarentals.es/fr/location-scooter-magaluf",
    },
    openGraph: {
      title: "Location scooter Magaluf | NEXA Rentals Majorque",
      description:
        "Louez un scooter 125cc à Magaluf. Réservez et payez en ligne, puis récupérez votre scooter directement chez NEXA Rentals.",
      url: "https://www.nexarentals.es/fr/location-scooter-magaluf",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Magaluf chez NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterMagalufPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Où louer un scooter à Magaluf ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Le retrait et le retour standard s’effectuent dans notre agence.",
        },
      },
      {
        "@type": "Question",
        name: "Puis-je payer ma location de scooter en ligne ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Chez NEXA Rentals, vous pouvez réserver votre scooter et payer le montant de la location directement en ligne. Votre scooter est ainsi confirmé pour les dates choisies.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location de scooter à Magaluf ?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "La livraison à l’hôtel est-elle disponible à Magaluf ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue dans notre agence à Magaluf. Une livraison gratuite à l’hôtel peut être disponible sur demande dans certaines zones proches, selon les dates et l’adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Magaluf",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Magaluf, Majorque",
    },
  };
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
        ...
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            ...
            <p className="nexa-hero-text">
              ...
              <strong>scooter 125cc à Magaluf</strong> ou une{" "}
              <strong>location de scooter à Majorque</strong> ? Chez NEXA
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-top">
                <Image
                  ...
                  alt="Location de scooter à Magaluf avec NEXA Rentals"
                  width={900}
                  height={620}
                  priority
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Magaluf chez NEXA Rentals"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>La façon simple de louer un scooter à Magaluf.</h2>

            <p>
              De nombreux voyageurs attendent d’être sur place pour chercher
              une location de scooter à Magaluf ou ailleurs à Majorque. Avec
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Magaluf et Majorque</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter à Magaluf en seulement quelques étapes.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                voyageurs séjournant à Magaluf ou dans les environs.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                réservé avant le début de votre séjour à Magaluf.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs francophones qui souhaitent découvrir Magaluf
            et Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Magaluf »,
            « louer un scooter à Magaluf », « scooter 125cc Magaluf » ou
            « location scooter Majorque », vous cherchez généralement une
            solution simple, rapide et transparente. Cette page vous présente
            toutes les informations nécessaires pour réserver en ligne,
            récupérer votre scooter à Magaluf et commencer immédiatement à
            découvrir l’île.
          </p>
          ...
          <p>
            ...
            notre agence à Magaluf. Notre objectif est simple : une mobilité
            facile, des prix clairs et un moyen rapide de rejoindre les plages,
            restaurants, points de vue et villages de Majorque.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter Magaluf</span>
            <span>Louer un scooter à Magaluf</span>
            ...
            <span>Réserver scooter Magaluf</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Magaluf</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              ...
              <p>
                ...
                NEXA Rentals à Magaluf. Une livraison gratuite à l’hôtel peut
                être disponible sur demande dans certaines zones proches,
                selon les dates et l’adresse.
              </p>
            </details>
          ...
          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Magaluf et Majorque ?</h3>

            <p>
              Réservez votre scooter 125cc en ligne et partez directement
              depuis notre agence à Magaluf.
            </p>
