// app/[locale]/roller-mieten-portals-nous/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal für Navigation rund um Portals Nous.",
  },
  {
    image: "/images/ex3.png",
    title: "Schloss",
    text: "Für sichere Stopps am Hafen, Strand oder Restaurant.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Portals Nous | 125cc Scooter Puerto Portals | NEXA Rentals",
    description:
      "Roller mieten in Portals Nous und Puerto Portals. 125cc Scooter online bei NEXA Rentals buchen, in Magaluf abholen und Portals Nous, Bendinat, Illetes, Costa d’en Blanes, Palmanova und Südwest Mallorca flexibel entdecken.",
    keywords: [
      "Roller mieten Portals Nous",
      "Scooter mieten Portals Nous",
      "125cc Roller Portals Nous",
      "Motorroller mieten Portals Nous",
      "Roller Verleih Portals Nous",
      "Scooter Rental Portals Nous",
      "Roller mieten Puerto Portals",
      "Scooter mieten Puerto Portals",
      "125cc Roller Puerto Portals",
      "Roller mieten Bendinat",
      "Scooter mieten Bendinat",
      "Roller mieten Illetes",
      "Scooter mieten Illetes",
      "Roller mieten Costa d’en Blanes",
      "Scooter mieten Costa d’en Blanes",
    ...
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-portals-nous`,
    },
    openGraph: {
      title: "Roller mieten Portals Nous | NEXA Rentals Mallorca",
      description:
        "125cc Roller für Portals Nous, Puerto Portals, Bendinat, Illetes und Costa d’en Blanes online buchen. Abholung bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-portals-nous`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Portals Nous bei NEXA Rentals Mallorca",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenPortalsNousPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich in Portals Nous einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist praktisch für Gäste aus Portals Nous, Puerto Portals, Bendinat, Illetes und Costa d’en Blanes.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Portals Nous entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Von Portals Nous erreichst du unseren Standort je nach Verkehr ungefähr in 12 bis 18 Minuten mit dem Auto. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Ist ein Roller praktisch für Portals Nous und Puerto Portals?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Portals Nous, Puerto Portals, Bendinat, Illetes, Costa d’en Blanes, Palmanova, Magaluf und den Südwesten Mallorcas flexibel entdecken möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung nach Portals Nous?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Portals Nous",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-portals-nous`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 12–18 Min. von Portals Nous entfernt
              </span>
            ...
            <h1>Roller mieten in Portals Nous und Puerto Portals flexibel erleben.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Portals Nous</strong>,{" "}
              <strong>Scooter mieten Puerto Portals</strong> oder{" "}
              <strong>125cc Roller Bendinat</strong>? Bei NEXA Rentals buchst du
              deinen Roller online, bezahlst sicher online und holst ihn direkt
              in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Portals Nous, Puerto Portals, Bendinat, Illetes, Costa
              d’en Blanes, Palmanova, Magaluf und den Südwesten Mallorcas.
              Aktuell Abholung und Rückgabe nur bei NEXA Rentals in Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Puerto Portals Portals Nous"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Für Portals Nous, Puerto Portals, Bendinat, Illetes und Costa d’en Blanes</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Puerto Portals, Bendinat und Südwest Mallorca einfacher verbinden.</h2>

            <p>
              Portals Nous und Puerto Portals sind perfekt für Hafen, Restaurants,
              Hotels, Strandtage und kurze Wege Richtung Bendinat, Illetes,
              Palmanova oder Magaluf. Mit einem 125cc Roller bist du flexibler
              unterwegs und kannst Mallorca ohne Taxi-Wartezeit oder Bus-Stress
              erleben.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Portals Nous, Scooter mieten Puerto Portals oder
              Motorroller mieten Bendinat suchen. Du buchst online, bezahlst
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Portals Nous und Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Portals Nous zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                schnell, klar und ideal für deinen Urlaub in Portals Nous.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Portals Nous, Puerto Portals, Bendinat oder deine Mallorca-Tour.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller für Portals Nous buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Für Gäste, die Portals Nous und den Südwesten Mallorcas unabhängig
            entdecken möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Portals Nous”, “Scooter mieten Portals
            Nous”, “Roller mieten Puerto Portals”, “125cc Roller Bendinat” oder
            “Motorroller mieten Illetes” suchst, brauchst du eine einfache
            Lösung: online buchen, sicher bezahlen und mit einem 125cc Roller
            flexibel unterwegs sein.
          </p>

          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Portals Nous,
            Puerto Portals, Bendinat, Illetes, Costa d’en Blanes, Cala Major,
            Palmanova und Magaluf. NEXA Rentals bietet dir eine einfache
          ...
          <div className="nexa-keyword-cloud">
            <span>Roller mieten Portals Nous</span>
            <span>Scooter mieten Portals Nous</span>
            <span>Roller mieten Puerto Portals</span>
            <span>Roller mieten Bendinat</span>
            <span>Roller mieten Illetes</span>
            <span>Roller mieten Costa d’en Blanes</span>
            <span>125cc Roller Portals Nous</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten in Portals Nous</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Portals Nous buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für Portals
                Nous, Puerto Portals, Bendinat, Illetes und Costa d’en Blanes.
              </p>
            </details>

            <details>
              <summary>Wie weit ist NEXA Rentals von Portals Nous entfernt?</summary>
              <p>
                Unser Standort befindet sich in Magaluf. Von Portals Nous sind
                es je nach Verkehr ungefähr 12 bis 18 Minuten mit dem Auto.
            ...
            <details>
              <summary>Gibt es Lieferung nach Portals Nous?</summary>
              <p>
