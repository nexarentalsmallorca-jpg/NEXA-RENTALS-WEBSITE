// app/[locale]/scooter-hire-mallorca/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Practical storage for beach gear, bags and shopping.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-hire-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Hire Mallorca | 125cc Scooter Rental in Magaluf | NEXA Rentals",
    description:
      "Scooter hire in Mallorca with NEXA Rentals in Magaluf. Book a 125cc Piaggio or SYM scooter online from €39 for a half day, with two helmets, a 50-litre top box, security lock, waterproof phone holder, unlimited kilometres and basic insurance included.",
    keywords: [
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-hire-mallorca",
    },
    openGraph: {
      title: "Scooter Hire Mallorca | NEXA Rentals Magaluf",
      description:
        "Book a 125cc scooter online in Mallorca. Standard collection and return take place at NEXA Rentals in Magaluf; hotel delivery may be available only on request and subject to confirmation.",
      url: "https://www.nexarentals.es/en/scooter-hire-mallorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter hire in Mallorca with NEXA Rentals in Magaluf",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterHireMallorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Where can I hire a scooter in Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "You can book a 125cc scooter online with NEXA Rentals and collect it directly from our Magaluf office. Standard collection and return take place at NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Can I pay online for scooter hire in Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. With NEXA Rentals you can book your scooter online and pay the rental price online, so your 125cc scooter is reserved for the dates you select.",
        },
      },
      {
        "@type": "Question",
        name: "Which driving licence do I need to ride a 125cc scooter in Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What is included with scooter hire in Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Standard collection and return take place at our Magaluf office. Hotel delivery may be available on request for selected nearby areas, depending on the location, date and address. Contact NEXA Rentals before booking to confirm availability.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter hire in Mallorca",
      priceCurrency: "EUR",
      price: "39",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Scooter hire in Mallorca: book your 125cc scooter online.</h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter hire in Mallorca</strong>, a{" "}
              <strong>125cc scooter in Mallorca</strong> or a{" "}
              <strong>motor scooter rental in Mallorca</strong>? With NEXA Rentals,
              you can book online, pay securely and collect your 125cc scooter
              directly from our Magaluf office.
            </p>

            <p className="nexa-hero-text small">
              Ideal for Magaluf, Palmanova, Palma Nova, Santa Ponsa, Paguera,
              Calvià, beach days, scenic viewpoints, restaurants and independent
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Directly in Magaluf, Mallorca.</strong>
                <span>
                  NEXA Rentals is based in Magaluf: book online, collect your
                  scooter from our office and set off towards the beach, Palmanova,
                  Santa Ponsa or Paguera.
                </span>
              </div>
            ...
            <div className="nexa-hero-points">
              <div>
                ...
                <span>Half-day scooter hire</span>
              </div>
              ...
              <div>
                ...
                <span>Book online and collect from our office</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc scooter hire in Mallorca with NEXA Rentals"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Chosen by travellers who want to explore Mallorca freely</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>A simple way to hire a scooter in Mallorca.</h2>

            <p>
              Many travellers choose a scooter in Mallorca so they do not have to
              rely on taxis, buses or long waits every day. With NEXA Rentals,
              it is simple: book your 125cc scooter online, pay online and collect
              it directly from our Magaluf office.
            </p>

            <p>
              Our scooters are ideal for short journeys, beach days and trips between
              Magaluf, Palmanova, Palma Nova, Portals Nous, Santa Ponsa, Paguera
              and Calvià. Set off and explore Mallorca at your own pace.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Mallorca</li>
              <li>Direct collection in Magaluf</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Hire your scooter in Mallorca in just a few steps.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                quick, clear and designed for travellers visiting Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                travel dates. This confirms the vehicle before your day in Mallorca begins.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                and an ID card or passport. We will explain everything and you can
                set off straight away towards the beach, Palmanova, Santa Ponsa or Paguera.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Book your scooter in Mallorca
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Scooter hire Mallorca</span>

          <h2>
            For travellers who want to discover Mallorca freely and with maximum
            flexibility.
          </h2>

          <p>
            When you search for “scooter hire Mallorca”, “scooter rental Mallorca”,
            “rent a scooter Mallorca”, “motor scooter hire Mallorca” or “125cc scooter
            Mallorca”, you want a simple and quick option. NEXA Rentals offers clear
            information, online booking, secure payment and a scooter for exploring
            Mallorca with complete freedom.
          </p>

          <p>
            This page is particularly useful if you are staying in Magaluf,
            Palmanova, Palma Nova, Santa Ponsa, Paguera, Portals Nous or southwest
            Mallorca. Standard collection and return take place at NEXA Rentals in
            Magaluf. Hotel delivery may be available on request for selected nearby
            areas, depending on the location, date and address. Contact us before
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Scooter hire Palmanova</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter hire in Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Which driving licence do I need for a 125cc scooter?</summary>
              <p>
                A, A1 and A2 motorcycle licences are accepted. You may also ride a
                125cc scooter with a category B car licence if it has been valid for at
                least 3 years. Provisional and learner licences are not accepted.
              </p>
            </details>

            <details>
              <summary>Where do I collect the scooter?</summary>
              <p>
                Standard collection and return take place at NEXA Rentals in
                Magaluf. Hotel delivery may be available on request for selected nearby
                areas. Contact us before booking to confirm availability for your
            ...
            <details>
              ...
              <p>
                Yes. You can book online and pay the rental price online, so the
                scooter remains reserved for your selected dates.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                ...
                phone holder, unlimited kilometres and basic insurance are included.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Yes. Our Magaluf office is convenient if you are staying in Magaluf,
                Palmanova, Palma Nova, Santa Ponsa, Paguera or Calvià and want to
                hire a scooter in Mallorca.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Ready to discover Mallorca?</h3>
            <p>
              Book your 125cc scooter online and start your journey directly from
