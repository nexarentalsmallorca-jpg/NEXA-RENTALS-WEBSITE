...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per la navigazione a Palma e a Maiorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Lucchetto",
    text: "Per soste sicure in città, in spiaggia o in hotel.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "it") {
    return "/it/noleggio-scooter-palma";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Palma | Scooter 125cc Palma de Mallorca | NEXA Rentals",
    description:
      "Noleggio scooter a Palma e Palma de Mallorca. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf ed esplora il centro storico, La Seu, Santa Catalina, Paseo Marítimo e Maiorca.",
    keywords: [
      "noleggio scooter Palma",
      "affitto scooter Palma",
      "scooter 125cc Palma",
      "noleggio motorino Palma",
      "scooter a noleggio Palma",
      "scooter rental Palma",
      "noleggio scooter Palma de Mallorca",
      "affitto scooter Palma de Mallorca",
      "scooter 125cc Palma de Mallorca",
      ...
      "affitto scooter Cala Major",
      "noleggio scooter Maiorca Palma",
      "prenotare scooter online Palma",
      "NEXA Rentals Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/it/noleggio-scooter-palma",
    },
    openGraph: {
      title: "Noleggio scooter Palma | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per Palma, Palma de Mallorca, il centro storico, Santa Catalina e Cala Major. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Palma con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterPalmaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter per Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo direttamente a Magaluf. È una soluzione pratica per chi soggiorna a Palma, Palma de Mallorca, Cala Major, Santa Catalina, Portixol e nelle zone vicine.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da Palma puoi raggiungere la nostra sede in circa 20-25 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per visitare Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è pratico per raggiungere Palma, il centro storico, Santa Catalina, Paseo Marítimo, Cala Major, Portixol, Palmanova, Magaluf e altre località di Maiorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna a Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc per Palma",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            ...
            <h1>
              Noleggia uno scooter per Palma ed esplora Maiorca senza perdere
              tempo.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un <strong>noleggio scooter a Palma</strong>, uno{" "}
              <strong>scooter a noleggio a Palma de Mallorca</strong> o uno{" "}
              <strong>scooter 125cc a Palma</strong>? Con NEXA Rentals prenoti
              online, paghi in modo sicuro e ritiri il tuo scooter direttamente
              a Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideale per il centro storico di Palma, la Cattedrale La Seu, Santa
              Catalina, Paseo Marítimo, Cala Major, Portixol, Palmanova e le
              escursioni giornaliere a Maiorca. Perfetto per raggiungere
              liberamente città, spiagge, porti e località costiere.
            </p>
      ...
      <section className="nexa-trust-section">
        <p>
          Per Palma, Palma de Mallorca, il centro storico, Santa Catalina e Cala
          Major
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Raggiungi più facilmente Palma, il centro storico e la costa.
            </h2>

            <p>
              Palma è perfetta per il centro storico, lo shopping, i ristoranti,
              Santa Catalina, la Cattedrale La Seu e il Paseo Marítimo. Con uno
              scooter 125cc puoi esplorare Palma e la costa con maggiore
              libertà, senza dover organizzare ogni spostamento in autobus, taxi
              o cercando parcheggio per l’auto.
            </p>

            <p>
              NEXA Rentals è una soluzione pratica per chi cerca un noleggio
              scooter a Palma, uno scooter a noleggio a Palma de Mallorca o un
              motorino a Palma. Prenoti online, paghi online e ritiri il tuo
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Palma e Maiorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota il tuo scooter per Palma in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Palma, Magaluf, Palmanova o il tuo itinerario sull’isola.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora lo scooter per Palma
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole scoprire Palma e Maiorca in completa libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter Palma”, “affitto scooter Palma”,
            “noleggio scooter Palma de Mallorca”, “scooter 125cc Palma” o
            “noleggio motorino centro storico Palma”, hai bisogno di una
            soluzione semplice: prenotazione online, pagamento sicuro e uno
            scooter 125cc per spostarti liberamente.
          </p>

          <p>
            Uno scooter è particolarmente pratico per gli spostamenti tra
            Palma, Santa Catalina, Paseo Marítimo, Cala Major, Portixol,
            Magaluf, Palmanova e altre località di Maiorca. NEXA Rentals offre
            una prenotazione online semplice e il ritiro a Magaluf. Al momento
            non offriamo un servizio di consegna, così la consegna del veicolo,
            il controllo dei documenti e la riconsegna vengono gestiti in modo
            chiaro e sicuro.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Noleggio scooter Palma</span>
            <span>Affitto scooter Palma</span>
            <span>Noleggio scooter Palma de Mallorca</span>
            <span>Scooter 125cc Palma</span>
            <span>Noleggio scooter Santa Catalina</span>
            <span>Noleggio scooter Cala Major</span>
            <span>Noleggio motorino Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Posso prenotare uno scooter per Palma?</summary>
              <p>
                ...
                Palma, Palma de Mallorca, Santa Catalina, Cala Major e
                Portixol.
              </p>
            </details>

            <details>
              <summary>Quanto dista NEXA Rentals da Palma?</summary>
              <p>
                La nostra sede si trova a Magaluf. Da Palma puoi raggiungerci in
                circa 20-25 minuti in auto, a seconda del traffico. Il ritiro e
                la riconsegna avvengono direttamente presso NEXA Rentals a
                Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>È disponibile la consegna a Palma?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Palma?</h3>
            <p>
