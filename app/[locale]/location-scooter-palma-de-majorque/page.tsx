// app/[locale]/location-scooter-palma-de-majorque/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Top case",
    text: "Pratique pour un sac, un casque ou vos achats.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Support téléphone",
    text: "Idéal pour utiliser le GPS à Palma de Majorque.",
  },
  {
    image: "/images/ex3.png",
    title: "Antivol",
    text: "Pour stationner en sécurité en ville, au port ou à l’hôtel.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-palma-de-majorque";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-palma-de-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Palma de Majorque | Scooter 125cc | NEXA Rentals",
    description:
      "Location de scooter à Palma de Majorque. Réservez un scooter 125cc dès 39 €, payez en ligne et récupérez-le chez NEXA Rentals à Magaluf pour découvrir la vieille ville, La Seu, Santa Catalina, le Paseo Marítimo et Majorque.",
    keywords: [
      "location scooter Palma de Majorque",
      "location de scooter Palma de Majorque",
      "louer un scooter Palma de Majorque",
      "location scooter Palma",
      "louer un scooter Palma",
      "scooter 125cc Palma de Majorque",
      "location scooter 125 Palma",
      "location scooter pas cher Palma",
      "location deux roues Palma de Majorque",
      "location scooter vieille ville Palma",
      "location scooter cathédrale Palma",
      "location scooter La Seu",
      "location scooter Santa Catalina",
      "location scooter Paseo Marítimo",
      "location scooter port de Palma",
      "location scooter port de croisière Palma",
      "location scooter Cala Major",
      "location scooter centre Palma",
      "location scooter capitale Majorque",
      "réserver scooter Palma de Majorque",
      "NEXA Rentals Palma de Majorque",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-palma-de-majorque",
    },
    openGraph: {
      title: "Location scooter Palma de Majorque | NEXA Rentals",
      description:
        "Réservez un scooter 125cc pour découvrir Palma de Majorque, la vieille ville, La Seu, Santa Catalina, le Paseo Marítimo et le port.",
      url: "https://www.nexarentals.es/fr/location-scooter-palma-de-majorque",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Palma de Majorque avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterPalmaDeMajorquePage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter pour Palma de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Cette solution convient aux voyageurs qui souhaitent découvrir Palma de Majorque, la vieille ville, Santa Catalina, Cala Major, Portixol et les environs.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de Palma de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis Palma de Majorque, le trajet prend généralement environ 20 à 25 minutes en voiture selon la circulation. Le retrait et le retour standard s’effectuent directement chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Un scooter est-il pratique pour visiter Palma de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour relier la vieille ville de Palma, la cathédrale La Seu, Santa Catalina, le Paseo Marítimo, le port de croisière, Cala Major, Portixol et d’autres destinations de Majorque.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison est-elle disponible à Palma de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue dans notre agence à Magaluf. Une livraison à Palma de Majorque n’est pas garantie. Contactez-nous avant de réserver afin de vérifier les possibilités pour vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Palma de Majorque",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Palma de Majorque",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-palma-de-majorque"
      ...
      <Script
        id="nexa-schema-faq-palma-de-majorque"
      ...
      <Script
        id="nexa-schema-business-palma-de-majorque"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                À environ 20 à 25 min de Palma de Majorque
              </span>
            ...
            <h1>
              Location de scooter à Palma de Majorque pour découvrir la
              capitale librement.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Palma de Majorque</strong>, une{" "}
              <strong>location de scooter à Palma</strong> ou un{" "}
              <strong>scooter 125cc à Palma de Majorque</strong> ? Chez NEXA
              Rentals, vous réservez votre scooter en ligne, payez en toute
              sécurité et le récupérez directement dans notre agence à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Une solution idéale pour découvrir la vieille ville de Palma, la
              cathédrale La Seu, Santa Catalina, le Paseo Marítimo, le port de
              croisière, Cala Major, Portixol et d’autres destinations de
              Majorque. Le retrait et le retour standard s’effectuent chez NEXA
              Rentals à Magaluf.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Palma de Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Pour Palma de Majorque, la vieille ville, La Seu, Santa Catalina et
          le port
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Reliez facilement la vieille ville de Palma, le port et la côte.
            </h2>

            <p>
              Palma de Majorque est une destination idéale pour découvrir la
              vieille ville, faire du shopping, profiter des restaurants,
              visiter la cathédrale La Seu, explorer Santa Catalina, longer le
              Paseo Marítimo et rejoindre le port. Avec un scooter 125cc, vous
              pouvez organiser vos trajets plus librement sans dépendre
              uniquement des bus ou des taxis.
            </p>

            <p>
              NEXA Rentals est une solution pratique pour les voyageurs qui
              recherchent une location de scooter à Palma de Majorque, une
              location de scooter dans le centre de Palma ou un scooter 125cc
              pour visiter la capitale. Vous réservez en ligne, payez en ligne
              et récupérez votre scooter directement à Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Palma de Majorque et l’île</li>
              <li>Réservation et paiement en ligne</li>
              <li>Deux casques inclus</li>
              <li>Top case pour un sac, un casque ou vos achats</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Votre scooter pour Palma de Majorque en trois étapes simples.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                votre scooter pour Palma de Majorque, Magaluf, Palmanova ou
                votre excursion sur l’île.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour Palma de Majorque
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Louer un scooter à Palma de Majorque
          </span>

          <h2>
            Pour les voyageurs francophones qui souhaitent découvrir Palma et
            Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Palma de
            Majorque », « louer un scooter à Palma », « location scooter vieille
            ville Palma », « location scooter cathédrale Palma » ou « location
            scooter port de Palma », vous cherchez généralement une solution
            simple : réserver en ligne, payer en toute sécurité et disposer
            d’un scooter 125cc pour vous déplacer librement.
          </p>

          <p>
            Un scooter est particulièrement pratique pour relier la vieille
            ville de Palma, Santa Catalina, le Paseo Marítimo, Cala Major,
            Portixol, Magaluf, Palmanova et les autres destinations de
            Majorque. NEXA Rentals vous propose une réservation simple en ligne
            et un retrait à Magaluf. Pour une demande de livraison à Palma,
            contactez-nous avant de réserver afin de vérifier les possibilités
            selon vos dates et votre adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter Palma de Majorque</span>
            <span>Louer un scooter à Palma</span>
            <span>Location scooter vieille ville Palma</span>
            <span>Location scooter cathédrale Palma</span>
            <span>Location scooter port de Palma</span>
            <span>Scooter 125cc Palma de Majorque</span>
            <span>Location deux roues centre Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>
            Questions sur la location de scooter à Palma de Majorque
          </h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Puis-je réserver un scooter pour Palma de Majorque ?
              </summary>

              <p>
                Oui. Vous pouvez réserver votre scooter 125cc en ligne chez
                NEXA Rentals et le récupérer directement dans notre agence à
                Magaluf. Cette solution est pratique pour découvrir Palma de
                Majorque, la vieille ville, Santa Catalina, Cala Major et
                Portixol.
              </p>
            </details>
            ...
            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de Palma de
                Majorque ?
              </summary>

              <p>
                Notre agence se trouve à Magaluf. Depuis Palma de Majorque, le
                trajet prend généralement environ 20 à 25 minutes en voiture
                selon la circulation. Le retrait et le retour standard
                s’effectuent directement chez NEXA Rentals à Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>
                La livraison est-elle disponible à Palma de Majorque ?
              </summary>

              <p>
                Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Une
                livraison à Palma de Majorque n’est pas garantie. Contactez-nous
                avant de réserver afin de vérifier les possibilités pour vos
                dates et votre adresse.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Palma de Majorque ?</h3>
