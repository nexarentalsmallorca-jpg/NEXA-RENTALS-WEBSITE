// app/[locale]/alquiler-scooter-magaluf/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por Magaluf y Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  ...
  if (languageCode === "es") {
    return "/es/alquiler-scooter-magaluf";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Magaluf | 125 cc | NEXA Rentals",
    description:
      "Alquiler de scooter en Magaluf, Mallorca, directamente con NEXA Rentals. Reserva online un scooter de 125 cc desde 39 €, recógelo en nuestra oficina de Magaluf y descubre Palmanova, Santa Ponsa, Portals Nous y Calvià con libertad.",
    keywords: [
      "alquiler scooter Magaluf",
      "alquiler de scooters Magaluf",
      "alquilar scooter Magaluf",
      "scooter 125cc Magaluf",
      "alquiler moto scooter Magaluf",
      "scooter de alquiler Magaluf",
      ...
      "reservar scooter online Magaluf",
      "alquiler scooter barato Magaluf",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/es/alquiler-scooter-magaluf",
    },
    openGraph: {
      title: "Alquiler de scooter en Magaluf | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc en Magaluf desde 39 €. Recogida y devolución en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-magaluf",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Magaluf con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalMagalufPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Dónde puedo alquilar un scooter en Magaluf?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Qué permiso de conducir necesito para un scooter de 125 cc en Magaluf?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Qué incluye el alquiler de scooter en Magaluf?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en hoteles de Magaluf?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Magaluf",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Alquila un scooter en Magaluf y descubre Mallorca con libertad.</h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Magaluf</strong>,{" "}
              <strong>alquilar un scooter en Magaluf</strong> o un{" "}
              <strong>scooter de 125 cc en Magaluf</strong>? Con NEXA Rentals
              puedes reservar online, pagar de forma segura y recoger tu
              scooter directamente en nuestra oficina del centro de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal para Magaluf, Palmanova, Palma Nova, Torrenova, Santa Ponsa,
              Portals Nous y Calvià, así como para días de playa, miradores,
              beach clubs y excursiones sin depender de taxis ni autobuses.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter de 125 cc en Magaluf con NEXA Rentals"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>La opción práctica para descubrir Mallorca con libertad desde Magaluf</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>La forma sencilla de alquilar un scooter en Magaluf.</h2>

            <p>
              Cuando te alojas en Magaluf, no necesitas perder tiempo buscando
              una empresa de alquiler lejos de tu hotel. Con NEXA Rentals
              puedes reservar online un scooter de 125 cc, pagar por internet y
              recogerlo directamente en nuestra oficina de Magaluf. Sabrás que
              tu vehículo está reservado y podrás comenzar el día de inmediato.
            </p>

            <p>
              Nuestros scooters son ideales para trayectos cortos, días de
              playa y excursiones a Palmanova, Palma Nova, Portals Nous, Santa
              Ponsa, El Toro y Calvià. No tendrás que esperar taxis ni organizar
              el día según los horarios de autobús. Recoge tu scooter y descubre
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Magaluf y Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Reserva un scooter en Magaluf en tres sencillos pasos.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                para quienes se alojan en Magaluf.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Alquiler de scooter en Magaluf</span>

          <h2>
            Para viajeros que quieren disfrutar de Magaluf y Mallorca con mayor
            libertad.
          </h2>

          <p>
            Si buscas “alquiler scooter Magaluf”, “alquiler de scooters
            Magaluf”, “scooter 125 cc Magaluf”, “alquiler moto scooter Magaluf”
            o “alquilar scooter Magaluf”, necesitas una solución sencilla:
            información clara, reserva online, pago seguro y un punto de
            recogida fácil de encontrar. NEXA Rentals está en Magaluf, en C.
            Galeón, 13, Loc 57.
          </p>

          <p>
            Nuestro servicio resulta especialmente práctico para quienes se
            alojan en Magaluf, Torrenova, Palmanova, Palma Nova, Santa Ponsa o
            Calvià. Con un scooter puedes llegar a playas, restaurantes, beach
            clubs, miradores y destinos cercanos sin depender siempre de un
            taxi. La recogida y la devolución habituales se realizan en nuestra
            oficina de Magaluf. Actualmente no ofrecemos servicio de entrega de
            scooters.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Magaluf</span>
            <span>Alquiler de scooters Magaluf</span>
            <span>Scooter 125 cc Magaluf</span>
            <span>Alquiler moto scooter Magaluf</span>
            <span>Alquilar scooter Magaluf</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Magaluf</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Dónde recojo el scooter en Magaluf?</summary>
              <p>
            ...
            <details>
              <summary>¿Hay servicio de entrega en hoteles de Magaluf?</summary>
              <p>
