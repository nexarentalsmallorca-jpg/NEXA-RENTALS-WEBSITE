// app/[locale]/mallorca-scooter-rental/page.tsx
...
export async function generateMetadata({
  ...
  return {
    title:
      "Mallorca Scooter Rental | 125cc Scooters from €39 | NEXA Rentals",
    description:
      "Mallorca scooter rental with NEXA Rentals. Book a 125cc scooter online and collect it directly in Magaluf. Ideal for Magaluf, Palmanova, Santa Ponsa, Palma, Paguera and south-west Mallorca. Two helmets, a 50-litre top box, security lock, waterproof phone holder and unlimited kilometres included.",
    keywords: [
    ...
    alternates: {
      canonical: "https://www.nexarentals.es/en/mallorca-scooter-rental",
    },
    openGraph: {
      title: "Mallorca Scooter Rental | NEXA Rentals",
      description:
        "Book a 125cc scooter online, collect it in Magaluf and explore Mallorca freely. Two helmets, a 50-litre top box, security lock, waterproof phone holder and unlimited kilometres are included.",
      url: "https://www.nexarentals.es/en/mallorca-scooter-rental",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Mallorca scooter rental with NEXA Rentals",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function MallorcaScooterRentalPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Where can I rent a scooter in Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals offers 125cc scooter rental in Magaluf, Mallorca. You can book your scooter online and collect it directly from NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "How much does it cost to rent a scooter in Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "With NEXA Rentals, half-day scooter rental starts from €39 and 24-hour rental costs €49. Multi-day rates may also be available depending on the season and rental duration.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is a deposit required to rent a scooter?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. The deposit is €150 per scooter and is returned after the scooter is returned correctly.",
        },
      },
      {
        "@type": "Question",
        name: "Does NEXA Rentals offer scooter delivery in Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. We do not currently provide a scooter delivery service. Collection and return take place directly at NEXA Rentals in Magaluf.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: [
      {
        "@type": "Offer",
        name: "Half-day 125cc scooter rental in Mallorca",
        price: "39",
        priceCurrency: "EUR",
      ...
      {
        "@type": "Offer",
        name: "24-hour 125cc scooter rental in Mallorca",
        price: "49",
        priceCurrency: "EUR",
        availability: "https://schema.org/InStock",
        areaServed: "Mallorca",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-mallorca-scooter-rental"
      ...
      <Script
        id="nexa-schema-faq-mallorca-scooter-rental"
      ...
      <Script
        id="nexa-schema-business-mallorca-scooter-rental"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Mallorca scooter rental · Collection in Magaluf
              </span>
            ...
            <h1>
              Rent a scooter in Mallorca: book your 125cc online and explore freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Mallorca</strong>,{" "}
              <strong>scooter hire in Mallorca</strong> or a{" "}
            ...
            <p className="nexa-hero-text small">
              Ideal for Magaluf, Palmanova, Santa Ponsa, Palma, Paguera, Camp
              de Mar, Portals Nous, Cala Vinyes and south-west Mallorca. Prices
              start from €39 for a half day and €49 for 24 hours, with two
              helmets, a 50-litre top box, security lock, waterproof phone
              holder and unlimited kilometres included.
            </p>
      ...
      <section className="nexa-trust-section">
        <p>
          Scooter rental for Mallorca, Magaluf, Palmanova, Santa Ponsa and Palma
        </p>

        <div className="nexa-trust-logos">
          <span>Mallorca scooter rental</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              A simple way to rent a scooter during your Mallorca holiday.
            </h2>

            <p>
              With a 125cc scooter, Mallorca becomes easier to explore on your own
              schedule. Beaches, hotels, restaurants, ports, viewpoints and
              smaller coastal roads are much easier to reach. With NEXA
              Rentals, you book and pay online, collect your scooter in
              Magaluf and start your trip.
            </p>

            <p>
              Our scooter rental service is particularly practical for guests
              staying in Magaluf, Palmanova, Santa Ponsa, Portals Nous, Cala
              Vinyes, Paguera, Palma and south-west Mallorca. We do not
              currently provide a scooter delivery service. Collection and
              return take place directly at NEXA Rentals in Magaluf, where the
              vehicle handover and document checks are handled clearly and
              securely.
            </p>
          </article>
      ...
      <section className="nexa-price-section">
        <div className="nexa-price-inner">
          ...
          <h2>Clear scooter rental prices for Mallorca.</h2>

          <div className="nexa-price-grid">
            <div className="nexa-price-card">
              <span className="nexa-price-badge">Half day</span>
              <h3>Same-day rental</h3>
              <p>Ideal for the beach, the city or a short Mallorca route.</p>
              <strong>€39</strong>
              <Link href={bookHref}>Book half day</Link>
            </div>

            <div className="nexa-price-card featured">
              <span className="nexa-price-badge">Most popular</span>
              <h3>24 hours</h3>
              <p>Ideal for exploring Mallorca with maximum freedom.</p>
              <strong>€49</strong>
              <Link href={bookHref}>Book 24 hours</Link>
            </div>

            <div className="nexa-price-card">
              <span className="nexa-price-badge">Deposit</span>
              <h3>Security deposit</h3>
              <p>Returned after the scooter is returned correctly.</p>
              <strong>€150</strong>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Rent a scooter in Mallorca in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                quick, clear and easy to arrange for your Mallorca holiday.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Pay securely online and reserve your scooter for Magaluf,
                Palmanova, Santa Ponsa, Palma or your route around the island.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Mallorca independently without relying on taxis.
          </h2>

          <p>
            When you search for “Mallorca scooter rental”, “scooter rental
            Mallorca”, “scooter hire Mallorca”, “motor scooter rental Mallorca”
            or “125cc scooter Mallorca”, you want a simple option: online
            booking, secure payment and a 125cc scooter that gives you freedom
            to explore the island.
          </p>

          <p>
            A scooter is particularly practical for travelling between Magaluf,
            Palmanova, Santa Ponsa, Portals Nous, Cala Vinyes, Paguera, Palma,
            Camp de Mar and many other parts of Mallorca. NEXA Rentals offers
            simple online booking with collection in Magaluf. We do not
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Affordable scooter rental Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Where is NEXA Rentals located?</summary>
              <p>
                NEXA Rentals is located in Magaluf, Mallorca: C. Galeón, 13, Loc
                57, 07181 Magaluf, Illes Balears, Spain.
              </p>
            </details>

            <details>
              <summary>How much does it cost to rent a scooter in Mallorca?</summary>
              <p>
                With NEXA Rentals, half-day scooter rental starts from €39 and
                24-hour rental costs €49. The deposit is €150 per scooter and is
                returned after the scooter is returned correctly.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                ...
                valid for at least 3 years. Provisional and learner licences are
                not accepted.
              </p>
            </details>

            <details>
              <summary>Is scooter delivery available in Mallorca?</summary>
              <p>
