...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Top case",
    text: "Un espace pratique pour la plage, un sac ou vos achats.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Support téléphone",
    text: "Parfait pour naviguer entre El Toro, Magaluf et Calvià.",
  },
  {
    image: "/images/ex3.png",
    title: "Antivol",
    text: "Pour stationner en sécurité au port, à la plage, à l’hôtel ou au restaurant.",
  },
  {
    image: "/images/ex5.png",
    title: "Assurance",
    text: "L’assurance de base est incluse dans le prix de la location.",
  },
];
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-el-toro";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location de scooter à El Toro | Scooter 125cc à Majorque | NEXA Rentals",
    description:
      "Louez un scooter 125cc pour El Toro et Port Adriano avec NEXA Rentals. Réservation en ligne, retrait à Magaluf et découverte facile de Santa Ponsa, Palmanova et Calvià.",
    keywords: [
      "location scooter El Toro",
      "louer scooter El Toro",
      "location scooter 125cc El Toro",
      "location deux roues El Toro",
      "location scooter Port Adriano",
      "louer scooter Port Adriano",
      "scooter El Toro Majorque",
      "location scooter Majorque",
      "location scooter Santa Ponsa",
      "location scooter Calvià",
      "location scooter Magaluf",
      "scooter 125cc Majorque",
      "réserver scooter El Toro",
      "NEXA Rentals El Toro",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/fr/location-scooter-el-toro",
    },
    openGraph: {
      title: "Location de scooter à El Toro | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour El Toro et Port Adriano. Retrait chez NEXA Rentals à Magaluf, à environ 20 minutes d’El Toro.",
      url: "https://www.nexarentals.es/fr/location-scooter-el-toro",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à El Toro avec NEXA Rentals Majorque",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterElToroPage({ params }: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Puis-je louer un scooter pour El Toro ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le retirer à Magaluf. Notre agence se trouve à environ 20 minutes d’El Toro et constitue une solution pratique pour les visiteurs séjournant à El Toro, Port Adriano, Santa Ponsa ou Calvià.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-elle d’El Toro ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf, à environ 20 minutes d’El Toro en voiture. Le retrait et le retour standards s’effectuent directement dans notre agence de Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Puis-je louer un scooter pour visiter Port Adriano et El Toro ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour découvrir El Toro, Port Adriano, Santa Ponsa, Magaluf, Palmanova et Calvià avec davantage de liberté.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous devez posséder un permis A, A1 ou A2. Vous pouvez également conduire un scooter 125cc avec un permis B valide depuis au moins 3 ans. Les permis provisoires et les permis d’apprentissage ne sont pas acceptés.",
        },
      },
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location de scooter pour El Toro ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Chez NEXA Rentals, deux casques, un top case, un antivol, un support téléphone, les kilomètres illimités et l’assurance de base sont inclus.",
        },
      },
      {
        "@type": "Question",
        name: "Proposez-vous une livraison à El Toro ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait et le retour standards s’effectuent chez NEXA Rentals à Magaluf. Une livraison à El Toro peut être disponible sur demande selon les dates et l’adresse. Contactez-nous avant de réserver afin que nous puissions vérifier la disponibilité.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à El Toro",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
        ...
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <div className="nexa-hero-kicker">
              À environ 20 minutes d’El Toro
            </div>

            <h1>Louez un scooter à El Toro et découvrez Majorque en toute liberté.</h1>

            <p className="nexa-hero-text">
              Vous recherchez une <strong>location de scooter à El Toro</strong>,{" "}
              un <strong>scooter 125cc à El Toro</strong> ou une{" "}
              <strong>location de scooter à Port Adriano</strong> ? Chez NEXA
              Rentals, vous réservez et payez votre scooter en ligne, puis vous
              le retirez directement à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Une solution idéale pour les visiteurs séjournant à El Toro, Port
              Adriano, Santa Ponsa, Calvià, Magaluf ou Palmanova. Rejoignez
              facilement le port, la plage, un restaurant, un point de vue ou
              votre prochaine excursion sans dépendre des taxis ni attendre le bus.
            </p>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Retrait dans notre agence</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Location de scooter à El Toro et Port Adriano"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Idéal pour les visiteurs d’El Toro, Port Adriano, Santa Ponsa et Calvià</p>

        <div className="nexa-trust-logos">
          <span>Location scooter El Toro</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Location de scooter à El Toro</span>

            <h2>La solution simple pour vous déplacer autour d’El Toro.</h2>

            <p>
              El Toro et Port Adriano sont parfaits pour découvrir une facette
              plus calme et élégante de Majorque. Avec un scooter 125cc, vous
              rejoignez facilement les plages, restaurants, points de vue ainsi
              que Santa Ponsa, Magaluf, Palmanova et Calvià, sans dépendre des
              taxis ou des horaires de bus.
            </p>

            <p>
              NEXA Rentals est une option pratique pour les visiteurs d’El Toro :
              vous réservez votre scooter en ligne et le retirez dans notre
              agence de Magaluf, située à environ 20 minutes. Une fois les
              documents vérifiés, vous pouvez commencer immédiatement votre
              journée à Majorque.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour El Toro et Port Adriano</li>
              ...
              <li>Support téléphone résistant à l’eau</li>
              <li>Antivol de sécurité inclus</li>
              <li>Kilométrage illimité</li>
              <li>Assurance de base incluse</li>
              <li>Retrait et retour standards chez NEXA Rentals à Magaluf</li>
              <li>Livraison à El Toro sur demande selon les dates et l’adresse</li>
            </ul>
          </aside>
        </div>
      </section>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Réservez votre scooter pour El Toro en trois étapes simples.</h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Choisissez en ligne</h3>
              <p>
                Choisissez votre scooter 125cc, vos dates et la durée de location.
                La réservation est rapide, claire et adaptée à votre séjour à El Toro.
              </p>
            </div>

            <div>
              <span>02</span>
              <h3>Confirmez en ligne</h3>
              <p>
                Payez votre location en ligne et réservez votre scooter pour
                El Toro, Port Adriano, Santa Ponsa ou vos excursions à Majorque.
              </p>
            </div>

            <div>
              <span>03</span>
              <h3>Retirez-le à Magaluf</h3>
              <p>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver maintenant pour El Toro
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Location scooter El Toro</span>

          <h2>
            Pour découvrir librement El Toro, Port Adriano et le sud-ouest de
            Majorque.
          </h2>

          <p>
            Lorsque vous recherchez « location scooter El Toro », « louer un
            scooter à El Toro », « scooter 125cc El Toro », « location scooter
            Port Adriano » ou « scooter à Majorque », vous souhaitez une
            solution simple : réserver en ligne, payer en toute sécurité,
            profiter d’un retrait clair et vous déplacer librement.
          </p>

          <p>
            El Toro se trouve à proximité de Port Adriano et de Santa Ponsa.
            Disposer d’un scooter est particulièrement pratique pour éviter de
            réserver un taxi à chaque déplacement ou d’attendre les transports.
            NEXA Rentals propose une réservation en ligne simple, des services
            transparents et un retrait à Magaluf, à environ 20 minutes d’El Toro.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter El Toro</span>
            <span>Louer scooter El Toro</span>
            <span>Scooter 125cc El Toro</span>
            <span>Location scooter Port Adriano</span>
            <span>Location scooter El Toro Majorque</span>
            <span>Location deux roues El Toro</span>
            <span>Scooter El Toro</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à El Toro</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Puis-je réserver un scooter pour El Toro ?</summary>
              <p>
                Oui. Vous pouvez réserver votre scooter en ligne chez NEXA
                Rentals et le retirer directement à Magaluf. Cette solution est
                pratique pour les visiteurs d’El Toro, Port Adriano, Santa Ponsa
                et Calvià.
              </p>
            </details>

            <details>
              <summary>À quelle distance NEXA Rentals se trouve-t-elle d’El Toro ?</summary>
              <p>
                Notre agence se trouve à Magaluf, à environ 20 minutes d’El Toro.
                Le retrait et le retour standards s’effectuent chez NEXA Rentals
                à Magaluf.
              </p>
            </details>

            <details>
              <summary>Quel permis faut-il pour conduire un scooter 125cc ?</summary>
              <p>
                Vous devez posséder un permis A, A1 ou A2. Un permis B est
                également accepté s’il est valide depuis au moins 3 ans. Les
                permis provisoires et les permis d’apprentissage ne sont pas acceptés.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Deux casques, un top case, un antivol, un support téléphone, les
                kilomètres illimités et l’assurance de base sont inclus.
              </p>
            </details>

            <details>
              <summary>Proposez-vous une livraison à El Toro ?</summary>
              <p>
                Le retrait et le retour standards s’effectuent chez NEXA Rentals
                à Magaluf. Une livraison à El Toro peut être disponible sur
                demande selon les dates et l’adresse. Contactez-nous avant de
                réserver afin que nous puissions vérifier la disponibilité.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Prêt à découvrir El Toro ?</h3>
            <p>
              Réservez votre scooter 125cc en ligne et prenez la route depuis
              NEXA Rentals à Magaluf.
            </p>
      ...
      <footer className="nexa-seo-footer">
        <div className="nexa-seo-footer-inner">
          <div className="nexa-seo-footer-brand">
            ...
            />
            <p>NEXA Rentals · Location de scooters et vélos électriques à Magaluf, Majorque</p>
          </div>
