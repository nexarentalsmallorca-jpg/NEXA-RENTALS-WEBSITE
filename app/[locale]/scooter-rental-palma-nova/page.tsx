// app/[locale]/scooter-rental-palma-nova/page.tsx
...
const SEO_PATH = "/scooter-rental-palma-nova";
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal for navigation around Palma Nova and Mallorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title: "Scooter Rental Palma Nova from €39 | NEXA Rentals",
    description:
      "Rent a 125cc scooter for Palma Nova from €39. Book online with NEXA Rentals, collect in nearby Magaluf and explore southwest Mallorca freely.",
    keywords: [
      "scooter rental Palma Nova",
      "scooter hire Palma Nova",
      "rent a scooter Palma Nova",
      "125cc scooter Palma Nova",
      "motor scooter rental Palma Nova",
      "scooter rental Palmanova",
      "scooter hire Palmanova",
      "scooter rental Son Matias",
      "scooter rental Magaluf",
      "scooter rental Calvià",
      "scooter rental Portals Nous",
      "scooter rental Santa Ponsa",
      "scooter rental southwest Mallorca",
      "book scooter online Palma Nova",
    ...
    openGraph: {
      title: "Scooter Rental Palma Nova | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Palma Nova from €39 and collect it at NEXA Rentals in nearby Magaluf.",
      url: canonicalUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Palma Nova with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalPalmaNovaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Palma Nova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book a 125cc scooter online with NEXA Rentals and collect it from our office in nearby Magaluf. It is a practical option for guests staying in Palma Nova, Palmanova, Son Matias and Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "How far is NEXA Rentals from Palma Nova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf, only a short journey from Palma Nova. Travel time depends on your starting point and traffic. Collection and return take place at our Magaluf office.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for Palma Nova and Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is practical for exploring Palma Nova, Palmanova, Son Matias, Magaluf, Portals Nous, Santa Ponsa, Cala Vinyes and southwest Mallorca.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "A, A1 and A2 motorcycle licences are accepted. A category B car licence may also qualify under applicable Spanish rules when it has been valid for at least 3 years. Rental acceptance can depend on the licence and issuing country, so contact NEXA Rentals if you are unsure.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in Palma Nova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "We do not currently provide a delivery service. Standard collection and return take place directly at NEXA Rentals in Magaluf.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental for Palma Nova",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-palma-nova"
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            ...
            <h1>
              Rent a scooter in Palma Nova and explore Mallorca freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Palma Nova</strong>,{" "}
              <strong>scooter hire in Palma Nova</strong> or a{" "}
              <strong>125cc scooter near Palmanova</strong>? Book online with
              NEXA Rentals, pay securely and collect your scooter from our
              office in nearby Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal for Palma Nova, Palmanova, Son Matias, Magaluf, Portals
              Nous, Santa Ponsa, Cala Vinyes and southwest Mallorca. Connect
              beaches, hotels, restaurants and coastal destinations without
              planning your day around buses or taxis.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc scooter hire for Palma Nova and Palmanova"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>A practical way to explore from Palma Nova</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Scooter rental Palma Nova</span>

            <h2>
              Connect Palma Nova, Magaluf and southwest Mallorca with ease.
            </h2>

            <p>
              Palma Nova is an excellent base for beaches, hotels, restaurants
              and short trips to Magaluf, Son Matias, Portals Nous or Santa
              Ponsa. A 125cc scooter gives you more freedom to explore Mallorca
              without waiting for buses or repeatedly booking taxis.
            </p>

            <p>
              NEXA Rentals is a practical choice when you need scooter rental in
              Palma Nova, scooter hire in Palmanova or a 125cc scooter near Son
              Matias. Reserve and pay online, then collect your scooter directly
              from our rental office in Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Palma Nova and Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book your Palma Nova scooter in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <h3>Choose online</h3>
              <p>
                Select your 125cc scooter, rental date and duration. The booking
                process is quick, clear and convenient for your stay in Palma
                Nova.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Pay the rental price online to reserve your scooter for the
                selected dates. Your booking confirmation is sent automatically.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Visit NEXA Rentals with your original driving licence and a
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Book your scooter for Palma Nova
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Explore Palma Nova and southwest Mallorca with greater freedom.
          </h2>

          <p>
            When you search for “scooter rental Palma Nova”, “scooter hire
            Palma Nova”, “rent a scooter Palma Nova” or “125cc scooter
            Palmanova”, you need a straightforward service with clear
            information, secure online payment and a convenient collection
            point. NEXA Rentals lets you reserve your scooter before your trip.
          </p>

          <p>
            A scooter is particularly practical for journeys between Palma
            Nova, Son Matias, Magaluf, Portals Nous, Cala Vinyes, Santa Ponsa,
            Palma and other Mallorca destinations. Collection and return take
            place at our Magaluf office, where we can check the required
            documents and explain the vehicle before you set off. We do not
            currently provide a scooter delivery service.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Scooter rental Palma Nova</span>
            <span>Scooter hire Palma Nova</span>
            <span>Rent a scooter Palmanova</span>
            <span>125cc scooter Palma Nova</span>
            <span>Scooter rental Son Matias</span>
            <span>Scooter rental Magaluf</span>
            <span>Scooter rental Calvià</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Palma Nova</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for Palma Nova?</summary>
              <p>
                Yes. Book a 125cc scooter online with NEXA Rentals and collect
                it directly from our nearby Magaluf office. This is convenient
                for Palma Nova, Palmanova, Son Matias and Magaluf.
              </p>
            </details>

            <details>
              <summary>Where do I collect my Palma Nova scooter?</summary>
              <p>
                Collection and return take place at NEXA Rentals, C. Galeón,
                13, Loc 57, 07181 Magaluf, a short journey from Palma Nova.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                A, A1 and A2 motorcycle licences are accepted. A category B car
                licence may also qualify under applicable Spanish rules when
                it has been valid for at least 3 years. Rental acceptance can
                depend on the licence and issuing country, so contact us if you
                are unsure. Provisional and learner licences are not accepted.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Two helmets, a 50-litre top box, security lock, waterproof phone
                holder, unlimited kilometres and basic insurance are included.
              </p>
            </details>

            <details>
              <summary>Is scooter delivery available in Palma Nova?</summary>
              <p>
                We do not currently provide a delivery service. Standard
                collection and return take place at NEXA Rentals in Magaluf.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Ready to explore Palma Nova?</h3>
            <p>
              Book your 125cc scooter online and start your journey from NEXA
              Rentals in nearby Magaluf.
            </p>
