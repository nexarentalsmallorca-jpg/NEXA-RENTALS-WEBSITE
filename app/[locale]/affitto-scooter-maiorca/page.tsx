...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per la navigazione in tutta Maiorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Affitto scooter Maiorca | Scooter 125cc da 39€ | NEXA Rentals",
    description:
      "Affitto scooter a Maiorca con NEXA Rentals a Magaluf. Prenota online uno scooter 125cc da 39€, ritiralo nel nostro ufficio e scopri Magaluf, Palmanova, Santa Ponsa e Calvià in libertà.",
    keywords: [
      "affitto scooter Maiorca",
      "scooter in affitto Maiorca",
      "affittare scooter Maiorca",
      ...
      "scooter economico Maiorca",
      "prenotare scooter Maiorca",
      "scooter Maiorca online",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/it/affitto-scooter-maiorca",
    },
    openGraph: {
      title: "Affitto scooter Maiorca | NEXA Rentals Magaluf",
      description:
        "Affitta uno scooter 125cc a Maiorca da 39€. Prenotazione online e ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/affitto-scooter-maiorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Affitto scooter a Maiorca con NEXA Rentals a Magaluf",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function AffittoScooterMaiorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Dove posso affittare uno scooter a Maiorca con NEXA Rentals?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Cosa è incluso nell’affitto dello scooter a Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Affitto scooter 125cc a Maiorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Affitta uno scooter a Maiorca direttamente a Magaluf.</h1>

            <p className="nexa-hero-text">
              Cerchi <strong>affitto scooter Maiorca</strong>,{" "}
              <strong>scooter in affitto a Magaluf</strong> o uno{" "}
            ...
            <p className="nexa-hero-text small">
              Ideale per Magaluf, Palmanova, Palma Nova, Santa Ponsa, Portals
              Nous e Calvià, per giornate in spiaggia, punti panoramici, beach
              club ed escursioni senza dipendere da taxi o autobus.
            </p>

            <div className="nexa-hero-actions">
              <Link href={bookHref} className="nexa-primary-cta">
                Affitta ora lo scooter
              </Link>
            ...
            <div className="nexa-hero-points">
              <div>
                <strong>da 39€</strong>
                <span>Affitto per mezza giornata</span>
              </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter 125cc in affitto a Maiorca con NEXA Rentals"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Una soluzione semplice per esplorare Maiorca in libertà</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Il modo semplice per affittare uno scooter a Maiorca.</h2>

            <p>
              Molti viaggiatori aspettano di essere già in vacanza per cercare
              uno scooter in affitto a Maiorca, Magaluf o Palmanova. Con NEXA
              Rentals puoi organizzarti prima: prenoti online il tuo scooter
              125cc, paghi in modo sicuro e lo ritiri direttamente nel nostro
              ufficio di Magaluf. Così non perdi tempo e sai già che il veicolo
              sarà riservato per te.
            </p>

            <p>
              I nostri scooter sono ideali per brevi tragitti, giornate in
              spiaggia ed escursioni verso Magaluf, Palmanova, Palma Nova,
              Portals Nous, Santa Ponsa e Calvià. Non devi aspettare taxi,
              controllare gli orari degli autobus o affrontare lunghe attese:
              sali sullo scooter e scopri Maiorca al tuo ritmo.
            </p>
          </article>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Affitta uno scooter a Maiorca in tre semplici passaggi.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                Scegli il tuo scooter 125cc, la data e la durata dell’affitto.
                La prenotazione è rapida, chiara e pensata per chi visita
                Maiorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Affitta ora lo scooter a Maiorca
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Affitto scooter Maiorca</span>

          <h2>
            Per chi vuole scoprire Maiorca in modo libero, semplice e
            conveniente.
          </h2>

          <p>
            Quando cerchi “affitto scooter Maiorca”, “scooter in affitto
            Maiorca”, “affittare scooter a Maiorca” o “scooter 125cc Maiorca”,
            vuoi una soluzione semplice: informazioni chiare, prenotazione
            online, pagamento sicuro e un punto di ritiro facile da
            raggiungere. NEXA Rentals si trova direttamente a Magaluf, in C.
            Galeón, 13, Loc 57.
          </p>

          <p>
            Il nostro servizio è particolarmente comodo per chi soggiorna a
            Magaluf, Palmanova, Palma Nova, Torrenova, Santa Ponsa, Portals Nous
            o Calvià. Con uno scooter puoi raggiungere spiagge, ristoranti,
            beach club, punti panoramici e località vicine senza dipendere ogni
            volta da un taxi. Il ritiro e la riconsegna standard avvengono
            presso il nostro ufficio di Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Affitto scooter Maiorca</span>
            <span>Scooter in affitto Maiorca</span>
            <span>Affittare scooter Maiorca</span>
            <span>Scooter 125cc Maiorca</span>
            <span>Affitto motorino Maiorca</span>
            <span>Affitto scooter Magaluf</span>
            <span>Prenotare scooter Maiorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sull’affitto di scooter a Maiorca</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>Dove si ritira e si riconsegna lo scooter?</summary>
              <p>
            ...
            <details>
              ...
              <p>
                Sì. Puoi scegliere lo scooter, le date e la durata direttamente
                online. Il pagamento online conferma la prenotazione per le
                date selezionate.
              </p>
            </details>
          ...
          <div className="nexa-final-cta">
            ...
            <Link href={bookHref}>Affitta ora lo scooter</Link>
          </div>
        </div>
      </section>
      ...
      <footer className="nexa-seo-footer">
        <div className="nexa-seo-footer-inner">
          <div className="nexa-seo-footer-brand">
            ...
            />
            <p>
              NEXA Rentals · Affitto scooter ed e-bike a Magaluf, Maiorca
            </p>
          </div>
