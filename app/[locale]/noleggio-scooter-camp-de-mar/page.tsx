...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per orientarsi nel sud-ovest di Maiorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Camp de Mar | Scooter 125cc Maiorca | NEXA Rentals",
    description:
      "Noleggio scooter a Camp de Mar e nel sud-ovest di Maiorca. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf e scopri Camp de Mar, Cala Fornells, Paguera, Port d’Andratx e Andratx in libertà.",
    keywords: [
      "noleggio scooter Camp de Mar",
      "affitto scooter Camp de Mar",
      "scooter 125cc Camp de Mar",
      "noleggio motorino Camp de Mar",
      "scooter a noleggio Camp de Mar",
      ...
      "noleggio scooter Port d’Andratx",
      "affitto scooter Port d’Andratx",
      "noleggio scooter Andratx",
      "noleggio scooter sud-ovest Maiorca",
      "affitto scooter sud-ovest Maiorca",
      "scooter 125cc sud-ovest Maiorca",
      "prenotare scooter online Camp de Mar",
      "NEXA Rentals Camp de Mar",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-camp-de-mar",
    },
    openGraph: {
      title: "Noleggio scooter Camp de Mar | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per Camp de Mar, Cala Fornells, Paguera e il sud-ovest di Maiorca. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-camp-de-mar",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Camp de Mar con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterCampDeMarPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter per Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online uno scooter 125cc con NEXA Rentals e ritirarlo direttamente presso il nostro ufficio di Magaluf. È una soluzione pratica per chi soggiorna a Camp de Mar, Cala Fornells, Paguera, Andratx o Port d’Andratx.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da Camp de Mar puoi raggiungere la nostra sede generalmente in circa 20-25 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna standard avvengono presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per Camp de Mar e il sud-ovest di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è molto pratico per scoprire Camp de Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa Ponsa e altre località del sud-ovest di Maiorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna dello scooter a Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Camp de Mar",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Circa 20-25 minuti da Camp de Mar
              </span>
            ...
            <h1>
              Noleggia uno scooter a Camp de Mar e scopri il sud-ovest di
              Maiorca.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un servizio di{" "}
              <strong>noleggio scooter a Camp de Mar</strong>,{" "}
              <strong>affitto scooter a Camp de Mar</strong> o uno{" "}
            ...
            <p className="nexa-hero-text small">
              Ideale per Camp de Mar, Cala Fornells, Paguera, Port d’Andratx,
              Andratx, Santa Ponsa e per splendidi itinerari costieri nel
              sud-ovest di Maiorca. Perfetto per raggiungere spiagge, porti e
              ristoranti in completa libertà.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Camp de Mar nel sud-ovest di Maiorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Per Camp de Mar, Cala Fornells, Paguera, Andratx e il sud-ovest di
          Maiorca
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Scopri Camp de Mar, Paguera e Port d’Andratx con maggiore libertà.
            </h2>

            <p>
              Camp de Mar è perfetta per giornate rilassanti, spiagge
              affascinanti, ristoranti sul mare ed escursioni nel sud-ovest di
              Maiorca. Con uno scooter 125cc puoi raggiungere più facilmente
              località come Cala Fornells, Paguera, Port d’Andratx, Andratx,
              Santa Ponsa e Magaluf.
            </p>

            <p>
              NEXA Rentals è una soluzione pratica per chi cerca noleggio
              scooter a Camp de Mar, affitto scooter a Camp de Mar o noleggio
              motorino nel sud-ovest di Maiorca. Prenoti online, paghi online e
              ritiri il tuo scooter direttamente presso il nostro ufficio di
              Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Camp de Mar e il sud-ovest di Maiorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota uno scooter per Camp de Mar in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                La prenotazione è rapida, chiara e ideale per la tua vacanza nel
            ...
            <div>
              ...
              <p>
                ...
                Camp de Mar, Paguera, Port d’Andratx o per il tuo itinerario a
                Maiorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota uno scooter per Camp de Mar
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole esplorare Camp de Mar e il sud-ovest di Maiorca in
            autonomia.
          </h2>

          <p>
            Quando cerchi “noleggio scooter Camp de Mar”, “affitto scooter Camp
            de Mar”, “scooter 125cc Camp de Mar”, “noleggio motorino Camp de
            Mar” o “noleggio scooter sud-ovest Maiorca”, hai bisogno di una
            soluzione semplice: prenotazione online, pagamento sicuro e uno
            scooter 125cc con cui spostarti in completa libertà.
          </p>

          <p>
            Uno scooter è particolarmente pratico per gli spostamenti tra Camp
            de Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa
            Ponsa, Magaluf e Palmanova. NEXA Rentals offre una prenotazione
            online semplice e il ritiro presso il nostro ufficio di Magaluf. La
            consegna può essere disponibile solo su richiesta, in base alla
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a Camp de Mar</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Posso prenotare uno scooter per Camp de Mar?</summary>
              <p>
                Sì. Puoi prenotare online uno scooter 125cc con NEXA Rentals e
                ritirarlo direttamente a Magaluf. È una soluzione pratica per
                Camp de Mar, Cala Fornells, Paguera, Andratx e Port d’Andratx.
              </p>
            </details>

            <details>
              <summary>Quanto dista NEXA Rentals da Camp de Mar?</summary>
              <p>
                La nostra sede si trova a Magaluf. Da Camp de Mar il tragitto
                richiede generalmente circa 20-25 minuti in auto, a seconda del
                traffico. Il ritiro e la riconsegna standard avvengono presso
            ...
            <details>
              <summary>È disponibile la consegna a Camp de Mar?</summary>
              <p>
                Il ritiro e la riconsegna standard avvengono presso NEXA
                Rentals a Magaluf. La consegna può essere disponibile solo su
                richiesta, in base alla località, alla data e all’indirizzo.
                Contattaci prima di prenotare per verificarne la disponibilità.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Pronto a scoprire Camp de Mar?</h3>
            <p>
