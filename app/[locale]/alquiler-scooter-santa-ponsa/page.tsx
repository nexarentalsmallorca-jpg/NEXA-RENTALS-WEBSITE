// app/[locale]/alquiler-scooter-santa-ponsa/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por Santa Ponsa y Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-santa-ponsa";
  }

  if (languageCode === "es") {
    return "/es/alquiler-scooter-santa-ponsa";
  }

  if (languageCode === "it") {
    return "/it/noleggio-scooter-santa-ponsa";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-santa-ponsa";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Santa Ponsa | 125 cc | NEXA Rentals",
    description:
      "Alquiler de scooter en Santa Ponsa y Nova Santa Ponsa. Reserva online un scooter de 125 cc con NEXA Rentals, recógelo en Magaluf y descubre Costa de la Calma, El Toro, Port Adriano, Palmanova y el suroeste de Mallorca.",
    keywords: [
      "alquiler scooter Santa Ponsa",
      "alquilar scooter Santa Ponsa",
      "scooter 125cc Santa Ponsa",
      "alquiler moto scooter Santa Ponsa",
      "alquiler motos Santa Ponsa",
      "scooter de alquiler Santa Ponsa",
      ...
      "alquilar scooter Costa de la Calma",
      "alquiler scooter El Toro",
      "alquilar scooter El Toro",
      "alquiler scooter Port Adriano",
      "alquilar scooter Port Adriano",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-santa-ponsa",
    },
    openGraph: {
      title: "Alquiler de scooter en Santa Ponsa | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro y Port Adriano. Recogida en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-santa-ponsa",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Santa Ponsa con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalSantaPonsaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter en Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online tu scooter de 125 cc con NEXA Rentals y recogerlo directamente en nuestra oficina de Magaluf. Es una opción práctica si te alojas en Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro o Port Adriano.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se encuentra en Magaluf. Desde Santa Ponsa, nuestra oficina está a unos 10–15 minutos en coche, dependiendo del tráfico. La recogida y la devolución habituales se realizan directamente en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para Santa Ponsa y el suroeste de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es práctico para descubrir con libertad Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano, Palmanova, Magaluf y el suroeste de Mallorca.",
        },
      },
      {
        "@type": "Question",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Santa Ponsa",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <Script
        id="nexa-schema-faq-santa-ponsa"
      ...
      <Script
        id="nexa-schema-business-santa-ponsa"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A unos 10–15 minutos de Santa Ponsa
              </span>
            ...
            <h1>
              Alquila un scooter en Santa Ponsa y descubre Calvià con libertad.
            </h1>
            ...
            <p className="nexa-hero-text">
              ...
              <strong>scooter de 125 cc para Costa de la Calma</strong>? Con NEXA Rentals
            ...
            <p className="nexa-hero-text small">
              Ideal para Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El
              Toro, Port Adriano, Palmanova, Magaluf y el suroeste de Mallorca. La
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en Nova Santa Ponsa y Santa Ponsa"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro y Port Adriano
        </p>

        <div className="nexa-trust-logos">
          <span>Santa Ponsa</span>
          <span>Nova Santa Ponsa</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Santa Ponsa
            </span>

            <h2>
              Descubre Nova Santa Ponsa, Costa de la Calma y el suroeste de Mallorca con más facilidad.
            </h2>

            <p>
              Santa Ponsa y Nova Santa Ponsa son ideales para disfrutar del puerto
              deportivo, restaurantes, hoteles, días de playa y excursiones hacia
              Costa de la Calma, El Toro, Palmanova o Magaluf. Con un scooter de 125 cc
            ...
            <p>
              ...
              de scooter en Santa Ponsa, alquilar un scooter en Nova Santa Ponsa o
              una moto scooter para Costa de la Calma. Reserva y paga online, y después
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva tu scooter para Santa Ponsa en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                Paga online de forma segura y reserva tu scooter para Santa
                Ponsa, Nova Santa Ponsa, Port Adriano o tu ruta por Mallorca.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooter en Nova Santa Ponsa
          </span>

          <h2>
            Para viajeros que quieren descubrir Santa Ponsa y el suroeste de Mallorca con total libertad.
          </h2>

          <p>
            Cuando buscas “alquiler scooter Santa Ponsa”, “alquilar scooter
            Santa Ponsa”, “alquiler scooter Nova Santa Ponsa”, “scooter 125 cc
            Costa de la Calma” o “alquiler scooter El Toro”, quieres una opción sencilla:
          ...
          <p>
            ...
            Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano,
            Paguera, Palmanova y Magaluf. NEXA Rentals ofrece una reserva
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Alquiler scooter Costa de la Calma</span>
            <span>Alquiler scooter El Toro</span>
            <span>Alquiler scooter Port Adriano</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Santa Ponsa?</summary>
              <p>
                ...
                opción práctica para Santa Ponsa, Nova Santa Ponsa, Costa de la Calma,
            ...
            <details>
              <summary>
                ¿A qué distancia está NEXA Rentals de Santa Ponsa?
              </summary>
              <p>
                Nuestra oficina está en Magaluf. Desde Santa Ponsa está a unos
                10–15 minutos en coche, dependiendo del tráfico. La recogida y
            ...
            <details>
              <summary>
                ¿Hay servicio de entrega de scooters en Santa Ponsa?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Santa Ponsa?</h3>
            <p>
