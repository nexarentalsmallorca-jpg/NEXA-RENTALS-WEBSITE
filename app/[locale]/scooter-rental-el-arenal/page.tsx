...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal for navigation around the Bay of Palma.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental El Arenal | 125cc Scooter Hire Playa de Palma | NEXA Rentals",
    description:
      "Scooter rental in El Arenal and Playa de Palma. Book a 125cc scooter online with NEXA Rentals, collect it in Magaluf and explore El Arenal, Playa de Palma, Can Pastilla, Palma and Llucmajor freely.",
    keywords: [
      "scooter rental El Arenal",
      "scooter hire El Arenal",
      "rent a scooter El Arenal",
      "125cc scooter El Arenal",
      "motor scooter rental El Arenal",
      "motor scooter hire El Arenal",
      "scooter rental S'Arenal",
      "scooter hire S'Arenal",
      "scooter rental Playa de Palma",
      "scooter hire Playa de Palma",
      "scooter rental Can Pastilla",
      "scooter hire Can Pastilla",
      "scooter rental Palma",
      "scooter rental Llucmajor",
      "scooter rental south Mallorca",
      "125cc scooter Playa de Palma",
      "book scooter online El Arenal",
      "NEXA Rentals El Arenal",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-el-arenal",
    },
    openGraph: {
      title: "Scooter Rental El Arenal | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for El Arenal, Playa de Palma, Can Pastilla and southern Mallorca. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-el-arenal",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in El Arenal with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalElArenalPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book a 125cc scooter online with NEXA Rentals and collect it directly from our office in Magaluf. It is a practical option for exploring El Arenal, S’Arenal, Playa de Palma, Can Pastilla, Palma and Llucmajor.",
        },
      },
      {
        "@type": "Question",
        name: "How far is NEXA Rentals from El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf. The journey from El Arenal usually takes around 25 to 30 minutes by car, depending on traffic. Standard scooter collection and return take place at NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for El Arenal and Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is a practical way to explore El Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor and other destinations in southern Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental in El Arenal",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Around 25–30 minutes from El Arenal
              </span>
            ...
            <h1>
              Rent a scooter for El Arenal and explore the Bay of Palma freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for{" "}
              <strong>scooter rental in El Arenal</strong>,{" "}
              <strong>scooter hire in El Arenal</strong> or a{" "}
              <strong>125cc scooter in Playa de Palma</strong>? With NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal for El Arenal, Playa de Palma, Can Pastilla, Palma,
              Llucmajor and enjoyable routes around the Bay of Palma. A scooter
              is perfect for reaching beaches, restaurants and popular tourist
              destinations with greater freedom.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter hire in El Arenal and Playa de Palma"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For El Arenal, Playa de Palma, Can Pastilla, Palma and southern
          Mallorca
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore El Arenal, Playa de Palma and Can Pastilla with greater
              freedom.
            </h2>

            <p>
              El Arenal is ideal for beach days, restaurants, nightlife and
              trips around the Bay of Palma. With a 125cc scooter, you can
              travel more easily between El Arenal, Playa de Palma, Can
              Pastilla, Palma, Llucmajor and other destinations in southern
              Mallorca.
            </p>

            <p>
              NEXA Rentals is a practical choice for travellers searching for
              scooter rental in El Arenal, scooter hire in El Arenal or motor
              scooter rental in Playa de Palma. You book online, pay online and
              collect your scooter directly from our office in Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for El Arenal and Playa de Palma</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book a scooter for El Arenal in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Arenal, Playa de Palma, Can Pastilla or your planned Mallorca
                route.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore El Arenal, Playa de Palma and
            southern Mallorca independently.
          </h2>

          <p>
            When you search for “scooter rental El Arenal”, “scooter hire El
            Arenal”, “125cc scooter El Arenal”, “motor scooter rental El
            Arenal” or “scooter rental Playa de Palma”, you need a simple
            solution: online booking, secure payment and a 125cc scooter that
            gives you the freedom to explore.
          </p>

          <p>
            A scooter is particularly practical for travelling between El
            Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor, Magaluf and
            Palmanova. Standard collection and return take place directly at
            NEXA Rentals in Magaluf. We do not currently provide a scooter
            delivery service.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Scooter rental El Arenal</span>
            <span>Scooter hire El Arenal</span>
            <span>125cc scooter El Arenal</span>
            <span>Scooter rental Playa de Palma</span>
            <span>Scooter rental Can Pastilla</span>
            <span>Scooter rental Palma</span>
            <span>Scooter rental Llucmajor</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in El Arenal</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for El Arenal?</summary>
              <p>
                ...
                Arenal, Playa de Palma, Can Pastilla, Llucmajor and Palma.
              </p>
            </details>

            <details>
              <summary>How far is NEXA Rentals from El Arenal?</summary>
              <p>
                Our office is located in Magaluf. The journey from El Arenal
                generally takes around 25 to 30 minutes by car, depending on
            ...
            <details>
              <summary>Is delivery available in El Arenal?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore El Arenal?</h3>
            <p>
