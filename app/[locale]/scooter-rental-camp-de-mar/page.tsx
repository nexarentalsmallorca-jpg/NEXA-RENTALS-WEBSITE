...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Camp de Mar | 125cc Scooter Hire Mallorca | NEXA Rentals",
    description:
      "Scooter rental in Camp de Mar and south-west Mallorca. Book a 125cc scooter online with NEXA Rentals, collect it in Magaluf and explore Camp de Mar, Cala Fornells, Paguera, Port d’Andratx and Andratx freely.",
    keywords: [
      "scooter rental Camp de Mar",
      "scooter hire Camp de Mar",
      "rent a scooter Camp de Mar",
      "125cc scooter Camp de Mar",
      "motor scooter rental Camp de Mar",
      "motor scooter hire Camp de Mar",
      "scooter rental Cala Fornells",
      "scooter hire Cala Fornells",
      ...
      "125cc scooter south-west Mallorca",
      "book scooter online Camp de Mar",
      "NEXA Rentals Camp de Mar",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-camp-de-mar",
    },
    openGraph: {
      title: "Scooter Rental Camp de Mar | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Camp de Mar, Cala Fornells, Paguera and south-west Mallorca. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-camp-de-mar",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Camp de Mar with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalCampDeMarPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book a 125cc scooter online with NEXA Rentals and collect it directly from our office in Magaluf. It is a practical option for guests staying in Camp de Mar, Cala Fornells, Paguera, Andratx or Port d’Andratx.",
        },
      },
      {
        "@type": "Question",
        name: "How far is NEXA Rentals from Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf. The journey from Camp de Mar usually takes around 20 to 25 minutes by car, depending on traffic. Standard scooter collection and return take place at NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for Camp de Mar and south-west Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is a practical way to explore Camp de Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa Ponsa and other destinations in south-west Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in Camp de Mar?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental in Camp de Mar",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Around 20–25 minutes from Camp de Mar
              </span>
            ...
            <h1>
              Rent a scooter for Camp de Mar and explore south-west Mallorca.
            </h1>

            <p className="nexa-hero-text">
              Looking for{" "}
              <strong>scooter rental in Camp de Mar</strong>,{" "}
              <strong>scooter hire in Camp de Mar</strong> or a{" "}
            ...
            <p className="nexa-hero-text small">
              Ideal for Camp de Mar, Cala Fornells, Paguera, Port d’Andratx,
              Andratx, Santa Ponsa and beautiful coastal routes across
              south-west Mallorca. A scooter gives you the freedom to reach
              beaches, ports and restaurants without relying on taxis.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter hire in Camp de Mar and south-west Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For Camp de Mar, Cala Fornells, Paguera, Andratx and south-west
          Mallorca
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore Camp de Mar, Paguera and Port d’Andratx with greater
              freedom.
            </h2>

            <p>
              Camp de Mar is ideal for relaxing days, beautiful beaches,
              seaside restaurants and trips around south-west Mallorca. With a
              125cc scooter, you can travel more easily between Cala Fornells,
              Paguera, Port d’Andratx, Andratx, Santa Ponsa and Magaluf.
            </p>

            <p>
              NEXA Rentals is a practical choice for travellers searching for
              scooter rental in Camp de Mar, scooter hire in Camp de Mar or a
              motor scooter in south-west Mallorca. You book online, pay online
              and collect your scooter directly from our office in Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Camp de Mar and south-west Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book a scooter for Camp de Mar in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                Pay the rental price online and reserve your scooter for Camp
                de Mar, Paguera, Port d’Andratx or your planned Mallorca route.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Book a scooter for Camp de Mar
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Camp de Mar and south-west
            Mallorca independently.
          </h2>

          <p>
            When you search for “scooter rental Camp de Mar”, “scooter hire Camp
            de Mar”, “125cc scooter Camp de Mar”, “motor scooter rental Camp de
            Mar” or “scooter rental south-west Mallorca”, you need a simple
            solution: online booking, secure payment and a 125cc scooter that
            gives you the freedom to explore.
          </p>

          <p>
            A scooter is particularly practical for travelling between Camp de
            Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa Ponsa,
            Magaluf and Palmanova. NEXA Rentals offers straightforward online
            booking and collection from our office in Magaluf. We do not
            currently provide a scooter delivery service.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Scooter rental Camp de Mar</span>
            <span>Scooter hire Camp de Mar</span>
            <span>125cc scooter Camp de Mar</span>
            <span>Scooter rental Cala Fornells</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Camp de Mar</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for Camp de Mar?</summary>
              <p>
                Yes. You can book a 125cc scooter online with NEXA Rentals and
                collect it directly in Magaluf. It is a practical option for
                Camp de Mar, Cala Fornells, Paguera, Andratx and Port
                d’Andratx.
              </p>
            </details>

            <details>
              <summary>How far is NEXA Rentals from Camp de Mar?</summary>
              <p>
                Our office is located in Magaluf. The journey from Camp de Mar
                generally takes around 20 to 25 minutes by car, depending on
                traffic. Standard collection and return take place at NEXA
                Rentals in Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>Is delivery available in Camp de Mar?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Camp de Mar?</h3>
            <p>
