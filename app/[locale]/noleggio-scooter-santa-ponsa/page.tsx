...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per la navigazione a Santa Ponsa e nei dintorni.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Santa Ponsa | Scooter 125cc sud-ovest Maiorca | NEXA Rentals",
    description:
      "Noleggio scooter a Santa Ponsa. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf ed esplora Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano e Calvià.",
    keywords: [
      ...
      "noleggio scooter Nova Santa Ponsa",
      "affitto scooter Nova Santa Ponsa",
      "noleggio scooter Costa de la Calma",
      "affitto scooter Costa de la Calma",
      ...
      "prenotare scooter online Santa Ponsa",
      "NEXA Rentals Santa Ponsa",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-santa-ponsa",
    },
    openGraph: {
      title: "Noleggio scooter Santa Ponsa | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro e Port Adriano. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-santa-ponsa",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Santa Ponsa con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterSantaPonsaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter a Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo direttamente a Magaluf. È una soluzione pratica per chi soggiorna a Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro e Port Adriano.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da Santa Ponsa puoi raggiungere la nostra sede in circa 10-15 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per Santa Ponsa e il sud-ovest di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è pratico per esplorare liberamente Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano, Palmanova, Magaluf e il sud-ovest di Maiorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna a Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Santa Ponsa",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A circa 10–15 minuti da Santa Ponsa
              </span>
            ...
            <h1>
              Noleggia uno scooter a Santa Ponsa ed esplora Calvià in libertà.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un <strong>noleggio scooter a Santa Ponsa</strong>, uno{" "}
              <strong>scooter a noleggio a Santa Ponsa</strong> o uno{" "}
            ...
            <p className="nexa-hero-text small">
              Ideale per Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El
              Toro, Port Adriano, Palmanova, Magaluf e gli itinerari costieri
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Santa Ponsa nel sud-ovest di Maiorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Per Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro e Port
          Adriano
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Collega facilmente Santa Ponsa, Port Adriano e il sud-ovest di
              Maiorca.
            </h2>

            <p>
              Santa Ponsa è ideale per la spiaggia, il lungomare, i ristoranti,
              gli hotel e gli spostamenti verso Nova Santa Ponsa, Costa de la
              Calma, El Toro, Port Adriano, Palmanova e Magaluf. Con uno scooter
              125cc puoi muoverti con maggiore libertà e vivere Maiorca senza
              attese per il taxi o complicazioni con gli autobus.
            </p>

            <p>
              NEXA Rentals è una soluzione pratica per chi cerca un noleggio
              scooter a Santa Ponsa, uno scooter a noleggio a Santa Ponsa o un
              motorino nel sud-ovest di Maiorca. Prenoti online, paghi online e
              ritiri il tuo scooter direttamente a Magaluf.
            </p>
          </article>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota il tuo scooter da Santa Ponsa in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Santa Ponsa, Port Adriano, Palmanova o il tuo itinerario a
                Maiorca.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole esplorare Santa Ponsa e il sud-ovest di Maiorca in
            completa libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter Santa Ponsa”, “affitto scooter Santa
            Ponsa”, “scooter 125cc Santa Ponsa”, “noleggio scooter Port Adriano”
            o “noleggio scooter Costa de la Calma”, hai bisogno di una soluzione
            semplice: prenotazione online, pagamento sicuro e uno scooter 125cc
            per muoverti liberamente.
          </p>

          <p>
            Uno scooter è particolarmente pratico per gli spostamenti tra Santa
            Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano,
            Palmanova, Magaluf e Paguera. NEXA Rentals offre una prenotazione
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Noleggio scooter Nova Santa Ponsa</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            <details>
              <summary>Posso prenotare uno scooter per Santa Ponsa?</summary>
              <p>
                ...
                Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro e Port
                Adriano.
              </p>
            </details>
            ...
            <details>
              <summary>
                Quanto dista NEXA Rentals da Santa Ponsa?
              </summary>
              <p>
                La nostra sede si trova a Magaluf. Da Santa Ponsa puoi
                raggiungerci in circa 10-15 minuti in auto, a seconda del
            ...
            <details>
              <summary>
                È disponibile la consegna a Santa Ponsa?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Santa Ponsa?</h3>
            <p>
