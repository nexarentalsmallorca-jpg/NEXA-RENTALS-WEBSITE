// app/[locale]/alquiler-scooter-palma/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por Palma y Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-palma";
  }

  if (languageCode === "es") {
    return "/es/alquiler-scooter-palma";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Palma | Scooter de 125 cc | NEXA Rentals Mallorca",
    description:
      "Alquiler de scooter en Palma y Mallorca. Reserva online un scooter de 125 cc con NEXA Rentals, recógelo en Magaluf y descubre Palma, Santa Catalina, Paseo Marítimo, Portixol y Can Pastilla con libertad.",
    keywords: [
      "alquiler scooter Palma",
      "alquilar scooter Palma",
      "scooter 125cc Palma",
      "alquiler moto scooter Palma",
      "alquiler motos Palma",
      "scooter de alquiler Palma",
      "alquiler scooter barato Palma",
      "alquiler scooter cerca de mí Palma",
      "alquiler scooter centro Palma",
      "scooter 125cc Palma Mallorca",
      "alquiler scooter Santa Catalina",
      "alquiler scooter Paseo Marítimo Palma",
      "alquiler scooter Portixol",
      "alquiler scooter Can Pastilla",
      "alquiler scooter costa de Palma",
      "alquilar scooter capital Mallorca",
      "reservar scooter online Palma",
      "precios alquiler scooter Palma",
      "NEXA Rentals Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-palma",
    },
    openGraph: {
      title: "Alquiler de scooter en Palma | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Palma, Santa Catalina, Paseo Marítimo, Portixol y la costa cercana. Recogida en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Palma con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalPalmaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo directamente en Magaluf. Es una opción práctica para descubrir Palma, Santa Catalina, Paseo Marítimo, Portixol y Can Pastilla.",
        },
      },
      {
        "@type": "Question",
        name: "¿Dónde recojo un scooter reservado para Palma?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para recorrer Palma y la costa cercana?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es práctico para descubrir con libertad Palma, Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla y otras zonas de Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc para Palma",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            ...
            <h1>
              Alquila un scooter para Palma y descubre la capital de Mallorca
              con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Palma</strong>,{" "}
              <strong>alquilar un scooter en el centro de Palma</strong> o un{" "}
              <strong>scooter de 125 cc en la capital de Mallorca</strong>? Con
            ...
            <p className="nexa-hero-text small">
              Ideal para recorrer Palma, Santa Catalina, Paseo Marítimo,
              Portixol, Can Pastilla y la costa cercana. Perfecto para llegar a
              playas, barrios, puertos deportivos y restaurantes con mayor
              libertad.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter de 125 cc en Palma y Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para Palma, Santa Catalina, Paseo Marítimo, Portixol y Can Pastilla
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Palma
            </span>

            <h2>
              Descubre Palma, Portixol y la costa cercana con más facilidad.
            </h2>

            <p>
              Palma combina calles históricas, barrios llenos de vida, playas,
              restaurantes y un extenso paseo marítimo. Con un scooter de 125
              cc puedes desplazarte más fácilmente entre el centro de Palma,
              Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla, Illetes y
              otras zonas cercanas.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en Palma, alquilar un scooter en la ciudad o recorrer
              la capital y la costa de Mallorca en moto scooter. Reservas y
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Palma y la costa cercana</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva un scooter para Palma en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                tu estancia en Palma y Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Palma, Portixol, Can Pastilla o la ruta que tengas prevista por
                Mallorca.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Para viajeros que quieren descubrir Palma y la costa de Mallorca
            con total libertad.
          </h2>

          <p>
            Cuando buscas “alquiler scooter Palma”, “alquilar scooter Palma”,
            “scooter de alquiler Palma”, “scooter 125 cc Palma” o “alquiler
            scooter barato Palma”, necesitas una solución sencilla: reserva
            online, pago seguro y un scooter de 125 cc que te dé libertad para
            descubrir la zona.
          </p>

          <p>
            Un scooter resulta especialmente práctico para desplazarte entre
            Palma, Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla,
            Illetes y otras zonas cercanas. NEXA Rentals ofrece una reserva
            online sencilla y recogida en Magaluf. Actualmente no ofrecemos
            servicio de entrega de scooters.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Palma</span>
            <span>Alquilar scooter Palma</span>
            <span>Scooter de alquiler Palma</span>
            <span>Alquiler scooter Santa Catalina</span>
            <span>Alquiler scooter Paseo Marítimo</span>
            <span>Alquiler scooter Portixol</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Palma?</summary>
              <p>
                ...
                Palma, Santa Catalina, Paseo Marítimo, Portixol y Can Pastilla.
              </p>
            </details>

            <details>
              <summary>¿Dónde recojo un scooter reservado para Palma?</summary>
              <p>
            ...
            <details>
              <summary>¿Hay servicio de entrega en Palma?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Palma?</h3>
            <p>
