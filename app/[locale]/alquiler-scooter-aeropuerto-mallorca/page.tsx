// app/[locale]/alquiler-scooter-aeropuerto-mallorca/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Espacio práctico para una mochila, un casco o una bolsa de playa.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Soporte impermeable para móvil",
    text: "Perfecto para orientarte después de llegar a Mallorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Candado de seguridad",
    text: "Para estacionar con más tranquilidad en tu hotel, la playa o un restaurante.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-mallorca-airport";
  }

  if (languageCode === "it") {
    return "/it/noleggio-scooter-aeroporto-maiorca";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-mallorca-flughafen";
  }

  if (languageCode === "es") {
    return "/es/alquiler-scooter-aeropuerto-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler scooter Aeropuerto Mallorca | 125 cc | NEXA Rentals",
    description:
      "¿Buscas alquiler de scooter cerca del Aeropuerto de Mallorca? Reserva online un scooter de 125 cc con NEXA Rentals y recógelo tras tu llegada en nuestra oficina de Magaluf. No ofrecemos recogida ni entrega en el aeropuerto.",
    keywords: [
      "alquiler scooter aeropuerto Mallorca",
      "alquiler scooter aeropuerto Palma",
      "alquiler de scooters aeropuerto Mallorca",
      "alquiler scooter aeropuerto Palma de Mallorca",
      "alquiler scooter PMI",
      "scooter 125cc aeropuerto Mallorca",
      "alquiler moto scooter aeropuerto Mallorca",
      "alquilar scooter aeropuerto Mallorca",
      "alquiler moto scooter aeropuerto Palma",
      "alquiler scooter Son Sant Joan",
      "aeropuerto Mallorca alquiler scooter",
      "alquiler scooter al llegar a Mallorca",
      "reservar scooter aeropuerto Mallorca",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-aeropuerto-mallorca",
    },
    openGraph: {
      title: "Alquiler de scooter cerca del Aeropuerto de Mallorca | NEXA Rentals",
      description:
        "Reserva online un scooter de 125 cc antes de llegar a Mallorca. Recogida en NEXA Rentals, Magaluf, desde 39 € con accesorios útiles incluidos.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-aeropuerto-mallorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter cerca del Aeropuerto de Mallorca con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalMallorcaAirportPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo recoger un scooter directamente en el Aeropuerto de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo después de tu llegada en nuestra oficina de Magaluf. No ofrecemos recogida ni entrega directamente en el Aeropuerto de Mallorca.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals del Aeropuerto de Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals está en Magaluf, en C. Galeón, 13, Loc 57. Desde el Aeropuerto de Palma de Mallorca, PMI, el trayecto hasta Magaluf suele durar entre 25 y 35 minutos en coche o taxi, según el tráfico.",
        },
      },
      {
        "@type": "Question",
        name: "¿Puedo reservar el scooter online antes de mi vuelo?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes elegir online el scooter, las fechas y la duración del alquiler, y pagar el precio por internet. Así reservas tu scooter de 125 cc para las fechas seleccionadas.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en el Aeropuerto de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. No ofrecemos entrega de scooters en el Aeropuerto de Mallorca ni en hoteles. La recogida y la devolución habituales se realizan directamente en NEXA Rentals, Magaluf.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc cerca del Aeropuerto de Mallorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-mallorca-airport"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Reserva online antes de llegar · Recogida en Magaluf
              </span>
            ...
            <h1>
              ¿Buscas alquiler de scooter en el Aeropuerto de Mallorca? Recógelo
              en Magaluf y muévete con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en el Aeropuerto de Mallorca</strong>,{" "}
              <strong>alquiler de scooter cerca del Aeropuerto de Palma</strong>{" "}
              o un <strong>scooter de 125 cc cerca del Aeropuerto PMI</strong>?
              Con NEXA Rentals puedes reservar online, pagar de forma segura y
              recoger tu scooter después de llegar, directamente en nuestra
              oficina de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Importante: no ofrecemos recogida ni entrega directamente en el
              aeropuerto. Puedes reservar antes de tu vuelo, conocer el precio
              de antemano y recoger tu scooter en NEXA Rentals, Magaluf.
            </p>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                <strong>PMI</strong>
                <span>Movilidad después de tu llegada</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter cerca del Aeropuerto de Palma de Mallorca PMI"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Ideal para moverte después de llegar al Aeropuerto de Palma de Mallorca
          PMI
        </p>

        <div className="nexa-trust-logos">
          <span>Aeropuerto de Mallorca</span>
          <span>Aeropuerto PMI</span>
          <span>Aeropuerto de Palma</span>
          <span>Magaluf</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter después de llegar a Mallorca
            </span>

            <h2>
              Después de tu vuelo, muévete con libertad sin complicadas búsquedas
              de última hora.
            </h2>

            <p>
              Muchos viajeros buscan “alquiler scooter Aeropuerto Mallorca”,
              “alquiler scooter Aeropuerto PMI” o “alquiler moto scooter
              Aeropuerto de Palma” nada más aterrizar. El objetivo es sencillo:
              desplazarse con más facilidad, evitar organizar cada trayecto en
              taxi y descubrir Mallorca con mayor libertad.
            </p>

            <p>
              Con NEXA Rentals puedes reservar online tu scooter de 125 cc y
              recogerlo en nuestra oficina de Magaluf. Nuestra ubicación resulta
              especialmente práctica si tu hotel está en Magaluf, Palmanova,
              Santa Ponsa, Calvià o el suroeste de Mallorca.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>
                Scooter de 125 cc para recorrer Mallorca después de llegar
              </li>
              <li>Reserva online y pago seguro por internet</li>
              <li>Dos cascos incluidos</li>
              <li>Baúl de 50 litros para una mochila, casco o bolsa de playa</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Del Aeropuerto de Mallorca a tu scooter en tres sencillos pasos.
          </h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Reserva online con antelación</h3>
              <p>
                Elige tu scooter de 125 cc, la fecha y la duración del alquiler.
                Es la forma ideal de organizar tu movilidad antes del vuelo.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Paga online el precio del alquiler y reserva tu scooter para tu
                estancia y las excursiones que hayas planeado por Mallorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva tu scooter para tu llegada
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooter Aeropuerto de Mallorca
          </span>

          <h2>
            Para viajeros que quieren independencia después de su vuelo y
            libertad para descubrir Mallorca.
          </h2>

          <p>
            Si buscas “alquiler scooter Aeropuerto Mallorca”, “alquiler de
            scooter Aeropuerto de Palma”, “alquiler scooter PMI”, “alquiler moto
            scooter Aeropuerto Mallorca” o “Aeropuerto Mallorca alquiler
            scooter”, probablemente quieras organizar tu movilidad antes de
            llegar.
          </p>

          <p>
            Nuestra ubicación resulta especialmente práctica para quienes se
            alojan en el suroeste de Mallorca: Magaluf, Palmanova, Santa Ponsa,
            Calvià, Port Adriano o El Toro. No ofrecemos entrega en el
            aeropuerto ni en hoteles. La entrega del vehículo, la comprobación
            de documentos, las instrucciones y la devolución habitual se
            realizan en nuestra oficina de Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Aeropuerto Mallorca</span>
            <span>Alquiler scooter Aeropuerto Palma</span>
            <span>Scooter 125 cc PMI</span>
            <span>Alquiler scooter después de llegar</span>
            <span>Aeropuerto Mallorca alquiler scooter</span>
            <span>Alquiler moto scooter Aeropuerto Mallorca</span>
            <span>Reservar scooter online Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter cerca del Aeropuerto de Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                ¿Puedo recoger un scooter directamente en el Aeropuerto de Mallorca?
              </summary>
              <p>
                No. Puedes reservar tu scooter online con NEXA Rentals y
                recogerlo directamente en nuestra oficina de Magaluf.
              </p>
            </details>

            <details>
              <summary>¿A qué distancia está NEXA Rentals del Aeropuerto de Palma?</summary>
              <p>
                Nuestra oficina está en Magaluf. Desde el Aeropuerto de Palma de
                Mallorca, PMI, normalmente puedes llegar en unos 25–35 minutos
                en coche o taxi, según el tráfico.
              </p>
            </details>

            <details>
              <summary>¿Puedo reservar el scooter antes de mi vuelo?</summary>
              <p>
                Sí. Puedes elegir online el scooter, la fecha y la duración del
                alquiler, y pagar el precio por internet. Así reservas el
                vehículo para las fechas seleccionadas.
              </p>
            </details>
            ...
            <details>
              <summary>
                ¿Hay servicio de entrega en el aeropuerto o en el hotel?
              </summary>
              <p>
                No. No ofrecemos entrega de scooters en el aeropuerto ni en
                hoteles. La recogida y la devolución habituales se realizan
                directamente en NEXA Rentals, Magaluf.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>¿Quieres tener libertad desde que llegues?</h3>
            <p>
              Reserva online tu scooter de 125 cc y recógelo en NEXA Rentals,
              Magaluf.
            </p>
