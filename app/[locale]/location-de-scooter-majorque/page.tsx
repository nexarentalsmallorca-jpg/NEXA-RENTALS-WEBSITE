// app/[locale]/location-de-scooter-majorque/page.tsx
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-de-scooter-majorque";
  }
...
export async function generateMetadata({
  ...
  return {
    title: "Location de scooter Majorque | Scooter 125cc | NEXA Rentals",
    description:
      "Location de scooter à Majorque : réservez votre scooter 125cc en ligne chez NEXA Rentals, récupérez-le à Magaluf et découvrez l’île librement. Dès 39 € avec deux casques, top case, antivol, support téléphone et kilométrage illimité inclus.",
    keywords: [
      "location de scooter Majorque",
      "location scooter Majorque",
      "louer scooter Majorque",
      "scooter Majorque",
      "location scooter Magaluf",
      "loueur scooter Magaluf",
      "scooter 125cc Majorque",
      "location scooter 125cc Majorque",
      "location deux roues Majorque",
      "scooter rental Majorque",
      "location scooter pas cher Majorque",
      "prix location scooter Majorque",
      "réserver scooter en ligne Majorque",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-de-scooter-majorque",
    },
    openGraph: {
      title: "Location de scooter Majorque | NEXA Rentals",
      description:
        "Réservez un scooter 125cc à Majorque en ligne et récupérez-le chez NEXA Rentals à Magaluf. Dès 39 € avec les principaux équipements inclus.",
      url: "https://www.nexarentals.es/fr/location-de-scooter-majorque",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Majorque chez NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationDeScooterMajorquePage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Puis-je louer un scooter à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Chez NEXA Rentals, vous pouvez réserver un scooter 125cc en ligne et le récupérer directement à Magaluf. Nos scooters sont parfaits pour Magaluf, Palmanova, Santa Ponsa, Palma, Paguera et les excursions à Majorque.",
        },
      },
      {
        "@type": "Question",
        name: "Quels scooters NEXA Rentals propose-t-il ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals propose des scooters 125cc comme le Piaggio Liberty 125 et le SYM Symphony 125. Nous ne proposons actuellement pas de scooters 50cc.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Pour conduire un scooter 125cc, vous devez posséder un permis A, A1 ou A2. Le permis B est également accepté lorsqu’il est valide depuis au moins 3 ans. Les permis provisoires et les permis d’apprentissage ne sont pas acceptés.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Combien coûte la location d’un scooter à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Chez NEXA Rentals, la location d’un scooter 125cc commence à 39 € pour la demi-journée. La location de 24 heures coûte 49 €. Des tarifs dégressifs sont disponibles pour les locations de plusieurs jours.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter à Majorque",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-location-de-scooter-majorque"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Scooter 125cc · récupération à Magaluf
              </span>
            ...
            <h1>
              Louez un scooter à Majorque et découvrez l’île en toute liberté.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Majorque</strong>, un{" "}
              <strong>loueur de scooters à Majorque</strong> ou un{" "}
              <strong>scooter 125cc à Majorque</strong> ? Chez NEXA Rentals,
              vous réservez votre scooter en ligne, payez en toute sécurité et
              le récupérez directement à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Nos scooters 125cc sont parfaits pour Magaluf, Palmanova, Santa
              Ponsa, Palma, Paguera, Cala Vinyes, Camp de Mar et les excursions
              dans le sud-ouest de Majorque. Nous ne proposons pas de scooters
              50cc. Une livraison à l’hôtel peut être disponible sur demande
              selon la zone, la date et l’adresse.
            </p>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Récupération à notre agence</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Location de scooter 125cc à Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Des scooters pour Magaluf, Palmanova, Santa Ponsa, Palma et Majorque
        </p>

        <div className="nexa-trust-logos">
          <span>Location de scooter à Majorque</span>
          <span>Scooters 125cc</span>
          <span>Loueur de scooters à Majorque</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Location de scooter à Majorque
            </span>

            <h2>
              Avec un scooter 125cc, vous découvrez davantage de Majorque.
            </h2>

            <p>
              Le scooter est l’un des moyens les plus simples de relier les
              plages, les ports, les restaurants et les points de vue de
              Majorque. Au lieu de dépendre des horaires de bus ou du prix des
              taxis, vous choisissez librement votre prochaine destination.
            </p>

            <p>
              NEXA Rentals propose des scooters 125cc à Magaluf. Plus puissants
              et plus confortables que les petits modèles 50cc, ils sont
              particulièrement adaptés aux trajets vers Palmanova, Santa Ponsa,
              Palma, Paguera, Portals Nous, Cala Vinyes ou Camp de Mar.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              ...
              <li>Récupération et retour chez NEXA Rentals à Magaluf</li>
            </ul>
          </aside>
        </div>
      </section>
      ...
      <section className="nexa-license-section">
        <div className="nexa-license-inner">
          <span className="nexa-section-label">Permis pour scooter 125cc</span>

          <h2>Quel permis faut-il pour conduire un scooter 125cc ?</h2>
          ...
          <div className="nexa-license-grid">
            ...
            <div>
              ...
              <p>
                Avec un permis B, vous pouvez conduire un scooter 125cc si votre
                permis voiture est valide depuis au moins 3 ans.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Les permis d’apprentissage, permis provisoires, photographies
                et photocopies ne sont pas acceptés. Vous devez présenter le
                permis original.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Réservez votre scooter à Majorque en trois étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                location. La réservation est rapide, claire et parfaitement
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Scooter à Majorque</span>
          ...
          <p>
            Si vous recherchez “location de scooter Majorque”, “loueur scooter
            Majorque”, “scooter 125cc Majorque”, “location scooter Magaluf” ou
            “réserver un scooter en ligne à Majorque”, vous avez besoin d’une
            solution claire : réserver en ligne, payer en toute sécurité,
            récupérer le scooter à Magaluf et partir immédiatement.
          </p>

          <p>
            NEXA Rentals simplifie la location de scooter à Majorque : scooters
            125cc, tarifs transparents, deux casques, top case, antivol, support
            téléphone, kilométrage illimité et assurance de base inclus. La
            récupération et le retour standards s’effectuent à notre agence de
            Magaluf. Une livraison à l’hôtel peut être disponible sur demande
            selon la zone, la date et l’adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location de scooter à Majorque</span>
            <span>Location de scooter Majorque</span>
            <span>Loueur de scooters Majorque</span>
            <span>Scooter 125cc Majorque</span>
            <span>Location scooter Magaluf</span>
            <span>Louer un scooter à Majorque</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Majorque</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Puis-je louer un scooter chez NEXA Rentals ?</summary>
              <p>
                Oui. Vous pouvez réserver un scooter 125cc en ligne et le
                récupérer directement chez NEXA Rentals à Magaluf.
              </p>
            </details>

            <details>
              <summary>Proposez-vous des scooters 50cc ou 125cc ?</summary>
              <p>
                Nous proposons actuellement des scooters 125cc. Nous ne
                proposons pas de scooters 50cc.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                ...
                lorsqu’il est valide depuis au moins 3 ans. Les permis
            ...
            <details>
              <summary>La livraison à l’hôtel est-elle disponible ?</summary>
              <p>
                Une livraison à l’hôtel peut être disponible sur demande selon
                la zone, la date et l’adresse. Contactez-nous avant de réserver
                pour vérifier la disponibilité. La récupération et le retour
                standards s’effectuent à Magaluf.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Prêt à louer votre scooter ?</h3>
            <p>
