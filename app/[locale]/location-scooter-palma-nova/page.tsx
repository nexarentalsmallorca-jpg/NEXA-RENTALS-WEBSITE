// app/[locale]/location-scooter-palma-nova/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Top case",
    text: "Idéal pour un sac de plage, une serviette ou quelques achats.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Support téléphone",
    text: "Parfait pour naviguer entre Palma Nova, Magaluf et Calvià.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-palma-nova";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-palma-nova";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Palma Nova | Location scooter Palmanova | NEXA Rentals",
    description:
      "Location de scooter à Palma Nova et Palmanova avec NEXA Rentals. Réservez un scooter 125cc en ligne dès 39 €, récupérez-le à Magaluf et découvrez Palma Nova, Son Matias, Portals Nous et Calvià en toute liberté.",
    keywords: [
      ...
      "location de scooter Palma Nova",
      "location de scooter Palmanova",
      "location deux roues Palma Nova",
      "location scooter Son Matias",
      "location scooter près de Palmanova",
      "location scooter Magaluf",
      "scooter Palma Nova Majorque",
      "réserver scooter Palma Nova",
      "NEXA Rentals Palma Nova",
      "NEXA Rentals Palmanova",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-palma-nova",
    },
    openGraph: {
      title: "Location scooter Palma Nova | NEXA Rentals",
      description:
        "Réservez un scooter 125cc pour Palma Nova et Palmanova. Retrait rapide chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-palma-nova",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Palma Nova avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterPalmaNovaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter à Palma Nova ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Notre emplacement est très pratique pour les voyageurs qui séjournent à Palma Nova, Palmanova ou Son Matias.",
        },
      },
      {
        "@type": "Question",
        name: "NEXA Rentals est-il proche de Palma Nova ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. NEXA Rentals se trouve à Magaluf, juste à côté de Palma Nova et Palmanova. De nombreux clients rejoignent rapidement notre agence depuis Palma Nova et commencent leur excursion à partir de Magaluf.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location pour Palma Nova ?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "La livraison à Palma Nova est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait et le retour standard s’effectuent chez NEXA Rentals à Magaluf. Une livraison gratuite à Palma Nova peut être disponible sur demande. Contactez-nous avant de réserver afin de vérifier la disponibilité pour vos dates et votre hôtel.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Palma Nova",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Palma Nova, Majorque",
    },
  };
    ...
    <main className={`${pageFont.variable} palma-nova-seo-page`}>
      ...
      <header className="palma-nova-navbar" data-scrolled="false">
        <div className="palma-nova-nav-inner">
          <Link
            href={homeHref}
            className="palma-nova-logo-link hide-on-scroll"
          >
            <Image
          ...
          <div className="palma-nova-hero-copy">
            <div className="palma-nova-topline">
              <span className="palma-nova-kicker">
                À seulement environ 10 minutes à pied de Palmanova
              </span>
            ...
            <h1>
              Location de scooter à Palma Nova pour découvrir Majorque en toute
              liberté.
            </h1>

            <p className="palma-nova-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Palma Nova</strong>, une{" "}
              <strong>location de scooter à Palmanova</strong> ou un{" "}
              <strong>scooter 125cc à Palma Nova</strong> ? Chez NEXA Rentals,
              vous réservez votre scooter en ligne et le récupérez directement
              dans la ville voisine de Magaluf.
            </p>

            <p className="palma-nova-hero-text small">
              Une solution idéale pour les voyageurs qui séjournent à Palma
              Nova, Palmanova, Son Matias ou Magaluf et souhaitent rejoindre
              facilement les plages, hôtels, restaurants, beach clubs et plus
              beaux points de vue de Majorque.
            </p>
            ...
            <div className="palma-nova-visual-stack">
              ...
              <div className="palma-nova-photo-card palma-nova-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Palma Nova et Palmanova"
                  width={900}
                  height={720}
                  className="palma-nova-hero-image"
                />
      ...
      <section className="palma-nova-intent-section">
        <div className="palma-nova-intent-inner">
          <div>
            ...
            <p>
              Réservez rapidement votre scooter 125cc pour Palma Nova depuis
              notre site.
            </p>
          </div>
          ...
          <div>
            <span>02</span>
            <strong>Récupérez-le à Magaluf</strong>
            <p>
              Notre agence est idéalement située pour Palma Nova et Palmanova.
            </p>
          </div>

          <div>
            <span>03</span>
            <strong>Découvrez Majorque librement</strong>
            <p>
              Rejoignez facilement Magaluf, Portals Nous, Santa Ponsa ou Calvià.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="palma-nova-included-section">
        <div className="palma-nova-section-heading">
          <span>Inclus chez NEXA Rentals</span>
          <h2>Tout ce dont vous avez besoin pour partir de Palma Nova.</h2>
        </div>
      ...
      <section className="palma-nova-content-section">
        <div className="palma-nova-content-grid">
          <article>
            ...
            <h2>
              Pourquoi un scooter est particulièrement pratique à Palma Nova.
            </h2>

            <p>
              Palma Nova et Palmanova sont idéales si vous séjournez près de la
              plage tout en souhaitant découvrir davantage Majorque. Avec un
              scooter 125cc, vous ne dépendez pas des taxis, des bus ou des
              longs trajets à pied. Vous pouvez aller à la plage le matin,
              rejoindre Magaluf à midi et partir spontanément vers Portals Nous
              ou Santa Ponsa en soirée.
            </p>

            <p>
              NEXA Rentals est particulièrement pratique pour les voyageurs de
              Palma Nova, car notre agence se trouve directement à Magaluf.
              Vous réservez en ligne, payez en ligne et récupérez votre scooter
              dans notre agence. Vous pouvez ensuite partir immédiatement, sans
              procédure compliquée et sans frais cachés.
            </p>
          </article>
          ...
          <aside className="palma-nova-local-box">
            ...
            <div className="palma-nova-keywords-list">
              ...
              <span>Louer un scooter Palma Nova</span>
              <span>Scooter 125cc Palmanova</span>
              <span>Location de scooter Palma Nova</span>
              <span>Scooter Palma Nova Majorque</span>
            </div>
          </aside>
        </div>
      </section>
      ...
      <section className="palma-nova-how-section">
        <div className="palma-nova-how-inner">
          ...
          <h2>
            Votre scooter pour Palma Nova en trois étapes simples.
          </h2>
          ...
          <div className="palma-nova-how-grid">
            <div>
              ...
              <p>
                Sélectionnez votre scooter, la durée de location et l’heure de
                départ souhaitée pour votre journée à Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Payez en ligne afin de confirmer définitivement votre
                réservation et de préparer votre scooter.
              </p>
            </div>

            <div>
              <span>3</span>
              <h3>Récupérez-le et partez</h3>
              <p>
                Présentez-vous chez NEXA Rentals à Magaluf avec votre permis
                original et votre carte d’identité ou passeport.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="palma-nova-bottom-cta">
            Réserver un scooter pour Palma Nova
          </Link>
        </div>
      </section>
      ...
      <section className="palma-nova-seo-text-section">
        <div className="palma-nova-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs qui souhaitent relier librement Palma Nova,
            Palmanova et Magaluf.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Palma Nova »,
            « location scooter Palmanova », « louer un scooter à Palma Nova » ou
            « scooter 125cc Palmanova », vous cherchez probablement une solution
            simple : réserver en ligne, récupérer rapidement votre scooter et
            partir sans perdre de temps. Cette page a été créée exactement pour
            cela.
          </p>

          <p>
            Palma Nova se trouve directement à côté de Magaluf. NEXA Rentals
            est donc une solution pratique pour les voyageurs qui séjournent à
            Palma Nova, Son Matias, Palmanova ou Torrenova. Vous pouvez réserver
            votre scooter en ligne et le récupérer dans notre agence à Magaluf.
            Vous rejoindrez ensuite les plages, restaurants, hôtels, points de
            vue et villes voisines beaucoup plus facilement.
          </p>
          ...
          <div className="palma-nova-keyword-cloud">
            ...
            <span>Scooter 125cc Palmanova</span>
            <span>Location de scooter Palma Nova</span>
            <span>Réserver scooter Palma Nova</span>
            <span>NEXA Rentals Magaluf</span>
            <span>Location scooter Majorque</span>
          </div>
        </div>
      </section>
      ...
      <section className="palma-nova-faq-section">
        <div className="palma-nova-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Palma Nova</h2>

          <div className="palma-nova-faq-list">
            <details>
              <summary>
                Puis-je réserver un scooter pour Palma Nova ?
              </summary>
              <p>
                Oui. Vous pouvez réserver votre scooter en ligne et le
                récupérer chez NEXA Rentals à Magaluf. Cette solution est très
                pratique pour les voyageurs de Palma Nova, Palmanova et Son
                Matias.
              </p>
            </details>
            ...
            <details>
              <summary>
                Palma Nova est-elle loin de NEXA Rentals ?
              </summary>
              <p>
                Non. Palma Nova se trouve directement à côté de Magaluf. De
                nombreux clients rejoignent rapidement NEXA Rentals depuis
                Palma Nova et commencent leur excursion depuis notre agence.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Pour conduire un scooter 125cc, vous devez posséder un permis A,
                A1 ou A2. Avec un permis voiture B, vous pouvez conduire si
                celui-ci est valide depuis au moins 3 ans. Les permis
                provisoires et d’apprentissage ne sont pas acceptés.
              </p>
            </details>
            ...
            <details>
              <summary>
                Le scooter peut-il être livré à Palma Nova ?
              </summary>
              <p>
                Le retrait et le retour standard s’effectuent chez NEXA Rentals
                à Magaluf. Une livraison gratuite à Palma Nova peut être
                disponible sur demande. Contactez-nous avant de réserver afin
                de vérifier la disponibilité pour vos dates et votre hôtel.
              </p>
            </details>
          </div>

          <div className="palma-nova-final-cta">
            <h3>Prêt à découvrir Palma Nova ?</h3>
            <p>
              Réservez votre scooter 125cc en ligne et partez directement
