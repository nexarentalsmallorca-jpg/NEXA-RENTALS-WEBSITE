...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Idéal pour utiliser le GPS partout à Majorque.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/scooter-majorque-location";
  }
...
export async function generateMetadata({
  ...
  return {
    title: "Location scooter Majorque | Scooter 125cc dès 39 € | NEXA Rentals",
    description:
      "Location de scooter à Majorque chez NEXA Rentals à Magaluf. Réservez et payez en ligne votre scooter 125cc dès 39 €, puis récupérez-le directement à Magaluf. Idéal pour Magaluf, Palmanova, Santa Ponsa, Paguera et le sud-ouest de Majorque.",
    keywords: [
      "location scooter Majorque",
      "scooter Majorque location",
      ...
      "réserver scooter Majorque en ligne",
      "scooter pas cher Majorque",
      "location scooter sud-ouest Majorque",
      "NEXA Rentals Magaluf",
      "NEXA Rentals Majorque",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/fr/scooter-majorque-location",
    },
    openGraph: {
      title: "Location scooter Majorque | NEXA Rentals Magaluf",
      description:
        "Réservez en ligne un scooter 125cc à Majorque dès 39 €. Retrait et retour chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/scooter-majorque-location",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Majorque chez NEXA Rentals à Magaluf",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function ScooterMajorqueLocationPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Où peut-on louer un scooter à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Le retrait et le retour standard s’effectuent chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Chez NEXA Rentals, vous pouvez réserver votre scooter en ligne et payer le montant de la location directement en ligne. Votre scooter 125cc est ainsi confirmé pour les dates choisies.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location d’un scooter à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "La livraison du scooter est-elle disponible à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison dans une zone proche, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Location scooter Majorque : réservez votre scooter 125cc.</h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Majorque</strong>, souhaitez{" "}
              <strong>louer un scooter à Majorque</strong> ou réserver un{" "}
            ...
            <p className="nexa-hero-text small">
              Une solution idéale pour Magaluf, Palmanova, Palma Nova, Santa
              Ponsa, Paguera, Calvià, les journées à la plage, les points de
              vue, les restaurants et les excursions sans dépendre des taxis.
            </p>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Directement à Magaluf, Majorque.</strong>
                <span>
                  NEXA Rentals se trouve à Magaluf. Réservez en ligne, récupérez
                  votre scooter sur place et partez directement vers la plage,
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Réservation en ligne et retrait sur place</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-top">
                <Image
                  ...
                  alt="Location de scooter à Majorque avec NEXA Rentals à Magaluf"
                  width={900}
                  height={620}
                  priority
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter 125cc à Majorque chez NEXA Rentals"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Une solution pratique pour les voyageurs francophones à Majorque</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>La solution simple pour louer un scooter à Majorque.</h2>

            <p>
              De nombreux voyageurs recherchent un scooter ou un deux-roues à
              Majorque afin de ne pas dépendre chaque jour des taxis, des bus ou
              des longues attentes. Chez NEXA Rentals, la procédure est simple :
              vous réservez votre scooter 125cc en ligne, payez en ligne et le
              récupérez directement dans notre agence à Magaluf.
            </p>

            <p>
              Nos scooters sont parfaits pour les petits trajets, les journées à
              la plage et les excursions autour de Magaluf, Palmanova, Palma
              Nova, Portals Nous, Santa Ponsa, Paguera et Calvià. Montez sur
              votre scooter et découvrez Majorque à votre propre rythme.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              ...
              <li>Retrait direct à Magaluf</li>
              <li>Réservation et paiement en ligne</li>
              <li>Deux casques inclus</li>
              <li>
                Top case de 50 litres pour un sac, un casque ou vos achats
              </li>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                scooter pour les dates choisies avant le début de votre journée
                à Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                expliquons tout avant votre départ vers la plage, Palmanova,
                Santa Ponsa ou Paguera.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Location scooter Majorque</span>
          ...
          <p>
            Lorsque vous recherchez sur Google « location scooter Majorque », «
            scooter Majorque location », « louer un scooter à Majorque », «
            location scooter 125cc Majorque » ou « location de deux-roues à
            Majorque », vous cherchez généralement une solution simple et
            rapide. NEXA Rentals vous propose des informations claires, une
            véritable réservation en ligne, un paiement sécurisé et un scooter
            125cc pour découvrir l’île en toute liberté.
          </p>
          ...
          <p>
            ...
            sud-ouest de Majorque. Le retrait standard s’effectue directement
            chez NEXA Rentals à Magaluf. Pour une demande de livraison dans une
            zone proche, contactez-nous avant de réserver afin de vérifier la
            disponibilité selon vos dates et votre adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter Majorque</span>
            <span>Scooter Majorque location</span>
            <span>Scooter 125cc Majorque</span>
            <span>Louer un scooter Majorque</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>Où récupère-t-on le scooter ?</summary>
              <p>
                Le retrait et le retour standard s’effectuent directement chez
                NEXA Rentals à Magaluf. Pour une demande de livraison dans une
                zone proche, contactez-nous avant de réserver afin de vérifier
                la disponibilité selon vos dates et votre adresse.
              </p>
            </details>
            ...
            <details>
              <summary>
                NEXA Rentals est-il pratique pour Magaluf et Palmanova ?
              </summary>
              <p>
                Oui. Notre agence à Magaluf est pratique si vous séjournez à
                Magaluf, Palmanova, Palma Nova, Santa Ponsa, Paguera ou Calvià
                et souhaitez louer un scooter 125cc à Majorque.
              </p>
            </details>
          </div>
