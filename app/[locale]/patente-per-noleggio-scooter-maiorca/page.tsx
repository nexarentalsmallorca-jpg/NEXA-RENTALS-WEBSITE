// app/[locale]/patente-per-noleggio-scooter-maiorca/page.tsx
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "it") {
    return "/it/patente-per-noleggio-scooter-maiorca";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-mallorca-fuehrerschein";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Patente per noleggio scooter Maiorca | Patente B da 3 anni | NEXA Rentals",
    description:
      "Quale patente serve per noleggiare uno scooter a Maiorca? Scooter 125cc con patente A, A1, A2 o patente B valida da almeno 3 anni. Prenota online e ritira a Magaluf.",
    keywords: [
      "patente per noleggio scooter Maiorca",
      "noleggio scooter Maiorca patente B",
      "scooter 125cc Maiorca patente",
      "scooter 125cc Maiorca patente auto",
      "noleggio motorino Maiorca patente",
      "scooter Maiorca patente B 3 anni",
      "noleggio scooter Maiorca patente auto",
      "guidare scooter Maiorca patente B",
      "guidare scooter 125cc Maiorca",
      "noleggio scooter Maiorca patente A1",
      "noleggio scooter Maiorca patente A2",
      "noleggio scooter Maiorca patente A",
      "patente motorino Maiorca",
      "scooter Maiorca patente italiana",
      "noleggio scooter Maiorca senza patente moto",
      "noleggio scooter Maiorca patente italiana",
      "scooter 125cc Maiorca patente B",
      "NEXA Rentals patente",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/patente-per-noleggio-scooter-maiorca",
    },
    openGraph: {
      title: "Patente per noleggio scooter Maiorca | NEXA Rentals",
      description:
        "Quale patente serve per guidare uno scooter 125cc a Maiorca? A, A1, A2 oppure patente B valida da almeno 3 anni.",
      url: "https://www.nexarentals.es/it/patente-per-noleggio-scooter-maiorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Patente per noleggiare uno scooter a Maiorca con NEXA Rentals",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function PatentePerNoleggioScooterMaiorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Per guidare uno scooter 125cc sono accettate le patenti A, A1 e A2. Puoi guidarlo anche con la patente B, purché sia valida da almeno 3 anni.",
        },
      },
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter a Maiorca con la patente italiana B?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì, se la tua patente B è valida da almeno 3 anni. Al momento del ritiro devi presentare la patente originale e un documento d’identità o passaporto.",
        },
      },
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter con una patente provvisoria?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. Non sono accettate patenti provvisorie, fogli rosa, fotografie o copie. Devi presentare la patente originale e valida.",
        },
      },
      {
        "@type": "Question",
        name: "NEXA Rentals noleggia scooter 50cc?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. NEXA Rentals noleggia attualmente scooter 125cc Piaggio e SYM. Al momento non offriamo scooter 50cc.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Con NEXA Rentals sono inclusi 2 caschi, bauletto da 50 litri, lucchetto, portacellulare impermeabile, chilometri illimitati e assicurazione di base.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Il ritiro e la riconsegna standard avvengono presso NEXA Rentals, in C. Galeón, 13, Loc 57, 07181 Magaluf. La consegna in alcune zone alberghiere vicine può essere disponibile solo su richiesta, in base alla località, alla data e all’indirizzo. Contattaci prima di prenotare.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Maiorca con patente valida",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-fuehrerschein"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A / A1 / A2 · Patente B da almeno 3 anni
              </span>
            ...
            <h1>
              Noleggio scooter a Maiorca: quale patente è necessaria?
            </h1>

            <p className="nexa-hero-text">
              Cerchi informazioni su{" "}
              <strong>patente per noleggio scooter a Maiorca</strong>,{" "}
              <strong>scooter 125cc con patente B</strong> o{" "}
              <strong>guidare uno scooter a Maiorca con la patente auto</strong>
              ? Con NEXA Rentals puoi verificare facilmente quale patente serve
              per noleggiare uno dei nostri scooter 125cc.
            </p>

            <p className="nexa-hero-text small">
              In breve: sono accettate le patenti A, A1 e A2. Con la patente B
              puoi noleggiare uno scooter 125cc se la patente auto è valida da
              almeno 3 anni. Patenti provvisorie, fogli rosa, fotografie e
              copie non sono accettati.
            </p>
            ...
            <div className="nexa-hero-points">
              <div>
                ...
                <span>Patenti accettate</span>
              </div>

              <div>
                <strong>B da 3+ anni</strong>
                <span>Patente auto accettata</span>
              </div>

              <div>
                <strong>Originale</strong>
                <span>Porta la patente fisica</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter 125cc a Maiorca con patente B"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Regole chiare per guidare uno scooter 125cc a Maiorca</p>

        <div className="nexa-trust-logos">
          <span>Patente B da 3 anni</span>
          <span>A1 / A2 / A</span>
          <span>Scooter 125cc</span>
          <span>Documento originale</span>
          <span>Nessun foglio rosa</span>
        </div>
      </section>

      <section className="nexa-license-section">
        <div className="nexa-license-inner">
          <span className="nexa-section-label">Requisiti della patente</span>

          <h2>
            Queste sono le patenti accettate per i nostri scooter 125cc.
          </h2>
          ...
          <div className="nexa-license-grid">
            <div>
              <strong>A / A1 / A2</strong>
              <p>
                Con una patente A, A1 o A2 puoi noleggiare uno scooter 125cc
                presso NEXA Rentals, purché la patente sia valida e venga
                presentata in originale.
              </p>
            </div>

            <div>
              <strong>Patente B</strong>
              <p>
                Puoi noleggiare uno scooter 125cc con la patente B se la tua
                patente auto è valida da almeno 3 anni.
              </p>
            </div>

            <div>
              <strong>Non accettati</strong>
              <p>
                Fogli rosa, patenti provvisorie, fotografie o copie non sono
                accettati. Porta con te la patente originale.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Scooter 125cc con patente auto
            </span>

            <h2>
              Puoi guidare uno scooter 125cc con la patente B, ma deve essere
              valida da almeno 3 anni.
            </h2>

            <p>
              Molti turisti italiani vogliono sapere prima del viaggio se
              possono guidare uno scooter a Maiorca con la normale patente
              dell’auto. Con NEXA Rentals, per noleggiare uno dei nostri scooter
              125cc devi possedere una patente A, A1, A2 oppure una patente B
              valida da almeno 3 anni.
            </p>

            <p>
              Al momento del ritiro devi presentare la patente originale e una
              carta d’identità o un passaporto. Non sono accettati fogli rosa,
              patenti provvisorie, fotografie o copie. Il ritiro e la
              riconsegna standard avvengono direttamente presso NEXA Rentals a
              Magaluf.
            </p>
          </article>

          <aside className="nexa-info-box">
            <h3>Prima del ritiro</h3>

            <ul>
              <li>Porta la patente originale</li>
              <li>Porta una carta d’identità o un passaporto</li>
              <li>La patente B deve essere valida da almeno 3 anni</li>
              <li>Sono accettate le patenti A, A1 e A2</li>
              <li>Le patenti provvisorie non sono accettate</li>
              <li>I fogli rosa non sono accettati</li>
              <li>Fotografie e copie non sono accettate</li>
              <li>Ritiro presso NEXA Rentals a Magaluf</li>
            </ul>
          </aside>
        </div>
      </section>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Verifica la patente, prenota online e parti da Magaluf.</h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Verifica la patente</h3>
              <p>
                Le patenti A, A1 e A2 sono accettate. Anche la patente B è
                accettata se è valida da almeno 3 anni.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Paga online il prezzo in modo sicuro.
              </p>
            </div>

            <div>
              <span>03</span>
              <h3>Porta i documenti originali</h3>
              <p>
                Presentati da NEXA Rentals a Magaluf con patente originale e
                carta d’identità o passaporto. Dopo la spiegazione puoi partire.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Patente scooter Maiorca
          </span>

          <h2>
            Una risposta chiara per chi vuole noleggiare uno scooter a
            Maiorca.
          </h2>

          <p>
            Quando cerchi “patente per noleggio scooter Maiorca”, “noleggio
            scooter Maiorca con patente B”, “scooter 125cc Maiorca patente auto”
            o “guidare scooter a Maiorca con patente italiana”, hai bisogno di
            una risposta semplice: per uno scooter 125cc sono accettate le
            patenti A, A1 e A2 oppure la patente B valida da almeno 3 anni.
          </p>

          <p>
            Con NEXA Rentals trovi scooter 125cc Piaggio e SYM, prezzi
            trasparenti e una prenotazione online semplice. Nel prezzo sono
            inclusi 2 caschi, bauletto da 50 litri, lucchetto, portacellulare
            impermeabile, chilometri illimitati e assicurazione di base. Il
            ritiro e la riconsegna standard avvengono presso il nostro ufficio
            di Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Patente per noleggio scooter Maiorca</span>
            <span>Patente B da 3 anni</span>
            <span>Scooter 125cc con patente auto</span>
            <span>Scooter Maiorca patente A1</span>
            <span>Scooter Maiorca patente A2</span>
            <span>Patente italiana a Maiorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>
            Domande sulla patente necessaria per guidare uno scooter a Maiorca
          </h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Posso noleggiare uno scooter 125cc con la patente B?
              </summary>
              <p>
                Sì, purché la tua patente B sia valida da almeno 3 anni. Devi
                presentare la patente originale al momento del ritiro.
              </p>
            </details>

            <details>
              <summary>Quali patenti accetta NEXA Rentals?</summary>
              <p>
                Sono accettate le patenti A, A1 e A2. La patente B è accettata
                se è valida da almeno 3 anni.
              </p>
            </details>

            <details>
              <summary>Posso noleggiare con il foglio rosa?</summary>
              <p>
                No. Fogli rosa, patenti provvisorie, fotografie e copie non sono
                accettati.
              </p>
            </details>

            <details>
              <summary>NEXA Rentals noleggia scooter 50cc?</summary>
              <p>
                No. NEXA Rentals noleggia attualmente scooter 125cc Piaggio e
                SYM, non scooter 50cc.
              </p>
            </details>

            <details>
              <summary>Dove avviene il ritiro dello scooter?</summary>
              <p>
                Il ritiro e la riconsegna standard avvengono presso NEXA
                Rentals, in C. Galeón, 13, Loc 57, 07181 Magaluf. Per alcune
                zone alberghiere vicine, la consegna può essere disponibile
                solo su richiesta, in base alla località, alla data e
                all’indirizzo. Contattaci prima di prenotare.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>La tua patente è valida?</h3>
            <p>
              Prenota online il tuo scooter 125cc e ritiralo presso NEXA
              Rentals a Magaluf.
            </p>
