...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por Palmanova y Mallorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "es") {
    return "/es/alquiler-scooter-palmanova";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Palmanova | Scooter 125cc | NEXA Rentals",
    description:
      "Alquiler de scooter en Palmanova y Palma Nova. Reserva online una moto 125cc, recógela en NEXA Rentals Magaluf y explora el suroeste de Mallorca.",
    keywords: [
      "alquiler scooter Palmanova",
      "alquiler de scooter Palmanova",
      "alquiler moto Palmanova",
      "alquiler moto 125cc Palmanova",
      ...
      "reservar scooter online Palmanova",
      "NEXA Rentals Palmanova",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/es/alquiler-scooter-palmanova",
    },
    openGraph: {
      title: "Alquiler de scooter en Palmanova | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter 125cc para Palmanova, Palma Nova, Son Matias, Magaluf y Calvià. Recogida en NEXA Rentals Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-palmanova",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Palmanova con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function AlquilerScooterPalmanovaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter en Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online tu scooter 125cc con NEXA Rentals y recogerlo directamente en Magaluf. Es una opción especialmente práctica si te alojas en Palmanova, Palma Nova, Son Matias o Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se encuentra en Magaluf. Desde Palmanova puedes llegar a nuestra oficina en unos 5-10 minutos, dependiendo del tráfico. La recogida y la devolución se realizan directamente en NEXA Rentals Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico moverse en scooter por Palmanova y Palma Nova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter 125cc es una opción práctica para explorar con libertad Palmanova, Palma Nova, Son Matias, Magaluf, Portals Nous, Santa Ponsa, Cala Vinyes y el suroeste de Mallorca.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aceptamos los permisos A, A1 y A2. También puedes conducir un scooter 125cc con el permiso B si tiene una antigüedad mínima de 3 años.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega en Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter 125cc en Palmanova",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A unos 5–10 minutos de Palmanova
              </span>
            ...
            <h1>
              Alquila un scooter en Palmanova y explora Mallorca con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en Palmanova</strong>, una{" "}
              <strong>moto de alquiler en Palma Nova</strong> o un{" "}
              <strong>scooter 125cc en Palmanova</strong>? Con NEXA Rentals
              reservas online, pagas de forma segura y recoges tu scooter
              directamente en Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal para recorrer Palmanova, Palma Nova, Son Matias, Magaluf,
              Portals Nous, Santa Ponsa, Cala Vinyes y el suroeste de Mallorca.
              Perfecto para desplazarte con libertad entre playas, hoteles,
              restaurantes y localidades costeras.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en Palmanova y Palma Nova"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Para Palmanova, Palma Nova, Son Matias, Magaluf y Calvià</p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Palmanova
            </span>

            <h2>
              Recorre fácilmente Palmanova, Magaluf y el suroeste de Mallorca.
            </h2>

            <p>
              Palmanova es perfecta para disfrutar de sus playas, hoteles y
              restaurantes, además de hacer trayectos cortos hacia Magaluf, Son
              Matias, Portals Nous o Santa Ponsa. Con un scooter 125cc puedes
              moverte con mayor libertad y descubrir Mallorca sin depender del
              autobús ni esperar un taxi.
            </p>

            <p>
              NEXA Rentals es una solución práctica para quienes buscan
              alquiler de scooter en Palmanova, una moto de alquiler en Palma
              Nova o un scooter 125cc cerca de su hotel. Reservas y pagas online
              y recoges tu scooter directamente en Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc para Palmanova y Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva tu scooter desde Palmanova en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                alquiler. El proceso es rápido, claro y perfecto para organizar
                tus vacaciones en Palmanova.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Palmanova, Magaluf, Santa Ponsa o tu ruta por Mallorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva ahora tu scooter para Palmanova
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Para explorar Palmanova y el suroeste de Mallorca con total
            libertad.
          </h2>

          <p>
            Si buscas “alquiler scooter Palmanova”, “alquiler de motos en
            Palmanova”, “alquiler scooter Palma Nova”, “scooter 125cc
            Palmanova” o “alquilar moto en Palmanova”, necesitas una solución
            sencilla: reserva online, pago seguro y un scooter 125cc para
          ...
          <p>
            ...
            Ponsa, Palma y otros lugares de Mallorca. NEXA Rentals ofrece una
            reserva online sencilla y recogida en Magaluf. Actualmente no
            ofrecemos servicio de entrega; así, la entrega del vehículo, la
            comprobación de documentos y la devolución se gestionan de forma
            clara y segura.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Palmanova</span>
            <span>Alquiler de motos Palmanova</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Palmanova</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Palmanova?</summary>
              <p>
                ...
                Palmanova, Palma Nova, Son Matias y Magaluf.
              </p>
            </details>

            <details>
              <summary>¿A qué distancia está NEXA Rentals de Palmanova?</summary>
              <p>
                Nuestra oficina se encuentra en Magaluf. Desde Palmanova puedes
                llegar en unos 5-10 minutos, dependiendo del tráfico. La
                recogida y la devolución se realizan directamente en NEXA
                Rentals Magaluf.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Aceptamos los permisos A, A1 y A2. También puedes conducir un
                scooter 125cc con el permiso B si tiene una antigüedad mínima
                de 3 años. No se aceptan permisos provisionales ni de aprendizaje.
              </p>
            </details>
            ...
            <details>
              <summary>¿Hay servicio de entrega en Palmanova?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Preparado para explorar Palmanova?</h3>
            <p>
