// app/[locale]/location-scooter-camp-de-mar/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Idéal pour utiliser le GPS dans le sud-ouest de Majorque.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-camp-de-mar";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-camp-de-mar";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Camp de Mar | Scooter 125cc sud-ouest Majorque | NEXA Rentals",
    description:
      "Location de scooter à Camp de Mar et dans le sud-ouest de Majorque. Réservez en ligne votre scooter 125cc chez NEXA Rentals, récupérez-le à Magaluf et découvrez Camp de Mar, Cala Fornells, Paguera, Port d’Andratx et Andratx en toute liberté.",
    keywords: [
      "location scooter Camp de Mar",
      "louer scooter Camp de Mar",
      "scooter 125cc Camp de Mar",
      "location deux roues Camp de Mar",
      "location scooter Cala Fornells",
      "louer scooter Cala Fornells",
      "location scooter Paguera",
      "louer scooter Paguera",
      "location scooter Port d’Andratx",
      "louer scooter Port d’Andratx",
      "location scooter Andratx",
      "location scooter sud-ouest Majorque",
      "louer scooter sud-ouest Majorque",
      "scooter 125cc sud-ouest Majorque",
      "réserver scooter Camp de Mar en ligne",
      "NEXA Rentals Camp de Mar",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-camp-de-mar",
    },
    openGraph: {
      title: "Location scooter Camp de Mar | NEXA Rentals Majorque",
      description:
        "Réservez en ligne un scooter 125cc pour Camp de Mar, Cala Fornells, Paguera et le sud-ouest de Majorque. Retrait chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-camp-de-mar",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Camp de Mar avec NEXA Rentals à Majorque",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterCampDeMarPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter pour Camp de Mar ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement à Magaluf. Cette solution est pratique pour les voyageurs séjournant à Camp de Mar, Cala Fornells, Paguera, Andratx ou Port d’Andratx.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de Camp de Mar ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis Camp de Mar, le trajet jusqu’à notre agence prend généralement entre 20 et 25 minutes en voiture, selon la circulation. Le retrait et le retour standard s’effectuent chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Un scooter est-il pratique pour Camp de Mar et le sud-ouest de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour découvrir librement Camp de Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa Ponsa et le sud-ouest de Majorque.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison à Camp de Mar est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait et le retour standard s’effectuent chez NEXA Rentals à Magaluf. Pour une demande de livraison à Camp de Mar ou dans une zone proche, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Camp de Mar",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                À environ 20–25 min de Camp de Mar
              </span>
            ...
            <h1>
              Location de scooter à Camp de Mar pour découvrir le sud-ouest de
              Majorque.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Camp de Mar</strong>, souhaitez{" "}
              <strong>louer un scooter à Camp de Mar</strong> ou réserver un{" "}
              <strong>scooter 125cc dans le sud-ouest de Majorque</strong> ?
              Chez NEXA Rentals, vous réservez et payez en ligne, puis récupérez
              votre scooter directement à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Une solution idéale pour Camp de Mar, Cala Fornells, Paguera, Port
              d’Andratx, Andratx, Santa Ponsa et les belles routes côtières du
              sud-ouest de Majorque. Parfait pour relier librement les plages,
              les ports et les restaurants.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Camp de Mar dans le sud-ouest de Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Pour Camp de Mar, Cala Fornells, Paguera, Andratx et le sud-ouest de
          Majorque
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Découvrez plus librement Camp de Mar, Paguera et Port d’Andratx.
            </h2>

            <p>
              Camp de Mar est idéal pour profiter de journées tranquilles, de
              belles plages, de restaurants face à la mer et d’excursions dans
              le sud-ouest de Majorque. Avec un scooter 125cc, vous pouvez relier
              plus facilement Camp de Mar, Cala Fornells, Paguera, Port
              d’Andratx, Andratx, Santa Ponsa et Magaluf.
            </p>

            <p>
              NEXA Rentals est une solution pratique pour les voyageurs qui
              recherchent une location de scooter à Camp de Mar, souhaitent
              louer un scooter à Camp de Mar ou découvrir le sud-ouest de
              Majorque en deux-roues. Vous réservez en ligne, payez en ligne et
              récupérez votre scooter directement à Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Camp de Mar et le sud-ouest de Majorque</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Réservez votre scooter pour Camp de Mar en trois étapes simples.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                vacances dans le sud-ouest de Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                scooter pour Camp de Mar, Paguera, Port d’Andratx ou votre
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour Camp de Mar
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Louer un scooter à Camp de Mar
          </span>

          <h2>
            Pour les voyageurs qui souhaitent découvrir Camp de Mar et le
            sud-ouest de Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez « location scooter Camp de Mar », « louer un
            scooter Camp de Mar », « scooter 125cc Camp de Mar », « location
            deux-roues Camp de Mar » ou « location scooter sud-ouest Majorque »,
            vous avez besoin d’une solution simple : réserver en ligne, payer en
            toute sécurité et vous déplacer librement avec un scooter 125cc.
          </p>

          <p>
            Un scooter est particulièrement pratique pour les trajets entre Camp
            de Mar, Cala Fornells, Paguera, Port d’Andratx, Andratx, Santa
            Ponsa, Magaluf et Palmanova. Le retrait standard s’effectue chez
            NEXA Rentals à Magaluf. Pour une demande de livraison à Camp de Mar
            ou dans une zone proche, contactez-nous avant de réserver afin de
            vérifier la disponibilité selon vos dates et votre adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter Camp de Mar</span>
            <span>Louer scooter Camp de Mar</span>
            <span>Scooter 125cc Camp de Mar</span>
            <span>Location scooter Cala Fornells</span>
            <span>Location scooter Paguera</span>
            <span>Location scooter Port d’Andratx</span>
            <span>Location scooter sud-ouest Majorque</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Camp de Mar</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Peut-on réserver un scooter pour Camp de Mar ?
              </summary>
              <p>
                ...
                est pratique pour Camp de Mar, Cala Fornells, Paguera, Andratx
                et Port d’Andratx.
              </p>
            </details>
            ...
            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de Camp de Mar ?
              </summary>
              <p>
                Notre agence se trouve à Magaluf. Depuis Camp de Mar, le trajet
                prend généralement entre 20 et 25 minutes en voiture, selon la
                circulation. Le retrait et le retour standard s’effectuent
                directement chez NEXA Rentals à Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>La livraison à Camp de Mar est-elle disponible ?</summary>
              <p>
                Le retrait et le retour standard s’effectuent chez NEXA Rentals
                à Magaluf. Pour une demande de livraison à Camp de Mar ou dans
                une zone proche, contactez-nous avant de réserver afin de
                vérifier la disponibilité selon vos dates et votre adresse.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Camp de Mar ?</h3>
            <p>
