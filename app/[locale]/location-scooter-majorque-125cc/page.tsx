// app/[locale]/location-scooter-majorque-125cc/page.tsx
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-majorque-125cc";
  }

  if (languageCode === "de") {
    return "/de/125cc-roller-mieten-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter 125cc Majorque | Permis B depuis 3 ans | NEXA Rentals",
    description:
      "Louez un scooter 125cc à Majorque chez NEXA Rentals. Réservation en ligne, récupération à Magaluf et équipements inclus dès 39 €. Permis A, A1, A2 ou permis B valide depuis au moins 3 ans.",
    keywords: [
      "location scooter 125cc Majorque",
      "louer scooter 125cc Majorque",
      "location 125cc Majorque",
      "scooter 125cc Majorque",
      "location scooter Majorque 125cc",
      "louer un scooter 125cc à Majorque",
      "location moto 125 Majorque",
      "scooter 125 Majorque",
      "location scooter permis B Majorque",
      "scooter 125cc permis B Majorque",
      "location scooter Majorque permis voiture",
      "location scooter Majorque permis B",
      "location scooter Majorque permis A1",
      "location scooter Majorque permis A2",
      "scooter 125cc Magaluf",
      "location scooter 125cc Magaluf",
      "Piaggio Liberty 125 Majorque",
      "SYM Symphony 125 Majorque",
      "NEXA Rentals 125cc",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-majorque-125cc",
    },
    openGraph: {
      title: "Location scooter 125cc Majorque | NEXA Rentals",
      description:
        "Réservez un scooter 125cc à Majorque en ligne et récupérez-le chez NEXA Rentals à Magaluf. Deux casques, top case, antivol, support téléphone et kilométrage illimité inclus.",
      url: "https://www.nexarentals.es/fr/location-scooter-majorque-125cc",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter 125cc à Majorque chez NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterMajorque125CcPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Puis-je louer un scooter 125cc à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Chez NEXA Rentals, vous pouvez réserver un scooter 125cc en ligne et le récupérer directement à Magaluf. Nos scooters sont adaptés à Magaluf, Palmanova, Santa Ponsa, Palma, aux plages et aux excursions à Majorque.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous devez posséder un permis A, A1 ou A2. Le permis B est également accepté lorsqu’il est valide depuis au moins 3 ans.",
        },
      },
      {
        "@type": "Question",
        name: "Puis-je louer un scooter 125cc à Majorque avec un permis voiture ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui, si votre permis B est valide depuis au moins 3 ans. Les permis provisoires et les permis d’apprentissage ne sont pas acceptés.",
        },
      },
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location du scooter 125cc ?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Où dois-je récupérer le scooter 125cc ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "La récupération et le retour standards s’effectuent directement chez NEXA Rentals à Magaluf. Selon la zone, la date et l’adresse, une livraison à l’hôtel peut être disponible sur demande. Contactez-nous avant de réserver pour vérifier la disponibilité.",
        },
      },
      {
        "@type": "Question",
        name: "Combien coûte la location d’un scooter 125cc à Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Chez NEXA Rentals, la location d’un scooter 125cc commence à 39 € pour la demi-journée. La location de 24 heures coûte 49 €. Des tarifs dégressifs peuvent être disponibles pour les locations de plusieurs jours.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Majorque",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-location-scooter-majorque-125cc"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Scooter 125cc · permis B depuis 3 ans
              </span>
            ...
            <h1>
              Louez un scooter 125cc à Majorque et découvrez l’île librement.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter 125cc à Majorque</strong>, un{" "}
              <strong>scooter 125cc à Majorque</strong> ou une{" "}
              <strong>location de scooter avec permis B à Majorque</strong> ?
              Chez NEXA Rentals, vous réservez votre scooter 125cc en ligne,
              payez en toute sécurité et le récupérez directement à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Les permis A, A1 et A2 sont acceptés. Le permis B est également
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                <strong>Permis B 3 ans</strong>
                <span>Permis voiture accepté</span>
              </div>

              <div>
                <strong>Magaluf</strong>
                <span>Récupération à l’agence</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter 125cc à Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Scooters 125cc pour Magaluf, Palmanova, Santa Ponsa, Palma et Majorque
        </p>

        <div className="nexa-trust-logos">
          <span>Scooter 125cc Majorque</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Scooter 125cc Majorque</span>

            <h2>
              Plus puissant qu’un 50cc et idéal pour découvrir Majorque.
            </h2>

            <p>
              Un scooter 125cc est nettement plus pratique à Majorque qu’un
              petit scooter 50cc. Il offre davantage de stabilité, monte plus
              facilement les routes en pente et permet de rejoindre Palmanova,
              Santa Ponsa, Palma, Paguera, Portals Nous ou Camp de Mar avec plus
              de liberté.
            </p>

            <p>
              NEXA Rentals propose des scooters 125cc comme le Piaggio Liberty
              125 et le SYM Symphony 125. La réservation s’effectue en ligne et
              la récupération standard se fait directement chez NEXA Rentals à
              Magaluf. Deux casques, un top case, un antivol, un support
              téléphone, le kilométrage illimité et l’assurance de base sont
              inclus.
            </p>
          </article>

          <aside className="nexa-info-box">
            <h3>Conditions de permis</h3>

            <ul>
              <li>Le permis A est accepté</li>
              <li>Le permis A1 est accepté</li>
              <li>Le permis A2 est accepté</li>
              <li>Le permis B doit être valide depuis au moins 3 ans</li>
              <li>Le permis de conduire original est obligatoire</li>
              <li>Une carte d’identité ou un passeport est obligatoire</li>
              <li>Les permis provisoires ne sont pas acceptés</li>
              <li>
                Récupération et retour standards chez NEXA Rentals à Magaluf
              </li>
            </ul>
          </aside>
        </div>
      ...
      <section className="nexa-license-section">
        <div className="nexa-license-inner">
          <span className="nexa-section-label">Important avant de réserver</span>

          <h2>Pouvez-vous conduire un scooter 125cc à Majorque ?</h2>

          <div className="nexa-license-grid">
            <div>
              <strong>A / A1 / A2</strong>
              <p>
                Avec un permis A, A1 ou A2, vous pouvez louer un scooter 125cc
                chez NEXA Rentals si votre permis est valide et que vous
                présentez le document original.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Avec un permis B, vous pouvez conduire un scooter 125cc lorsque
                votre permis voiture est valide depuis au moins 3 ans.
              </p>
            </div>

            <div>
              <strong>Non accepté</strong>
              <p>
                Les permis d’apprentissage, permis provisoires, photographies et
                photocopies ne sont pas acceptés. Vous devez présenter
                l’original.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Réservez votre scooter 125cc en trois étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                location. La réservation est rapide et claire.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs qui souhaitent découvrir Majorque librement et
            sans dépendre des bus.
          </h2>

          <p>
            Si vous recherchez « location scooter 125cc Majorque », « louer un
            scooter 125cc à Majorque », « scooter Majorque 125cc » ou « scooter
            125cc Majorque avec permis B », vous avez besoin d’informations
            claires : quels permis sont acceptés, ce qui est inclus et où
            s’effectue la récupération.
          </p>

          <p>
            Chez NEXA Rentals, tout est simple : vous réservez en ligne, payez
            en ligne et récupérez votre scooter directement à Magaluf. Selon la
            zone, la date et l’adresse, une livraison à l’hôtel peut être
            disponible sur demande. Contactez-nous avant de réserver pour
            vérifier la disponibilité.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter 125cc Majorque</span>
            <span>Scooter 125cc Majorque</span>
            <span>Scooter Majorque avec permis B</span>
            <span>Permis B depuis 3 ans</span>
            <span>Piaggio Liberty 125 Majorque</span>
            <span>SYM Symphony 125 Majorque</span>
            <span>Location scooter 125cc Magaluf</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter 125cc à Majorque</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Puis-je louer un scooter 125cc avec un permis B ?</summary>
              <p>
                Oui, si votre permis B est valide depuis au moins 3 ans. Vous
                devez présenter le permis de conduire original lors de la
                récupération.
              </p>
            </details>

            <details>
              <summary>Quels permis NEXA Rentals accepte-t-il ?</summary>
              <p>
                Les permis A, A1 et A2 sont acceptés. Le permis B est accepté
                lorsqu’il est valide depuis au moins 3 ans.
              </p>
            </details>

            <details>
              <summary>
                NEXA Rentals propose-t-il aussi des scooters 50cc ?
              </summary>
              <p>
                Non. NEXA Rentals propose actuellement des scooters 125cc et ne
                propose pas de scooters 50cc.
              </p>
            </details>
          ...
          <div className="nexa-final-cta">
            <h3>Prêt à louer votre scooter 125cc ?</h3>
            <p>
              Réservez votre scooter en ligne et commencez votre aventure chez
      ...
      <style>{`
        ...
        .nexa-final-cta a {
          ...
          box .nexa-bottom-cta,
        .nexa-final-cta a {
-shadow: 0 18px 38px rgba(17, 17, 22, 0.2);
        }
