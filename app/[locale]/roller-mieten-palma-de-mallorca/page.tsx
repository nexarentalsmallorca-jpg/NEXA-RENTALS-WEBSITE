// app/[locale]/roller-mieten-palma-de-mallorca/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Topcase",
    text: "Praktisch für Tasche, Helm oder Shopping.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Handyhalterung",
    text: "Ideal für Navigation durch Palma de Mallorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Schloss",
    text: "Für sichere Stopps in der Stadt, am Hafen oder Hotel.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Palma de Mallorca | 125cc Scooter Hauptstadt | NEXA Rentals",
    description:
      "Roller mieten in Palma de Mallorca. 125cc Scooter online bei NEXA Rentals buchen, in Magaluf abholen und Palma Altstadt, Kathedrale La Seu, Santa Catalina, Paseo Marítimo, Kreuzfahrthafen und Mallorca flexibel entdecken.",
    keywords: [
      "Roller mieten Palma de Mallorca",
      "Scooter mieten Palma de Mallorca",
      "125cc Roller Palma de Mallorca",
      "Motorroller mieten Palma de Mallorca",
      "Roller Verleih Palma de Mallorca",
      "Scooter Rental Palma de Mallorca",
      "Roller mieten Palma Altstadt",
      "Scooter mieten Palma Altstadt",
      "Roller mieten Kathedrale Palma",
      "Roller mieten La Seu Palma",
      "Roller mieten Santa Catalina",
      "Scooter mieten Santa Catalina",
      "Roller mieten Paseo Marítimo",
      "Roller mieten Kreuzfahrthafen Palma",
      "Scooter mieten Hafen Palma",
      "Roller mieten Cala Major",
      "Roller mieten Palma Zentrum",
      "Roller mieten Mallorca Hauptstadt",
      "Roller online buchen Palma de Mallorca",
      "NEXA Rentals Palma de Mallorca",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-palma-de-mallorca`,
    },
    openGraph: {
      title: "Roller mieten Palma de Mallorca | NEXA Rentals",
      description:
        "125cc Roller für Palma de Mallorca, Altstadt, Kathedrale La Seu, Santa Catalina, Paseo Marítimo und Kreuzfahrthafen online buchen. Abholung bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-palma-de-mallorca`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Palma de Mallorca bei NEXA Rentals",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenPalmaDeMallorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich in Palma de Mallorca einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist praktisch für Gäste aus Palma de Mallorca, Palma Altstadt, Santa Catalina, Cala Major, Portixol und Umgebung.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Palma de Mallorca entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Von Palma de Mallorca erreichst du unseren Standort je nach Verkehr ungefähr in 20 bis 25 Minuten mit dem Auto. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Ist ein Roller praktisch für Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Palma Altstadt, Kathedrale La Seu, Santa Catalina, Paseo Marítimo, Kreuzfahrthafen, Cala Major, Portixol und weitere Orte auf Mallorca flexibel verbinden möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung nach Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Palma de Mallorca",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-palma-de-mallorca`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 20–25 Min. von Palma de Mallorca entfernt
              </span>
            ...
            <h1>Roller mieten in Palma de Mallorca und die Hauptstadt frei erleben.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Palma de Mallorca</strong>,{" "}
              <strong>Scooter mieten Palma de Mallorca</strong> oder{" "}
              <strong>125cc Roller Palma de Mallorca</strong>? Bei NEXA Rentals
              buchst du deinen Roller online, bezahlst sicher online und holst
              ihn direkt in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Palma Altstadt, Kathedrale La Seu, Santa Catalina, Paseo
              Marítimo, Kreuzfahrthafen Palma, Cala Major, Portixol und
              Tagesausflüge auf Mallorca. Aktuell Abholung und Rückgabe nur bei
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Palma de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Für Palma de Mallorca, Altstadt, La Seu, Santa Catalina und Kreuzfahrthafen</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Roller Verleih Palma de Mallorca</span>

            <h2>Palma de Mallorca, Altstadt und Küste flexibel verbinden.</h2>

            <p>
              Palma de Mallorca ist perfekt für Altstadt, Shopping, Restaurants,
              Kathedrale La Seu, Santa Catalina, Paseo Marítimo und den Hafen.
              Mit einem 125cc Roller kannst du die Hauptstadt und die Küste
              flexibler erleben, ohne jeden Weg mit Bus, Taxi oder Parkplatzsuche
              zu planen.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Palma de Mallorca, Scooter mieten Palma de Mallorca oder
              Motorroller mieten Palma Zentrum suchen. Du buchst online, bezahlst
              online und holst deinen Roller direkt in Magaluf ab.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Palma de Mallorca und Mallorca</li>
              <li>Online buchen und online bezahlen</li>
              <li>2 Helme inklusive</li>
              <li>Topcase für Tasche, Helm oder Shopping</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Palma de Mallorca zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                schnell, klar und ideal für deinen Mallorca-Urlaub.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Palma de Mallorca, Magaluf, Palmanova oder deine Insel-Tour.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller für Palma de Mallorca buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Für Gäste, die Palma de Mallorca und die Insel unabhängig entdecken
            möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Palma de Mallorca”, “Scooter mieten
            Palma de Mallorca”, “Roller mieten Palma Altstadt”, “Roller mieten
            Kathedrale Palma” oder “Roller mieten Kreuzfahrthafen Palma” suchst,
            brauchst du eine einfache Lösung: online buchen, sicher bezahlen und
            mit einem 125cc Roller flexibel unterwegs sein.
          </p>

          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Palma Altstadt,
            Santa Catalina, Paseo Marítimo, Cala Major, Portixol, Magaluf,
            Palmanova und weiteren Orten auf Mallorca. NEXA Rentals bietet dir
            eine einfache Online-Buchung und Abholung in Magaluf. Aktuell bieten
            wir keinen Lieferservice an, damit Übergabe, Dokumentencheck und
            Rückgabe klar und sicher bleiben.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Roller mieten Palma de Mallorca</span>
            <span>Scooter mieten Palma de Mallorca</span>
            <span>Roller mieten Palma Altstadt</span>
            <span>Roller mieten Kathedrale Palma</span>
            <span>Roller mieten Kreuzfahrthafen Palma</span>
            <span>125cc Roller Palma de Mallorca</span>
            <span>Motorroller mieten Palma Zentrum</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten in Palma de Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Palma de Mallorca buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für Palma de
                Mallorca, Altstadt, Santa Catalina, Cala Major und Portixol.
              </p>
            </details>

            <details>
              <summary>
                Wie weit ist NEXA Rentals von Palma de Mallorca entfernt?
              </summary>
              <p>
                Unser Standort befindet sich in Magaluf. Von Palma de Mallorca
                sind es je nach Verkehr ungefähr 20 bis 25 Minuten mit dem Auto.
            ...
            <details>
              <summary>Gibt es Lieferung nach Palma de Mallorca?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Bereit für Palma de Mallorca?</h3>
            <p>
