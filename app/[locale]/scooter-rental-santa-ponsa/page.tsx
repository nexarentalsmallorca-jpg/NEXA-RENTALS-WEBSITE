// app/[locale]/scooter-rental-santa-ponsa/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal for navigation around Santa Ponsa and nearby areas.",
  },
  {
    image: "/images/ex3.png",
    title: "Security lock",
    text: "For secure stops at the beach, your hotel or a restaurant.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Santa Ponsa | 125cc Scooter Hire | NEXA Rentals",
    description:
      "Scooter rental in Santa Ponsa with NEXA Rentals. Book a 125cc scooter online, collect it in Magaluf and explore Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano and Calvià.",
    keywords: [
      "scooter rental Santa Ponsa",
      "scooter hire Santa Ponsa",
      "125cc scooter Santa Ponsa",
      "motor scooter rental Santa Ponsa",
      "rent a scooter Santa Ponsa",
      "Santa Ponsa scooter rental",
      "scooter rental Nova Santa Ponsa",
      "scooter hire Nova Santa Ponsa",
      "scooter rental Costa de la Calma",
      "scooter hire Costa de la Calma",
      "scooter rental El Toro",
      "scooter hire El Toro",
      "scooter rental Port Adriano",
      "scooter hire Port Adriano",
      "scooter rental Calvià",
      "south west Mallorca scooter rental",
      "south west Mallorca scooter hire",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-santa-ponsa",
    },
    openGraph: {
      title: "Scooter Rental Santa Ponsa | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro and Port Adriano. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-santa-ponsa",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Santa Ponsa with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalSantaPonsaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book your 125cc scooter online with NEXA Rentals and collect it directly from our Magaluf office. It is a practical option if you are staying in Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro or Port Adriano.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf. From Santa Ponsa, our office is around 10–15 minutes away by car, depending on traffic. Standard collection and return take place directly at NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for Santa Ponsa and south-west Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is a practical way to explore Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano, Palmanova, Magaluf and the south-west of Mallorca.",
        },
      },
      {
        "@type": "Question",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental in Santa Ponsa",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Around 10–15 minutes from Santa Ponsa
              </span>
            ...
            <h1>
              Rent a scooter for Santa Ponsa and explore Calvià freely.
            </h1>
            ...
            <p className="nexa-hero-text small">
              Ideal for Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El
              Toro, Port Adriano, Palmanova, Magaluf and coastal routes across
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc scooter rental in Santa Ponsa and south-west Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro and Port
          Adriano
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore Santa Ponsa, Port Adriano and south-west Mallorca more easily.
            </h2>

            <p>
              Santa Ponsa is ideal for the beach, seafront, restaurants, hotels
              and trips towards Nova Santa Ponsa, Costa de la Calma, El Toro,
              Port Adriano, Palmanova and Magaluf. With a 125cc scooter, you can
              travel with greater freedom without waiting for taxis or planning
              around bus services.
            </p>

            <p>
              NEXA Rentals is a practical option for travellers looking for
              scooter rental in Santa Ponsa, scooter hire in Santa Ponsa or a
              motor scooter in south-west Mallorca. Book and pay online, then
              collect your scooter directly from our Magaluf office.
            </p>
          </article>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book your scooter for Santa Ponsa in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                quick, clear and easy to arrange for your stay in Santa Ponsa.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Pay securely online and reserve your scooter for Santa Ponsa, Port
                Adriano, Palmanova or your route around Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                and an ID card or passport. We will explain everything before
                you set off.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Santa Ponsa and south-west Mallorca
            with complete freedom.
          </h2>

          <p>
            When you search for “scooter rental Santa Ponsa”, “scooter hire Santa
            Ponsa”, “125cc scooter Santa Ponsa”, “scooter rental Port Adriano”
            or “scooter rental Costa de la Calma”, you want a simple option:
            online booking, secure payment and a 125cc scooter that gives you
            the freedom to travel around Mallorca.
          </p>

          <p>
            A scooter is particularly practical for travelling between Santa
            Ponsa, Nova Santa Ponsa, Costa de la Calma, El Toro, Port Adriano,
            Palmanova, Magaluf and Paguera. NEXA Rentals offers simple online
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Scooter rental Nova Santa Ponsa</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for Santa Ponsa?</summary>
              <p>
                Yes. You can book your 125cc scooter online with NEXA Rentals and
                collect it directly from our Magaluf office. It is a practical
                option for Santa Ponsa, Nova Santa Ponsa, Costa de la Calma, El
                Toro and Port Adriano.
              </p>
            </details>

            <details>
              <summary>
                How far is NEXA Rentals from Santa Ponsa?
              </summary>
              <p>
                Our office is in Magaluf. From Santa Ponsa, it is around 10–15
            ...
            <details>
              ...
              <p>
                ...
                125cc scooter with a category B car licence if it has been valid
                for at least 3 years. Provisional and learner licences are not
                accepted.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Two helmets, a 50-litre top box, a security lock, a waterproof phone
            ...
            <details>
              <summary>
                Is scooter delivery available in Santa Ponsa?
              </summary>
              <p>
                No. We do not currently provide a scooter delivery service. Standard
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Santa Ponsa?</h3>
            <p>
              Book your 125cc scooter online and start your trip directly from NEXA
              Rentals in Magaluf.
            </p>
