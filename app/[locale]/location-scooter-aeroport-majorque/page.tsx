// app/[locale]/location-scooter-aeroport-majorque/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Top case",
    text: "Pratique pour un sac à dos, un casque ou un sac de plage.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Support téléphone",
    text: "Idéal pour utiliser le GPS après votre arrivée.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-aeroport-majorque";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter aéroport Majorque | Scooter 125cc PMI | NEXA Rentals",
    description:
      "Vous cherchez une location de scooter près de l’aéroport de Majorque ? Réservez votre scooter 125cc en ligne chez NEXA Rentals, puis récupérez-le à Magaluf après votre arrivée. Idéal pour l’aéroport de Palma PMI, Son Sant Joan, Magaluf, Palmanova et le sud-ouest de Majorque.",
    keywords: [
      "location scooter aéroport Majorque",
      "louer scooter aéroport Majorque",
      "location scooter aéroport Palma",
      "louer scooter aéroport Palma",
      "location scooter PMI",
      "scooter 125cc aéroport Majorque",
      "location deux roues aéroport Majorque",
      "location scooter Son Sant Joan",
      "scooter après arrivée Majorque",
      "réserver scooter aéroport Majorque en ligne",
      "location scooter Palma de Majorque aéroport",
      "location scooter Magaluf",
      "location scooter Palmanova",
      "location scooter sud-ouest Majorque",
      "NEXA Rentals aéroport Majorque",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-aeroport-majorque",
    },
    openGraph: {
      title: "Location scooter aéroport Majorque | NEXA Rentals",
      description:
        "Réservez votre scooter 125cc en ligne avant ou après votre vol. Retrait chez NEXA Rentals à Magaluf, à environ 25 à 35 minutes de l’aéroport de Palma PMI.",
      url: "https://www.nexarentals.es/fr/location-scooter-aeroport-majorque",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter près de l’aéroport de Majorque avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterAeroportMajorquePage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter directement à l’aéroport de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals avant ou après votre vol, puis le récupérer dans notre agence à Magaluf. Nous ne proposons pas de retrait directement à l’aéroport.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de l’aéroport de Palma de Majorque ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis l’aéroport de Palma de Majorque PMI, le trajet jusqu’à Magaluf prend généralement entre 25 et 35 minutes en voiture ou en taxi, selon la circulation.",
        },
      },
      {
        "@type": "Question",
        name: "Peut-on réserver le scooter avant le vol ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez choisir vos dates, réserver votre scooter et payer le montant de la location en ligne. Votre scooter 125cc est ainsi confirmé pour les dates sélectionnées.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison du scooter à l’aéroport de Majorque est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Nous ne proposons pas de livraison à l’aéroport. Le retrait et le retour standard s’effectuent directement chez NEXA Rentals à Magaluf. Pour une éventuelle livraison dans une zone hôtelière proche, contactez-nous avant de réserver afin de vérifier la disponibilité.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc près de l’aéroport de Majorque",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Aéroport de Majorque",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-aeroport"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Réservez après votre arrivée · Retrait à Magaluf
              </span>
            ...
            <h1>
              Location de scooter à l’aéroport de Majorque ? Commencez librement
              depuis Magaluf.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à l’aéroport de Majorque</strong>,{" "}
              souhaitez{" "}
              <strong>louer un scooter près de l’aéroport de Palma</strong> ou
              réserver un{" "}
              <strong>scooter 125cc après votre arrivée à PMI</strong> ? Chez
              NEXA Rentals, vous réservez et payez en ligne, puis vous récupérez
              votre scooter directement dans notre agence à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Important : nous ne proposons pas de livraison ni de retrait
              directement à l’aéroport. Vous bénéficiez cependant d’une
              réservation en ligne claire, de tarifs transparents et d’un
              retrait simple chez NEXA Rentals à Magaluf.
            </p>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                <strong>PMI</strong>
                <span>Mobile après votre arrivée</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Location de scooter près de l’aéroport de Palma de Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Idéal après votre arrivée à l’aéroport de Palma de Majorque PMI
        </p>

        <div className="nexa-trust-logos">
          <span>Aéroport de Majorque</span>
          <span>Aéroport PMI</span>
          <span>Aéroport de Palma</span>
          <span>Magaluf</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Un scooter après votre arrivée à Majorque
            </span>

            <h2>Soyez mobile après votre vol, sans recherches compliquées.</h2>

            <p>
              De nombreux voyageurs recherchent dès leur arrivée une location
              de scooter à l’aéroport de Majorque, un scooter près de PMI ou une
              location de deux-roues près de l’aéroport de Palma. L’objectif est
              simple : être rapidement mobile, éviter de dépendre des taxis et
              découvrir Majorque librement.
            </p>

            <p>
              Chez NEXA Rentals, vous réservez votre scooter 125cc en ligne et
              le récupérez à Magaluf. Notre emplacement est particulièrement
              pratique si votre hôtel se trouve à Magaluf, Palmanova, Santa
              Ponsa, Calvià ou dans le sud-ouest de Majorque.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc disponible après votre arrivée à Majorque</li>
              <li>Réservation et paiement en ligne</li>
              <li>Deux casques inclus</li>
              <li>
                Top case pour un sac, un casque ou vos affaires de plage
              </li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            De l’aéroport de Majorque à votre scooter en trois étapes.
          </h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Réservez en ligne à l’avance</h3>
              <p>
                Choisissez votre scooter 125cc, vos dates et la durée de
                location. C’est idéal pour organiser votre mobilité avant même
                votre vol.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Payez le montant de la location en ligne afin de confirmer votre
                scooter pour votre séjour et vos excursions à Majorque.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver mon scooter après l’arrivée
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs qui souhaitent rester indépendants après leur
            vol.
          </h2>

          <p>
            Lorsque vous recherchez « location scooter aéroport Majorque », «
            louer un scooter aéroport Palma », « location scooter PMI », «
            scooter 125cc aéroport Majorque » ou « location de deux-roues après
            l’arrivée », vous souhaitez probablement être mobile rapidement dès
            le début de votre séjour.
          </p>

          <p>
            Notre agence est particulièrement pratique si vous séjournez dans le
            sud-ouest de Majorque : Magaluf, Palmanova, Santa Ponsa, Calvià,
            Port Adriano ou El Toro. Nous ne proposons pas de livraison à
            l’aéroport, afin que la remise du scooter, les explications, le
            contrôle des documents et le retour soient effectués correctement
            dans notre agence.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter aéroport Majorque</span>
            <span>Location scooter aéroport Palma</span>
            <span>Scooter 125cc PMI</span>
            <span>Scooter après l’arrivée</span>
            <span>Scooter aéroport Palma PMI</span>
            <span>Deux-roues aéroport Majorque</span>
            <span>Réserver scooter Majorque en ligne</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>
            Questions sur la location de scooter près de l’aéroport de Majorque
          </h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Peut-on récupérer un scooter directement à l’aéroport de
                Majorque ?
              </summary>
              <p>
                Non. Vous pouvez réserver votre scooter en ligne chez NEXA
                Rentals et le récupérer directement dans notre agence à
                Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de l’aéroport de
                Palma ?
              </summary>
              <p>
                Notre agence se trouve à Magaluf. Depuis l’aéroport de Palma de
                Majorque PMI, le trajet prend généralement entre 25 et 35
                minutes en voiture ou en taxi, selon la circulation.
              </p>
            </details>

            <details>
              <summary>Peut-on réserver le scooter avant le vol ?</summary>
              <p>
                Oui. Vous pouvez choisir en ligne les dates, la durée et le
                scooter, puis payer le montant de la location en ligne. Votre
                scooter est ainsi confirmé.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Vous devez posséder un permis A, A1 ou A2. Avec un permis voiture
                B, vous pouvez conduire un scooter 125cc si votre permis est
                valide depuis au moins 3 ans. Les permis provisoires et
            ...
            <details>
              <summary>
                La livraison à l’aéroport ou à l’hôtel est-elle disponible ?
              </summary>
              <p>
                Nous ne proposons pas de livraison à l’aéroport. Le retrait et
                le retour standard s’effectuent directement chez NEXA Rentals à
                Magaluf. Pour une livraison éventuelle dans une zone hôtelière
                proche, contactez-nous avant de réserver.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Prêt à être mobile après votre vol ?</h3>
            <p>
              Réservez votre scooter 125cc en ligne et commencez votre séjour
              directement depuis NEXA Rentals à Magaluf.
            </p>
