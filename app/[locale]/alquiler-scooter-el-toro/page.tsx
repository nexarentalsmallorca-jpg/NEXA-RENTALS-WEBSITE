// app/[locale]/alquiler-scooter-el-toro/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Espacio práctico para lo necesario en la playa, una bolsa o compras.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Soporte impermeable para móvil",
    text: "Perfecto para orientarte entre El Toro, Magaluf y Calvià.",
  },
  {
    image: "/images/ex3.png",
    title: "Candado de seguridad",
    text: "Para estacionar con más tranquilidad en el puerto, la playa, el hotel o un restaurante.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  ...
  if (languageCode === "es") {
    return "/es/alquiler-scooter-el-toro";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en El Toro | 125 cc | NEXA Rentals",
    description:
      "Alquiler de scooter en El Toro, Mallorca. Reserva online un scooter de 125 cc con NEXA Rentals, recógelo en Magaluf y descubre El Toro, Port Adriano, Santa Ponsa, Palmanova y Calvià con libertad. A unos 20 minutos de El Toro.",
    keywords: [
      "alquiler scooter El Toro",
      "alquiler de scooters El Toro",
      "alquilar scooter El Toro",
      "scooter 125cc El Toro",
      "alquiler moto scooter El Toro",
      "scooter de alquiler El Toro",
      "El Toro alquiler scooter",
      "El Toro alquiler de scooters",
      "alquiler scooter El Toro Mallorca",
      "scooter 125cc El Toro Mallorca",
      ...
      "reservar scooter online El Toro",
      "scooter El Toro Mallorca",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/es/alquiler-scooter-el-toro",
    },
    openGraph: {
      title: "Alquiler de scooter en El Toro | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para El Toro y Port Adriano. Recogida en NEXA Rentals, Magaluf, a unos 20 minutos de El Toro.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-el-toro",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en El Toro con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalElToroPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo en nuestra oficina de Magaluf. Nuestra oficina está a unos 20 minutos de El Toro y es una opción práctica para quienes se alojan en El Toro, Port Adriano, Santa Ponsa y Calvià.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals está en Magaluf, a unos 20 minutos en coche de El Toro. La recogida y la devolución habituales del scooter se realizan en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Puedo reservar un scooter para Port Adriano y El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es ideal para descubrir El Toro, Port Adriano, Santa Ponsa, Magaluf, Palmanova y Calvià con libertad.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Qué incluye el alquiler del scooter para El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en El Toro",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
        ...
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <div className="nexa-hero-kicker">
              A unos 20 minutos de El Toro
            </div>

            <h1>
              Alquila un scooter para El Toro y descubre Mallorca con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en El Toro</strong>,{" "}
              <strong>alquilar un scooter en El Toro</strong> o un{" "}
              <strong>scooter de 125 cc en El Toro, Mallorca</strong>? Con NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal para quienes se alojan en El Toro, Port Adriano, Santa
              Ponsa, Calvià, Magaluf y Palmanova. Llega fácilmente al puerto,
              las playas, restaurantes y miradores, o comienza una excursión
              sin depender de taxis ni sufrir largas esperas.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en El Toro y Port Adriano"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Ideal para quienes se alojan en El Toro, Port Adriano, Santa Ponsa y
          Calvià
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en El Toro
            </span>

            <h2>
              La forma más cómoda de moverte por El Toro y sus alrededores.
            </h2>

            <p>
              El Toro y Port Adriano son lugares ideales para disfrutar de
              Mallorca de una forma tranquila, exclusiva y flexible. Con un
              scooter de 125 cc puedes llegar a playas, restaurantes, miradores
              y destinos como Santa Ponsa, Magaluf, Palmanova y Calvià mucho
              más fácilmente que en taxi o autobús.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes se alojan en El
              Toro. Puedes reservar online y recoger tu scooter en nuestra
              oficina de Magaluf, a unos 20 minutos de El Toro. Reserva tu
              scooter online y empieza a descubrir Mallorca de inmediato.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para El Toro y Port Adriano</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva un scooter para El Toro en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Toro, Port Adriano, Santa Ponsa o las excursiones que hayas
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva un scooter para El Toro
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooters en El Toro
          </span>

          <h2>
            Para viajeros que quieren descubrir El Toro, Port Adriano y el
            suroeste de Mallorca con libertad.
          </h2>

          <p>
            Si buscas “alquiler scooter El Toro”, “alquiler de scooters El
            Toro”, “scooter 125 cc El Toro”, “alquilar scooter El Toro” o
            “alquiler scooter El Toro Mallorca”, necesitas una solución
            sencilla: reserva online, pago seguro, recogida clara y un scooter
            que te dé total libertad.
          </p>

          <p>
            El Toro está cerca de Port Adriano y Santa Ponsa. Un scooter resulta
            especialmente útil en esta zona si no quieres pedir un taxi cada
            vez ni esperar al transporte público. NEXA Rentals ofrece una
            reserva online sencilla, servicios transparentes y recogida en
            nuestra oficina de Magaluf, a unos 20 minutos de El Toro.
            Actualmente no ofrecemos servicio de entrega de scooters.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter El Toro</span>
            <span>Alquiler de scooters El Toro</span>
            <span>Scooter 125 cc El Toro</span>
            <span>Alquiler scooter Port Adriano</span>
            <span>Alquilar scooter El Toro</span>
            <span>Alquiler moto scooter El Toro</span>
            <span>Alquiler scooter El Toro Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en El Toro</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para El Toro?</summary>
              <p>
                Sí. Puedes reservar online un scooter con NEXA Rentals y
                recogerlo directamente en Magaluf. Es una opción práctica para
                El Toro, Port Adriano, Santa Ponsa y Calvià.
              </p>
            </details>

            <details>
              <summary>¿A qué distancia está NEXA Rentals de El Toro?</summary>
              <p>
                Nuestra oficina está en Magaluf, a unos 20 minutos de El Toro.
            ...
            <details>
              <summary>¿Hay servicio de entrega en El Toro?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Listo para descubrir El Toro?</h3>
            <p>
