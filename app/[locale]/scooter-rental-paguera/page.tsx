...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Paguera | 125cc Scooter Hire Peguera | NEXA Rentals Mallorca",
    description:
      "Scooter rental in Paguera, Peguera and south-west Mallorca. Book a 125cc scooter online with NEXA Rentals, collect it in Magaluf and explore Paguera, Cala Fornells, Camp de Mar, Santa Ponsa and Port d’Andratx freely.",
    keywords: [
      "scooter rental Paguera",
      "scooter hire Paguera",
      "125cc scooter Paguera",
      "motor scooter rental Paguera",
      "rent a scooter Paguera",
      "scooter rental Paguera",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-paguera",
    },
    openGraph: {
      title: "Scooter Rental Paguera | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter online for Paguera, Peguera, Cala Fornells, Camp de Mar and south-west Mallorca. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-paguera",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental in Paguera with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalPagueraPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book a 125cc scooter online with NEXA Rentals and collect it directly in Magaluf. It is a practical option for guests staying in Paguera, Peguera, Cala Fornells, Camp de Mar and Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals is located in Magaluf. From Paguera, you can reach our office in around 20–25 minutes by car, depending on traffic. Standard collection and return take place directly at NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Is a scooter practical for Paguera and south-west Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is practical for exploring Paguera, Cala Fornells, Camp de Mar, Santa Ponsa, Port d’Andratx, Andratx and south-west Mallorca freely.",
        },
      },
      {
        "@type": "Question",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental for Paguera",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Around 20–25 minutes from Paguera
              </span>
            ...
            <h1>
              Rent a scooter for Paguera and explore south-west Mallorca freely.
            </h1>
            ...
            <p className="nexa-hero-text">
              ...
              scooter directly in Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal for Paguera, Peguera, Cala Fornells, Camp de Mar, Santa
              Ponsa, Port d’Andratx and beautiful coastal routes around
              south-west Mallorca. Perfect for reaching beaches, ports and
              restaurants with greater freedom.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter hire in Paguera and south-west Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For Paguera, Peguera, Cala Fornells, Camp de Mar and Santa Ponsa
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore Paguera, Cala Fornells and Camp de Mar more easily.
            </h2>

            <p>
              Paguera is ideal for beaches, restaurants, seafront walks and
              trips around south-west Mallorca. With a 125cc scooter, you can
              reach places such as Cala Fornells, Camp de Mar, Santa Ponsa,
              Port d’Andratx, Andratx, Magaluf and Palmanova more easily.
            </p>

            <p>
              NEXA Rentals is a practical choice for travellers looking for
              scooter rental in Paguera, scooter hire in Peguera or a motor
              scooter in south-west Mallorca. You book online, pay online and
              collect your scooter directly in Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Paguera and south-west Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book a scooter for Paguera in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Paguera, Cala Fornells, Camp de Mar or your planned route around
                Mallorca.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Paguera and south-west Mallorca
            with complete freedom.
          </h2>

          <p>
            When you search for “scooter rental Paguera”, “scooter hire
            Paguera”, “scooter rental Peguera”, “125cc scooter Paguera” or
            “scooter rental south-west Mallorca”, you need a simple solution:
            online booking, secure payment and a 125cc scooter that gives you
            the freedom to explore.
          </p>

          <p>
            A scooter is particularly practical for travelling between
            Paguera, Cala Fornells, Camp de Mar, Santa Ponsa, Port d’Andratx,
            Andratx, Magaluf and Palmanova. NEXA Rentals offers straightforward
        ...
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              ...
              <p>
                Our office is located in Magaluf. From Paguera, you can reach us
                in around 20–25 minutes by car, depending on traffic. Standard
            ...
            <details>
              <summary>Is delivery available in Paguera?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Paguera?</h3>
            <p>
