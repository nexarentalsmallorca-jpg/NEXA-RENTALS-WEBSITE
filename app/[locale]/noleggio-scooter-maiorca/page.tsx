...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Spazio pratico per spiaggia, borse e acquisti.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Portacellulare impermeabile",
    text: "Ideale per orientarsi a Maiorca.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "it") {
    return "/it/noleggio-scooter-maiorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Maiorca | Scooter 125cc a Magaluf | NEXA Rentals",
    description:
      "Noleggio scooter a Maiorca con NEXA Rentals a Magaluf. Prenota online scooter 125cc Piaggio e SYM da 39€ per mezza giornata, con 2 caschi, bauletto, lucchetto, portacellulare, chilometri illimitati e assicurazione di base inclusi.",
    keywords: [
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-maiorca",
    },
    openGraph: {
      title: "Noleggio scooter Maiorca | NEXA Rentals Magaluf",
      description:
        "Prenota online uno scooter 125cc a Maiorca. Ritiro e riconsegna presso NEXA Rentals a Magaluf; consegna in hotel disponibile solo su richiesta e previa conferma.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-maiorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Maiorca con NEXA Rentals a Magaluf",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterMaiorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Dove posso noleggiare uno scooter a Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Puoi prenotare online uno scooter 125cc con NEXA Rentals e ritirarlo direttamente presso il nostro ufficio di Magaluf. Il ritiro e la riconsegna standard avvengono presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Posso pagare online il noleggio dello scooter a Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Con NEXA Rentals puoi prenotare lo scooter online e pagare online il prezzo del noleggio, così il tuo scooter 125cc resta riservato per le date selezionate.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Cosa è incluso nel noleggio scooter a Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna dello scooter in hotel?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Il ritiro e la riconsegna standard avvengono presso il nostro ufficio di Magaluf. La consegna in hotel può essere disponibile su richiesta per alcune zone vicine, in base alla località, alla data e all’indirizzo. Contatta NEXA Rentals prima di prenotare per verificarne la disponibilità.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Maiorca",
      priceCurrency: "EUR",
      price: "39",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Noleggio scooter a Maiorca: prenota online il tuo 125cc.</h1>

            <p className="nexa-hero-text">
              Cerchi un servizio di{" "}
              <strong>noleggio scooter a Maiorca</strong>, uno{" "}
              <strong>scooter 125cc a Maiorca</strong> o un{" "}
              <strong>motorino a noleggio a Maiorca</strong>? Con NEXA Rentals
              prenoti online, paghi direttamente il noleggio e ritiri facilmente
              il tuo scooter 125cc presso il nostro ufficio di Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideale per Magaluf, Palmanova, Palma Nova, Santa Ponsa, Paguera,
              Calvià, giornate in spiaggia, punti panoramici, ristoranti ed
              escursioni libere senza dipendere da taxi o autobus.
            </p>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Direttamente a Magaluf, Maiorca.</strong>
                <span>
                  NEXA Rentals si trova a Magaluf: prenota online, ritira lo
                  scooter in sede e parti subito verso la spiaggia, Palmanova,
                  Santa Ponsa o Paguera.
                </span>
              </div>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Prenota online e ritira in sede</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter 125cc a Maiorca con NEXA Rentals"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Scelto dai viaggiatori che vogliono esplorare Maiorca in libertà</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Il modo semplice per noleggiare uno scooter a Maiorca.</h2>

            <p>
              Molti viaggiatori scelgono uno scooter o un motorino a Maiorca per
              non dipendere ogni giorno da taxi, autobus o lunghe attese. Con
              NEXA Rentals è semplice: prenoti online il tuo scooter 125cc, paghi
              online e lo ritiri direttamente presso il nostro ufficio di
              Magaluf.
            </p>

            <p>
              I nostri scooter sono perfetti per brevi spostamenti, giornate in
              spiaggia ed escursioni tra Magaluf, Palmanova, Palma Nova, Portals
              Nous, Santa Ponsa, Paguera e Calvià. Sali, parti e scopri Maiorca
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              ...
              <li>Ritiro diretto a Magaluf</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Il tuo scooter a Maiorca in pochi passaggi.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                Scegli il tuo scooter 125cc, la data e la durata del noleggio. La
                prenotazione è rapida, chiara e pensata per chi visita Maiorca.
              </p>
            </div>
            ...
            <div>
              ...
              <h3>Paga online</h3>
              <p>
                Paghi online il prezzo del noleggio e riservi lo scooter per le
                date del tuo viaggio. In questo modo il veicolo è confermato
                prima dell’inizio della tua giornata a Maiorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                carta d’identità o passaporto. Ti spieghiamo tutto e puoi partire
                subito verso la spiaggia, Palmanova, Santa Ponsa o Paguera.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora il tuo scooter a Maiorca
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Noleggio scooter Maiorca</span>

          <h2>
            Per chi vuole scoprire Maiorca in libertà e con la massima
            flessibilità.
          </h2>

          <p>
            Quando cerchi su Google “noleggio scooter Maiorca”, “affitto scooter
            Maiorca”, “scooter a noleggio Maiorca”, “noleggio motorino Maiorca”
            o “scooter 125cc Maiorca”, desideri una soluzione semplice e veloce.
            NEXA Rentals offre informazioni chiare, prenotazione online,
            pagamento sicuro e uno scooter con cui esplorare Maiorca in completa
            libertà.
          </p>

          <p>
            Questa pagina è particolarmente utile se soggiorni a Magaluf,
            Palmanova, Palma Nova, Santa Ponsa, Paguera, Portals Nous o nel
            sud-ovest di Maiorca. Il ritiro e la riconsegna standard avvengono
            presso NEXA Rentals a Magaluf. La consegna in hotel può essere
            disponibile su richiesta per alcune zone vicine, in base alla
            località, alla data e all’indirizzo: contattaci prima di prenotare
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            <details>
              <summary>Quale patente serve per uno scooter 125cc?</summary>
              <p>
                Sono accettate le patenti A, A1 e A2. Puoi guidare uno scooter
                125cc anche con la patente B, purché sia valida da almeno 3 anni.
                Non sono accettate patenti provvisorie o da allievo conducente.
              </p>
            </details>

            <details>
              <summary>Dove ritiro lo scooter?</summary>
              <p>
                Il ritiro e la riconsegna standard avvengono presso NEXA Rentals
                a Magaluf. La consegna in hotel può essere disponibile su
                richiesta per alcune zone vicine. Contattaci prima di prenotare
                per verificare la disponibilità per la tua località, data e
                indirizzo.
              </p>
            </details>

            <details>
              <summary>Posso pagare lo scooter online?</summary>
              <p>
                Sì. Prenoti online e paghi online il prezzo del noleggio, così lo
                scooter resta riservato per le date selezionate.
              </p>
            </details>
            ...
            <details>
              <summary>NEXA Rentals è comoda per Magaluf e Palmanova?</summary>
              <p>
                Sì. La nostra sede di Magaluf è ideale se soggiorni a Magaluf,
                Palmanova, Palma Nova, Santa Ponsa, Paguera o Calvià e desideri
                noleggiare uno scooter a Maiorca.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            ...
            <div className="nexa-final-cta-actions">
              <Link href={bookHref}>Prenota lo scooter</Link>
              <a href={mapsHref} target="_blank" rel="noreferrer">
                Apri in Maps
              </a>
            </div>
