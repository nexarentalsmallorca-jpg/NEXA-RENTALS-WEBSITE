...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Spazio pratico per borsa da spiaggia, casco e acquisti.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Portacellulare impermeabile",
    text: "Ideale per navigare da Santa Ponsa in tutta Maiorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Lucchetto",
    text: "Per soste sicure in spiaggia, in hotel o nei punti panoramici.",
  },
  {
    image: "/images/ex5.png",
    title: "Assicurazione",
    text: "L’assicurazione di base è inclusa.",
  },
];
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter a noleggio Santa Ponsa | Noleggio scooter Santa Ponsa Maiorca | NEXA Rentals",
    description:
      "Noleggio scooter a Santa Ponsa, Maiorca: prenota online uno scooter 125cc da 39€ con NEXA Rentals, paga online e ritiralo a Magaluf. A circa 10 minuti da Santa Ponsa. Ideale per Santa Ponsa, Costa de la Calma, El Toro, Port Adriano e il sud-ovest di Maiorca.",
    keywords: [
      "scooter a noleggio Santa Ponsa",
      "noleggio scooter Santa Ponsa",
      "noleggio scooter Santa Ponsa Maiorca",
      "affitto scooter Santa Ponsa",
      "noleggio motorino Santa Ponsa",
      "scooter 125cc Santa Ponsa",
      "scooter 125cc Santa Ponsa Maiorca",
      "scooter a noleggio Santa Ponsa Maiorca",
      "prenotare scooter Santa Ponsa online",
      "noleggio scooter Costa de la Calma",
      "noleggio scooter El Toro",
      "noleggio scooter Port Adriano",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/scooter-a-noleggio-santa-ponsa",
    },
    openGraph: {
      title:
        "Scooter a noleggio Santa Ponsa | Noleggio scooter con NEXA Rentals",
      description:
        "Prenota online uno scooter 125cc per Santa Ponsa e il sud-ovest di Maiorca. A circa 10 minuti da Santa Ponsa. Ritiro e riconsegna presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/scooter-a-noleggio-santa-ponsa",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter a noleggio a Santa Ponsa, Maiorca, con NEXA Rentals",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function ScooterANoleggioSantaPonsaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Dove posso noleggiare uno scooter a Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo presso il nostro ufficio a Magaluf. NEXA Rentals si trova a circa 10 minuti da Santa Ponsa ed è ideale per chi soggiorna a Santa Ponsa, Costa de la Calma, El Toro, Port Adriano o Paguera.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf, a circa 10 minuti da Santa Ponsa in auto o taxi. Il ritiro e la riconsegna avvengono direttamente presso l’ufficio di NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "È disponibile la consegna dello scooter a Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Al momento non offriamo un servizio di consegna a Santa Ponsa. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf, così la consegna del veicolo rimane veloce, sicura e chiara.",
        },
      },
      {
        "@type": "Question",
        name: "Posso pagare online il noleggio dello scooter per Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online il tuo scooter e pagare online il prezzo del noleggio. In questo modo il tuo scooter 125cc viene riservato per le date selezionate.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sono accettate le patenti A, A1 e A2. Puoi guidare uno scooter 125cc anche con la patente B, purché sia valida da almeno 3 anni. Patenti provvisorie e fogli rosa non sono accettati.",
        },
      },
      {
        "@type": "Question",
        name: "Cosa è incluso nel noleggio scooter a Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Santa Ponsa, Maiorca",
      price: "39",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Santa Ponsa, Maiorca",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Scooter a noleggio a Santa Ponsa: noleggia un 125cc per esplorare
              Maiorca.
            </h1>

            <p className="nexa-hero-text">
              Cerchi uno <strong>scooter a noleggio a Santa Ponsa</strong>, un{" "}
              <strong>noleggio scooter a Santa Ponsa</strong> o uno{" "}
              <strong>scooter 125cc a Santa Ponsa, Maiorca</strong>? Con NEXA
              Rentals prenoti online il tuo scooter, paghi direttamente online
              e ritiri comodamente il tuo 125cc a Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideale per chi soggiorna a Santa Ponsa, Costa de la Calma, El
              Toro, Port Adriano, Paguera e nel sud-ovest di Maiorca e vuole
              visitare spiagge, ristoranti, punti panoramici e altre località
              senza dipendere dai taxi.
            </p>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>A circa 10 minuti da Santa Ponsa.</strong>
                <span>
                  NEXA Rentals si trova a Magaluf: prenota online, ritira lo
                  scooter a Magaluf e parti direttamente verso Santa Ponsa,
                  Costa de la Calma o Port Adriano.
                </span>
              </div>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Prenota online e ritira a Magaluf</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Santa Ponsa e nel sud-ovest di Maiorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Scelto dai viaggiatori italiani che soggiornano nel sud-ovest di
          Maiorca
        </p>

        <div className="nexa-trust-logos">
          <span>Scooter a noleggio Santa Ponsa</span>
          <span>Noleggio scooter Santa Ponsa</span>
          <span>10 min da Santa Ponsa</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Perché scegliere NEXA Rentals?
            </span>

            <h2>
              Noleggia uno scooter vicino a Santa Ponsa con una semplice
              prenotazione online.
            </h2>

            <p>
              Molti viaggiatori che soggiornano a Santa Ponsa cercano un
              servizio affidabile di noleggio scooter a Maiorca per non dover
              dipendere ogni giorno da taxi, autobus o lunghe attese. Con NEXA
              Rentals è tutto più semplice: prenoti online il tuo scooter 125cc,
              paghi online e lo ritiri direttamente presso il nostro ufficio a
              Magaluf.
            </p>

            <p>
              NEXA Rentals si trova a circa 10 minuti da Santa Ponsa ed è quindi
              una soluzione pratica per chi soggiorna a Santa Ponsa, Costa de
              la Calma, El Toro, Port Adriano, Paguera, Palmanova, Magaluf e
              Calvià. Puoi esplorare spiagge, calette, ristoranti e punti
              panoramici seguendo i tuoi ritmi e organizzare la tua vacanza a
              Maiorca con maggiore libertà.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Santa Ponsa e Maiorca</li>
              <li>A circa 10 minuti da Santa Ponsa</li>
              <li>Prenotazione e pagamento online</li>
              <li>Due caschi inclusi</li>
              <li>
                Bauletto da 50 litri per borsa da spiaggia, casco o acquisti
              </li>
              <li>Portacellulare impermeabile per la navigazione</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota in pochi passaggi il tuo scooter per Santa Ponsa.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                noleggio. La prenotazione è veloce, chiara e ideale per chi
                soggiorna a Santa Ponsa e nelle località vicine.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                le date della tua vacanza. In questo modo il veicolo sarà
                confermato prima dell’inizio della giornata.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Presentati da NEXA Rentals a Magaluf con la patente originale e
                una carta d’identità o un passaporto. La nostra sede si trova a
                circa 10 minuti da Santa Ponsa. Ti spiegheremo tutto e potrai
                partire subito verso Santa Ponsa, la spiaggia o il tuo
                itinerario.
              </p>
            </div>
          </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora lo scooter per Santa Ponsa
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per i viaggiatori italiani che vogliono esplorare Santa Ponsa e
            Maiorca in completa libertà.
          </h2>

          <p>
            Quando cerchi su Google “scooter a noleggio Santa Ponsa”, “noleggio
            scooter Santa Ponsa”, “noleggio motorino Santa Ponsa”, “affitto
            scooter Santa Ponsa” o “scooter 125cc Santa Ponsa Maiorca”,
            probabilmente non vuoi una procedura complicata, ma una soluzione
            veloce. NEXA Rentals offre informazioni chiare, prenotazione online,
            pagamento sicuro e uno scooter con cui esplorare Maiorca
            liberamente.
          </p>

          <p>
            Questa pagina è particolarmente utile per chi soggiorna a Santa
            Ponsa, Costa de la Calma, El Toro, Port Adriano, Paguera o nel
            sud-ovest di Maiorca. NEXA Rentals si trova a Magaluf, a circa 10
            minuti da Santa Ponsa. Al momento non offriamo la consegna a Santa
            Ponsa: il ritiro e la riconsegna avvengono direttamente presso NEXA
            Rentals a Magaluf. In questo modo la consegna del veicolo rimane
            personale, veloce e ben organizzata.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Noleggio motorino Santa Ponsa</span>
            <span>Affitto scooter Santa Ponsa</span>
            <span>Noleggio scooter Costa de la Calma</span>
            <span>Noleggio scooter Port Adriano</span>
            <span>10 minuti da Santa Ponsa</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a Santa Ponsa</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>Quanto dista NEXA Rentals da Santa Ponsa?</summary>
              <p>
                NEXA Rentals si trova a Magaluf, a circa 10 minuti da Santa
                Ponsa. Puoi prenotare online, ritirare lo scooter a Magaluf e
                partire direttamente verso Santa Ponsa, Costa de la Calma, El
                Toro o Port Adriano.
              </p>
            </details>
            ...
            <details>
              <summary>
                Posso ricevere lo scooter direttamente a Santa Ponsa?
              </summary>
              <p>
                Al momento non offriamo un servizio di consegna a Santa Ponsa.
                Il ritiro e la riconsegna avvengono direttamente presso NEXA
                Rentals a Magaluf. In questo modo la consegna del veicolo rimane
                più veloce, chiara e sicura.
              </p>
            </details>

            <details>
              <summary>Posso pagare online lo scooter?</summary>
              <p>
                Sì. Puoi prenotare online e pagare online il prezzo del
                noleggio, così il tuo scooter viene riservato per le date
                selezionate.
              </p>
            </details>
            ...
            <details>
              <summary>
                NEXA Rentals è una buona soluzione per Santa Ponsa, El Toro e
                Port Adriano?
              </summary>
              <p>
                Sì. NEXA Rentals è ideale se soggiorni a Santa Ponsa, Costa de
                la Calma, El Toro, Port Adriano, Paguera, Magaluf o Palmanova e
                vuoi noleggiare uno scooter 125cc a Maiorca.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Santa Ponsa e Maiorca?</h3>
            <p>
              Prenota online il tuo scooter 125cc e parti direttamente da NEXA
              Rentals a Magaluf, a circa 10 minuti da Santa Ponsa.
            </p>
