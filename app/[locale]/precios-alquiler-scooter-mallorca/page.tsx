// app/[locale]/precios-alquiler-scooter-mallorca/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Espacio práctico para una bolsa, un casco o lo necesario para la playa.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Soporte impermeable para móvil",
    text: "Ideal para orientarte y recorrer Mallorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Candado de seguridad",
    text: "Para estacionar con más tranquilidad en el hotel, la playa o un restaurante.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  ...
  if (languageCode === "es") {
    return "/es/precios-alquiler-scooter-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Precios de alquiler de scooter en Mallorca | Desde 39 € | NEXA Rentals",
    description:
      "Precios de alquiler de scooter en Mallorca: scooters de 125 cc desde 39 € por media jornada y 49 € por 24 horas. Reserva online con NEXA Rentals y recógelo en Magaluf. Dos cascos, baúl, candado, soporte para móvil y kilómetros ilimitados incluidos.",
    keywords: [
      "precios alquiler scooter Mallorca",
      "precio alquiler scooter Mallorca",
      "tarifas alquiler scooter Mallorca",
      "cuánto cuesta alquilar scooter Mallorca",
      "alquiler scooter Mallorca desde 39 euros",
      "alquiler scooter Mallorca 39€",
      "alquiler scooter Mallorca 49€",
      "precios scooter 125cc Mallorca",
      "alquiler scooter 125cc Mallorca",
      "precio alquiler moto scooter Mallorca",
      "alquiler scooter barato Mallorca",
      "alquiler scooter económico Mallorca",
      "precios alquiler scooter Magaluf",
      "tarifas scooter Magaluf",
      "ofertas alquiler scooter Mallorca",
      "fianza alquiler scooter Mallorca",
      "depósito scooter Mallorca",
      "alquiler scooter todo incluido Mallorca",
      "alquiler scooter Mallorca sin costes ocultos",
      "precios NEXA Rentals",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/precios-alquiler-scooter-mallorca",
    },
    openGraph: {
      title: "Precios de alquiler de scooter en Mallorca | NEXA Rentals",
      description:
        "Scooters de 125 cc desde 39 € por media jornada y 49 € por 24 horas. Dos cascos, baúl, candado, soporte para móvil y kilómetros ilimitados incluidos.",
      url: "https://www.nexarentals.es/es/precios-alquiler-scooter-mallorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Precios de alquiler de scooter en Mallorca con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalMallorcaPricesPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Cuánto cuesta alquilar un scooter en Mallorca con NEXA Rentals?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Con NEXA Rentals, un scooter de 125 cc cuesta desde 39 € por media jornada. El alquiler de 24 horas cuesta 49 €. También ofrecemos tarifas diarias reducidas para alquileres de varios días.",
        },
      },
      {
        "@type": "Question",
        name: "¿Qué incluye el precio del alquiler del scooter?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "El precio incluye dos cascos, un baúl de 50 litros, candado de seguridad, soporte impermeable para móvil, kilómetros ilimitados y seguro básico.",
        },
      },
      {
        "@type": "Question",
        name: "¿Hay que dejar una fianza para alquilar un scooter en Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. En NEXA Rentals, la fianza es de 150 € por scooter. La fianza se devuelve después de entregar el scooter correctamente.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. Los principales extras, incluidos dos cascos, baúl, candado de seguridad, soporte impermeable para móvil, kilómetros ilimitados y seguro básico, están incluidos. La fianza de 150 € se abona por separado y se devuelve después de entregar el scooter correctamente.",
        },
      },
      {
        "@type": "Question",
        name: "¿Dónde recojo el scooter?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "La recogida y la devolución se realizan directamente en NEXA Rentals, C. Galeón, 13, Loc 57, 07181 Magaluf. Actualmente no ofrecemos servicio de entrega de scooters.",
        },
      },
      {
        "@type": "Question",
        name: "¿Qué permiso de conducir necesito para un scooter de 125 cc?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aceptamos los permisos de moto A, A1 y A2. También puedes conducir un scooter de 125 cc con un permiso de coche de categoría B si tiene una antigüedad mínima de 3 años.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: [
      {
        "@type": "Offer",
        name: "Alquiler de scooter de 125 cc por media jornada",
        price: "39",
        priceCurrency: "EUR",
      ...
      {
        "@type": "Offer",
        name: "Alquiler de scooter de 125 cc durante 24 horas",
        price: "49",
        priceCurrency: "EUR",
        availability: "https://schema.org/InStock",
        areaServed: "Mallorca",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Scooters de 125 cc desde 39 € · todo incluido
              </span>
            ...
            <h1>
              Precios de alquiler de scooter en Mallorca: claros, sencillos y
              económicos.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas los{" "}
              <strong>precios de alquiler de scooter en Mallorca</strong>, un{" "}
              <strong>alquiler de scooter económico en Mallorca</strong> o un{" "}
              <strong>scooter de 125 cc desde 39 €</strong>? Con NEXA Rentals
              tienes tarifas transparentes, reserva online sencilla y recogida
              directa en nuestra oficina de Magaluf.
            </p>

            <p className="nexa-hero-text small">
              La media jornada cuesta desde 39 € y el alquiler de 24 horas,
              49 €. El precio incluye dos cascos, un baúl de 50 litros, candado
              de seguridad, soporte impermeable para móvil, kilómetros
              ilimitados y seguro básico. La fianza es de 150 € por scooter y
              se devuelve después de entregarlo correctamente.
            </p>

            <div className="nexa-hero-actions">
              <Link href={bookHref} className="nexa-primary-cta">
                Consulta precios y reserva
              </Link>
            ...
            <div className="nexa-hero-points">
              <div>
                <strong>€39</strong>
                <span>Media jornada hasta las 20:00</span>
              </div>

              <div>
                <strong>€49</strong>
                <span>Alquiler de scooter durante 24 horas</span>
              </div>

              <div>
                <strong>€150</strong>
                <span>Fianza por scooter</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter de 125 cc en Mallorca desde 39 euros"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Precios transparentes de alquiler de scooter en Mallorca y Magaluf</p>

        <div className="nexa-trust-logos">
          <span>desde 39 €</span>
          <span>24 horas 49 €</span>
          <span>todo incluido</span>
          <span>scooters de 125 cc</span>
          <span>fianza de 150 €</span>
        </div>
      </section>

      <section className="nexa-price-section">
        <div className="nexa-price-inner">
          <span className="nexa-section-label">Precios</span>

          <h2>Tarifas claras y sin condiciones complicadas.</h2>

          <div className="nexa-price-grid">
            <div className="nexa-price-card">
              <span className="nexa-price-badge">Media jornada</span>
              <h3>El mismo día</h3>
              <p className="nexa-price-time">
                Recogida por la mañana · devolución antes de las 20:00
              </p>
              ...
              <Link href={bookHref}>Reserva media jornada</Link>
            </div>

            <div className="nexa-price-card featured">
              <span className="nexa-price-badge">Más popular</span>
              <h3>24 hours</h3>
              <p className="nexa-price-time">
                Ideal para excursiones y planes flexibles
              </p>
              <div className="nexa-price-number">
                <span>solo</span>
                <strong>€49</strong>
              ...
              <ul>
                <li>Scooter de 125 cc durante 24 horas</li>
                <li>Dos cascos incluidos</li>
                <li>Baúl incluido</li>
                <li>Candado de seguridad incluido</li>
                <li>Soporte para móvil incluido</li>
              ...
              <Link href={bookHref}>Reserva 24 horas</Link>
            </div>

            <div className="nexa-price-card">
              <span className="nexa-price-badge">Varios días</span>
              <h3>Alquiler de varios días</h3>
              <p className="nexa-price-time">
                Ideal para estancias más largas en Mallorca
              </p>
              <div className="nexa-price-number">
                <span>desde</span>
                <strong>€43</strong>
              ...
              <ul>
                <li>2 días: 47 € al día</li>
                <li>3 días: 46 € al día</li>
                <li>4 días: 45 € al día</li>
                <li>5 días: 44 € al día</li>
                <li>6 días: 43 € al día</li>
                <li>Todo incluido</li>
              </ul>
              <Link href={bookHref}>Reserva varios días</Link>
            </div>
          </div>

          <div className="nexa-deposit-box">
            <div>
              <strong>Fianza de 150 € por scooter</strong>
              <p>
                La fianza se devuelve después de entregar el scooter
                correctamente. Trae tu permiso de conducir original y el
                pasaporte o documento de identidad.
              </p>
            </div>
            <Link href={bookHref}>Consulta disponibilidad</Link>
          </div>
        </div>
      </section>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Precios de scooter en Mallorca
            </span>

            <h2>
              Por qué los precios de NEXA Rentals son fáciles de entender.
            </h2>

            <p>
              Muchos viajeros buscan precios de alquiler de scooter en
              Mallorca, alquiler de scooter económico en Mallorca o scooters
              de 125 cc desde 39 €. Con NEXA Rentals es muy sencillo: consulta
              el precio online, reserva directamente y recoge tu scooter en
              nuestra oficina de Magaluf.
            </p>

            <p>
              Los principales extras ya están incluidos en el precio del
              alquiler: dos cascos, un baúl de 50 litros, candado de seguridad,
              soporte impermeable para móvil, kilómetros ilimitados y seguro
              básico. La fianza de 150 € por scooter se abona por separado y se
              devuelve después de entregarlo correctamente.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              ...
              <li>Dos cascos incluidos</li>
              <li>Baúl de 50 litros para una bolsa, casco o accesorios</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Consulta el precio, reserva online y recógelo en Magaluf.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                Selecciona la fecha, la duración del alquiler y el scooter. Verás
                inmediatamente la opción que mejor se adapta a tus planes.
              </p>
            </div>
            ...
            <div>
              ...
              <h3>Paga online</h3>
              <p>
                Paga online el precio del alquiler y reserva tu scooter de 125
                cc para tu estancia en Mallorca.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Acude a NEXA Rentals con tu permiso de conducir original y el
                pasaporte o documento de identidad. Tras la recogida y la
                explicación, podrás comenzar tu ruta.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Consulta los precios ahora
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Tarifas de alquiler de scooter en Mallorca
          </span>

          <h2>
            Para viajeros que buscan precios económicos y extras útiles
            incluidos en el alquiler.
          </h2>

          <p>
            Cuando buscas “precios alquiler scooter Mallorca”, “alquiler
            scooter barato Mallorca”, “tarifas scooter Mallorca” o “precios
            scooter 125 cc Mallorca”, quieres saber exactamente cuánto pagarás
            y qué incluye el alquiler.
          </p>

          <p>
            Con NEXA Rentals alquilas scooters de 125 cc con tarifas claras y
            los extras importantes ya incluidos. Actualmente no ofrecemos
            servicio de entrega de scooters. La recogida y la devolución se
            realizan directamente en NEXA Rentals, Magaluf, para gestionar la
            entrega del vehículo, la comprobación de documentos y la devolución
            de forma sencilla y segura.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Precios alquiler scooter Mallorca</span>
            <span>Alquiler scooter barato Mallorca</span>
            <span>Scooter 125 cc desde 39 €</span>
            <span>Alquiler scooter Mallorca 49 €</span>
            <span>Fianza alquiler scooter Mallorca</span>
            <span>Alquiler scooter todo incluido Mallorca</span>
            <span>Precios scooter Magaluf</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre los precios de alquiler de scooter en Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                ¿Cuánto cuesta alquilar un scooter con NEXA Rentals?
              </summary>
              <p>
                La media jornada cuesta desde 39 €. El alquiler de 24 horas
                cuesta 49 €. Hay tarifas diarias reducidas para alquileres de
                varios días.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Incluye dos cascos, un baúl de 50 litros, candado de seguridad,
                soporte impermeable para móvil, kilómetros ilimitados y seguro
                básico.
              </p>
            </details>
            ...
            <details>
              <summary>¿Cuánto cuesta la fianza?</summary>
              <p>
                La fianza es de 150 € por scooter. Se devuelve después de
                entregar el vehículo correctamente.
              </p>
            </details>

            <details>
              <summary>¿Hay costes ocultos?</summary>
              <p>
                Los principales extras están incluidos en el precio del
                alquiler. La fianza se abona por separado y se devuelve cuando
                el scooter se entrega correctamente.
              </p>
            </details>

            <details>
              <summary>¿Dónde se realiza la recogida?</summary>
              <p>
                La recogida y la devolución se realizan directamente en NEXA
                Rentals, C. Galeón, 13, Loc 57, 07181 Magaluf. Actualmente no
                ofrecemos servicio de entrega de scooters.
              </p>
            </details>

            <details>
              <summary>¿Qué permiso de conducir necesito?</summary>
              <p>
                Aceptamos los permisos de moto A, A1 y A2. También puedes
                conducir un scooter de 125 cc con un permiso de coche de
                categoría B si tiene al menos 3 años de antigüedad.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>¿Has encontrado la tarifa ideal?</h3>
            <p>
              Reserva online tu scooter de 125 cc y recógelo directamente en
              NEXA Rentals, Magaluf.
            </p>
