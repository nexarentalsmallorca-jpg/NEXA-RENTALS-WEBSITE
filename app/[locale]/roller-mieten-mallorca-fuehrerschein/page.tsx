// app/[locale]/roller-mieten-mallorca-fuehrerschein/page.tsx
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Mallorca Führerschein | B-Führerschein 3 Jahre | NEXA Rentals",
    description:
      "Roller mieten auf Mallorca: Welcher Führerschein reicht? 125cc Roller mit A, A1, A2 oder B-Führerschein seit mindestens 3 Jahren. Online buchen, in Magaluf bei NEXA Rentals abholen.",
    keywords: [
      "Roller mieten Mallorca Führerschein",
      "Roller mieten Mallorca B Führerschein",
      "125cc Roller Mallorca Führerschein",
      "125cc Roller Mallorca Autoführerschein",
      "Scooter mieten Mallorca Führerschein",
      "Roller Mallorca B Führerschein 3 Jahre",
      "Roller mieten Mallorca Autoführerschein",
      "Roller fahren Mallorca B Führerschein",
      "125cc Roller fahren Mallorca",
      "Roller mieten Mallorca A1",
      "Roller mieten Mallorca A2",
      "Roller mieten Mallorca A Führerschein",
      "Motorroller Mallorca Führerschein",
      "Scooter Mallorca Führerschein deutsch",
      "Roller mieten Mallorca ohne Motorradführerschein",
      "Roller mieten Mallorca deutscher Führerschein",
      "125cc Scooter Mallorca B license",
      "NEXA Rentals Führerschein",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-mallorca-fuehrerschein`,
    },
    openGraph: {
      title: "Roller mieten Mallorca Führerschein | NEXA Rentals",
      description:
        "Welchen Führerschein brauchst du für einen 125cc Roller auf Mallorca? A, A1, A2 oder B-Führerschein seit mindestens 3 Jahren.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-mallorca-fuehrerschein`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Mallorca Führerschein bei NEXA Rentals",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenMallorcaFuehrerscheinPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Für einen 125cc Roller brauchst du A, A1 oder A2. Mit einem B-Führerschein kannst du einen 125cc Roller fahren, wenn dein B-Führerschein seit mindestens 3 Jahren gültig ist.",
        },
      },
      {
        "@type": "Question",
        name: "Kann ich mit deutschem Autoführerschein einen Roller auf Mallorca mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja, wenn dein B-Führerschein seit mindestens 3 Jahren gültig ist. Der Original-Führerschein muss bei der Abholung vorgelegt werden.",
        },
      },
      {
        "@type": "Question",
        name: "Kann ich mit provisorischem Führerschein einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Nein. Provisorische Führerscheine, Lernführerscheine, Fotos oder Kopien werden nicht akzeptiert. Du brauchst den originalen gültigen Führerschein.",
        },
      },
      {
        "@type": "Question",
        name: "Vermietet NEXA Rentals 50cc Roller?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Nein. NEXA Rentals vermietet aktuell 125cc Roller. 50cc Roller bieten wir derzeit nicht an.",
        },
      },
      {
        "@type": "Question",
        name: "Was ist beim Roller mieten inklusive?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Mallorca mit Führerschein",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-mallorca-fuehrerschein`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A / A1 / A2 · B-Führerschein 3+ Jahre
              </span>
            ...
            <h1>Roller mieten auf Mallorca: Welcher Führerschein reicht?</h1>

            <p className="nexa-hero-text">
              Du suchst nach{" "}
              <strong>Roller mieten Mallorca Führerschein</strong>,{" "}
              <strong>125cc Roller Mallorca B-Führerschein</strong> oder{" "}
              <strong>Roller fahren Mallorca mit Autoführerschein</strong>? Bei
              NEXA Rentals erklären wir dir klar, welche Fahrerlaubnis du für
              einen 125cc Roller brauchst.
            </p>

            <p className="nexa-hero-text small">
              Kurz gesagt: A, A1 und A2 werden akzeptiert. Mit B-Führerschein
              kannst du einen 125cc Roller mieten, wenn dein Autoführerschein
              seit mindestens 3 Jahren gültig ist. Provisorische oder
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Führerschein mitbringen</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc Roller Mallorca mit B Führerschein"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Klare Führerschein-Regeln für 125cc Roller auf Mallorca</p>
        ...
        <div className="nexa-trust-logos">
          ...
          <span>Keine Lernführerscheine</span>
        </div>
      </section>

      <section className="nexa-license-section">
        <div className="nexa-license-inner">
          <span className="nexa-section-label">Führerschein-Regel</span>

          <h2>Diese Fahrerlaubnisse akzeptieren wir für 125cc Roller.</h2>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">125cc Roller mit Autoführerschein</span>

            <h2>Mit B-Führerschein 125cc Roller fahren — aber nur mit 3 Jahren Erfahrung.</h2>

            <p>
              Viele deutsche Urlauber suchen vor der Reise nach Mallorca, ob sie
              mit dem Autoführerschein einen Roller fahren dürfen. Bei NEXA
              Rentals gilt: Für unsere 125cc Roller brauchst du A, A1, A2 oder
              einen B-Führerschein, der seit mindestens 3 Jahren gültig ist.
            </p>

            <p>
              Wichtig ist, dass du bei der Abholung den originalen Führerschein
              und einen Ausweis oder Pass mitbringst. Fotos, Kopien,
              Lernführerscheine oder provisorische Dokumente werden nicht
              akzeptiert. Die Abholung und Rückgabe erfolgt direkt bei NEXA
              Rentals in Magaluf.
            </p>
          </article>

          <aside className="nexa-info-box">
            <h3>Vor der Abholung</h3>

            <ul>
              <li>Original-Führerschein mitbringen</li>
              <li>Ausweis oder Pass mitbringen</li>
              <li>B-Führerschein muss mindestens 3 Jahre gültig sein</li>
              <li>A, A1 und A2 werden akzeptiert</li>
              <li>Keine provisorischen Führerscheine</li>
              <li>Keine Lernführerscheine</li>
              <li>Keine Fotos oder Kopien</li>
              <li>Abholung bei NEXA Rentals in Magaluf</li>
            </ul>
          </aside>
        </div>
      </section>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Führerschein prüfen, online buchen und in Magaluf starten.</h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Führerschein prüfen</h3>
              <p>
                A, A1 oder A2 sind okay. B ist okay, wenn dein Autoführerschein
                seit mindestens 3 Jahren gültig ist.
              </p>
            </div>
            ...
            <div>
              ...
              <h3>Online buchen</h3>
              <p>
                Wähle deinen 125cc Roller, Datum und Mietdauer. Bezahle den
                Mietpreis sicher online.
              </p>
            </div>

            <div>
              <span>03</span>
              <h3>Original mitbringen</h3>
              <p>
                Komm mit Original-Führerschein und Ausweis oder Pass zu NEXA
                Rentals in Magaluf. Danach kannst du direkt starten.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Roller Mallorca Führerschein</span>

          <h2>
            Klare Antwort für alle, die auf Mallorca einen Roller mieten möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Mallorca Führerschein”, “Roller mieten
            Mallorca B-Führerschein”, “125cc Roller Mallorca Autoführerschein”
            oder “Roller fahren Mallorca mit deutschem Führerschein” suchst,
            brauchst du vor allem eine klare Antwort: Für 125cc Roller brauchst
            du A, A1, A2 oder B mit mindestens 3 Jahren Erfahrung.
          </p>

          <p>
            Bei NEXA Rentals bekommst du 125cc Roller, transparente Preise und
            eine einfache Online-Buchung. Im Preis enthalten sind 2 Helme,
            Topcase, Schloss, Handyhalterung, unbegrenzte Kilometer und
            Basisversicherung. Aktuell bieten wir keinen Lieferservice an, damit
            Dokumentencheck, Übergabe und Rückgabe sicher im Büro stattfinden.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Roller mieten Mallorca Führerschein</span>
            <span>B-Führerschein 3 Jahre</span>
            <span>125cc Roller Autoführerschein</span>
            <span>Roller Mallorca A1</span>
            <span>Roller Mallorca A2</span>
            <span>Deutscher Führerschein Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Führerschein für Roller auf Mallorca</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              ...
              <p>
                A, A1 und A2 werden akzeptiert. B wird akzeptiert, wenn der
                B-Führerschein seit mindestens 3 Jahren gültig ist.
              </p>
            </details>

            <details>
              <summary>Kann ich mit einem Lernführerschein mieten?</summary>
              <p>
                Nein. Lernführerscheine, provisorische Führerscheine, Fotos oder
                Kopien werden nicht akzeptiert.
              </p>
            </details>

            <details>
              <summary>Vermietet NEXA Rentals 50cc Roller?</summary>
              <p>
            ...
            <details>
              <summary>Wo findet die Abholung statt?</summary>
              <p>
