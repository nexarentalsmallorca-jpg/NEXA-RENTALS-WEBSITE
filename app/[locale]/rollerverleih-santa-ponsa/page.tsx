...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Topcase",
    text: "Praktischer Stauraum für Strand, Tasche und Einkäufe.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Handyhalterung",
    text: "Ideal für Navigation von Santa Ponsa über Mallorca.",
  },
  {
    image: "/images/ex3.png",
    title: "Schloss",
    text: "Für sichere Stopps am Strand, Hotel oder Aussichtspunkt.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Rollerverleih Santa Ponsa | Roller mieten Santa Ponsa Mallorca | NEXA Rentals",
    description:
      "Roller mieten in Santa Ponsa Mallorca: 125cc Roller ab 39€ bei NEXA Rentals online buchen, online bezahlen und in Magaluf abholen. Nur ca. 10 Minuten von Santa Ponsa entfernt. Ideal für Santa Ponsa, Costa de la Calma, El Toro, Port Adriano und Südwest-Mallorca.",
    keywords: [
      "Rollerverleih Santa Ponsa",
      "Roller mieten Santa Ponsa",
      "Roller mieten Santa Ponsa Mallorca",
      "Motorroller mieten Santa Ponsa",
      "Scooter mieten Santa Ponsa",
      "125cc Roller Santa Ponsa",
      "125cc Roller Santa Ponsa Mallorca",
      "Roller Verleih Santa Ponsa Mallorca",
      "Roller Santa Ponsa online buchen",
      "Roller mieten Costa de la Calma",
    ...
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/rollerverleih-santa-ponsa`,
    },
    openGraph: {
      title: "Rollerverleih Santa Ponsa | Roller mieten bei NEXA Rentals",
      description:
        "125cc Roller für Santa Ponsa und Südwest-Mallorca online buchen. Nur ca. 10 Minuten von Santa Ponsa entfernt. Abholung und Rückgabe bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/rollerverleih-santa-ponsa`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Rollerverleih Santa Ponsa Mallorca bei NEXA Rentals",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerverleihSantaPonsaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Wo kann ich einen Roller in Santa Ponsa mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und im Büro in Magaluf abholen. NEXA Rentals ist nur ca. 10 Minuten von Santa Ponsa entfernt und ideal für Gäste, die in Santa Ponsa, Costa de la Calma, El Toro, Port Adriano oder Paguera wohnen.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Santa Ponsa entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf und ist mit dem Auto oder Taxi nur ca. 10 Minuten von Santa Ponsa entfernt. Die Abholung und Rückgabe erfolgt direkt im Büro von NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Gibt es eine Lieferung nach Santa Ponsa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aktuell bieten wir keinen Lieferservice nach Santa Ponsa an. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf, damit die Übergabe schnell, sicher und klar bleibt.",
        },
      },
      {
        "@type": "Question",
        name: "Kann ich den Roller für Santa Ponsa online bezahlen?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen Roller online reservieren und den Mietpreis online bezahlen. Dadurch ist dein 125cc Roller für deine gewünschten Daten fest gebucht.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Du brauchst A, A1 oder A2. Mit einem B-Führerschein kannst du einen 125cc Roller fahren, wenn der Führerschein seit mindestens 3 Jahren gültig ist. Provisorische oder Lernführerscheine werden nicht akzeptiert.",
        },
      },
      {
        "@type": "Question",
        name: "Was ist beim Rollerverleih Santa Ponsa inklusive?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Santa Ponsa Mallorca",
      priceCurrency: "EUR",
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/rollerverleih-santa-ponsa`}
                      className={
                        active
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Rollerverleih Santa Ponsa: 125cc Roller für Mallorca mieten.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Rollerverleih Santa Ponsa</strong>,{" "}
              <strong>Roller mieten Santa Ponsa</strong> oder{" "}
              <strong>125cc Roller Santa Ponsa Mallorca</strong>? Bei NEXA
              Rentals buchst du deinen Roller online, bezahlst den Mietpreis
              direkt online und holst deinen 125cc Roller unkompliziert in
              Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Gäste in Santa Ponsa, Costa de la Calma, El Toro, Port
              Adriano, Paguera und Südwest-Mallorca, die Strände, Restaurants,
              Aussichtspunkte und Ausflüge flexibel ohne Taxi-Stress erleben
              möchten.
            </p>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Nur ca. 10 Minuten von Santa Ponsa entfernt.</strong>
                <span>
                  NEXA Rentals befindet sich in Magaluf — einfach online buchen,
                  in Magaluf abholen und direkt Richtung Santa Ponsa, Costa de
                  la Calma oder Port Adriano starten.
                </span>
              </div>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Online buchen, in Magaluf abholen</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-top">
                <Image
                  ...
                  alt="Rollerverleih Santa Ponsa Mallorca mit NEXA Rentals"
                  width={900}
                  height={620}
                  priority
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Roller mieten Santa Ponsa und Südwest Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        ...
        <div className="nexa-trust-logos">
          <span>Rollerverleih Santa Ponsa</span>
          <span>Roller mieten Santa Ponsa</span>
          <span>10 Min. von Santa Ponsa</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Roller mieten nahe Santa Ponsa: einfach online buchen.</h2>

            <p>
              Viele Urlauber in Santa Ponsa suchen nach einem zuverlässigen
              Rollerverleih auf Mallorca, damit sie nicht jeden Tag auf Taxi,
              Bus oder lange Wartezeiten angewiesen sind. Bei NEXA Rentals
              machst du es einfacher: Du reservierst deinen 125cc Roller online,
              bezahlst online und holst ihn direkt im Büro in Magaluf ab.
            </p>

            <p>
              NEXA Rentals ist nur ca. 10 Minuten von Santa Ponsa entfernt und
              dadurch praktisch für Gäste in Santa Ponsa, Costa de la Calma, El
              Toro, Port Adriano, Paguera, Palmanova, Magaluf und Calvià. Du
              kannst Strände, Buchten, Restaurants und Aussichtspunkte in deinem
              eigenen Tempo entdecken und deine Mallorca-Reise viel freier
              planen.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Santa Ponsa und Mallorca</li>
              <li>Nur ca. 10 Minuten von Santa Ponsa entfernt</li>
              <li>Online buchen und online bezahlen</li>
              <li>2 Helme inklusive</li>
              <li>50L Topcase für Strandtasche, Helm oder Einkauf</li>
              <li>Wasserdichte Handyhalterung für Navigation</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>In wenigen Schritten zum Roller für Santa Ponsa.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                Buchung ist schnell, klar und ideal für Mallorca Urlauber in
                Santa Ponsa und Umgebung.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                für deine Reisedaten. So ist dein Fahrzeug fest reserviert,
                bevor dein Urlaubstag startet.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Rentals in Magaluf. Unser Standort ist nur ca. 10 Minuten von
                Santa Ponsa entfernt. Wir erklären dir alles und du kannst
                direkt Richtung Santa Ponsa, Strand oder Ausflug losfahren.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller für Santa Ponsa buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Rollerverleih Santa Ponsa</span>

          <h2>
            Für deutsche Gäste, die Santa Ponsa und Mallorca flexibel erleben
            möchten.
          </h2>

          <p>
            Wenn du bei Google nach “Rollerverleih Santa Ponsa”, “Roller mieten
            Santa Ponsa”, “Motorroller mieten Santa Ponsa”, “Scooter mieten
            Santa Ponsa” oder “125cc Roller Santa Ponsa Mallorca” suchst, willst
            du meistens keine komplizierte Seite, sondern eine schnelle Lösung.
            Genau dafür ist NEXA Rentals gemacht: klare Informationen, echte
            Online-Buchung, sichere Online-Zahlung und ein Roller, mit dem du
            Mallorca flexibel erleben kannst.
          </p>

          <p>
            Diese Seite ist besonders praktisch, wenn du in Santa Ponsa, Costa
            de la Calma, El Toro, Port Adriano, Paguera oder im Südwesten von
            Mallorca wohnst. NEXA Rentals befindet sich in Magaluf und ist nur
            ca. 10 Minuten von Santa Ponsa entfernt. Aktuell bieten wir keine
            Lieferung nach Santa Ponsa an: Die Abholung und Rückgabe erfolgt
            direkt bei NEXA Rentals in Magaluf. So bleibt die Übergabe
            persönlich, schnell und sauber organisiert.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Rollerverleih Santa Ponsa</span>
            <span>Roller mieten Santa Ponsa</span>
            <span>125cc Roller Santa Ponsa</span>
            <span>Motorroller mieten Santa Ponsa</span>
            <span>Scooter mieten Santa Ponsa</span>
            <span>Roller mieten Costa de la Calma</span>
            <span>Roller mieten Port Adriano</span>
            <span>10 Minuten von Santa Ponsa</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Rollerverleih Santa Ponsa</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>Wie weit ist NEXA Rentals von Santa Ponsa entfernt?</summary>
              <p>
                NEXA Rentals befindet sich in Magaluf und ist nur ca. 10 Minuten
                von Santa Ponsa entfernt. Du kannst online buchen, den Roller in
                Magaluf abholen und direkt Richtung Santa Ponsa, Costa de la
                Calma, El Toro oder Port Adriano starten.
              </p>
            </details>

            <details>
              <summary>Kann ich den Roller direkt nach Santa Ponsa liefern lassen?</summary>
              <p>
                Aktuell bieten wir keinen Lieferservice nach Santa Ponsa an. Die
                Abholung und Rückgabe erfolgt direkt bei NEXA Rentals in
                Magaluf. So bleibt die Übergabe schneller, klarer und sicherer.
              </p>
            </details>
            ...
            <details>
              <summary>Ist NEXA Rentals gut für Santa Ponsa, El Toro und Port Adriano?</summary>
              <p>
                Ja. NEXA Rentals ist ideal, wenn du in Santa Ponsa, Costa de la
                Calma, El Toro, Port Adriano, Paguera, Magaluf oder Palmanova
                unterwegs bist und einen 125cc Roller auf Mallorca mieten
                möchtest.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            <h3>Bereit für Santa Ponsa und Mallorca?</h3>
            <p>
              Buche deinen 125cc Roller online und starte direkt bei NEXA
              Rentals in Magaluf — nur ca. 10 Minuten von Santa Ponsa entfernt.
            </p>
