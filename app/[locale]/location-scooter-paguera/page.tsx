...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-paguera";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Paguera | Louer un scooter à Peguera | NEXA Rentals",
    description:
      "Location de scooter à Paguera et Peguera, Majorque. Réservez un scooter 125cc dès 39 €, payez en ligne et récupérez-le chez NEXA Rentals à Magaluf, à environ 10 minutes de Paguera.",
    keywords: [
      ...
      "location scooter 125cc Paguera",
      "scooter 125 Peguera",
      "location scooter pas cher Paguera",
    ...
    alternates: {
      canonical: "https://www.nexarentals.es/fr/location-scooter-paguera",
    },
    openGraph: {
      title: "Location scooter Paguera | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour Paguera, Peguera et le sud-ouest de Majorque. NEXA Rentals se trouve à environ 10 minutes de Paguera.",
      url: "https://www.nexarentals.es/fr/location-scooter-paguera",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Paguera et Peguera avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterPagueraPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Où louer un scooter à Paguera ou Peguera ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer dans notre agence à Magaluf. NEXA Rentals se trouve à environ 10 minutes de Paguera et convient aux voyageurs séjournant à Paguera, Peguera, Camp de Mar, Cala Fornells ou Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf, à environ 10 minutes de Paguera en voiture ou en taxi. Le retrait et le retour standard du scooter s’effectuent directement dans notre agence à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Est-il possible de faire livrer un scooter à Paguera ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison à Paguera, contactez-nous avant votre réservation afin de vérifier la disponibilité du service pour vos dates et votre adresse.",
        },
      },
      {
        "@type": "Question",
        name: "Puis-je payer en ligne ma location de scooter pour Paguera ?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location de scooter à Paguera ?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Paguera, Majorque",
      priceCurrency: "EUR",
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Location de scooter à Paguera : scooters 125cc à Majorque.</h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Paguera</strong>, une{" "}
              <strong>location de scooter à Peguera</strong> ou un{" "}
              <strong>scooter 125cc à Paguera, Majorque</strong> ? Chez NEXA
              Rentals, vous réservez votre scooter en ligne, payez directement
              en ligne et le récupérez facilement dans notre agence à Magaluf.
            </p>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>À seulement environ 10 minutes de Paguera.</strong>
                <span>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Louer un scooter à Paguera dans le sud-ouest de Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Louer un scooter près de Paguera, simplement et rapidement.
            </h2>
            ...
            <p>
              NEXA Rentals se trouve à environ 10 minutes de Paguera, ce qui
              rend notre agence pratique pour les voyageurs installés à
              Paguera, Cala Fornells, Camp de Mar, Santa Ponsa, Palmanova,
              Magaluf ou Calvià. Vous pouvez découvrir les plages, les criques,
              les restaurants et les points de vue à votre rythme.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              ...
              <li>
                Retrait et retour standard chez NEXA Rentals à Magaluf
              </li>
            </ul>
          </aside>
        </div>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter pour Paguera en seulement quelques étapes.</h2>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <p>
            Lorsque vous recherchez sur Google « location scooter Paguera »,
            « location scooter Peguera », « louer un scooter à Paguera »,
            « location scooter 125cc Peguera » ou « location scooter Majorque
            », vous cherchez généralement une solution rapide et claire. NEXA
            Rentals vous permet de réserver en ligne, de payer en toute
            sécurité et de récupérer un scooter prêt pour votre séjour.
          </p>
          ...
          <p>
            ...
            10 minutes de Paguera. Le retrait standard s’effectue dans notre
            agence, et vous pouvez nous contacter pour vérifier les possibilités
            de livraison selon votre zone et vos dates.
          </p>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              ...
              <p>
                ...
                Paguera. Vous pouvez réserver en ligne, récupérer votre scooter
                à Magaluf et partir directement vers Paguera, Camp de Mar, Cala
                Fornells ou Santa Ponsa.
              </p>
            </details>

            <details>
              <summary>
                Puis-je faire livrer le scooter directement à Paguera ?
              </summary>
              <p>
                Le retrait standard s’effectue directement chez NEXA Rentals à
                Magaluf. Pour une demande de livraison à Paguera, contactez-nous
                avant votre réservation afin de confirmer la disponibilité
                selon votre adresse et vos dates.
              </p>
            </details>
            ...
            <details>
              <summary>
                NEXA Rentals est-il bien situé pour Paguera, Peguera et Camp de
                Mar ?
              </summary>
              <p>
                Oui. NEXA Rentals convient aux voyageurs séjournant à Paguera,
                Peguera, Cala Fornells, Camp de Mar, Santa Ponsa, Magaluf ou
                Palmanova et souhaitant louer un scooter 125cc à Majorque.
              </p>
            </details>
          </div>
