...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per navigare da Paguera in tutta Maiorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter a noleggio Paguera | Noleggio scooter Peguera Maiorca | NEXA Rentals",
    description:
      "Scooter a noleggio a Paguera e Peguera, Maiorca: prenota online uno scooter 125cc da 39€ con NEXA Rentals, paga online e ritiralo a Magaluf. A circa 10 minuti da Paguera. Ideale per Paguera, Camp de Mar, Cala Fornells, Santa Ponsa e il sud-ovest di Maiorca.",
    keywords: [
      ...
      "scooter a noleggio Paguera Maiorca",
      "prenotare scooter Paguera online",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/scooter-a-noleggio-paguera",
    },
    openGraph: {
      title:
        "Scooter a noleggio Paguera | Noleggio scooter con NEXA Rentals",
      description:
        "Prenota online uno scooter 125cc per Paguera e il sud-ovest di Maiorca. A circa 10 minuti da Paguera. Ritiro e riconsegna presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/scooter-a-noleggio-paguera",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter a noleggio a Paguera, Maiorca, con NEXA Rentals",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function ScooterANoleggioPagueraPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Dove posso noleggiare uno scooter a Paguera o Peguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo presso il nostro ufficio a Magaluf. NEXA Rentals si trova a circa 10 minuti da Paguera ed è ideale per chi soggiorna a Paguera, Peguera, Camp de Mar, Cala Fornells o Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf, a circa 10 minuti da Paguera in auto o taxi. Il ritiro e la riconsegna avvengono direttamente presso l’ufficio di NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "È disponibile la consegna dello scooter a Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Al momento non offriamo un servizio di consegna a Paguera. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf, così la consegna del veicolo rimane veloce, sicura e chiara.",
        },
      },
      {
        "@type": "Question",
        name: "Posso pagare online il noleggio dello scooter per Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Cosa è incluso nel noleggio scooter a Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Paguera, Maiorca",
      price: "39",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Paguera, Peguera, Maiorca",
    },
  };
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Scooter a noleggio a Paguera: noleggia un 125cc per esplorare
              Maiorca.
            </h1>

            <p className="nexa-hero-text">
              Cerchi uno <strong>scooter a noleggio a Paguera</strong>, un{" "}
              <strong>noleggio scooter a Paguera</strong> o uno{" "}
              <strong>scooter 125cc a Peguera, Maiorca</strong>? Con NEXA
            ...
            <p className="nexa-hero-text small">
              Ideale per chi soggiorna a Paguera, Peguera, Cala Fornells, Camp
              de Mar, Santa Ponsa e nel sud-ovest di Maiorca e vuole visitare
              spiagge, ristoranti, punti panoramici e altre località senza
              dipendere dai taxi.
            </p>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>A circa 10 minuti da Paguera.</strong>
                <span>
                  NEXA Rentals si trova a Magaluf: prenota online, ritira lo
                  scooter a Magaluf e parti direttamente verso Paguera, Camp de
                  Mar o Santa Ponsa.
                </span>
              </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Paguera e nel sud-ovest di Maiorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        ...
        <div className="nexa-trust-logos">
          <span>Scooter a noleggio Paguera</span>
          <span>Noleggio scooter Peguera</span>
          <span>10 min da Paguera</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Noleggia uno scooter vicino a Paguera con una semplice
              prenotazione online.
            </h2>

            <p>
              Molti viaggiatori che soggiornano a Paguera o Peguera cercano un
            ...
            <p>
              NEXA Rentals si trova a circa 10 minuti da Paguera ed è quindi una
              soluzione pratica per chi soggiorna a Paguera, Cala Fornells,
              Camp de Mar, Santa Ponsa, Palmanova, Magaluf e Calvià. Puoi
              esplorare spiagge, calette, ristoranti e punti panoramici seguendo
              i tuoi ritmi e organizzare la tua vacanza a Maiorca con maggiore
              libertà.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Paguera e Maiorca</li>
              <li>A circa 10 minuti da Paguera</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota in pochi passaggi il tuo scooter per Paguera.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                soggiorna a Paguera, Peguera e nelle località vicine.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                circa 10 minuti da Paguera. Ti spiegheremo tutto e potrai
                partire subito verso Paguera, la spiaggia o il tuo itinerario.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per i viaggiatori italiani che vogliono esplorare Paguera e Maiorca
            in completa libertà.
          </h2>

          <p>
            Quando cerchi su Google “scooter a noleggio Paguera”, “noleggio
            scooter Paguera”, “noleggio scooter Peguera”, “noleggio motorino
            Paguera” o “scooter 125cc Paguera Maiorca”, probabilmente non vuoi
            una procedura complicata, ma una soluzione veloce. NEXA Rentals
            offre informazioni chiare, prenotazione online, pagamento sicuro e
            uno scooter con cui esplorare Maiorca liberamente.
          </p>

          <p>
            Questa pagina è particolarmente utile per chi soggiorna a Paguera,
            Peguera, Cala Fornells, Camp de Mar, Santa Ponsa o nel sud-ovest di
            Maiorca. NEXA Rentals si trova a Magaluf, a circa 10 minuti da
            Paguera. Al momento non offriamo la consegna a Paguera: il ritiro e
            la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf.
            In questo modo la consegna del veicolo rimane personale, veloce e
            ben organizzata.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Noleggio scooter Peguera</span>
            <span>Scooter 125cc Paguera</span>
            <span>Noleggio motorino Paguera</span>
            <span>Affitto scooter Paguera</span>
            <span>Noleggio scooter Camp de Mar</span>
            <span>10 minuti da Paguera</span>
        ...
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              ...
              <p>
                NEXA Rentals si trova a Magaluf, a circa 10 minuti da Paguera.
                Puoi prenotare online, ritirare lo scooter a Magaluf e partire
                direttamente verso Paguera, Camp de Mar, Cala Fornells o Santa
                Ponsa.
              </p>
            </details>
            ...
            <details>
              <summary>
                Posso ricevere lo scooter direttamente a Paguera?
              </summary>
              <p>
                Al momento non offriamo un servizio di consegna a Paguera. Il
            ...
            <details>
              <summary>
                NEXA Rentals è una buona soluzione per Paguera, Peguera e Camp
                de Mar?
              </summary>
              <p>
                Sì. NEXA Rentals è ideale se soggiorni a Paguera, Peguera, Cala
                Fornells, Camp de Mar, Santa Ponsa, Magaluf o Palmanova e vuoi
                noleggiare uno scooter 125cc a Maiorca.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Paguera e Maiorca?</h3>
            <p>
              Prenota online il tuo scooter 125cc e parti direttamente da NEXA
              Rentals a Magaluf, a circa 10 minuti da Paguera.
            </p>
