// app/[locale]/louer-un-scooter-paguera/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Idéal pour utiliser le GPS entre Paguera et le reste de Majorque.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/louer-un-scooter-paguera";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Louer un scooter à Paguera | Location scooter Peguera Majorque | NEXA Rentals",
    description:
      "Louez un scooter 125cc à Paguera ou Peguera dès 39 €. Réservez et payez en ligne, puis récupérez votre scooter chez NEXA Rentals à Magaluf, à environ 10 minutes de Paguera. Idéal pour Camp de Mar, Cala Fornells, Santa Ponsa et le sud-ouest de Majorque.",
    keywords: [
      "louer un scooter Paguera",
      "location scooter Paguera",
      "louer un scooter Peguera",
      "location scooter Peguera",
      "location scooter Paguera Majorque",
      "location scooter Peguera Majorque",
      "scooter 125cc Paguera",
      "scooter 125cc Peguera",
      "location deux roues Paguera",
      "réserver scooter Paguera en ligne",
      "location scooter Camp de Mar",
      "louer un scooter Camp de Mar",
    ...
    alternates: {
      canonical: "https://www.nexarentals.es/fr/louer-un-scooter-paguera",
    },
    openGraph: {
      title: "Louer un scooter à Paguera | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour Paguera et le sud-ouest de Majorque. NEXA Rentals se trouve à Magaluf, à environ 10 minutes de Paguera.",
      url: "https://www.nexarentals.es/fr/louer-un-scooter-paguera",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Louer un scooter à Paguera avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LouerUnScooterPagueraPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Où peut-on louer un scooter à Paguera ou Peguera ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer dans notre agence à Magaluf. NEXA Rentals se trouve à environ 10 minutes de Paguera et constitue une solution pratique pour les voyageurs séjournant à Paguera, Peguera, Camp de Mar, Cala Fornells ou Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de Paguera ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf, à environ 10 minutes de Paguera en voiture ou en taxi selon la circulation. Le retrait et le retour standard s’effectuent directement dans notre agence à Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "La livraison à Paguera est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison à Paguera, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
      {
        "@type": "Question",
        name: "Peut-on payer la location du scooter en ligne ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter en ligne et payer le montant de la location directement en ligne. Votre scooter 125cc est ainsi confirmé pour les dates choisies.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Qu’est-ce qui est inclus dans la location du scooter à Paguera ?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Paguera",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Paguera, Peguera, Majorque",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>
              Louer un scooter à Paguera : découvrez Majorque en scooter 125cc.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Paguera</strong>, souhaitez{" "}
              <strong>louer un scooter à Peguera</strong> ou réserver un{" "}
              <strong>scooter 125cc à Majorque</strong> ? Chez NEXA Rentals,
            ...
            <p className="nexa-hero-text small">
              Une solution idéale pour les voyageurs séjournant à Paguera,
              Peguera, Cala Fornells, Camp de Mar, Santa Ponsa et dans le
              sud-ouest de Majorque qui souhaitent découvrir les plages, les
              restaurants, les criques et les points de vue sans dépendre des
              taxis.
            </p>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                ...
                <span>Réservation en ligne et retrait à Magaluf</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Location de scooter à Paguera et dans le sud-ouest de Majorque"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Une solution pratique pour les voyageurs francophones à Majorque
        </p>

        <div className="nexa-trust-logos">
          <span>Louer un scooter Paguera</span>
          <span>Location scooter Peguera</span>
          <span>À 10 min de Paguera</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Louer un scooter près de Paguera avec une réservation simple en
              ligne.
            </h2>

            <p>
              De nombreux voyageurs séjournant à Paguera ou Peguera recherchent
              une location de scooter fiable à Majorque afin de ne pas dépendre
              chaque jour des taxis, des bus ou des longues attentes. Chez NEXA
              Rentals, la procédure est simple : vous réservez votre scooter
              125cc en ligne, payez en ligne et le récupérez directement dans
              notre agence à Magaluf.
            </p>

            <p>
              NEXA Rentals se trouve à environ 10 minutes de Paguera, ce qui est
              pratique pour les voyageurs séjournant à Paguera, Cala Fornells,
              Camp de Mar, Santa Ponsa, Palmanova, Magaluf ou Calvià. Vous
              pouvez découvrir les plages, les criques, les restaurants et les
              points de vue à votre propre rythme.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Paguera et Majorque</li>
              <li>À environ 10 minutes de Paguera</li>
              <li>Réservation et paiement en ligne</li>
              <li>Deux casques inclus</li>
              <li>Top case de 50 litres pour un sac, un casque ou vos achats</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter pour Paguera en quelques étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                voyageurs séjournant à Paguera, Peguera et dans les environs.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                votre scooter pour les dates choisies avant le début de votre
                journée à Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                se trouve à environ 10 minutes de Paguera. Nous vous expliquons
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour Paguera
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Location de scooter à Paguera
          </span>

          <h2>
            Pour les voyageurs francophones qui souhaitent découvrir Paguera et
            Majorque en toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « louer un scooter à Paguera »,
            « location scooter Paguera », « louer un scooter à Peguera »,
            « location scooter 125cc Paguera » ou « location de deux-roues à
            Paguera », vous cherchez généralement une solution rapide et
            simple. NEXA Rentals vous propose une réservation claire, un
            paiement sécurisé en ligne et un scooter 125cc pour découvrir
            Majorque librement.
          </p>

          <p>
            Cette page est particulièrement utile si vous séjournez à Paguera,
            Peguera, Cala Fornells, Camp de Mar, Santa Ponsa ou dans le
            sud-ouest de Majorque. NEXA Rentals se trouve à Magaluf, à environ
            10 minutes de Paguera. Le retrait standard s’effectue directement
            dans notre agence. Pour une demande de livraison à Paguera,
            contactez-nous avant de réserver afin de vérifier la disponibilité
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Paguera</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de Paguera ?
              </summary>
              <p>
                NEXA Rentals se trouve à Magaluf, à environ 10 minutes de
                Paguera selon la circulation. Vous pouvez réserver en ligne,
                récupérer votre scooter à Magaluf et partir directement vers
                Paguera, Camp de Mar, Cala Fornells ou Santa Ponsa.
              </p>
            </details>

            <details>
              <summary>
                Peut-on faire livrer le scooter directement à Paguera ?
              </summary>
              <p>
                Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour
                une demande de livraison à Paguera, contactez-nous avant de
                réserver afin de vérifier la disponibilité selon vos dates et
                votre adresse.
              </p>
            </details>

            <details>
              <summary>Peut-on payer le scooter en ligne ?</summary>
              <p>
                Oui. Vous réservez et payez le montant de la location en ligne
                afin que votre scooter soit confirmé pour les dates choisies.
              </p>
            </details>
            ...
            <details>
              <summary>
                NEXA Rentals est-il pratique pour Paguera, Peguera et Camp de
                Mar ?
              </summary>
              <p>
                Oui. NEXA Rentals est une solution pratique si vous séjournez à
                Paguera, Peguera, Cala Fornells, Camp de Mar, Santa Ponsa,
                Magaluf ou Palmanova et souhaitez louer un scooter 125cc à
                Majorque.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            <h3>Prêt à découvrir Paguera et Majorque ?</h3>
            <p>
              Réservez votre scooter 125cc en ligne et partez depuis NEXA
              Rentals à Magaluf, à environ 10 minutes de Paguera.
            </p>
