// app/[locale]/scooter-rental-playa-de-palma/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal for navigation around Playa de Palma and Mallorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter Rental Playa de Palma | 125cc Scooter Hire | NEXA Rentals",
    description:
      "Scooter rental for Playa de Palma, El Arenal, S'Arenal and Can Pastilla. Book a 125cc scooter online and collect it from NEXA Rentals in Magaluf.",
    keywords: [
      "scooter rental Playa de Palma",
      "scooter hire Playa de Palma",
      "125cc scooter Playa de Palma",
      "motor scooter rental Playa de Palma",
      "rent a scooter Playa de Palma",
      "cheap scooter rental Playa de Palma",
      "scooter rental near Playa de Palma",
      "scooter rental El Arenal",
      "scooter rental S'Arenal",
      "scooter hire Can Pastilla",
      "125cc scooter El Arenal Mallorca",
      "scooter rental Ballermann",
      "scooter hire Palma Beach",
      "scooter rental Las Maravillas",
      "scooter hire Mallorca south coast",
      "book scooter online Playa de Palma",
      "Playa de Palma scooter rental prices",
      "NEXA Rentals Playa de Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/en/scooter-rental-playa-de-palma",
    },
    openGraph: {
      title: "Scooter Rental Playa de Palma | NEXA Rentals Mallorca",
      description:
        "Book a 125cc scooter for Playa de Palma, El Arenal, S'Arenal and Can Pastilla. Collection from NEXA Rentals in Magaluf.",
      url: "https://www.nexarentals.es/en/scooter-rental-playa-de-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Scooter rental for Playa de Palma with NEXA Rentals Mallorca",
        },
      ],
      locale: "en_GB",
      type: "website",
...
export default async function ScooterRentalPlayaDePalmaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I rent a scooter for Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can book a 125cc scooter online with NEXA Rentals and collect it directly in Magaluf. It is a practical option for exploring Playa de Palma, El Arenal, S'Arenal, Can Pastilla and Mallorca.",
        },
      },
      {
        "@type": "Question",
        name: "Where do I collect a scooter booked for Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Is a scooter practical for Playa de Palma and the surrounding coast?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A 125cc scooter is practical for exploring Playa de Palma, El Arenal, S'Arenal, Can Pastilla, Las Maravillas and other parts of Mallorca freely.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Is scooter delivery available in Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc scooter rental for Playa de Palma",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Collection from NEXA Rentals in Magaluf
              </span>
            ...
            <h1>
              Rent a scooter for Playa de Palma and explore Mallorca freely.
            </h1>

            <p className="nexa-hero-text">
              Looking for <strong>scooter rental in Playa de Palma</strong>,{" "}
              <strong>scooter hire in El Arenal</strong> or a{" "}
              <strong>125cc scooter near Can Pastilla</strong>? With NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal for exploring Playa de Palma, El Arenal, S&apos;Arenal, Can
              Pastilla, Las Maravillas and the surrounding coast. Perfect for
              reaching beaches, promenades, restaurants and nearby resorts
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc scooter hire for Playa de Palma and El Arenal"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          For Playa de Palma, El Arenal, S&apos;Arenal, Can Pastilla and Las
          Maravillas
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Explore Playa de Palma, El Arenal and the coast more easily.
            </h2>

            <p>
              Playa de Palma combines a long sandy beach, a lively promenade,
              restaurants and neighbouring resorts. With a 125cc scooter, you
              can travel more easily between Playa de Palma, El Arenal,
              S&apos;Arenal, Can Pastilla, Las Maravillas and other nearby areas.
            </p>

            <p>
              NEXA Rentals is a practical choice for travellers looking for
              scooter rental in Playa de Palma, scooter hire in El Arenal or a
              motor scooter for exploring Mallorca’s south coast. You book
              online, pay online and collect your scooter directly in Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc scooter for Playa de Palma and the surrounding coast</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Book a scooter for Playa de Palma in three simple steps.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                Pay the rental price online and reserve your scooter for Playa
                de Palma, El Arenal, Can Pastilla or your planned route around
                Mallorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Book a scooter for Playa de Palma
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            For travellers who want to explore Playa de Palma and Mallorca’s
            coast with complete freedom.
          </h2>

          <p>
            When you search for “scooter rental Playa de Palma”, “scooter hire
            Playa de Palma”, “rent a scooter El Arenal”, “125cc scooter Can
            Pastilla” or “cheap scooter rental Playa de Palma”, you need a
            simple solution: online booking, secure payment and a 125cc scooter
            that gives you the freedom to explore.
          </p>

          <p>
            A scooter is particularly practical for travelling between Playa
            de Palma, El Arenal, S&apos;Arenal, Can Pastilla, Las Maravillas and
            other nearby areas. NEXA Rentals offers straightforward online
            booking and collection in Magaluf. We do not currently provide a
            scooter delivery service.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Scooter rental Playa de Palma</span>
            <span>Scooter hire Playa de Palma</span>
            <span>Rent a scooter El Arenal</span>
            <span>Scooter rental S&apos;Arenal</span>
            <span>Scooter hire Can Pastilla</span>
            <span>Scooter rental Las Maravillas</span>
            <span>125cc scooter Playa de Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions about scooter rental in Playa de Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Can I book a scooter for Playa de Palma?</summary>
              <p>
                Yes. You can book a 125cc scooter online with NEXA Rentals and
                collect it directly in Magaluf. It is a practical option for
                Playa de Palma, El Arenal, S&apos;Arenal and Can Pastilla.
              </p>
            </details>

            <details>
              <summary>Where do I collect a scooter booked for Playa de Palma?</summary>
              <p>
            ...
            <details>
              <summary>Is delivery available in Playa de Palma?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Ready to explore Playa de Palma?</h3>
            <p>
