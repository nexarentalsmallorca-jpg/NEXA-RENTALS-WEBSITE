...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Palma de Mallorca | 125 cc | NEXA Rentals",
    description:
      "Alquiler de scooter en Palma de Mallorca. Reserva online un scooter de 125 cc con NEXA Rentals, recógelo en Magaluf y descubre el casco antiguo, Santa Catalina, Paseo Marítimo, Portixol y la costa con libertad.",
    keywords: [
      "alquiler scooter Palma de Mallorca",
      "alquilar scooter Palma de Mallorca",
      "scooter 125cc Palma de Mallorca",
      "alquiler moto scooter Palma de Mallorca",
      "alquiler motos Palma de Mallorca",
      "scooter de alquiler Palma de Mallorca",
      "alquiler scooter barato Palma de Mallorca",
      "alquiler scooter cerca de mí Palma de Mallorca",
      "alquiler scooter centro Palma de Mallorca",
      "alquiler scooter casco antiguo Palma",
      "alquiler scooter cerca Catedral de Mallorca",
      "alquiler scooter Santa Catalina Palma",
      "alquiler scooter Paseo Marítimo Palma de Mallorca",
      "alquiler scooter Portixol Palma",
      "alquiler scooter Can Pastilla Mallorca",
      "alquiler scooter costa Palma de Mallorca",
      "reservar scooter online Palma de Mallorca",
      "precios alquiler scooter Palma de Mallorca",
      "NEXA Rentals Palma de Mallorca",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-palma-de-mallorca",
    },
    openGraph: {
      title: "Alquiler de scooter en Palma de Mallorca | NEXA Rentals",
      description:
        "Reserva online un scooter de 125 cc para Palma de Mallorca, el casco antiguo, Santa Catalina, Paseo Marítimo, Portixol y la costa. Recogida en Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-palma-de-mallorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Palma de Mallorca con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalPalmaDeMallorcaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo directamente en Magaluf. Es una opción práctica para descubrir Palma de Mallorca, el casco antiguo, Santa Catalina, Paseo Marítimo, Portixol y Can Pastilla.",
        },
      },
      {
        "@type": "Question",
        name: "¿Dónde recojo un scooter reservado para Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para recorrer Palma de Mallorca y la costa?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es práctico para descubrir con libertad Palma de Mallorca, Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla y otras zonas de la isla.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en Palma de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc para Palma de Mallorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Palma de Mallorca · Recogida en NEXA Rentals, Magaluf
              </span>
            ...
            <h1>
              Alquila un scooter para Palma de Mallorca y descubre la ciudad,
              la costa y la isla con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas{" "}
              <strong>alquiler de scooter en Palma de Mallorca</strong>,{" "}
              <strong>alquilar un scooter cerca del casco antiguo</strong> o un{" "}
            ...
            <p className="nexa-hero-text small">
              Ideal para recorrer Palma de Mallorca, el centro histórico,
              Santa Catalina, Paseo Marítimo, Portixol, Can Pastilla y la costa.
              Perfecto para combinar visitas por la ciudad, playas, puertos
              deportivos y restaurantes con mayor libertad.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter de 125 cc en Palma de Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para Palma de Mallorca, el casco antiguo, Santa Catalina, Portixol y la costa
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Palma de Mallorca
            </span>

            <h2>
              Descubre Palma de Mallorca desde el casco antiguo hasta la costa.
            </h2>

            <p>
              Palma de Mallorca combina un centro histórico, la catedral,
              barrios llenos de vida, playas, restaurantes y un extenso paseo
              marítimo. Con un scooter de 125 cc puedes desplazarte más
              fácilmente entre el casco antiguo, Santa Catalina, Paseo
              Marítimo, Portixol, Can Pastilla, Illetes y otras zonas cercanas.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en Palma de Mallorca, alquilar un scooter cerca del
              centro o recorrer la capital y la costa en moto scooter. Reservas
              y pagas online, y recoges el scooter directamente en Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Palma de Mallorca y la costa</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva un scooter para Palma de Mallorca en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                tu estancia en Palma de Mallorca y la isla.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Palma de Mallorca, Portixol, Can Pastilla o la ruta que tengas
                prevista por la isla.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva un scooter para Palma de Mallorca
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Para viajeros que quieren descubrir Palma de Mallorca desde el
            casco antiguo hasta la costa con total libertad.
          </h2>

          <p>
            Cuando buscas “alquiler scooter Palma de Mallorca”, “alquilar
            scooter Palma de Mallorca”, “scooter de alquiler Palma de Mallorca”,
            “scooter 125 cc Palma de Mallorca” o “alquiler scooter barato Palma
            de Mallorca”, necesitas una solución sencilla: reserva online, pago
            seguro y un scooter de 125 cc que te dé libertad para descubrir.
          </p>

          <p>
            Un scooter resulta especialmente práctico para desplazarte entre
            el casco antiguo de Palma, Santa Catalina, Paseo Marítimo, Portixol,
            Can Pastilla, Illetes y otras zonas cercanas. NEXA Rentals ofrece
            una reserva online sencilla y recogida en Magaluf. Actualmente no
            ofrecemos servicio de entrega de scooters.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Alquiler scooter Palma de Mallorca</span>
            <span>Alquilar scooter Palma de Mallorca</span>
            <span>Scooter de alquiler Palma de Mallorca</span>
            <span>Alquiler scooter casco antiguo Palma</span>
            <span>Alquiler scooter cerca Catedral de Mallorca</span>
            <span>Alquiler scooter Portixol Palma</span>
            <span>Alquiler scooter Can Pastilla Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en Palma de Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Palma de Mallorca?</summary>
              <p>
                ...
                Palma de Mallorca, el casco antiguo, Santa Catalina, Paseo
                Marítimo, Portixol y Can Pastilla.
              </p>
            </details>

            <details>
              <summary>¿Dónde recojo un scooter reservado para Palma de Mallorca?</summary>
              <p>
            ...
            <details>
              <summary>¿Hay servicio de entrega en Palma de Mallorca?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Palma de Mallorca?</h3>
            <p>
