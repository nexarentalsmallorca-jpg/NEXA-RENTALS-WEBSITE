...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal para orientarte por la bahía de Palma.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-el-arenal";
  }

  if (languageCode === "it") {
    return "/it/noleggio-scooter-el-arenal";
  }
  ...
  if (languageCode === "es") {
    return "/es/alquiler-scooter-el-arenal";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en El Arenal | 125 cc | NEXA Rentals",
    description:
      "Alquiler de scooter en El Arenal y Playa de Palma. Reserva online un scooter de 125 cc con NEXA Rentals, recógelo en Magaluf y descubre El Arenal, Playa de Palma, Can Pastilla, Palma y Llucmajor con libertad.",
    keywords: [
      "alquiler scooter El Arenal",
      "alquiler de scooters El Arenal",
      "alquilar scooter El Arenal",
      "scooter 125cc El Arenal",
      "alquiler moto scooter El Arenal",
      "scooter de alquiler El Arenal",
      "alquiler scooter S'Arenal",
      "alquilar scooter S'Arenal",
      "alquiler scooter Playa de Palma",
      "alquiler de scooters Playa de Palma",
      "alquiler scooter Can Pastilla",
      "alquilar scooter Can Pastilla",
      "alquiler scooter Palma",
      "alquiler scooter Llucmajor",
      "alquiler scooter sur de Mallorca",
      "scooter 125cc Playa de Palma",
      "reservar scooter online El Arenal",
      "NEXA Rentals El Arenal",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-el-arenal",
    },
    openGraph: {
      title: "Alquiler de scooter en El Arenal | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para El Arenal, Playa de Palma, Can Pastilla y el sur de Mallorca. Recogida en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-el-arenal",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en El Arenal con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalElArenalPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo directamente en nuestra oficina de Magaluf. Es una opción práctica para descubrir El Arenal, S’Arenal, Playa de Palma, Can Pastilla, Palma y Llucmajor.",
        },
      },
      {
        "@type": "Question",
        name: "¿A qué distancia está NEXA Rentals de El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals está en Magaluf. El trayecto desde El Arenal suele durar entre 25 y 30 minutos en coche, según el tráfico. La recogida y la devolución habituales del scooter se realizan en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para El Arenal y Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es una forma práctica de descubrir El Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor y otros destinos del sur de Mallorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "¿Hay servicio de entrega de scooters en El Arenal?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en El Arenal",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A unos 25–30 minutos de El Arenal
              </span>
            ...
            <h1>
              Alquila un scooter para El Arenal y descubre la bahía de Palma
              con libertad.
            </h1>

            <p className="nexa-hero-text">
              ¿Buscas <strong>alquiler de scooter en El Arenal</strong>,{" "}
              <strong>alquilar un scooter en El Arenal</strong> o un{" "}
              <strong>scooter de 125 cc en Playa de Palma</strong>? Con NEXA
            ...
            <p className="nexa-hero-text small">
              Ideal para El Arenal, Playa de Palma, Can Pastilla, Palma,
              Llucmajor y agradables rutas por la bahía de Palma. Un scooter es
              perfecto para llegar a playas, restaurantes y destinos turísticos
              populares con mayor libertad.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Alquiler de scooter en El Arenal y Playa de Palma"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Para El Arenal, Playa de Palma, Can Pastilla, Palma y el sur de
          Mallorca
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en El Arenal
            </span>

            <h2>
              Descubre El Arenal, Playa de Palma y Can Pastilla con mayor
              libertad.
            </h2>

            <p>
              El Arenal es ideal para disfrutar de días de playa, restaurantes,
              vida nocturna y excursiones por la bahía de Palma. Con un scooter
              de 125 cc puedes desplazarte con más facilidad entre El Arenal,
              Playa de Palma, Can Pastilla, Palma, Llucmajor y otros destinos
              del sur de Mallorca.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en El Arenal, alquilar un scooter en El Arenal o
              alquiler de moto scooter en Playa de Palma. Reservas y pagas
              online, y recoges tu scooter directamente en nuestra oficina de
              Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para El Arenal y Playa de Palma</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva un scooter para El Arenal en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                tus vacaciones en El Arenal y Playa de Palma.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Paga online el precio del alquiler y reserva tu scooter para El
                Arenal, Playa de Palma, Can Pastilla o la ruta que hayas
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva un scooter para El Arenal
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooters en El Arenal
          </span>

          <h2>
            Para viajeros que quieren descubrir El Arenal, Playa de Palma y el
            sur de Mallorca por su cuenta.
          </h2>

          <p>
            Si buscas “alquiler scooter El Arenal”, “alquiler de scooters El
            Arenal”, “scooter 125 cc El Arenal”, “alquiler moto scooter El
            Arenal” o “alquiler scooter Playa de Palma”, necesitas una solución
          ...
          <p>
            ...
            El Arenal, Playa de Palma, Can Pastilla, Palma, Llucmajor, Magaluf
            y Palmanova. La recogida y la devolución habituales se realizan
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el alquiler de scooter en El Arenal</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para El Arenal?</summary>
              <p>
                Sí. Puedes reservar online un scooter de 125 cc con NEXA
                Rentals y recogerlo directamente en Magaluf. Es una opción
                práctica para El Arenal, Playa de Palma, Can Pastilla,
                Llucmajor y Palma.
              </p>
            </details>

            <details>
              <summary>¿A qué distancia está NEXA Rentals de El Arenal?</summary>
              <p>
                Nuestra oficina está en Magaluf. El trayecto desde El Arenal
                suele durar entre 25 y 30 minutos en coche, según el tráfico.
            ...
            <details>
              <summary>¿Hay servicio de entrega en El Arenal?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Listo para descubrir El Arenal?</h3>
            <p>
