// app/[locale]/noleggio-scooter-el-toro/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Spazio pratico per la spiaggia, una borsa o gli acquisti.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Portacellulare impermeabile",
    text: "Perfetto per orientarsi tra El Toro, Magaluf e Calvià.",
  },
  {
    image: "/images/ex3.png",
    title: "Lucchetto",
    text: "Per soste sicure al porto, in spiaggia, in hotel o al ristorante.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter El Toro | Scooter 125cc El Toro Maiorca | NEXA Rentals",
    description:
      "Noleggio scooter a El Toro, Maiorca. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf e scopri El Toro, Port Adriano, Santa Ponsa, Palmanova e Calvià in libertà. A circa 20 minuti da El Toro.",
    keywords: [
      "noleggio scooter El Toro",
      "affitto scooter El Toro",
      "scooter 125cc El Toro",
      "noleggio motorino El Toro",
      "scooter a noleggio El Toro",
      "scooter rental El Toro",
      "El Toro noleggio scooter",
      "El Toro scooter rental",
      "noleggio scooter a El Toro Maiorca",
      "scooter 125cc El Toro Maiorca",
      "noleggio scooter Port Adriano",
      "affitto scooter Port Adriano",
      "noleggio scooter Santa Ponsa",
      "noleggio scooter Calvià",
      "NEXA Rentals El Toro",
      "prenotare scooter online El Toro",
      "scooter El Toro Maiorca",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/it/noleggio-scooter-el-toro",
    },
    openGraph: {
      title: "Noleggio scooter El Toro | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per El Toro e Port Adriano. Ritiro presso NEXA Rentals a Magaluf, a circa 20 minuti da El Toro.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-el-toro",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a El Toro con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterElToroPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter per El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online uno scooter 125cc con NEXA Rentals e ritirarlo presso il nostro ufficio di Magaluf. La nostra sede si trova a circa 20 minuti da El Toro ed è pratica per chi soggiorna a El Toro, Port Adriano, Santa Ponsa e Calvià.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf, a circa 20 minuti in auto da El Toro. Il ritiro e la riconsegna standard avvengono presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Posso prenotare uno scooter per Port Adriano ed El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. È una soluzione ideale per chi vuole scoprire El Toro, Port Adriano, Santa Ponsa, Magaluf, Palmanova e Calvià in libertà con uno scooter 125cc.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Cosa è incluso nel noleggio dello scooter per El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna dello scooter a El Toro?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Il ritiro e la riconsegna standard avvengono presso NEXA Rentals a Magaluf. La consegna può essere disponibile solo su richiesta, in base alla località, alla data e all’indirizzo. Contattaci prima di prenotare per verificarne la disponibilità.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a El Toro",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
        ...
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <div className="nexa-hero-kicker">
              A circa 20 minuti da El Toro
            </div>

            <h1>
              Noleggia uno scooter a El Toro e scopri Maiorca in libertà.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un servizio di{" "}
              <strong>noleggio scooter a El Toro</strong>,{" "}
              <strong>affitto scooter a El Toro</strong> o uno{" "}
              <strong>scooter 125cc a El Toro, Maiorca</strong>? Con NEXA
            ...
            <p className="nexa-hero-text small">
              Ideale per chi soggiorna a El Toro, Port Adriano, Santa Ponsa,
              Calvià, Magaluf e Palmanova. Raggiungi facilmente il porto, la
              spiaggia, i ristoranti, i punti panoramici o parti per
              un’escursione giornaliera senza dipendere da taxi o lunghe attese.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a El Toro e Port Adriano"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Ideale per chi soggiorna a El Toro, Port Adriano, Santa Ponsa e Calvià
        </p>

        <div className="nexa-trust-logos">
          <span>Noleggio scooter El Toro</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Il modo più semplice per muoversi nei dintorni di El Toro.
            </h2>

            <p>
              El Toro e Port Adriano sono perfetti per vivere Maiorca in modo
              tranquillo, esclusivo e flessibile. Con uno scooter 125cc puoi
              raggiungere spiagge, ristoranti, punti panoramici e località come
              Santa Ponsa, Magaluf, Palmanova e Calvià molto più facilmente
              rispetto al taxi o all’autobus.
            </p>

            <p>
              NEXA Rentals è una scelta pratica per chi soggiorna a El Toro:
              puoi prenotare online e ritirare lo scooter presso il nostro
              ufficio di Magaluf, a circa 20 minuti da El Toro. Prenoti online,
              riservi il tuo scooter e parti subito alla scoperta di Maiorca.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per El Toro e Port Adriano</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota uno scooter per El Toro in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                La prenotazione è rapida, chiara e ideale per chi soggiorna a
                El Toro.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                El Toro, Port Adriano, Santa Ponsa o per le tue escursioni a
                Maiorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota uno scooter per El Toro
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole esplorare El Toro, Port Adriano e il sud-ovest di
            Maiorca in completa libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter El Toro”, “affitto scooter El
            Toro”, “scooter 125cc El Toro”, “scooter a noleggio El Toro” o
            “scooter rental El Toro Maiorca”, hai bisogno di una soluzione
            semplice: prenotazione online, pagamento sicuro, ritiro chiaro e
            uno scooter con cui spostarti in completa libertà.
          </p>

          <p>
            El Toro si trova vicino a Port Adriano e Santa Ponsa. In questa zona
            uno scooter è particolarmente utile quando non vuoi ordinare ogni
            volta un taxi o attendere i collegamenti in autobus. NEXA Rentals
            offre una prenotazione online semplice, servizi trasparenti e ritiro
            presso il nostro ufficio di Magaluf, a circa 20 minuti da El Toro.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Noleggio scooter El Toro</span>
            <span>Affitto scooter El Toro</span>
            <span>Scooter 125cc El Toro</span>
            <span>Noleggio scooter Port Adriano</span>
            <span>Scooter rental El Toro</span>
            <span>Scooter a noleggio El Toro</span>
            <span>Noleggio motorino El Toro</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a El Toro</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Posso prenotare uno scooter per El Toro?</summary>
              <p>
                Sì. Puoi prenotare online uno scooter con NEXA Rentals e
                ritirarlo direttamente a Magaluf. È una soluzione pratica per
                El Toro, Port Adriano, Santa Ponsa e Calvià.
              </p>
            </details>

            <details>
              <summary>Quanto dista NEXA Rentals da El Toro?</summary>
              <p>
                La nostra sede si trova a Magaluf, a circa 20 minuti da El Toro.
            ...
            <details>
              <summary>È disponibile la consegna a El Toro?</summary>
              <p>
                Il ritiro e la riconsegna standard avvengono presso NEXA Rentals
                a Magaluf. La consegna può essere disponibile solo su richiesta,
                in base alla località, alla data e all’indirizzo. Contattaci
                prima di prenotare per verificarne la disponibilità.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Pronto a scoprire El Toro?</h3>
            <p>
