// app/[locale]/noleggio-scooter-aeroporto-maiorca/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Pratico per zaino, casco o borsa da spiaggia.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Portacellulare impermeabile",
    text: "Perfetto per orientarti dopo il tuo arrivo.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter aeroporto Maiorca | Scooter 125cc PMI | NEXA Rentals",
    description:
      "Cerchi un noleggio scooter vicino all’aeroporto di Maiorca? Prenota online uno scooter 125cc con NEXA Rentals, ritiralo dopo il tuo arrivo nel nostro ufficio di Magaluf e scopri Maiorca in libertà.",
    keywords: [
      "noleggio scooter aeroporto Maiorca",
      "noleggio scooter aeroporto Palma",
      "scooter aeroporto Maiorca",
      "scooter aeroporto Palma di Maiorca",
      "noleggio scooter PMI",
      "scooter 125cc aeroporto Maiorca",
      "noleggio motorino aeroporto Maiorca",
      "affitto scooter aeroporto Maiorca",
      "affitto motorino aeroporto Palma",
      "noleggio scooter Son Sant Joan",
      "scooter rental Mallorca airport",
      "noleggio scooter dopo arrivo Maiorca",
      "prenotare scooter aeroporto Maiorca",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-aeroporto-maiorca",
    },
    openGraph: {
      title: "Noleggio scooter aeroporto Maiorca | NEXA Rentals",
      description:
        "Prenota online uno scooter 125cc dopo il tuo arrivo a Maiorca. Ritiro presso NEXA Rentals a Magaluf, da 39€ tutto incluso.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-aeroporto-maiorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter vicino all’aeroporto di Maiorca con NEXA Rentals",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterAeroportoMaiorcaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso ritirare uno scooter direttamente all’aeroporto di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Puoi prenotare online uno scooter 125cc con NEXA Rentals e ritirarlo dopo il tuo arrivo presso il nostro ufficio di Magaluf. Al momento non offriamo il ritiro o la consegna direttamente all’aeroporto.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals dall’aeroporto di Palma di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf, in C. Galeón, 13, Loc 57. Dall’aeroporto di Palma di Maiorca PMI puoi raggiungere Magaluf in circa 25-35 minuti in auto o taxi, a seconda del traffico.",
        },
      },
      {
        "@type": "Question",
        name: "Posso prenotare lo scooter online prima del mio volo?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi scegliere online lo scooter, le date e la durata del noleggio e pagare il prezzo del noleggio online. In questo modo il tuo scooter 125cc resta riservato per le date selezionate.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna dello scooter all’aeroporto di Maiorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Non offriamo la consegna direttamente all’aeroporto. Il ritiro e la riconsegna standard avvengono presso NEXA Rentals a Magaluf. Per alcune zone alberghiere vicine, la consegna può essere disponibile solo su richiesta, in base alla località, alla data e all’indirizzo. Contattaci prima di prenotare.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc vicino all’aeroporto di Maiorca",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Prenota online prima dell’arrivo · Ritiro a Magaluf
              </span>
            ...
            <h1>
              Cerchi un noleggio scooter all’aeroporto di Maiorca? Parti da
              Magaluf in libertà.
            </h1>

            <p className="nexa-hero-text">
              Cerchi{" "}
              <strong>noleggio scooter aeroporto Maiorca</strong>,{" "}
              <strong>noleggio scooter aeroporto Palma</strong> o uno{" "}
              <strong>scooter 125cc vicino all’aeroporto PMI</strong>? Con NEXA
              Rentals prenoti online, paghi in modo sicuro e ritiri lo scooter
              dopo il tuo arrivo direttamente presso il nostro ufficio di
              Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Importante: non offriamo il ritiro o la consegna direttamente
              all’aeroporto. Puoi però prenotare prima del volo, conoscere il
              prezzo in anticipo e ritirare facilmente il tuo scooter presso
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                <strong>PMI</strong>
                <span>Mobilità dopo il tuo arrivo</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter aeroporto Palma di Maiorca PMI"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Ideale per muoversi dopo l’arrivo all’aeroporto di Palma di Maiorca
          PMI
        </p>

        <div className="nexa-trust-logos">
          <span>Aeroporto di Maiorca</span>
          <span>PMI Airport</span>
          <span>Aeroporto di Palma</span>
          <span>Magaluf</span>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Scooter dopo il tuo arrivo a Maiorca
            </span>

            <h2>
              Dopo il volo puoi muoverti in libertà, senza ricerche complicate.
            </h2>

            <p>
              Molti viaggiatori cercano subito dopo l’atterraggio “noleggio
              scooter aeroporto Maiorca”, “scooter aeroporto PMI” o “noleggio
              motorino aeroporto Palma”. L’obiettivo è semplice: muoversi
              facilmente, evitare di organizzare ogni tragitto in taxi e
              scoprire Maiorca con maggiore libertà.
            </p>

            <p>
              Con NEXA Rentals prenoti online il tuo scooter 125cc e lo ritiri
              presso il nostro ufficio di Magaluf. La nostra posizione è
              particolarmente pratica se il tuo hotel si trova a Magaluf,
              Palmanova, Santa Ponsa, Calvià o nella zona sud-occidentale di
              Maiorca.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per muoverti a Maiorca dopo il tuo arrivo</li>
              <li>Prenotazione e pagamento online</li>
              <li>2 caschi inclusi</li>
              <li>Bauletto da 50 litri per zaino, casco o borsa da spiaggia</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Dall’aeroporto di Maiorca al tuo scooter in tre semplici passaggi.
          </h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Prenota online in anticipo</h3>
              <p>
                Scegli il tuo scooter 125cc, la data e la durata del noleggio.
                È la soluzione ideale per organizzare la tua mobilità prima del
                volo.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Paga online il prezzo del noleggio e riserva lo scooter per il
                tuo soggiorno e le tue escursioni a Maiorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora lo scooter per il tuo arrivo
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole essere indipendente dopo il volo e scoprire Maiorca
            in libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter aeroporto Maiorca”, “scooter
            aeroporto Palma”, “noleggio scooter PMI”, “affitto motorino
            aeroporto Maiorca” o “scooter rental Mallorca airport”,
            probabilmente vuoi organizzare la tua mobilità già prima
            dell’arrivo.
          </p>

          <p>
            La nostra posizione è particolarmente comoda per chi soggiorna nel
            sud-ovest di Maiorca: Magaluf, Palmanova, Santa Ponsa, Calvià, Port
            Adriano o El Toro. Non offriamo la consegna direttamente
            all’aeroporto, perché la consegna del veicolo, il controllo dei
            documenti, la spiegazione e la riconsegna standard avvengono presso
            il nostro ufficio di Magaluf.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Noleggio scooter aeroporto Maiorca</span>
            <span>Noleggio scooter aeroporto Palma</span>
            <span>Scooter 125cc PMI</span>
            <span>Noleggio scooter dopo l’arrivo</span>
            <span>Scooter rental Mallorca airport</span>
            <span>Noleggio motorino aeroporto Maiorca</span>
            <span>Prenotare scooter online Maiorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>
            Domande sul noleggio scooter vicino all’aeroporto di Maiorca
          </h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Posso ritirare uno scooter direttamente all’aeroporto di
                Maiorca?
              </summary>
              <p>
                Al momento no. Puoi prenotare online il tuo scooter con NEXA
                Rentals e ritirarlo direttamente presso il nostro ufficio di
                Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>
                Quanto dista NEXA Rentals dall’aeroporto di Palma?
              </summary>
              <p>
                Il nostro ufficio si trova a Magaluf. Dall’aeroporto di Palma
                di Maiorca PMI puoi raggiungerci in circa 25-35 minuti in auto
                o taxi, a seconda del traffico.
              </p>
            </details>

            <details>
              <summary>
                Posso prenotare lo scooter prima del mio volo?
              </summary>
              <p>
                Sì. Puoi scegliere online lo scooter, la data e la durata del
                noleggio e pagare il prezzo online. In questo modo il veicolo
                resta riservato.
              </p>
            </details>
            ...
            <details>
              <summary>
                È disponibile la consegna all’aeroporto o in hotel?
              </summary>
              <p>
                Non offriamo la consegna direttamente all’aeroporto. Il ritiro
                e la riconsegna standard avvengono presso NEXA Rentals a
                Magaluf. Per alcune zone alberghiere vicine, la consegna può
                essere disponibile solo su richiesta, in base alla località,
                alla data e all’indirizzo. Contattaci prima di prenotare.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Vuoi essere subito indipendente dopo il volo?</h3>
            <p>
