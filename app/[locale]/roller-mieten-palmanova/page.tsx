...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal für Navigation in Palmanova und Mallorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Palmanova | 125cc Scooter Palma Nova | NEXA Rentals",
    description:
      "Roller mieten in Palmanova / Palma Nova. 125cc Scooter online bei NEXA Rentals buchen, direkt in Magaluf abholen und Palmanova, Son Matias, Magaluf, Portals Nous, Santa Ponsa und Calvià flexibel entdecken.",
    keywords: [
      ...
      "Roller mieten Son Matias",
      "Scooter mieten Son Matias",
      "Roller mieten Magaluf",
      "Scooter mieten Magaluf",
      "Roller mieten Calvia",
      "Roller mieten Portals Nous",
      "Roller mieten Santa Ponsa",
      "Roller mieten Mallorca Südwest",
      "Scooter mieten Mallorca Südwest",
      "Roller online buchen Palmanova",
      "NEXA Rentals Palmanova",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-palmanova`,
    },
    openGraph: {
      title: "Roller mieten Palmanova | NEXA Rentals Mallorca",
      description:
        "125cc Roller für Palmanova, Palma Nova, Son Matias, Magaluf und Calvià online buchen. Abholung direkt bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-palmanova`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Palmanova bei NEXA Rentals Mallorca",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenPalmanovaPage({ params }: PageProps) {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich in Palmanova einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist besonders praktisch für Gäste aus Palmanova, Palma Nova, Son Matias und Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Palmanova entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich direkt in Magaluf. Von Palmanova erreichst du unseren Standort je nach Verkehr ungefähr in 5 bis 10 Minuten. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Ist ein Roller praktisch für Palmanova und Palma Nova?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Palmanova, Palma Nova, Son Matias, Magaluf, Portals Nous, Santa Ponsa, Cala Vinyes und den Südwesten Mallorcas flexibel entdecken möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung nach Palmanova?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Palmanova",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-palmanova`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 5–10 Min. von Palmanova entfernt
              </span>
            ...
            <h1>Roller mieten in Palmanova und Mallorca flexibel entdecken.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Palmanova</strong>,{" "}
              <strong>Scooter mieten Palma Nova</strong> oder{" "}
              <strong>125cc Roller Palmanova</strong>? Bei NEXA Rentals buchst
              du deinen Roller online, bezahlst sicher online und holst ihn
              direkt in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Palmanova, Palma Nova, Son Matias, Magaluf, Portals Nous,
              Santa Ponsa, Cala Vinyes und den Südwesten Mallorcas. Perfekt,
              wenn du Strand, Hotel, Restaurants und Küstenorte flexibel
              verbinden möchtest.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Palmanova Palma Nova"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Für Palmanova, Palma Nova, Son Matias, Magaluf und Calvià</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Roller Verleih Palmanova</span>

            <h2>Palmanova, Magaluf und Südwest Mallorca einfacher verbinden.</h2>

            <p>
              Palmanova ist perfekt für Strand, Hotels, Restaurants und kurze
              Wege nach Magaluf, Son Matias, Portals Nous oder Santa Ponsa. Mit
              einem 125cc Roller bist du flexibler unterwegs und kannst Mallorca
              ohne Bus-Stress oder Taxi-Wartezeit erleben.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Palmanova, Scooter mieten Palma Nova oder Motorroller mieten
              Palmanova suchen. Du buchst online, bezahlst online und holst
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Palmanova und Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Palmanova zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                schnell, klar und ideal für deinen Urlaub in Palmanova.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Palmanova, Magaluf, Santa Ponsa oder deine Mallorca-Tour.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller für Palmanova buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Scooter mieten Palma Nova</span>

          <h2>
            Für Gäste, die Palmanova und den Südwesten Mallorcas unabhängig
            erleben möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Palmanova”, “Scooter mieten Palmanova”,
            “Roller mieten Palma Nova”, “125cc Roller Palmanova” oder
            “Motorroller mieten Palmanova” suchst, brauchst du eine einfache
            Lösung: online buchen, sicher bezahlen und mit einem 125cc Roller
            flexibel unterwegs sein.
          </p>

          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Palmanova, Son
            Matias, Magaluf, Portals Nous, Cala Vinyes, Santa Ponsa, Palma und
            weiteren Orten auf Mallorca. NEXA Rentals bietet dir eine einfache
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Roller mieten Son Matias</span>
            <span>Roller mieten Magaluf</span>
            <span>Roller mieten Calvià</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten in Palmanova</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Palmanova buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für
                Palmanova, Palma Nova, Son Matias und Magaluf.
              </p>
            </details>

            <details>
              <summary>Wie weit ist NEXA Rentals von Palmanova entfernt?</summary>
              <p>
                Unser Standort befindet sich direkt in Magaluf. Von Palmanova
                sind es je nach Verkehr ungefähr 5 bis 10 Minuten. Abholung und
            ...
            <details>
              <summary>Gibt es Lieferung nach Palmanova?</summary>
              <p>
