// app/[locale]/alquiler-scooter-paguera/page.tsx
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-paguera";
  }
  ...
  if (languageCode === "es") {
    return "/es/alquiler-scooter-paguera";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquiler de scooter en Paguera | Scooter 125 cc en Peguera | NEXA Rentals",
    description:
      "Alquiler de scooter en Paguera, Peguera y el suroeste de Mallorca. Reserva online un scooter de 125 cc con NEXA Rentals, recógelo en Magaluf y descubre Paguera, Cala Fornells, Camp de Mar, Santa Ponsa y Port d’Andratx con libertad.",
    keywords: [
      "alquiler scooter Paguera",
      "alquilar scooter Paguera",
      "scooter 125cc Paguera",
      "alquiler moto scooter Paguera",
      "alquiler motos Paguera",
      "scooter de alquiler Paguera",
    ...
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-paguera",
    },
    openGraph: {
      title: "Alquiler de scooter en Paguera | NEXA Rentals Mallorca",
      description:
        "Reserva online un scooter de 125 cc para Paguera, Peguera, Cala Fornells, Camp de Mar y el suroeste de Mallorca. Recogida en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-paguera",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquiler de scooter en Paguera con NEXA Rentals Mallorca",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalPagueraPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Puedo alquilar un scooter para Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Puedes reservar online un scooter de 125 cc con NEXA Rentals y recogerlo directamente en Magaluf. Es una opción práctica para quienes se alojan en Paguera, Peguera, Cala Fornells, Camp de Mar y Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se encuentra en Magaluf. Desde Paguera puedes llegar a nuestra oficina en unos 20–25 minutos en coche, dependiendo del tráfico. La recogida y la devolución habituales se realizan directamente en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Es práctico un scooter para recorrer Paguera y el suroeste de Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Un scooter de 125 cc es práctico para descubrir con libertad Paguera, Cala Fornells, Camp de Mar, Santa Ponsa, Port d’Andratx, Andratx y el suroeste de Mallorca.",
        },
      },
      {
        "@type": "Question",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc para Paguera",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A unos 20–25 minutos de Paguera
              </span>
            ...
            <h1>
              Alquila un scooter para Paguera y descubre el suroeste de Mallorca
              con libertad.
            </h1>
            ...
            <p className="nexa-hero-text">
              ...
              recoger tu scooter directamente en Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideal para recorrer Paguera, Peguera, Cala Fornells, Camp de Mar,
              Santa Ponsa, Port d’Andratx y las bonitas rutas costeras del
              suroeste de Mallorca. Perfecto para llegar a playas, puertos y
              restaurantes con mayor libertad.
            </p>
      ...
      <section className="nexa-trust-section">
        <p>
          Para Paguera, Peguera, Cala Fornells, Camp de Mar y Santa Ponsa
        </p>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Alquiler de scooter en Paguera
            </span>

            <h2>
              Descubre Paguera, Cala Fornells y Camp de Mar con más facilidad.
            </h2>

            <p>
              Paguera es ideal para disfrutar de playas, restaurantes, paseos
              marítimos y excursiones por el suroeste de Mallorca. Con un
              scooter de 125 cc puedes llegar más fácilmente a Cala Fornells,
              Camp de Mar, Santa Ponsa, Port d’Andratx, Andratx, Magaluf y
              Palmanova.
            </p>

            <p>
              NEXA Rentals es una opción práctica para quienes buscan alquiler
              de scooter en Paguera, alquilar un scooter en Peguera o recorrer
              el suroeste de Mallorca en moto scooter. Reservas y pagas online,
              y recoges el scooter directamente en Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter de 125 cc para Paguera y el suroeste de Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Reserva un scooter para Paguera en tres sencillos pasos.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Paguera, Cala Fornells, Camp de Mar o la ruta que tengas prevista
                por Mallorca.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva un scooter para Paguera
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler de scooter en Peguera
          </span>

          <h2>
            Para viajeros que quieren descubrir Paguera y el suroeste de
            Mallorca con total libertad.
          </h2>

          <p>
            Cuando buscas “alquiler scooter Paguera”, “alquilar scooter
            Paguera”, “alquiler scooter Peguera”, “scooter 125 cc Paguera” o
            “alquiler scooter suroeste Mallorca”, necesitas una solución
            sencilla: reserva online, pago seguro y un scooter de 125 cc que te
            dé libertad para descubrir la zona.
          </p>
          ...
          <p>
            ...
            Andratx, Magaluf y Palmanova. NEXA Rentals ofrece una reserva online
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <div className="nexa-faq-list">
            <details>
              <summary>¿Puedo reservar un scooter para Paguera?</summary>
              <p>
                ...
                Paguera, Peguera, Cala Fornells, Camp de Mar y Santa Ponsa.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Nuestra oficina está en Magaluf. Desde Paguera puedes llegar en
                unos 20–25 minutos en coche, dependiendo del tráfico. La recogida
                y la devolución habituales se realizan directamente en NEXA
                Rentals, Magaluf.
              </p>
            </details>
            ...
            <details>
              <summary>¿Hay servicio de entrega en Paguera?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>¿Todo listo para descubrir Paguera?</h3>
            <p>
