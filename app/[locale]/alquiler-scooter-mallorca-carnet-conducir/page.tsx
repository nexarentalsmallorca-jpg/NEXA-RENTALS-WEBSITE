...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "en") {
    return "/en/scooter-rental-mallorca-driving-licence";
  }

  if (languageCode === "es") {
    return "/es/alquiler-scooter-mallorca-carnet-conducir";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Carnet para alquilar scooter en Mallorca | 125 cc | NEXA Rentals",
    description:
      "¿Qué carnet necesitas para alquilar un scooter de 125 cc en Mallorca? NEXA Rentals acepta A, A1 y A2, o carnet B con al menos 3 años. Presenta el permiso físico original al recogerlo en Magaluf.",
    keywords: [
      "carnet para alquilar scooter Mallorca",
      "permiso conducir scooter 125cc Mallorca",
      "alquiler scooter Mallorca carnet B",
      "conducir scooter 125cc carnet coche",
      "carnet B scooter 125 Mallorca",
      "alquiler scooter Mallorca licencia conducir",
      "qué carnet necesito scooter Mallorca",
      "permiso A1 scooter Mallorca",
      "permiso A2 scooter Mallorca",
      "carnet moto Mallorca scooter",
      "scooter 125cc carnet 3 años",
      "alquiler scooter Magaluf carnet conducir",
      "conducir 125cc con carnet B Mallorca",
      "requisitos alquiler scooter Mallorca",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/es/alquiler-scooter-mallorca-carnet-conducir",
    },
    openGraph: {
      title: "Carnet para alquilar scooter en Mallorca | NEXA Rentals",
      description:
        "Consulta qué permiso necesitas para alquilar un scooter de 125 cc en Mallorca: A, A1, A2 o carnet B con al menos 3 años. Recogida en Magaluf.",
      url: "https://www.nexarentals.es/es/alquiler-scooter-mallorca-carnet-conducir",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Carnet para alquilar un scooter de 125 cc en Mallorca con NEXA Rentals",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function ScooterRentalMallorcaDrivingLicencePage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Qué carnet necesito para alquilar un scooter de 125 cc en Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aceptamos permisos de moto A, A1 y A2 válidos. También puedes alquilar un scooter de 125 cc con un permiso de coche de categoría B que tenga al menos 3 años de antigüedad.",
        },
      },
      {
        "@type": "Question",
        name: "¿Puedo conducir un scooter de 125 cc con el carnet B?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. NEXA Rentals acepta el permiso de coche de categoría B para sus scooters de 125 cc siempre que el permiso tenga una antigüedad mínima de 3 años.",
        },
      },
      {
        "@type": "Question",
        name: "¿Aceptáis permisos provisionales o de aprendizaje?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. No se aceptan permisos provisionales ni de aprendizaje para alquilar un scooter de 125 cc con NEXA Rentals.",
        },
      },
      {
        "@type": "Question",
        name: "¿Tengo que presentar el permiso de conducir original?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sí. Debes presentar el permiso de conducir físico original al recoger el scooter. No se aceptan fotografías ni copias del permiso.",
        },
      },
      {
        "@type": "Question",
        name: "¿Qué documentos debo llevar al recoger el scooter?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Debes llevar tu permiso de conducir físico original y tu pasaporte o documento de identidad al recoger el scooter en NEXA Rentals, Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "¿Dónde se recoge y se devuelve el scooter?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "La recogida y la devolución se realizan directamente en la oficina de NEXA Rentals en Magaluf. Actualmente no ofrecemos servicio de entrega de scooters.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Mallorca con carnet válido",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
      <Script
        id="nexa-seo-navbar-scroll-driving-licence-mallorca"
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Carnet A, A1, A2 o B con 3 años · Recogida en Magaluf
              </span>
            ...
            <h1>
              ¿Qué carnet necesitas para alquilar un scooter de 125 cc en
              Mallorca?
            </h1>

            <p className="nexa-hero-text">
              Si buscas información sobre el{" "}
              <strong>carnet para alquilar un scooter en Mallorca</strong>, en
              NEXA Rentals aceptamos los permisos de moto A, A1 y A2. También
              puedes conducir nuestros scooters de 125 cc con un{" "}
              <strong>carnet de coche B con al menos 3 años</strong> de
              antigüedad.
            </p>

            <p className="nexa-hero-text small">
              Debes presentar el permiso de conducir físico original al
              recoger el scooter. No se aceptan permisos provisionales o de
              aprendizaje, ni fotografías o copias del carnet.
            </p>

            <div className="nexa-hero-actions">
              <Link href={bookHref} className="nexa-primary-cta">
                Comprueba y reserva tu scooter
              </Link>
            ...
            <div className="nexa-hero-points">
              <div>
                ...
                <span>Permisos de moto aceptados</span>
              </div>

              <div>
                <strong>Carnet B</strong>
                <span>Válido desde hace al menos 3 años</span>
              </div>

              <div>
                <strong>Original</strong>
                <span>Documento físico obligatorio</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-top">
                <Image
                  ...
                  alt="Carnet válido para alquilar un scooter de 125 cc en Mallorca"
                  width={900}
                  height={620}
                  priority
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Conducir un scooter de 125 cc en Mallorca con carnet A, A1, A2 o B"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Requisitos claros para alquilar un scooter de 125 cc en Mallorca
        </p>
        ...
        <div className="nexa-trust-logos">
          ...
          <span>Carnet A1</span>
          <span>Carnet A2</span>
          <span>Carnet B + 3 años</span>
          <span>Permiso original</span>
        </div>
      </section>
        ...
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">
              Carnet para alquilar scooter en Mallorca
            </span>

            <h2>
              Comprueba tu permiso antes de reservar un scooter de 125 cc.
            </h2>

            <p>
              Para alquilar uno de nuestros scooters de 125 cc necesitas un
              permiso de moto A, A1 o A2 válido. También aceptamos el permiso
              de coche de categoría B cuando tiene una antigüedad mínima de 3
              años.
            </p>

            <p>
              El día de la recogida debes mostrar el permiso de conducir físico
              original. No podemos aceptar permisos provisionales o de
              aprendizaje, fotografías ni copias. Comprobar estos requisitos
              antes de reservar facilita una recogida rápida en nuestra oficina
              de Magaluf.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Permiso de moto A, A1 o A2 válido</li>
              <li>O permiso de coche B con al menos 3 años</li>
              <li>Permiso de conducir físico original obligatorio</li>
              <li>No se aceptan permisos provisionales o de aprendizaje</li>
              <li>No se aceptan fotografías ni copias del permiso</li>
              <li>Pasaporte o documento de identidad en la recogida</li>
      ...
      <section className="nexa-license-section">
        <div className="nexa-license-inner">
          <span className="nexa-section-label">
            Permiso de conducir para scooters de 125 cc
          </span>

          <h2>¿Qué permiso necesitas para conducir un scooter de 125 cc?</h2>

          <div className="nexa-license-grid">
            <div>
              <strong>A / A1 / A2</strong>
              <p>
                Puedes alquilar un scooter de 125 cc en NEXA Rentals con un
                permiso de moto A, A1 o A2 válido. Debes presentar el permiso
                físico original al recoger el scooter.
              </p>
            </div>

            <div>
              <strong>Permiso de categoría B</strong>
              <p>
                También puedes conducir un scooter de 125 cc con un permiso de
                coche de categoría B, siempre que tenga una antigüedad mínima
                de 3 años.
              </p>
            </div>

            <div>
              <strong>No aceptados</strong>
              <p>
                No se aceptan permisos provisionales o de aprendizaje, ni
                fotografías o copias. Trae tu permiso de conducir físico
                original.
              </p>
            </div>
          </div>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Comprueba tu carnet y reserva en tres sencillos pasos.
          </h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Revisa tu permiso</h3>
              <p>
                Comprueba que tienes un permiso A, A1 o A2 válido, o un carnet
                de coche B con una antigüedad mínima de 3 años.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Selecciona tu scooter de 125 cc, las fechas y la duración del
                alquiler, y completa el pago online de forma segura.
              </p>
            </div>

            <div>
              <span>03</span>
              <h3>Presenta el original</h3>
              <p>
                Acude a NEXA Rentals con tu permiso de conducir original y tu
                pasaporte o documento de identidad. Tras completar la recogida,
                podrás comenzar tu ruta de inmediato.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Reserva tu scooter de 125 cc
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">
            Alquiler scooter Mallorca carnet de conducir
          </span>

          <h2>
            Información clara sobre el carnet para conducir un scooter de 125
            cc en Mallorca.
          </h2>

          <p>
            Si buscas “carnet para alquilar scooter Mallorca”, “alquiler
            scooter Mallorca carnet B” o “permiso para conducir scooter 125 cc
            Mallorca”, la regla es sencilla: aceptamos A, A1 y A2, o un permiso
            de coche B que tenga al menos 3 años de antigüedad.
          </p>

          <p>
            Debes llevar el permiso físico original cuando recojas el scooter;
            no se aceptan permisos provisionales o de aprendizaje, fotografías
            ni copias. La recogida y la devolución se realizan en NEXA Rentals,
            Magaluf. Actualmente no ofrecemos servicio de entrega de scooters.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Carnet scooter 125 cc Mallorca</span>
            <span>Alquiler scooter Mallorca carnet B</span>
            <span>Permiso conducir scooter Mallorca</span>
            <span>Carnet B scooter 125 Mallorca</span>
            <span>Permiso A1 scooter Mallorca</span>
            <span>Permiso A2 scooter Mallorca</span>
            <span>Carnet moto scooter Mallorca</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre el carnet para alquilar scooter en Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                ¿Qué carnet necesito para alquilar un scooter de 125 cc?
              </summary>
              <p>
                Aceptamos permisos de moto A, A1 y A2 válidos. También puedes
                alquilarlo con un permiso de coche B que tenga al menos 3 años
                de antigüedad.
              </p>
            </details>

            <details>
              <summary>¿Puedo conducir un scooter de 125 cc con el carnet B?</summary>
              <p>
                Sí, siempre que tu permiso de coche de categoría B tenga una
                antigüedad mínima de 3 años.
              </p>
            </details>

            <details>
              <summary>¿Debo presentar el permiso de conducir original?</summary>
              <p>
                Sí. Debes presentar el permiso físico original al recoger el
                scooter. No se aceptan fotografías ni copias.
              </p>
            </details>

            <details>
              <summary>¿Aceptáis permisos provisionales o de aprendizaje?</summary>
              <p>
                No. Los permisos provisionales y de aprendizaje no se aceptan
                para alquilar nuestros scooters de 125 cc.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                ...
                en NEXA Rentals, Magaluf. Actualmente no ofrecemos servicio de
                entrega de scooters.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            <h3>¿Tu carnet cumple los requisitos?</h3>
            <p>
              Reserva online tu scooter de 125 cc y presenta el permiso físico
              original al recogerlo en NEXA Rentals, Magaluf.
            </p>
            <Link href={bookHref}>Reserva tu scooter</Link>
          </div>
        </div>
      </section>
