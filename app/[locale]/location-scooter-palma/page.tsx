...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Idéal pour utiliser le GPS dans Palma et partout à Majorque.",
  },
  {
    image: "/images/ex3.png",
    title: "Antivol",
    text: "Pour stationner en sécurité en ville, à la plage ou à l’hôtel.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-palma";
  }

  if (languageCode === "de") {
    return "/de/roller-mieten-palma";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Palma | Louer un scooter à Palma de Majorque | NEXA Rentals",
    description:
      "Location de scooter à Palma et Palma de Majorque. Réservez un scooter 125cc dès 39 €, payez en ligne et récupérez-le chez NEXA Rentals à Magaluf pour découvrir Palma, Santa Catalina, Cala Major et Majorque.",
    keywords: [
      "location scooter Palma",
      "location de scooter Palma",
      ...
      "location scooter Portixol",
      "location scooter Majorque",
      "réserver scooter Palma",
      "NEXA Rentals Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: "https://www.nexarentals.es/fr/location-scooter-palma",
    },
    openGraph: {
      title: "Location scooter Palma | NEXA Rentals Majorque",
      description:
        "Réservez un scooter 125cc pour Palma, Palma de Majorque, Santa Catalina, Cala Major et Portixol. Retrait chez NEXA Rentals à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Location de scooter à Palma avec NEXA Rentals",
        },
      ],
      locale: "fr_FR",
      type: "website",
...
export default async function LocationScooterPalmaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Peut-on louer un scooter à Palma ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Vous pouvez réserver votre scooter 125cc en ligne chez NEXA Rentals et le récupérer directement dans notre agence à Magaluf. Cette solution est pratique pour les voyageurs qui souhaitent découvrir Palma, Palma de Majorque, Cala Major, Santa Catalina, Portixol et les environs.",
        },
      },
      {
        "@type": "Question",
        name: "À quelle distance NEXA Rentals se trouve-t-il de Palma ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals se trouve à Magaluf. Depuis Palma, le trajet prend généralement environ 20 à 25 minutes en voiture selon la circulation. Le retrait et le retour standard s’effectuent directement chez NEXA Rentals à Magaluf.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Un scooter 125cc est pratique pour relier Palma, la vieille ville, Santa Catalina, le Paseo Marítimo, Cala Major, Portixol, Palmanova, Magaluf et d’autres destinations de Majorque.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "La livraison à Palma est-elle disponible ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le retrait standard s’effectue chez NEXA Rentals à Magaluf. Pour une demande de livraison à Palma, contactez-nous avant de réserver afin de vérifier la disponibilité selon vos dates et votre adresse.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Location de scooter 125cc à Palma",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Palma, Majorque",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                À environ 20 à 25 min de Palma
              </span>
            ...
            <h1>
              Location de scooter à Palma pour découvrir Majorque sans attendre.
            </h1>

            <p className="nexa-hero-text">
              Vous recherchez une <strong>location de scooter à Palma</strong>,
              une{" "}
              <strong>location de scooter à Palma de Majorque</strong> ou un{" "}
              <strong>scooter 125cc à Palma</strong> ? Chez NEXA Rentals, vous
              réservez votre scooter en ligne, payez en toute sécurité et le
              récupérez directement dans notre agence à Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Une solution idéale pour la vieille ville de Palma, la cathédrale
              La Seu, Santa Catalina, le Paseo Marítimo, Cala Major, Portixol,
              Palmanova et vos excursions à Majorque. Parfait pour relier la
              ville, les plages, le port et la côte en toute liberté.
            </p>
      ...
      <section className="nexa-trust-section">
        <p>
          Pour Palma, Palma de Majorque, Santa Catalina, Cala Major et Portixol
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Reliez plus facilement Palma, la vieille ville et la côte.
            </h2>

            <p>
              Palma est une destination idéale pour découvrir la vieille ville,
              les boutiques, les restaurants, Santa Catalina, la cathédrale La
              Seu et le Paseo Marítimo. Avec un scooter 125cc, vous pouvez
              explorer Palma et la côte plus librement, sans organiser chaque
              trajet autour des bus, des taxis ou des longues recherches de
              stationnement.
            </p>

            <p>
              NEXA Rentals est une solution pratique pour les voyageurs qui
              recherchent une location de scooter à Palma, une location de
              scooter à Palma de Majorque ou un scooter 125cc près de Palma.
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc pour Palma et Majorque</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter pour Palma en trois étapes simples.</h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                votre scooter pour Palma, Magaluf, Palmanova ou votre excursion
                sur l’île.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Réserver un scooter pour Palma
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            ...
            Majorque en toute indépendance.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Palma »,
            « louer un scooter à Palma », « location scooter Palma de
            Majorque », « scooter 125cc Palma » ou « location scooter vieille
            ville Palma », vous cherchez généralement une solution simple :
            réserver en ligne, payer en toute sécurité et disposer d’un scooter
            125cc pour vous déplacer librement.
          </p>

          <p>
            Un scooter est particulièrement pratique pour les trajets entre
            Palma, Santa Catalina, le Paseo Marítimo, Cala Major, Portixol,
            Magaluf, Palmanova et les autres destinations de Majorque. NEXA
            Rentals vous propose une réservation simple en ligne et un retrait
            à Magaluf. Pour une demande de livraison à Palma, contactez-nous
            avant de réserver afin de vérifier la disponibilité selon vos dates
            et votre adresse.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Location scooter Palma</span>
            <span>Louer un scooter Palma</span>
            <span>Location scooter Palma de Majorque</span>
            <span>Scooter 125cc Palma</span>
            <span>Location scooter Santa Catalina</span>
            <span>Location scooter Cala Major</span>
            <span>Location deux roues Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Questions sur la location de scooter à Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Puis-je réserver un scooter pour Palma ?</summary>

              <p>
                Oui. Vous pouvez réserver votre scooter 125cc en ligne chez
                NEXA Rentals et le récupérer directement dans notre agence à
                Magaluf. Cette solution est pratique pour Palma, Palma de
                Majorque, Santa Catalina, Cala Major et Portixol.
              </p>
            </details>

            <details>
              <summary>
                À quelle distance NEXA Rentals se trouve-t-il de Palma ?
              </summary>

              <p>
                Notre agence se trouve à Magaluf. Depuis Palma, le trajet prend
                généralement environ 20 à 25 minutes en voiture selon la
            ...
            <details>
              <summary>La livraison est-elle disponible à Palma ?</summary>

              <p>
                Le retrait standard s’effectue chez NEXA Rentals à Magaluf.
                Pour une demande de livraison à Palma, contactez-nous avant de
      ...
      <style>{`
        .nexa-seo-page,
        .nexa-seo-page * {
          font-family: var(--font-nexa-seo), Poppins, Arial, Helvetica,
            sans-serif;
