...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    title: "Topcase",
    text: "Praktisch für Rucksack, Helm oder Strandtasche.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Handyhalterung",
    text: "Perfekt für Navigation nach deiner Ankunft.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Mallorca Flughafen | 125cc Scooter PMI | NEXA Rentals",
    description:
      "Roller mieten Mallorca Flughafen gesucht? 125cc Roller online bei NEXA Rentals buchen, nach der Ankunft in Magaluf abholen und Mallorca flexibel entdecken. Ideal für Palma Flughafen PMI, Son Sant Joan, Magaluf, Palmanova und Südwest Mallorca.",
    keywords: [
      "Roller mieten Mallorca Flughafen",
      "Scooter mieten Mallorca Flughafen",
      "125cc Roller Mallorca Flughafen",
      "Motorroller mieten Mallorca Flughafen",
      "Roller mieten Palma Flughafen",
      "Scooter mieten Palma Flughafen",
      "Roller mieten PMI",
      "Scooter mieten PMI",
      "Roller mieten Flughafen Palma de Mallorca",
      "Scooter Rental Mallorca Airport",
      "Roller mieten Son Sant Joan",
      "125cc Scooter Mallorca Airport",
      "Roller mieten nach Ankunft Mallorca",
      "Roller online buchen Mallorca Flughafen",
      "NEXA Rentals Mallorca Flughafen",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-mallorca-flughafen`,
    },
    openGraph: {
      title: "Roller mieten Mallorca Flughafen | NEXA Rentals",
      description:
        "125cc Roller nach deiner Ankunft auf Mallorca online buchen. Abholung bei NEXA Rentals in Magaluf, von 39€ alles inklusive.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-mallorca-flughafen`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Mallorca Flughafen bei NEXA Rentals",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenMallorcaFlughafenPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich direkt am Mallorca Flughafen einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn nach deiner Ankunft direkt in Magaluf abholen. Aktuell bieten wir keine Abholung direkt am Flughafen an.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals vom Flughafen Palma de Mallorca entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Vom Flughafen Palma de Mallorca PMI erreichst du Magaluf je nach Verkehr ungefähr in 25 bis 35 Minuten mit Auto oder Taxi.",
        },
      },
      {
        "@type": "Question",
        name: "Kann ich den Roller schon vor meinem Flug online buchen?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen Roller online buchen und den Mietpreis online bezahlen. So ist dein 125cc Roller für deine gewünschten Daten reserviert.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung zum Mallorca Flughafen?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aktuell bieten wir keinen Lieferservice zum Flughafen an. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Mallorca Flughafen",
      priceCurrency: "EUR",
      availability: "https://schema.org/InStock",
      areaServed: "Mallorca Flughafen",
    },
  };
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-mallorca-flughafen`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Nach Ankunft online buchen · Abholung in Magaluf
              </span>
            ...
            <h1>Roller mieten am Mallorca Flughafen gesucht? Starte flexibel in Magaluf.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Mallorca Flughafen</strong>,{" "}
              <strong>Scooter mieten Palma Flughafen</strong> oder{" "}
              <strong>125cc Roller PMI Airport</strong>? Bei NEXA Rentals buchst du
              deinen Roller online, bezahlst sicher online und holst ihn nach deiner
              Ankunft direkt in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Wichtig: Wir bieten aktuell keine direkte Flughafen-Lieferung an.
              Dafür bekommst du eine klare Online-Buchung, transparente Preise und
              eine einfache Abholung bei NEXA Rentals in Magaluf.
            </p>
            ...
            <div className="nexa-hero-points">
              ...
              <div>
                <strong>PMI</strong>
                <span>Nach Ankunft mobil sein</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Palma Flughafen Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Ideal nach deiner Ankunft am Flughafen Palma de Mallorca PMI</p>

        <div className="nexa-trust-logos">
          <span>Mallorca Flughafen</span>
          <span>PMI Airport</span>
          <span>Palma Flughafen</span>
          <span>Magaluf</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Roller nach Ankunft auf Mallorca</span>

            <h2>Nach dem Flug direkt mobil sein – ohne komplizierte Suche.</h2>

            <p>
              Viele Urlauber suchen direkt nach der Landung nach Roller mieten
              Mallorca Flughafen, Scooter mieten PMI oder Motorroller mieten Palma
              Flughafen. Der Wunsch ist klar: schnell mobil sein, nicht jeden Weg
              mit Taxi planen und Mallorca frei entdecken.
            </p>

            <p>
              Bei NEXA Rentals reservierst du deinen 125cc Roller online und holst
              ihn in Magaluf ab. Unser Standort ist besonders praktisch, wenn dein
              Hotel in Magaluf, Palmanova, Santa Ponsa, Calvià oder im Südwesten
              Mallorcas liegt.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Mallorca nach deiner Ankunft</li>
              <li>Online buchen und online bezahlen</li>
              <li>2 Helme inklusive</li>
              <li>Topcase für Rucksack, Helm oder Strandzeug</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Vom Flughafen Mallorca zur Roller-Buchung in drei Schritten.</h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Vorab online buchen</h3>
              <p>
                Wähle deinen 125cc Roller, Datum und Mietdauer. Ideal, wenn du
                deine Mobilität schon vor dem Flug sichern möchtest.
              </p>
            </div>

            <div>
              <span>02</span>
              <h3>Reservierung sichern</h3>
              <p>
                Bezahle den Mietpreis online und sichere dir deinen Roller für
                deine Mallorca-Reise oder deine Touren.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Rentals. Wir erklären dir alles und du kannst direkt starten.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller nach Ankunft buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Scooter mieten Mallorca Airport</span>

          <h2>Für Urlauber, die nach dem Flug auf Mallorca unabhängig sein möchten.</h2>

          <p>
            Wenn du nach “Roller mieten Mallorca Flughafen”, “Scooter mieten
            Mallorca Flughafen”, “Roller mieten Palma Flughafen”, “Roller mieten
            PMI” oder “Scooter Rental Mallorca Airport” suchst, möchtest du
            wahrscheinlich schon direkt nach der Ankunft mobil sein.
          </p>

          <p>
            Unser Standort ist besonders sinnvoll, wenn du im Südwesten Mallorcas
            bleibst: Magaluf, Palmanova, Santa Ponsa, Calvià, Port Adriano oder
            El Toro. Aktuell bieten wir keine Lieferung zum Flughafen an, damit
            Übergabe, Erklärung, Dokumentencheck und Rückgabe sauber im Büro
            stattfinden.
          </p>

          <div className="nexa-keyword-cloud">
            <span>Roller mieten Mallorca Flughafen</span>
            <span>Scooter mieten Palma Flughafen</span>
            <span>125cc Roller PMI</span>
            <span>Roller mieten nach Ankunft</span>
            <span>Scooter Rental Mallorca Airport</span>
            <span>Motorroller Mallorca Flughafen</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten am Mallorca Flughafen</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich direkt am Flughafen Mallorca einen Roller abholen?</summary>
              <p>
                Aktuell nicht. Du kannst deinen Roller online bei NEXA Rentals
                buchen und ihn direkt in unserem Büro in Magaluf abholen.
              </p>
            </details>

            <details>
              <summary>Wie weit ist NEXA Rentals vom Flughafen Palma entfernt?</summary>
              <p>
                Unser Standort befindet sich in Magaluf. Vom Flughafen Palma de
                Mallorca PMI sind es je nach Verkehr ungefähr 25 bis 35 Minuten
                mit Auto oder Taxi.
              </p>
            </details>

            <details>
              <summary>Kann ich den Roller schon vor meinem Flug buchen?</summary>
              <p>
                Ja. Du kannst online Datum, Dauer und Roller auswählen und den
                Mietpreis online bezahlen. So ist dein Roller reserviert.
              </p>
            </details>
            ...
            <details>
              <summary>Gibt es Lieferung zum Flughafen oder Hotel?</summary>
              <p>
                Aktuell bieten wir keinen Lieferservice an. Abholung und Rückgabe
                erfolgen direkt bei NEXA Rentals in Magaluf.
              </p>
            </details>
          </div>

          <div className="nexa-final-cta">
            <h3>Nach dem Flug direkt mobil?</h3>
            <p>
