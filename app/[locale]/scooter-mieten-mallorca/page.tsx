...
export async function generateMetadata({
  ...
  return {
    title:
      "Scooter mieten Mallorca | 125cc Scooter & Roller mieten | NEXA Rentals",
    description:
      "Scooter mieten auf Mallorca bei NEXA Rentals in Magaluf. 125cc Scooter und Roller ab 39€ online buchen, online bezahlen und direkt in Magaluf abholen. Ideal für Magaluf, Palmanova, Santa Ponsa, Paguera, Palma Nova und Südwest-Mallorca.",
    keywords: [
      ...
      "günstig Scooter mieten Mallorca",
      "Mallorca Scooter online buchen",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/scooter-mieten-mallorca`,
    },
    openGraph: {
      title: "Scooter mieten Mallorca | NEXA Rentals Magaluf",
      description:
        "125cc Scooter und Roller auf Mallorca online buchen. Abholung und Rückgabe bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/scooter-mieten-mallorca`,
...
export default async function ScooterMietenMallorcaPage({ params }: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Wo kann ich einen Scooter auf Mallorca mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Du kannst deinen 125cc Scooter online bei NEXA Rentals buchen und direkt im Büro in Magaluf abholen. Die Abholung und Rückgabe erfolgt aktuell bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Kann ich den Scooter auf Mallorca online bezahlen?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Bei NEXA Rentals kannst du deinen Scooter online reservieren und den Mietpreis online bezahlen. So ist dein 125cc Scooter für deine gewünschten Daten fest gebucht.",
        },
      },
      {
        "@type": "Question",
        name: "Welche Fahrerlaubnis brauche ich für einen 125cc Scooter auf Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Du brauchst A, A1 oder A2. Mit einem B-Führerschein kannst du einen 125cc Scooter fahren, wenn der Führerschein seit mindestens 3 Jahren gültig ist. Provisorische oder Lernführerscheine werden nicht akzeptiert.",
        },
      },
      {
        "@type": "Question",
        name: "Was ist beim Scooter mieten auf Mallorca inklusive?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Gibt es eine Lieferung auf Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aktuell bieten wir keinen Lieferservice an. Die Abholung und Rückgabe erfolgt direkt bei NEXA Rentals in Magaluf, damit die Übergabe schnell, sicher und klar bleibt.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Scooter mieten Mallorca",
      priceCurrency: "EUR",
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/scooter-mieten-mallorca`}
                      className={
                        active
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Scooter mieten Mallorca: 125cc Scooter online buchen.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Scooter mieten Mallorca</strong>,{" "}
              <strong>125cc Scooter Mallorca</strong> oder{" "}
              <strong>Scooter Verleih Mallorca</strong>? Bei NEXA Rentals
              buchst du deinen Scooter online, bezahlst den Mietpreis direkt
              online und holst deinen 125cc Scooter unkompliziert in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Magaluf, Palmanova, Palma Nova, Santa Ponsa, Paguera,
              Calvià, Strandtage, Aussichtspunkte, Restaurants und flexible
              Ausflüge ohne Taxi-Stress.
            </p>

            <div className="nexa-hero-actions">
              <Link href={bookHref} className="nexa-primary-cta">
                Scooter jetzt buchen
              </Link>
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Direkt in Magaluf auf Mallorca.</strong>
                <span>
                  NEXA Rentals befindet sich in Magaluf — einfach online buchen,
                  vor Ort abholen und direkt Richtung Strand, Palmanova, Santa
                  Ponsa oder Paguera starten.
                </span>
              </div>
            ...
            <div className="nexa-hero-points">
              <div>
                ...
                <span>Halbtags Scooter mieten</span>
              </div>

              <div>
                <strong>125cc</strong>
                <span>Piaggio & SYM Scooter</span>
              </div>

              <div>
                <strong>Magaluf</strong>
                <span>Online buchen, vor Ort abholen</span>
              </div>
            </div>
          </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-top">
                <Image
                  ...
                  alt="Scooter mieten Mallorca mit NEXA Rentals in Magaluf"
                  width={900}
                  height={620}
                  priority
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="125cc Scooter mieten Mallorca bei NEXA Rentals"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Der einfache Weg, einen Scooter auf Mallorca zu mieten.</h2>

            <p>
              Viele Reisende suchen auf Mallorca nach einem Scooter, Roller oder
              Motorroller, um nicht jeden Tag auf Taxi, Bus oder lange
              Wartezeiten angewiesen zu sein. Bei NEXA Rentals machst du es
              einfacher: Du reservierst deinen 125cc Scooter online, bezahlst
              online und holst ihn direkt im Büro in Magaluf ab.
            </p>

            <p>
              Unsere Scooter sind perfekt für kurze Wege, Strandtage und
              flexible Ausflüge rund um Magaluf, Palmanova, Palma Nova, Portals
              Nous, Santa Ponsa, Paguera und Calvià. Du steigst auf, fährst los
              und entdeckst Mallorca in deinem eigenen Tempo.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Scooter für Mallorca</li>
              <li>Direkte Abholung in Magaluf</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>In wenigen Schritten zum Scooter auf Mallorca.</h2>

          <div className="nexa-how-grid">
            <div>
              <span>01</span>
              <h3>Scooter online wählen</h3>
              <p>
                Wähle deinen 125cc Scooter, dein Datum und deine Mietdauer. Die
                Buchung ist schnell, klar und ideal für Mallorca Urlauber.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Du bezahlst den Mietpreis online und sicherst dir deinen
                Scooter für deine Reisedaten. So ist dein Fahrzeug fest
                reserviert, bevor dein Urlaubstag startet.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Rentals in Magaluf. Wir erklären dir alles und du kannst direkt
                Richtung Strand, Palmanova, Santa Ponsa oder Paguera losfahren.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Scooter auf Mallorca buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Scooter mieten Mallorca</span>
          ...
          <p>
            Wenn du bei Google nach “Scooter mieten Mallorca”, “Scooter Rental
            Mallorca”, “Scooter Verleih Mallorca”, “Roller mieten Mallorca”
            oder “125cc Scooter Mallorca” suchst, willst du meistens keine
            komplizierte Seite, sondern eine schnelle Lösung. Genau dafür ist
            NEXA Rentals gemacht: klare Informationen, echte Online-Buchung,
            sichere Online-Zahlung und ein Scooter, mit dem du Mallorca flexibel
            erleben kannst.
          </p>

          <p>
            Diese Seite ist besonders praktisch, wenn du in Magaluf, Palmanova,
            Palma Nova, Santa Ponsa, Paguera, Portals Nous oder im Südwesten von
            Mallorca wohnst. Aktuell bieten wir keine Lieferung an: Die Abholung
            und Rückgabe erfolgt direkt bei NEXA Rentals in Magaluf. So bleibt
            die Übergabe persönlich, schnell und sauber organisiert.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Scooter mieten Palmanova</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Scooter mieten auf Mallorca</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Welche Fahrerlaubnis brauche ich für einen 125cc Scooter?</summary>
              <p>
                Du brauchst A, A1 oder A2. Mit einem B-Führerschein kannst du
                einen 125cc Scooter fahren, wenn dein B-Führerschein seit
            ...
            <details>
              <summary>Wo hole ich den Scooter ab?</summary>
              <p>
            ...
            <details>
              <summary>Kann ich den Scooter online bezahlen?</summary>
              <p>
                Ja. Du buchst online und bezahlst den Mietpreis online, damit
                dein Scooter für deine gewünschten Daten reserviert ist.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                ...
                Palmanova, Palma Nova, Santa Ponsa, Paguera oder Calvià
                unterwegs bist und einen Scooter auf Mallorca mieten möchtest.
              </p>
            </details>
          </div>
          ...
          <div className="nexa-final-cta">
            ...
            <p>
              Buche deinen 125cc Scooter online und starte direkt bei NEXA
              Rentals in Magaluf.
            </p>
            <div className="nexa-final-cta-actions">
              <Link href={bookHref}>Jetzt Scooter buchen</Link>
              <a href={mapsHref} target="_blank" rel="noreferrer">
                In Maps öffnen
              </a>
            </div>
