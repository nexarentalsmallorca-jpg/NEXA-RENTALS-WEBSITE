// app/[locale]/alquilar-scooter-mallorca/page.tsx
...
function getLanguageHref(languageCode: Locale) {
  ...
  if (languageCode === "es") {
    return "/es/alquilar-scooter-mallorca";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Alquilar scooter en Mallorca | 125 cc desde 39 € | NEXA Rentals",
    description:
      "Alquila un scooter en Mallorca con NEXA Rentals en Magaluf. Reserva online un scooter de 125 cc desde 39 €, recógelo en nuestra oficina y descubre Magaluf, Palmanova, Santa Ponsa y Calvià con libertad.",
    keywords: [
    ...
    alternates: {
      canonical: "https://www.nexarentals.es/es/alquilar-scooter-mallorca",
    },
    openGraph: {
      title: "Alquilar scooter en Mallorca | NEXA Rentals Magaluf",
      description:
        "Alquila un scooter de 125 cc en Mallorca desde 39 €. Reserva online y recógelo en NEXA Rentals, Magaluf.",
      url: "https://www.nexarentals.es/es/alquilar-scooter-mallorca",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Alquilar un scooter en Mallorca con NEXA Rentals en Magaluf",
        },
      ],
      locale: "es_ES",
      type: "website",
...
export default async function RentAScooterMallorcaPage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "¿Dónde puedo alquilar un scooter en Mallorca con NEXA Rentals?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "¿Qué incluye alquilar un scooter en Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Alquiler de scooter de 125 cc en Mallorca",
      price: "39",
      priceCurrency: "EUR",
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Alquila un scooter en Mallorca directamente desde Magaluf.</h1>

            <p className="nexa-hero-text">
              ¿Quieres <strong>alquilar un scooter en Mallorca</strong>, buscas{" "}
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>La forma sencilla de alquilar un scooter en Mallorca.</h2>

            <p>
              Muchos viajeros esperan a llegar de vacaciones para buscar
              alquiler de scooter en Mallorca, Magaluf o Palmanova. Con NEXA
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Alquila un scooter en Mallorca en tres sencillos pasos.</h2>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Alquila tu scooter en Mallorca
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Alquilar scooter en Mallorca</span>
          ...
          <p>
            Si buscas “alquilar scooter Mallorca”, “alquiler scooter Mallorca”,
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Preguntas sobre cómo alquilar un scooter en Mallorca</h2>
          ...
          <div className="nexa-final-cta">
            ...
            <Link href={bookHref}>Alquila tu scooter ahora</Link>
          </div>
        </div>
      </section>
