// app/[locale]/roller-mieten-paguera/page.tsx
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Paguera | 125cc Scooter Peguera | NEXA Rentals Mallorca",
    description:
      "Roller mieten in Paguera / Peguera und Südwest Mallorca. 125cc Scooter online bei NEXA Rentals buchen, in Magaluf abholen und Paguera, Cala Fornells, Camp de Mar, Santa Ponsa und Port d’Andratx flexibel entdecken.",
    keywords: [
      "Roller mieten Paguera",
      "Scooter mieten Paguera",
      "125cc Roller Paguera",
      "Motorroller mieten Paguera",
      "Roller Verleih Paguera",
      "Scooter Rental Paguera",
      "Roller mieten Peguera",
      "Scooter mieten Peguera",
      ...
      "Roller online buchen Paguera",
      "NEXA Rentals Paguera",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-paguera`,
    },
    openGraph: {
      title: "Roller mieten Paguera | NEXA Rentals Mallorca",
      description:
        "125cc Roller für Paguera, Peguera, Cala Fornells, Camp de Mar und Südwest Mallorca online buchen. Abholung bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-paguera`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Paguera bei NEXA Rentals Mallorca",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenPagueraPage({ params }: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich in Paguera einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist praktisch für Gäste aus Paguera, Peguera, Cala Fornells, Camp de Mar und Santa Ponsa.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Von Paguera erreichst du unseren Standort je nach Verkehr ungefähr in 20 bis 25 Minuten mit dem Auto. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Ist ein Roller praktisch für Paguera und Südwest Mallorca?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Paguera, Cala Fornells, Camp de Mar, Santa Ponsa, Port d’Andratx, Andratx und den Südwesten Mallorcas flexibel entdecken möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung nach Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Paguera",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-paguera`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 20–25 Min. von Paguera entfernt
              </span>
            ...
            <h1>Roller mieten in Paguera und den Südwesten Mallorcas frei erleben.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Paguera</strong>,{" "}
              <strong>Scooter mieten Peguera</strong> oder{" "}
            ...
            <p className="nexa-hero-text small">
              Ideal für Paguera, Peguera, Cala Fornells, Camp de Mar, Santa
              Ponsa, Port d’Andratx und schöne Küstenfahrten im Südwesten
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Paguera Südwest Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Für Paguera, Peguera, Cala Fornells, Camp de Mar und Santa Ponsa</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            <span className="nexa-section-label">Roller Verleih Paguera</span>

            <h2>Paguera, Cala Fornells und Camp de Mar flexibler entdecken.</h2>

            <p>
              Paguera ist perfekt für Strand, Restaurants, Promenade und Ausflüge
              im Südwesten Mallorcas. Mit einem 125cc Roller kannst du Orte wie
              Cala Fornells, Camp de Mar, Santa Ponsa, Port d’Andratx, Andratx,
              Magaluf und Palmanova einfacher verbinden.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Paguera, Scooter mieten Peguera oder Motorroller mieten
              Südwest Mallorca suchen. Du buchst online, bezahlst online und
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Paguera und Südwest Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Paguera zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Paguera, Cala Fornells, Camp de Mar oder deine Mallorca-Tour.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Scooter mieten Peguera</span>

          <h2>
            Für Gäste, die Paguera und den Südwesten Mallorcas unabhängig erleben
            möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Paguera”, “Scooter mieten Paguera”,
            “Roller mieten Peguera”, “125cc Roller Paguera” oder “Roller mieten
            Südwest Mallorca” suchst, brauchst du eine einfache Lösung: online
            buchen, sicher bezahlen und mit einem 125cc Roller flexibel unterwegs
            sein.
          </p>

          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Paguera, Cala
            Fornells, Camp de Mar, Santa Ponsa, Port d’Andratx, Andratx, Magaluf
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten in Paguera</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Paguera buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für Paguera,
                Peguera, Cala Fornells, Camp de Mar und Santa Ponsa.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Unser Standort befindet sich in Magaluf. Von Paguera sind es je
            ...
            <details>
              <summary>Gibt es Lieferung nach Paguera?</summary>
              <p>
