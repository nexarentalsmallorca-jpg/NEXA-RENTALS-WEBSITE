...
const INCLUDED_ITEMS = [
  {
    ...
    title: "Deux casques",
    text: "Pour le conducteur et le passager.",
  },
  {
    image: "/images/ex1.jpg",
    title: "Top case",
    text: "Un espace pratique pour ranger vos affaires.",
  },
  {
    image: "/images/ex2.jpg",
    title: "Support téléphone",
    text: "Idéal pour utiliser le GPS à Majorque.",
  },
  {
    image: "/images/ex3.png",
    title: "Antivol",
    text: "Pour stationner en sécurité à la plage ou à l’hôtel.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "fr") {
    return "/fr/location-scooter-majorque";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Location scooter Majorque | Louer un scooter à Magaluf | NEXA Rentals",
    description:
      "Location de scooter à Majorque chez NEXA Rentals à Magaluf. Scooters 125cc dès 39 €, réservation et paiement en ligne, retrait à Magaluf.",
    keywords: [
      ...
      "location scooter 125 Majorque",
      "location scooter pas cher Majorque",
      "location deux roues Majorque",
      "réserver scooter Majorque",
      "scooter Mallorca location",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/fr/location-scooter-majorque",
    },
    openGraph: {
      title: "Location scooter Majorque | NEXA Rentals Magaluf",
      description:
        "Louez un scooter 125cc à Majorque. Réservez et payez en ligne, puis récupérez votre scooter directement à Magaluf.",
      url: "https://www.nexarentals.es/fr/location-scooter-majorque",
...
export default async function LocationScooterMajorquePage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Où louer un scooter à Majorque avec NEXA Rentals ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous pouvez réserver votre scooter 125cc en ligne et le récupérer directement chez NEXA Rentals à Magaluf. Le retrait et le retour s’effectuent actuellement dans notre agence de Magaluf.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui. Chez NEXA Rentals, vous pouvez réserver votre scooter et payer le montant de la location directement en ligne. Votre scooter est ainsi confirmé pour votre séjour à Majorque.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vous devez posséder un permis A, A1 ou A2. Avec un permis voiture B, vous pouvez conduire un scooter 125cc si votre permis est valide depuis au moins 3 ans.",
        },
      },
      {
        "@type": "Question",
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Location de scooter à Majorque, directement à Magaluf.</h1>

            <p className="nexa-hero-text">
              Vous recherchez une{" "}
              <strong>location de scooter à Majorque</strong>, une{" "}
              <strong>location de scooter à Magaluf</strong> ou un{" "}
            ...
            <p className="nexa-hero-text small">
              ...
              Ponsa, Calvià, les journées à la plage, les points de vue, les
              beach clubs et les excursions sans dépendre des taxis.
            </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>La façon simple de louer un scooter à Majorque.</h2>

            <p>
              De nombreux voyageurs attendent d’être sur place pour chercher
              une location de scooter à Majorque, Magaluf ou Palmanova. Avec
              NEXA Rentals, tout est plus simple : vous réservez votre scooter
              125cc en ligne, payez en ligne et le récupérez directement dans
              notre agence à Magaluf. Vous ne perdez pas de temps pendant vos
              vacances et vous savez à l’avance que votre scooter sera prêt.
            </p>
            ...
            <p>
              ...
              Nova, Portals Nous, Santa Ponsa et Calvià. Plus besoin d’attendre
              un taxi ou de suivre les horaires de bus : montez sur votre
              scooter et découvrez Majorque à votre rythme.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              ...
              <li>
                Retrait et retour chez NEXA Rentals directement à Magaluf
              </li>
            </ul>
          </aside>
        </div>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Votre scooter à Majorque en seulement quelques étapes.</h2>
          ...
          <div className="nexa-how-grid">
            <div>
              ...
              <p>
                ...
                location. La réservation est rapide, claire et pensée pour les
                voyageurs à Majorque.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                votre scooter. Votre véhicule sera réservé pour votre séjour à
                Magaluf ou Palmanova.
              </p>
            </div>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Pour les voyageurs francophones qui veulent découvrir Majorque en
            toute liberté.
          </h2>

          <p>
            Lorsque vous recherchez sur Google « location scooter Majorque »,
            « location scooter Magaluf », « louer un scooter à Palmanova » ou
            « scooter 125cc Majorque », vous voulez généralement une solution
            simple, rapide et transparente. Cette page vous présente toutes les
            informations nécessaires pour réserver en ligne, récupérer votre
            scooter à Magaluf et commencer immédiatement à découvrir l’île.
          </p>

          <p>
            NEXA Rentals est particulièrement pratique si vous séjournez à
            Magaluf, Palmanova, Palma Nova, Torrenova, Santa Ponsa ou Calvià.
            Réservez votre scooter en ligne puis partez directement depuis
            notre agence. Notre objectif est simple : une mobilité facile, des
            prix clairs et un moyen rapide de rejoindre les plages,
            restaurants, points de vue et villages de Majorque.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Réserver scooter Majorque</span>
          ...
          <div className="nexa-faq-list">
            <details>
              ...
              <p>
                ...
                est valide depuis au moins 3 ans. Les permis provisoires ou
                permis d’apprentissage ne sont pas acceptés.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Le retrait et le retour s’effectuent directement chez NEXA
                Rentals à Magaluf. Nous ne proposons actuellement pas de
                service de livraison. La remise du scooter reste ainsi rapide,
                claire et sécurisée.
              </p>
            </details>
            ...
            <details>
              ...
              <p>
                Oui. Notre agence à Magaluf est idéalement située si vous
                séjournez à Magaluf, Palmanova, Palma Nova, Torrenova, Santa
                Ponsa ou Calvià.
              </p>
            </details>
          </div>
