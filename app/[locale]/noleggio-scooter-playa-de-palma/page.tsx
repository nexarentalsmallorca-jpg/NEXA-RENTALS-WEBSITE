...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideale per la navigazione lungo Playa de Palma.",
  },
  {
...
function getLanguageHref(languageCode: Locale) {
  if (languageCode === "it") {
    return "/it/noleggio-scooter-playa-de-palma";
  }
...
export async function generateMetadata({
  ...
  return {
    title:
      "Noleggio scooter Playa de Palma | Scooter 125cc Ballermann | NEXA Rentals",
    description:
      "Noleggio scooter a Playa de Palma. Prenota online uno scooter 125cc con NEXA Rentals, ritiralo a Magaluf ed esplora Playa de Palma, Ballermann, El Arenal, S’Arenal, Can Pastilla, Palma e Maiorca.",
    keywords: [
      "noleggio scooter Playa de Palma",
      "affitto scooter Playa de Palma",
      "scooter 125cc Playa de Palma",
      "noleggio motorino Playa de Palma",
      "scooter a noleggio Playa de Palma",
      "scooter rental Playa de Palma",
      "noleggio scooter Ballermann",
      "affitto scooter Ballermann",
      ...
      "noleggio scooter aeroporto di Palma",
      "affitto scooter aeroporto di Palma",
      "noleggio scooter Palma di Maiorca",
      "prenotare scooter online Playa de Palma",
      "NEXA Rentals Playa de Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical:
        "https://www.nexarentals.es/it/noleggio-scooter-playa-de-palma",
    },
    openGraph: {
      title: "Noleggio scooter Playa de Palma | NEXA Rentals Maiorca",
      description:
        "Prenota online uno scooter 125cc per Playa de Palma, Ballermann, El Arenal, S’Arenal e Can Pastilla. Ritiro presso NEXA Rentals a Magaluf.",
      url: "https://www.nexarentals.es/it/noleggio-scooter-playa-de-palma",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Noleggio scooter a Playa de Palma con NEXA Rentals Maiorca",
        },
      ],
      locale: "it_IT",
      type: "website",
...
export default async function NoleggioScooterPlayaDePalmaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Posso noleggiare uno scooter a Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Puoi prenotare online il tuo scooter 125cc con NEXA Rentals e ritirarlo direttamente a Magaluf. È una soluzione pratica per chi soggiorna a Playa de Palma, Ballermann, El Arenal, S’Arenal e Can Pastilla.",
        },
      },
      {
        "@type": "Question",
        name: "Quanto dista NEXA Rentals da Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals si trova a Magaluf. Da Playa de Palma puoi raggiungere la nostra sede in circa 30-35 minuti in auto, a seconda del traffico. Il ritiro e la riconsegna avvengono direttamente presso NEXA Rentals a Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Uno scooter è pratico per Playa de Palma e Ballermann?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Sì. Uno scooter 125cc è pratico per collegare liberamente Playa de Palma, Ballermann, El Arenal, Can Pastilla, Palma, Portixol, Cala Major e altre località di Maiorca.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "È disponibile la consegna a Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "Noleggio scooter 125cc a Playa de Palma",
      price: "39",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                A circa 30–35 minuti da Playa de Palma
              </span>
            ...
            <h1>
              Noleggia uno scooter a Playa de Palma ed esplora Maiorca in
              libertà.
            </h1>

            <p className="nexa-hero-text">
              Cerchi un <strong>noleggio scooter a Playa de Palma</strong>, uno{" "}
              <strong>scooter a noleggio al Ballermann</strong> o uno{" "}
              <strong>scooter 125cc a El Arenal</strong>? Con NEXA Rentals
              prenoti online, paghi in modo sicuro e ritiri il tuo scooter
              direttamente a Magaluf.
            </p>

            <p className="nexa-hero-text small">
              Ideale per Playa de Palma, Ballermann, El Arenal, S’Arenal, Can
              Pastilla, Palma, Portixol e le escursioni giornaliere a Maiorca.
              Perfetto per collegare liberamente spiaggia, città, ristoranti e
              costa.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Noleggio scooter a Playa de Palma e Ballermann"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>
          Per Playa de Palma, Ballermann, El Arenal, S’Arenal e Can Pastilla
        </p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>
              Collega più facilmente Playa de Palma, Ballermann e Palma.
            </h2>

            <p>
              Playa de Palma è perfetta per la spiaggia, il lungomare, i
              ristoranti, gli hotel e le escursioni verso Palma o Can Pastilla.
              Con uno scooter 125cc puoi muoverti con maggiore libertà, senza
              dover pianificare ogni spostamento in autobus, in taxi o in base
              alla disponibilità dei parcheggi.
            </p>

            <p>
              NEXA Rentals è una soluzione pratica per chi cerca un noleggio
              scooter a Playa de Palma, uno scooter a noleggio al Ballermann o
              un motorino a El Arenal. Prenoti online, paghi online e ritiri il
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>Scooter 125cc per Playa de Palma e Maiorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>
            Prenota il tuo scooter da Playa de Palma in tre semplici passaggi.
          </h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Playa de Palma, El Arenal, Palma o il tuo itinerario sull’isola.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Prenota ora lo scooter per Playa de Palma
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Per chi vuole esplorare Playa de Palma e Maiorca in completa
            libertà.
          </h2>

          <p>
            Quando cerchi “noleggio scooter Playa de Palma”, “affitto scooter
            Playa de Palma”, “noleggio scooter Ballermann”, “scooter 125cc El
            Arenal” o “noleggio motorino Can Pastilla”, hai bisogno di una
            soluzione semplice: prenotazione online, pagamento sicuro e uno
            scooter 125cc per muoverti liberamente.
          </p>

          <p>
            Uno scooter è particolarmente pratico per gli spostamenti tra Playa
            de Palma, Ballermann, El Arenal, S’Arenal, Can Pastilla, Palma,
            Portixol, Cala Major, Magaluf e Palmanova. NEXA Rentals offre una
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Affitto scooter Playa de Palma</span>
            <span>Noleggio scooter Ballermann</span>
            <span>Noleggio scooter El Arenal</span>
            <span>Noleggio scooter S’Arenal</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Domande sul noleggio scooter a Playa de Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>
                Posso prenotare uno scooter per Playa de Palma?
              </summary>
              <p>
                ...
                Playa de Palma, Ballermann, El Arenal, S’Arenal e Can Pastilla.
              </p>
            </details>

            <details>
              <summary>
                Quanto dista NEXA Rentals da Playa de Palma?
              </summary>
              <p>
                La nostra sede si trova a Magaluf. Da Playa de Palma puoi
                raggiungerci in circa 30-35 minuti in auto, a seconda del
            ...
            <details>
              <summary>
                È disponibile la consegna a Playa de Palma?
              </summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Pronto a esplorare Playa de Palma?</h3>
            <p>
