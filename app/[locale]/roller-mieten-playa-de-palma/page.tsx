// app/[locale]/roller-mieten-playa-de-palma/page.tsx
...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal für Navigation an der Playa de Palma.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Roller mieten Playa de Palma | 125cc Scooter Ballermann | NEXA Rentals",
    description:
      "Roller mieten an der Playa de Palma. 125cc Scooter online bei NEXA Rentals buchen, in Magaluf abholen und Playa de Palma, Ballermann, El Arenal, S’Arenal, Can Pastilla, Palma und Mallorca flexibel entdecken.",
    keywords: [
      "Roller mieten Playa de Palma",
      "Scooter mieten Playa de Palma",
      "125cc Roller Playa de Palma",
      "Motorroller mieten Playa de Palma",
      "Roller Verleih Playa de Palma",
      "Scooter Rental Playa de Palma",
      "Roller mieten Ballermann",
      "Scooter mieten Ballermann",
      "125cc Roller Ballermann",
      ...
      "Roller online buchen Playa de Palma",
      "NEXA Rentals Playa de Palma",
      "NEXA Rentals Magaluf",
    ],
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/roller-mieten-playa-de-palma`,
    },
    openGraph: {
      title: "Roller mieten Playa de Palma | NEXA Rentals Mallorca",
      description:
        "125cc Roller für Playa de Palma, Ballermann, El Arenal, S’Arenal und Can Pastilla online buchen. Abholung bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/roller-mieten-playa-de-palma`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Roller mieten Playa de Palma bei NEXA Rentals Mallorca",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerMietenPlayaDePalmaPage({
  params,
}: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Kann ich an der Playa de Palma einen Roller mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und ihn direkt in Magaluf abholen. Das ist praktisch für Gäste aus Playa de Palma, Ballermann, El Arenal, S’Arenal und Can Pastilla.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Playa de Palma entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf. Von Playa de Palma erreichst du unseren Standort je nach Verkehr ungefähr in 30 bis 35 Minuten mit dem Auto. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Ist ein Roller praktisch für Playa de Palma und Ballermann?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Ja. Ein 125cc Roller ist praktisch, wenn du Playa de Palma, Ballermann, El Arenal, Can Pastilla, Palma, Portixol, Cala Major oder weitere Orte auf Mallorca flexibel verbinden möchtest.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "Gibt es Lieferung zur Playa de Palma?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Playa de Palma",
      priceCurrency: "EUR",
  ...
  return (
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/roller-mieten-playa-de-palma`}
                      className={
                        active
          ...
          <div className="nexa-hero-copy">
            <div className="nexa-hero-topline">
              <span className="nexa-hero-kicker">
                Ca. 30–35 Min. von Playa de Palma entfernt
              </span>
            ...
            <h1>Roller mieten an der Playa de Palma und Mallorca frei erleben.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Roller mieten Playa de Palma</strong>,{" "}
              <strong>Scooter mieten Ballermann</strong> oder{" "}
              <strong>125cc Roller El Arenal</strong>? Bei NEXA Rentals buchst
              du deinen Roller online, bezahlst sicher online und holst ihn
              direkt in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Playa de Palma, Ballermann, El Arenal, S’Arenal, Can
              Pastilla, Palma, Portixol und Tagesausflüge auf Mallorca. Perfekt,
              wenn du Strand, Stadt, Restaurants und Küste flexibel verbinden
              möchtest.
            </p>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Scooter mieten Playa de Palma Ballermann"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        <p>Für Playa de Palma, Ballermann, El Arenal, S’Arenal und Can Pastilla</p>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Playa de Palma, Ballermann und Palma flexibler verbinden.</h2>

            <p>
              Playa de Palma ist perfekt für Strand, Promenade, Restaurants,
              Hotels und Ausflüge Richtung Palma oder Can Pastilla. Mit einem
              125cc Roller bist du flexibler unterwegs und musst nicht jeden Weg
              mit Bus, Taxi oder langer Parkplatzsuche planen.
            </p>

            <p>
              NEXA Rentals ist eine starke Option für Gäste, die nach Roller
              mieten Playa de Palma, Scooter mieten Ballermann oder Motorroller
              mieten El Arenal suchen. Du buchst online, bezahlst online und
              holst deinen Roller direkt in Magaluf ab.
            </p>
          </article>
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Playa de Palma und Mallorca</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>Von Playa de Palma zur Roller-Buchung in drei einfachen Schritten.</h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Playa de Palma, El Arenal, Palma oder deine Insel-Tour.
              </p>
            </div>
          ...
          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller für Playa de Palma buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          ...
          <h2>
            Für Gäste, die Playa de Palma und Mallorca unabhängig entdecken möchten.
          </h2>

          <p>
            Wenn du nach “Roller mieten Playa de Palma”, “Scooter mieten Playa
            de Palma”, “Roller mieten Ballermann”, “125cc Roller El Arenal” oder
            “Motorroller mieten Can Pastilla” suchst, brauchst du eine einfache
            Lösung: online buchen, sicher bezahlen und mit einem 125cc Roller
            flexibel unterwegs sein.
          </p>

          <p>
            Besonders praktisch ist ein Roller für Wege zwischen Playa de Palma,
            Ballermann, El Arenal, S’Arenal, Can Pastilla, Palma, Portixol, Cala
            Major, Magaluf und Palmanova. NEXA Rentals bietet dir eine einfache
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Scooter mieten Playa de Palma</span>
            <span>Roller mieten Ballermann</span>
            <span>Roller mieten El Arenal</span>
            <span>Roller mieten S’Arenal</span>
            <span>Roller mieten Can Pastilla</span>
            <span>125cc Roller Playa de Palma</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Roller mieten an der Playa de Palma</h2>

          <div className="nexa-faq-list">
            <details>
              <summary>Kann ich einen Roller für Playa de Palma buchen?</summary>
              <p>
                Ja. Du kannst deinen 125cc Roller online bei NEXA Rentals buchen
                und ihn direkt in Magaluf abholen. Das ist praktisch für Playa
                de Palma, Ballermann, El Arenal, S’Arenal und Can Pastilla.
              </p>
            </details>

            <details>
              <summary>
                Wie weit ist NEXA Rentals von Playa de Palma entfernt?
              </summary>
              <p>
                Unser Standort befindet sich in Magaluf. Von Playa de Palma sind
                es je nach Verkehr ungefähr 30 bis 35 Minuten mit dem Auto.
            ...
            <details>
              <summary>Gibt es Lieferung zur Playa de Palma?</summary>
              <p>
          ...
          <div className="nexa-final-cta">
            <h3>Bereit für Playa de Palma?</h3>
            <p>
