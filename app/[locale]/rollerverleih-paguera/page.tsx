...
const INCLUDED_ITEMS = [
  ...
  },
  {
    ...
    text: "Ideal für Navigation von Paguera über Mallorca.",
  },
  {
...
export async function generateMetadata({
  ...
  return {
    title:
      "Rollerverleih Paguera | Roller mieten Paguera Mallorca | NEXA Rentals",
    description:
      "Roller mieten in Paguera / Peguera Mallorca: 125cc Roller ab 39€ bei NEXA Rentals online buchen, online bezahlen und in Magaluf abholen. Nur ca. 10 Minuten von Paguera entfernt. Ideal für Paguera, Camp de Mar, Cala Fornells, Santa Ponsa und Südwest-Mallorca.",
    keywords: [
      "Rollerverleih Paguera",
      "Roller mieten Paguera",
      "Roller mieten Peguera",
      "Roller mieten Paguera Mallorca",
      "Motorroller mieten Paguera",
      "Scooter mieten Paguera",
      "125cc Roller Paguera",
      "125cc Roller Peguera",
      "Roller Verleih Paguera Mallorca",
      "Roller Paguera online buchen",
    ...
    alternates: {
      canonical: `https://www.nexarentals.es/${locale}/rollerverleih-paguera`,
    },
    openGraph: {
      title: "Rollerverleih Paguera | Roller mieten bei NEXA Rentals",
      description:
        "125cc Roller für Paguera und Südwest-Mallorca online buchen. Nur ca. 10 Minuten von Paguera entfernt. Abholung und Rückgabe bei NEXA Rentals in Magaluf.",
      url: `https://www.nexarentals.es/${locale}/rollerverleih-paguera`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Rollerverleih Paguera Mallorca bei NEXA Rentals",
        },
      ],
      locale: "de_DE",
      type: "website",
...
export default async function RollerverleihPagueraPage({ params }: PageProps) {
  const locale = await getPageLocale(params);
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Wo kann ich einen Roller in Paguera oder Peguera mieten?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Du kannst deinen 125cc Roller online bei NEXA Rentals buchen und im Büro in Magaluf abholen. NEXA Rentals ist nur ca. 10 Minuten von Paguera entfernt und ideal für Gäste, die in Paguera, Peguera, Camp de Mar, Cala Fornells oder Santa Ponsa wohnen.",
        },
      },
      {
        "@type": "Question",
        name: "Wie weit ist NEXA Rentals von Paguera entfernt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "NEXA Rentals befindet sich in Magaluf und ist mit dem Auto oder Taxi nur ca. 10 Minuten von Paguera entfernt. Die Abholung und Rückgabe erfolgt direkt im Büro von NEXA Rentals in Magaluf.",
        },
      },
      {
        "@type": "Question",
        name: "Gibt es eine Lieferung nach Paguera?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Aktuell bieten wir keinen Lieferservice nach Paguera an. Abholung und Rückgabe erfolgen direkt bei NEXA Rentals in Magaluf, damit die Übergabe schnell, sicher und klar bleibt.",
        },
      },
      {
        "@type": "Question",
        name: "Kann ich den Roller für Paguera online bezahlen?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Was ist beim Rollerverleih Paguera inklusive?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  const localBusinessSchema = {
    ...
    makesOffer: {
      "@type": "Offer",
      name: "125cc Roller mieten Paguera Mallorca",
      priceCurrency: "EUR",
    ...
    <main className={`${pageFont.variable} nexa-seo-page`}>
              ...
              <div className="nexa-seo-language-menu">
                {LANGUAGES.map((language) => {
                  ...
                  return (
                    <Link
                      key={language.code}
                      href={`/${language.code}/rollerverleih-paguera`}
                      className={
                        active
      ...
      <section className="nexa-hero-section">
        <div className="nexa-hero-grid">
          <div className="nexa-hero-copy">
            <h1>Rollerverleih Paguera: 125cc Roller für Mallorca mieten.</h1>

            <p className="nexa-hero-text">
              Du suchst nach <strong>Rollerverleih Paguera</strong>,{" "}
              <strong>Roller mieten Paguera</strong> oder{" "}
              <strong>125cc Roller Peguera Mallorca</strong>? Bei NEXA Rentals
              buchst du deinen Roller online, bezahlst den Mietpreis direkt
              online und holst deinen 125cc Roller unkompliziert in Magaluf ab.
            </p>

            <p className="nexa-hero-text small">
              Ideal für Gäste in Paguera, Peguera, Cala Fornells, Camp de Mar,
              Santa Ponsa und Südwest-Mallorca, die Strände, Restaurants,
            ...
            <div className="nexa-distance-note">
              <div>
                <strong>Nur ca. 10 Minuten von Paguera entfernt.</strong>
                <span>
                  NEXA Rentals befindet sich in Magaluf — einfach online buchen,
                  in Magaluf abholen und direkt Richtung Paguera, Camp de Mar
                  oder Santa Ponsa starten.
                </span>
              </div>
            ...
            <div className="nexa-visual-stack">
              ...
              <div className="nexa-photo-card nexa-photo-card-top">
                <Image
                  ...
                  alt="Rollerverleih Paguera Mallorca mit NEXA Rentals"
                  width={900}
                  height={620}
                  priority
              ...
              <div className="nexa-photo-card nexa-photo-card-bottom">
                <Image
                  ...
                  alt="Roller mieten Paguera und Südwest Mallorca"
                  width={900}
                  height={720}
                  className="nexa-hero-image"
                />
      ...
      <section className="nexa-trust-section">
        ...
        <div className="nexa-trust-logos">
          <span>Rollerverleih Paguera</span>
          <span>Roller mieten Peguera</span>
          <span>10 Min. von Paguera</span>
      ...
      <section className="nexa-content-section">
        <div className="nexa-content-grid">
          <article>
            ...
            <h2>Roller mieten nahe Paguera: einfach online buchen.</h2>

            <p>
              Viele Urlauber in Paguera oder Peguera suchen nach einem
              zuverlässigen Rollerverleih auf Mallorca, damit sie nicht jeden
              Tag auf Taxi, Bus oder lange Wartezeiten angewiesen sind. Bei NEXA
              Rentals machst du es einfacher: Du reservierst deinen 125cc Roller
              online, bezahlst online und holst ihn direkt im Büro in Magaluf
              ab.
            </p>

            <p>
              NEXA Rentals ist nur ca. 10 Minuten von Paguera entfernt und
              dadurch praktisch für Gäste in Paguera, Cala Fornells, Camp de
              Mar, Santa Ponsa, Palmanova, Magaluf und Calvià. Du kannst
              Strände, Buchten, Restaurants und Aussichtspunkte in deinem
          ...
          <aside className="nexa-info-box">
            ...
            <ul>
              <li>125cc Roller für Paguera und Mallorca</li>
              <li>Nur ca. 10 Minuten von Paguera entfernt</li>
      ...
      <section className="nexa-how-section">
        <div className="nexa-how-inner">
          ...
          <h2>In wenigen Schritten zum Roller für Paguera.</h2>
          ...
          <div className="nexa-how-grid">
            ...
            <div>
              ...
              <p>
                ...
                Paguera entfernt. Wir erklären dir alles und du kannst direkt
                Richtung Paguera, Strand oder Ausflug losfahren.
              </p>
            </div>
          </div>

          <Link href={bookHref} className="nexa-bottom-cta">
            Jetzt Roller für Paguera buchen
          </Link>
        </div>
      </section>
      ...
      <section className="nexa-seo-text-section">
        <div className="nexa-seo-text-inner">
          <span className="nexa-section-label">Rollerverleih Paguera</span>

          <h2>
            Für deutsche Gäste, die Paguera und Mallorca flexibel erleben
            möchten.
          </h2>

          <p>
            Wenn du bei Google nach “Rollerverleih Paguera”, “Roller mieten
            Paguera”, “Roller mieten Peguera”, “Motorroller mieten Paguera”
            oder “125cc Roller Paguera Mallorca” suchst, willst du meistens
            keine komplizierte Seite, sondern eine schnelle Lösung. Genau dafür
            ist NEXA Rentals gemacht: klare Informationen, echte Online-Buchung,
            sichere Online-Zahlung und ein Roller, mit dem du Mallorca flexibel
            erleben kannst.
          </p>

          <p>
            Diese Seite ist besonders praktisch, wenn du in Paguera, Peguera,
            Cala Fornells, Camp de Mar, Santa Ponsa oder im Südwesten von
            Mallorca wohnst. NEXA Rentals befindet sich in Magaluf und ist nur
            ca. 10 Minuten von Paguera entfernt. Aktuell bieten wir keine
            Lieferung nach Paguera an: Die Abholung und Rückgabe erfolgt direkt
            bei NEXA Rentals in Magaluf. So bleibt die Übergabe persönlich,
            schnell und sauber organisiert.
          </p>
          ...
          <div className="nexa-keyword-cloud">
            ...
            <span>Roller mieten Peguera</span>
            <span>125cc Roller Paguera</span>
            <span>Motorroller mieten Paguera</span>
            <span>Scooter mieten Paguera</span>
            <span>Roller mieten Camp de Mar</span>
            <span>10 Minuten von Paguera</span>
      ...
      <section className="nexa-faq-section">
        <div className="nexa-faq-inner">
          ...
          <h2>Fragen zum Rollerverleih Paguera</h2>
          ...
          <div className="nexa-faq-list">
            ...
            <details>
              <summary>Wie weit ist NEXA Rentals von Paguera entfernt?</summary>
              <p>
                NEXA Rentals befindet sich in Magaluf und ist nur ca. 10 Minuten
                von Paguera entfernt. Du kannst online buchen, den Roller in
                Magaluf abholen und direkt Richtung Paguera, Camp de Mar, Cala
                Fornells oder Santa Ponsa starten.
              </p>
            </details>

            <details>
              <summary>Kann ich den Roller direkt nach Paguera liefern lassen?</summary>
              <p>
                Aktuell bieten wir keinen Lieferservice nach Paguera an. Die
            ...
            <details>
              <summary>Ist NEXA Rentals gut für Paguera, Peguera und Camp de Mar?</summary>
              <p>
                Ja. NEXA Rentals ist ideal, wenn du in Paguera, Peguera, Cala
                Fornells, Camp de Mar, Santa Ponsa, Magaluf oder Palmanova
          ...
          <div className="nexa-final-cta">
            <h3>Bereit für Paguera und Mallorca?</h3>
            <p>
              Buche deinen 125cc Roller online und starte direkt bei NEXA
              Rentals in Magaluf — nur ca. 10 Minuten von Paguera entfernt.
            </p>
