...
const LANGUAGES: {
  ...
  { code: "sr", label: "Srpski", short: "SR", flagSrc: "/images/CS.png" },
...
/* Mobile page offset only. */
const MOBILE_PAGE_TOP_OFFSET_PX = 0;

/* Mobile navbar black-background trigger only. */
...
function getLocaleFromPath(pathname: string): Locale {
  ...
  return isLocale(firstPart) ? firstPart : "en";
}
