      ...
      <section className="grid gap-5 lg:grid-cols-2">
        <div className="rounded-[32px] border border-white/10 bg-[#080A10]/80 p-6 shadow-[0_25px_90px_rgba(0,0,0,0.4)] backdrop-blur-xl">
          ...
          <div className="mt-5 space-y-4">
            <input className="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-4 text-white outline-none placeholder:text-white/30" placeholder="Deposit amount: €150" />
            <input className="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-4 text-white outline-none placeholder:text-white/30" placeholder="Max rental days: 6" />
            <input className="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-4 text-white outline-none placeholder:text-white/30" placeholder="Shop opening time: 09:30" />
            <input className="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-4 text-white outline-none placeholder:text-white/30" placeholder="Shop closing time: 20:00" />
          </div>
        </div>
