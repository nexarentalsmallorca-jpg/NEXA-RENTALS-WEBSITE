...
export default function GoogleReviewsV3() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mb-[clamp(26px,3.2vw,46px)] max-w-[1320px] px-5 text-center sm:px-8">
        <div className="mx-auto inline-flex items-center gap-3 rounded-full border border-black/10 bg-white/75 px-5 py-2.5 shadow-[0_14px_45px_rgba(0,0,0,0.08)] backdrop-blur-xl">
      ...
      <div className="relative">
        <div className="pointer-events-none absolute inset-y-0 left-0 z-20 w-[72px] bg-gradient-to-r from-[#0a0a0a] via-[#141414]/75 to-transparent sm:w-[clamp(110px,12vw,220px)]" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-20 w-[72px] bg-gradient-to-l from-[#0a0a0a] via-[#141414]/75 to-transparent sm:w-[clamp(110px,12vw,220px)]" />
